...
typedef struct
{
    U8 URSA_6M30_LVDS_CHANNEL_SWAP_MODE;
    U8 URSA_6M30_IN_LVDS_TIMODE;
    U8 URSA_6M30_IN_LVDS_TI_BITNUM;
    U8 URSA_6M30_OUT_LVDS_TIMODE;
    U8 URSA_6M30_OUT_LVDS_TI_BITNUM;
    U8 URSA_6M30_SSC_SEL;
    U8 URSA_6M30_SSC_ENABLE;
    U16 URSA_6M30_SSC_FREQ;
    U16 URSA_6M30_SSC_PERCENT;
}ursa_6m30_cmd_table;

#if defined(PCB_WITH_MFC) && (CONFIG_VESTEL_MB97 == 1)
typedef struct
{
    U8 URSA5_LVDS_TX_PANEL_TYPE :3;
    U8 URSA5_MASK_HS :1;
    U8 URSA5_MASK_VS :1;
    U8 URSA5_MASK_DE :1;
    U8 URSA5_PANEL_INV_HSYNC :1;
    U8 URSA5_PANEL_INV_VSYNC :1;
    U8 URSA5_PANEL_INV_DE :1;
    U8 URSA5_DITHER_8BITS :1;
    U8 URSA5_DITHER_EN :1;

    U8 URSA5_LVDS_TX_SWAP_PAIR :1;
    U8 URSA5_LVDS_TX_SWAP_POL :1;
    U8 URSA5_LVDS_TX_INCREASE_VTOTAL_FOR_50HZ :1;
    U8 URSA5_DITHER_TAIL_CUT :1;

    U8 URSA5_LVDS_TX_CHANNEL_SWAP_CHANNEL_A :4;
    U8 URSA5_LVDS_TX_CHANNEL_SWAP_CHANNEL_B :4;
    U8 URSA5_LVDS_TX_CHANNEL_SWAP_CHANNEL_C :4;
    U8 URSA5_LVDS_TX_CHANNEL_SWAP_CHANNEL_D :4;

    U8 URSA5_LVDS_TX_CHANNEL_NUMBER;
    U8 URSA5_LVDS_TX_BIT_NUMBER;

    U16 URSA5_CUS_PANEL_SWING_DATA;
    U16 URSA5_LVDS_TX_HTOTAL;
    U16 URSA5_LVDS_TX_VTOTAL;
    U16 URSA5_LVDS_TX_HSTART;
    U16 URSA5_LVDS_TX_VSTART;
    U16 URSA5_LVDS_TX_WIDTH;
    U16 URSA5_LVDS_TX_HEIGHT;

    U8 URSA5_LVDS_TX_SHIFT_PAIR :1;
    U8 URSA5_LVDS_TX_TI_MODE :1;
    U8 URSA5_ENABLE_MST_MIRROR_FUNC :1;

    U8 URSA5_LVDS_RX_TI_MODE :1;
    U8 URSA5_LVDS_RX_SWAP_ODD_EVEN :1;

    U8 URSA5_LVDS_RX_CHCONNECT;
    U8 URSA5_LVDS_RX_BIT_NUM;

    U8 URSA5_CUS_LVDS_RX_SWAP_MSB_LSB;
    U8 URSA5_CUS_LVDS_RX_SWAP_P_N;
}ursa5_cmd_table; 
#endif
typedef struct
{
    U8 URSA_EXTERNAL;
    U8 URSA_MEMC_ENABLE;
    U8 URSA_LVDS_CHANNEL_SWAP_MODE;
    U8 URSA_LVDS_SWAP_POL;
    U8 URSA_IN_LVDS_TIMODE;
    U8 URSA_IN_LVDS_TI_BITNUM;
    U8 URSA_OUT_LVDS_TIMODE;
    U8 URSA_OUT_LVDS_TI_BITNUM;
    U8 URSA_SSC_SEL;
    U8 URSA_SSC_ENABLE;
    U16 URSA_SSC_FREQ;
    U16 URSA_SSC_PERCENT;
	U16 URSA_OSD_PROTECT_MODE;
}ursa_cmd_table;
