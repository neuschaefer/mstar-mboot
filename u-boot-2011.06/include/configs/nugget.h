...
//################MBOOT VERSION###########
#define MBOOT_VERSION_NUMBER		"054"   //Please do not use Hex value
#if (MS_BOARD_TYPE_SEL == BD_MST180F_D01A_S)
#if defined(CONFIG_CPU_1008MHZ)
#define MBOOT_VERSION_HEADER       "MBOOT_VER=MB98H"
#define MBOOT_VERSION       {"MBOOT_VER=MB98H"MBOOT_VERSION_NUMBER}
#else
#define MBOOT_VERSION_HEADER       "MBOOT_VER=MB98L"
#define MBOOT_VERSION       {"MBOOT_VER=MB98L"MBOOT_VERSION_NUMBER}
#endif
#else
#if defined(CONFIG_CPU_1008MHZ)
#define MBOOT_VERSION_HEADER       "MBOOT_VER=MB97H"
#define MBOOT_VERSION       {"MBOOT_VER=MB97H"MBOOT_VERSION_NUMBER}
#else
#define MBOOT_VERSION_HEADER       "MBOOT_VER=MB97L"
#define MBOOT_VERSION       {"MBOOT_VER=MB97L"MBOOT_VERSION_NUMBER}
#endif
#endif
/*
 * Size of malloc() pool
