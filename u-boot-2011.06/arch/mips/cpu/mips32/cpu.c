...
void flush_cache(ulong start_addr, ulong size)
{
    ...
    defined(CONFIG_EMERALD) || defined(CONFIG_NUGGET) || defined(CONFIG_NIKON) || defined(CONFIG_MILAN) || \
    defined(CONFIG_KENYA)|| defined(CONFIG_KERES)|| defined(CONFIG_KRITI)|| defined(CONFIG_KRIS)
