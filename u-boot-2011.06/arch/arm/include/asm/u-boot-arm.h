...
extern ulong _bss_str_start_ofs;
extern ulong _bss_str_end_ofs;
extern ulong uboot2_ofs;
extern ulong _end_str_ofs;
extern ulong __bss_str_end__;
extern ulong __config_text_start;
#endif
