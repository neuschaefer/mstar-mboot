...
#define  ClientGruop0_in_MIU1   (((VIVALDI9_DSP_DECODER == 1)? 0x0002 : 0  )| \
                                 ...
                                 ((FRC_SC_ARB_RW        == 1)? 0x0008 : 0  )| \
                                 ((FRC_R2_RW            == 1)? 0x0010 : 0  )| \
                                 ((AU_R2_RW             == 1)? 0x0020 : 0  )| \
                                 ((MAU1_RW              == 1)? 0x0040 : 0  )| \
                                 ((PM51_RW              == 1)? 0x0080 : 0  )| \
...
#define  ClientGruop0_in_IP     (((VIVALDI9_DSP_DECODER == 2)? 0x0002 : 0  )| \
                                 ...
                                 ((FRC_SC_ARB_RW        == 2)? 0x0008 : 0  )| \
                                 ((FRC_R2_RW            == 2)? 0x0010 : 0  )| \
                                 ((AU_R2_RW             == 2)? 0x0020 : 0  )| \
                                 ((MAU1_RW              == 2)? 0x0040 : 0  )| \
                                 ((PM51_RW              == 2)? 0x0080 : 0  )| \
...
// software selection enable 0: MIU0 1: MIU1
#define  ClientGruop3_in_MIU1     (((MIPS_RW              == 1)? 0x0001 : 0  )| \
                                   ((GOP_W                == 1)? 0x0002 : 0  )| \
                                   ((GOP0_R               == 1)? 0x0004 : 0  )| \
                                   ((GOP1_R               == 1)? 0x0008 : 0  )| \
                                   ((GOP2_R               == 1)? 0x0010 : 0  )| \
                                   ...
                                   ((FRC_OSD_RW           == 1)? 0x0200 : 0  )| \
                                   ((FRC_IP_R             == 1)? 0x0400 : 0  )| \
                                   ((FRC_IP_W             == 1)? 0x0800 : 0  )| \
                                   ((FRC_OD_R             == 1)? 0x1000 : 0  )| \
                                   ((FRC_OD_W             == 1)? 0x2000 : 0  )| \
                                   ((FRC_OPM_R            == 1)? 0x4000 : 0  )| \
                                   ((ADCDVIPLL_W          == 1)? 0x8000 : 0  ))
// Hardware selection enable 0: MIU0 1: depend on IP (software selection is invaild)
#define  ClientGruop3_in_IP       (((MIPS_RW              == 1)? 0x0001 : 0  )| \
                                   ((GOP_W                == 1)? 0x0002 : 0  )| \
                                   ((GOP0_R               == 1)? 0x0004 : 0  )| \
                                   ((GOP1_R               == 1)? 0x0008 : 0  )| \
                                   ((GOP2_R               == 1)? 0x0010 : 0  )| \
