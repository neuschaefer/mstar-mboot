...
#define _A5_ENBEDED_FLASH_      0       // 1: with enbeded flash, 0: without enbeded flash

#if defined (MIPS_CHAKRA) || defined(MSOS_TYPE_LINUX)
#define _MapBase_nonPM_S8 (RIU_MAP + 0x200000)
#define _MapBase_PM_S8    RIU_MAP
#else
#define _MapBase_nonPM_S8 0xA0200000
#define _MapBase_PM_S8   0xA0000000
#endif
...
#define PAD_TS2_SYNC_OUT (PAD_TS2_SYNC_IS_GPIO == GPIO_OUT_HIGH ? BIT0: 0)
        _RVM1(0x2b35, PAD_TS2_SYNC_OUT, BIT0),
        _RVM1(0x2b35, PAD_TS2_SYNC_OEN, BIT1),
#endif
...
#define PAD_TS2_CLK_OUT (PAD_TS2_CLK_IS_GPIO == GPIO_OUT_HIGH ? BIT0: 0)
        _RVM1(0x2b34, PAD_TS2_CLK_OUT, BIT0),
        _RVM1(0x2b34, PAD_TS2_CLK_OEN, BIT1),
#endif
...
#define PAD_EMMC_CDZ_OUT (PAD_EMMC_CDZ_IS_GPIO == GPIO_OUT_HIGH ? BIT0: 0)
        _RVM1(0x2bac, PAD_EMMC_CDZ_OUT, BIT0),
        _RVM1(0x2bac, PAD_EMMC_CDZ_OEN, BIT1),
#endif
...
#if(PAD_MPIF_CLK_IS_GPIO != GPIO_NONE)
#define PAD_MPIF_CLK_OEN (PAD_MPIF_CLK_IS_GPIO == GPIO_IN ? BIT1: 0)
#define PAD_MPIF_CLK_OUT (PAD_MPIF_CLK_IS_GPIO == GPIO_OUT_HIGH ? BIT0: 0)
        _RVM1(0x2b71, PAD_MPIF_CLK_OUT, BIT0),
        _RVM1(0x2b71, PAD_MPIF_CLK_OEN, BIT1),
#endif

#if(PAD_MPIF_BUSY_ERR_IS_GPIO != GPIO_NONE)
#define PAD_MPIF_BUSY_ERR_OEN (PAD_MPIF_BUSY_ERR_IS_GPIO == GPIO_IN ? BIT1: 0)
#define PAD_MPIF_BUSY_ERR_OUT (PAD_MPIF_BUSY_ERR_IS_GPIO == GPIO_OUT_HIGH ? BIT0: 0)
        _RVM1(0x2b72, PAD_MPIF_BUSY_ERR_OUT, BIT0),
        _RVM1(0x2b72, PAD_MPIF_BUSY_ERR_OEN, BIT1),
#endif

#if(PAD_MPIF_CS_N_IS_GPIO != GPIO_NONE)
#define PAD_MPIF_CS_N_OEN (PAD_MPIF_CS_N_IS_GPIO == GPIO_IN ? BIT1: 0)
#define PAD_MPIF_CS_N_OUT (PAD_MPIF_CS_N_IS_GPIO == GPIO_OUT_HIGH ? BIT0: 0)
        _RVM1(0x2b73, PAD_MPIF_CS_N_OUT, BIT0),
        _RVM1(0x2b73, PAD_MPIF_CS_N_OEN, BIT1),
#endif

#if(PAD_MPIF_D0_IS_GPIO != GPIO_NONE)
#define PAD_MPIF_D0_OEN (PAD_MPIF_D0_IS_GPIO == GPIO_IN ? BIT1: 0)
#define PAD_MPIF_D0_OUT (PAD_MPIF_D0_IS_GPIO == GPIO_OUT_HIGH ? BIT0: 0)
        _RVM1(0x2b74, PAD_MPIF_D0_OUT, BIT0),
        _RVM1(0x2b74, PAD_MPIF_D0_OEN, BIT1),
#endif

#if(PAD_MPIF_D1_IS_GPIO != GPIO_NONE)
#define PAD_MPIF_D1_OEN (PAD_MPIF_D1_IS_GPIO == GPIO_IN ? BIT1: 0)
#define PAD_MPIF_D1_OUT (PAD_MPIF_D1_IS_GPIO == GPIO_OUT_HIGH ? BIT0: 0)
        _RVM1(0x2b75, PAD_MPIF_D1_OUT, BIT0),
        _RVM1(0x2b75, PAD_MPIF_D1_OEN, BIT1),
#endif

#if(PAD_MPIF_D2_IS_GPIO != GPIO_NONE)
#define PAD_MPIF_D2_OEN (PAD_MPIF_D2_IS_GPIO == GPIO_IN ? BIT1: 0)
#define PAD_MPIF_D2_OUT (PAD_MPIF_D2_IS_GPIO == GPIO_OUT_HIGH ? BIT0: 0)
        _RVM1(0x2b76, PAD_MPIF_D2_OUT, BIT0),
        _RVM1(0x2b76, PAD_MPIF_D2_OEN, BIT1),
#endif

#if(PAD_MPIF_D3_IS_GPIO != GPIO_NONE)
#define PAD_MPIF_D3_OEN (PAD_MPIF_D3_IS_GPIO == GPIO_IN ? BIT1: 0)
#define PAD_MPIF_D3_OUT (PAD_MPIF_D3_IS_GPIO == GPIO_OUT_HIGH ? BIT0: 0)
        _RVM1(0x2b77, PAD_MPIF_D3_OUT, BIT0),
        _RVM1(0x2b77, PAD_MPIF_D3_OEN, BIT1),
#endif
...
#define I2S_OUT   ((PADS_I2S_OUT == SINGLE_CH_I2S_OUT) ? BIT4 : \
                   (PADS_I2S_OUT == MULTI_CH_I2S_OUT) ? BIT5 : \
                   (PADS_I2S_OUT == MULTI_CH_I2S_OUT_SD) ? BIT5|BIT4 : 0)
        _RVM1(0x1EAE, I2S_OUT, BIT5|BIT4),
#endif

#if (PADS_MPIF_MODE != Unknown_pad_mux)
#define MPIF_MODE   ((PADS_MPIF_MODE == MPIF_PAD_ONE_BIT_MODE) ? BIT1 : \
                     (PADS_MPIF_MODE == MPIF_PAD_TWO_BIT_MODE) ? BIT2 : \
                     (PADS_MPIF_MODE == MPIF_PAD_FOUR_BIT_MODE) ? BIT2|BIT1 : \
                     (PADS_MPIF_MODE == GPIO_PAD_ONE_BIT_MODE) ? BIT3 : \
                     (PADS_MPIF_MODE == GPIO_PAD_TWO_BIT_MODE) ? BIT3|BIT1 : \
                     (PADS_MPIF_MODE == GPIO_PAD_FOUR_BIT_MODE) ? BIT3|BIT2 : 0)
        _RVM1(0x1EDF, MPIF_MODE, BITMASK(3:1)),
#endif

#if (PADS_ET_MODE != Unknown_pad_mux)
#define ET_MODE   ((PADS_ET_MODE == PAD_GPIO25) ? BIT0 : 0)
...
#define SD_MODE   ((PADS_SD_MODE == ENABLE) ? BIT5:  \
        _RVM1(0x1EB4, SD_MODE, BIT5),
#endif
...
//---------------------------------------------------------------------
    ...
    #if (PIN_FLASH_WP0)
      #if ((MS_BOARD_TYPE_SEL == BD_MST129A_D01A_S))
      _RVM1(0x0F06, BIT1, BIT1), //out high = 1 //unprotect //PM3
      _RVM1(0x0F06,    0, BIT0), //oen = 0
      #elif ((MS_BOARD_TYPE_SEL == BD_MST129B_D01A_S))
      _RVM1(0x0F10, BIT1, BIT1), //out high = 1 //unprotect //PM8
      _RVM1(0x0F10,    0, BIT0), //oen = 0
    ...
    #if (PIN_FLASH_WP1)
      #if ((MS_BOARD_TYPE_SEL == BD_MST129A_D01A_S))
      _RVM1(0x0F16, BIT1, BIT1), //out high = 1 //unprotect //PM11
      _RVM1(0x0F16,    0, BIT0), //oen = 0
      #elif (MS_BOARD_TYPE_SEL == BD_MST129B_D01A_S)
      _RVM1(0x0F0E, BIT1, BIT1), //out high = 1 //unprotect //PM7
      _RVM1(0x0F0E,    0, BIT0), //oen = 0
      #elif (MS_BOARD_TYPE_SEL == BD_MST129C_D01A_S)
      _RVM1(0x0F10, BIT1, BIT1), //out high = 1 //unprotect //PM8
      _RVM1(0x0F10,    0, BIT0), //oen = 0
      #elif (MS_BOARD_TYPE_SEL == BD_MST129D_D01A_S)
