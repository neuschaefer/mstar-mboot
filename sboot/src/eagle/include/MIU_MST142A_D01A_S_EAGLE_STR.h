...
#define _MIU_MST142A_D01A_S_EAGLE_STR_H_

#if (ENABLE_MSTAR_BD_MST142A_D01A_S_EAGLE)
...
//bandwidth setting
    ...
    _RV32_2(0x101202, 0xf2a2),      //ck/addr/data/cke/data swap/Nx/col/bank/bus width/dram type => 0x2a2=ddr2+16bits+8banks+10col+4x
...
#endif /* _MIU_MST142A_D01A_S_STR_H_ */
