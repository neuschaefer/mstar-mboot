...
#ifndef _MIU_MST145B_D01A_S_EAGLE_H_
#define _MIU_MST145B_D01A_S_EAGLE_H_

#if (ENABLE_MSTAR_BD_MST145B_D01A_S_EAGLE)

const MS_REG_INIT MIU0_DDR_Init[] =
{
#if defined(CONFIG_MIU0_DDR3_1333)
    _RV32_2(0x110d36, 0x4005),  // reg_DDRPLL_LOOP_DIV_FIRST	: [15:14]	divide by 4
    _RV32_2(0x110d34, 0x0300),  // reg_DDRPLL_LOOP_DIV_SECOND	: [15:14]	divide by 3
    _RV32_2(0x110d30, 0x6b0e),  // set pll to 780 MHz
...
const MS_REG_INIT MIU1_DDR_Init[] =
{
    ...
    _RV32_2(0x110db6, 0x4002),  // reg_DDRPLL_LOOP_DIV_FIRST    : [15:14]   divide by 4
    _RV32_2(0x110db4, 0x0300),  // reg_DDRPLL_LOOP_DIV_SECOND   : [15:14]   divide by 3
    _RV32_2(0x110db0, 0x6b0e),  // set pll to 780 MHz
    _RV32_2(0x110db2, 0x001f),
    ...
    _RV32_2(0x110da4, 0x1000),    //Avoid DDRPLL unknown(MCLK05X & MCLK025X) by resset ddrat[28]
...
#endif  //ENABLE_MSTAR_BD_MST145B_D01A_S_EAGLE

#endif  /* _MIU_MST145B_D01A_S_EAGLE_H_ */
