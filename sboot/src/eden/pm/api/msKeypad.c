...
static BOOLEAN msKeypad_CH_GetKey(U8 Channel, U8 *pkey, U8* pflag)
{
        ...
        *pflag = 0;
        ...
        for ( i = 0; i < KEYPAD_STABLE_NUM; i++ )
        {
            ...
            {
       #if ((MS_BOARD_TYPE_SEL == BD_MST043B_10ALB_12351)||(MS_BOARD_TYPE_SEL == BD_MST043B_10BLB_12413)||(MS_BOARD_TYPE_SEL == BD_MST042B_10BLU_12423)||(MS_BOARD_TYPE_SEL == BD_MST042B_10BLU_12423_32))
