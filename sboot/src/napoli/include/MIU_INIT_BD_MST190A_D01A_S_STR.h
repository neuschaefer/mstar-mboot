...
#ifndef __MIU_BD_MST190A_D01A_S_STR_H__
#define __MIU_BD_MST190A_D01A_S_STR_H__

#if (ENABLE_MSTAR_NAPOLI_BD_MST190A_D01A_S)
const MS_REG_INIT MIU0_DDR_Init_STR[] =
{
    ...
    // === new phy setting ===
    _RV32_2(0x110d1A, 0x0111),
    _RV32_2(0x110d02, 0xAAAA),
    _RV32_2(0x110d04, 0x0080),
    _RV32_2(0x110d3c, 0x0144),
    ...
    _RV32_2(0x110d3a, 0x0004),  //reg_clkph_cmd         0       : [3:0]
                                //reg_clkph_dqsm        0       : [7:4]
                                //reg_clkph_sp0         0       : [11:8]
                                //reg_clkph_sp1         0       : [15:12]

    _RV32_2(0x110d4a, 0x0004),  //reg_clkph_cmd         0       : [3:0]
                                //reg_clkph_dqsm        0       : [7:4]
                                //reg_clkph_sp0         0       : [11:8]
                                //reg_clkph_sp1         0       : [15:12]
    ...
    _RV32_2(0x110d00, 0x2009),  //reg_pkg_sel      1   : [0]
                                //reg_odt_en       1   : [12:9]
    ...
    _RV32_2(0x110d5c, 0x5422),
    _RV32_2(0x110d5e, 0x5422),
...
#if 1
    //DLL DQ deskew (low word)
    _RV32_2(0x110da0, 0x2504),  //reg_dll0_3_deskew[3:0],  reg_dll0_2_deskew[3:0], //reg_dll0_1_deskew[3:0],  reg_dll0_0_deskew[3:0]
    _RV32_2(0x110da2, 0x3739),  //reg_dll0_7_deskew[3:0],  reg_dll0_6_deskew[3:0], //reg_dll0_5_deskew[3:0],  reg_dll0_4_deskew[3:0]
    _RV32_2(0x110da4, 0x8146),  //reg_dll0_11_deskew[3:0], reg_dll0_10_deskew[3:0],//reg_dll0_9_deskew[3:0],  reg_dll0_8_deskew[3:0]
    _RV32_2(0x110da6, 0x4153),  //reg_dll0_15_deskew[3:0], reg_dll0_14_deskew[3:0],//reg_dll0_13_deskew[3:0], reg_dll0_12_deskew[3:0]

    //DLL DQ deskew (high word)
    _RV32_2(0x110da8, 0x1706),  //reg_dll1_3_deskew[3:0],  reg_dll1_2_deskew[3:0], //reg_dll1_1_deskew[3:0],  reg_dll1_0_deskew[3:0]
    _RV32_2(0x110daa, 0x4668),  //reg_dll1_7_deskew[3:0],  reg_dll1_6_deskew[3:0], //reg_dll1_5_deskew[3:0],  reg_dll1_4_deskew[3:0]
    _RV32_2(0x110dac, 0x7346),  //reg_dll1_11_deskew[3:0], reg_dll1_10_deskew[3:0],//reg_dll1_9_deskew[3:0],  reg_dll1_8_deskew[3:0]
    _RV32_2(0x110dae, 0x6053),  //reg_dll1_15_deskew[3:0], reg_dll1_14_deskew[3:0],//reg_dll1_13_deskew[3:0], reg_dll1_12_deskew[3:0]
#endif
    //RX DQSx Phase select
    _RV32_2(0x110d70, 0x0000),  //[11]    : 'h   0 : dline_gated_control
    ...
    _RV32_2(0x110d5a, 0x2222),
    _RV32_2(0x110d5c, 0x5322),
    _RV32_2(0x110d5e, 0x5322),
    _RV32_2(0x110d74, 0x0606),
    _RV32_2(0x110d76, 0x0606),
...
const MS_REG_INIT MIU1_DDR_Init_STR[] =
{
    ...
    // === new phy setting ===
    _RV32_2(0x16161A, 0x0111),
    _RV32_2(0x161602, 0xAAAA),
    _RV32_2(0x161604, 0x0080),
    _RV32_2(0x16163c, 0x0144),
    ...
    _RV32_2(0x16163a, 0x0004),  //reg_clkph_cmd         0       : [3:0]
            //reg_clkph_dqsm        0       : [7:4]
            //reg_clkph_sp0         0       : [11:8]
            //reg_clkph_sp1         0       : [15:12]

    _RV32_2(0x16164a, 0x0004),  //reg_clkph_cmd         0       : [3:0]
            //reg_clkph_dqsm        0       : [7:4]
            //reg_clkph_sp0         0       : [11:8]
            //reg_clkph_sp1         0       : [15:12]
    ...
    //set reg_sel_mclk1x_skew_dq0~17 (high word)
    _RV32_2(0x161686, 0x5555),
    _RV32_2(0x161688, 0x5555),
    _RV32_2(0x16168a, 0x0005),

#if 1
    //DLL DQ deskew (low word)
    _RV32_2(0x1616a0, 0x5703),  //reg_dll0_3_deskew[3:0],  reg_dll0_2_deskew[3:0], //reg_dll0_1_deskew[3:0],  reg_dll0_0_deskew[3:0]
    _RV32_2(0x1616a2, 0x583A),  //reg_dll0_7_deskew[3:0],  reg_dll0_6_deskew[3:0], //reg_dll0_5_deskew[3:0],  reg_dll0_4_deskew[3:0]
    _RV32_2(0x1616a4, 0x7345),  //reg_dll0_11_deskew[3:0], reg_dll0_10_deskew[3:0],//reg_dll0_9_deskew[3:0],  reg_dll0_8_deskew[3:0]
    ...
    _RV32_2(0x1616aa, 0x5556),  //reg_dll1_7_deskew[3:0],  reg_dll1_6_deskew[3:0], //reg_dll1_5_deskew[3:0],  reg_dll1_4_deskew[3:0]
    _RV32_2(0x1616ac, 0x9567),  //reg_dll1_11_deskew[3:0], reg_dll1_10_deskew[3:0],//reg_dll1_9_deskew[3:0],  reg_dll1_8_deskew[3:0]
    _RV32_2(0x1616ae, 0x5165),  //reg_dll1_15_deskew[3:0], reg_dll1_14_deskew[3:0],//reg_dll1_13_deskew[3:0], reg_dll1_12_deskew[3:0]
#endif

    //RX DQSx Phase select
    _RV32_2(0x161670, 0x0000),  //[11]    : 'h   0 : dline_gated_control
    _RV32_2(0x16166c, 0x201B),  //[ 6: 0] : 'h   f : reg_dll0_ph //[14: 8] : 'h   f : reg_dll1_ph
    _RV32_2(0x16166e, 0x1D1F),  //[ 6: 0] : 'h   f : reg_dll2_ph //[14: 8] : 'h   f : reg_dll3_ph
    ...
    _RV32_2(0x161600, 0x2009),  //reg_pkg_sel      1   : [0]
            //reg_odt_en       1   : [12:9]
    ...
    _RV32_2(0x16165a, 0x2222),
    _RV32_2(0x16165c, 0x5422),
    _RV32_2(0x16165e, 0x5422),
    ...
    _RV32_2(0x100602, 0xF3A7),  //reg_dram_type		10	: [1:0]   00 : sdr, 01 : ddr, 10 : ddr2, 11 : ddr3
    _RV32_2(0x100604, 0x000C),  //reg_rd_timing		9	: [4:0] reg_1cmd_mode
    _RV32_2(0x100606, 0x0538),  //tREFRESH		2b	: [7:0] * 16
    ...
    _RV32_2(0x16163a, 0x6060),  //reg_clkph_cmd         0       : [3:0]
                                //reg_clkph_dqsm        0       : [7:4]
                                //reg_clkph_sp0         0       : [11:8]
                                //reg_clkph_sp1         0       : [15:12]
...
#if 1
    //DLL DQ deskew (low word)
    _RV32_2(0x1616a0, 0x4703),  //reg_dll0_3_deskew[3:0],  reg_dll0_2_deskew[3:0], //reg_dll0_1_deskew[3:0],  reg_dll0_0_deskew[3:0]
    _RV32_2(0x1616a2, 0x6759),  //reg_dll0_7_deskew[3:0],  reg_dll0_6_deskew[3:0], //reg_dll0_5_deskew[3:0],  reg_dll0_4_deskew[3:0]
    _RV32_2(0x1616a4, 0x8056),  //reg_dll0_11_deskew[3:0], reg_dll0_10_deskew[3:0],//reg_dll0_9_deskew[3:0],  reg_dll0_8_deskew[3:0]
    _RV32_2(0x1616a6, 0x6065),  //reg_dll0_15_deskew[3:0], reg_dll0_14_deskew[3:0],//reg_dll0_13_deskew[3:0], reg_dll0_12_deskew[3:0]

    //DLL DQ deskew (high word)
    _RV32_2(0x1616a8, 0x4805),  //reg_dll1_3_deskew[3:0],  reg_dll1_2_deskew[3:0], //reg_dll1_1_deskew[3:0],  reg_dll1_0_deskew[3:0]
    _RV32_2(0x1616aa, 0x5546),  //reg_dll1_7_deskew[3:0],  reg_dll1_6_deskew[3:0], //reg_dll1_5_deskew[3:0],  reg_dll1_4_deskew[3:0]
    _RV32_2(0x1616ac, 0x8477),  //reg_dll1_11_deskew[3:0], reg_dll1_10_deskew[3:0],//reg_dll1_9_deskew[3:0],  reg_dll1_8_deskew[3:0]
    _RV32_2(0x1616ae, 0x5174),  //reg_dll1_15_deskew[3:0], reg_dll1_14_deskew[3:0],//reg_dll1_13_deskew[3:0], reg_dll1_12_deskew[3:0]
#endif

    //RX DQSx Phase select
    _RV32_2(0x161670, 0x0000),  //[11]    : 'h   0 : dline_gated_control
    _RV32_2(0x16166c, 0x171A),  //[ 6: 0] : 'h   f : reg_dll0_ph //[14: 8] : 'h   f : reg_dll1_ph
    ...
    _RV32_2(0x16165a, 0x2222),
    _RV32_2(0x16165c, 0x5322),
    _RV32_2(0x16165e, 0x5322),
    _RV32_2(0x161674, 0x0606),
    _RV32_2(0x161676, 0x0606),
...
#endif /* ENABLE_MSTAR_BD_MST181B_D01A_S */
#endif /* __MIU_INIT_BD_MST181B_D01A_S_H__*/
