...
#ifndef __MIU_BD_MST181B_D01A_S_H__
#define __MIU_BD_MST181B_D01A_S_H__

#if (ENABLE_MSTAR_NAPOLI_BD_MST181B_D01A_S) || (ENABLE_MSTAR_NAPOLI_BD_MST181B_D01A_S_CASHMERE)
...
const MS_REG_INIT MIU0_DDR_Init[] =
{
    ...
    _RV32_2(0x110da0, 0x4607),  //reg_dll0_3_deskew[3:0],  reg_dll0_2_deskew[3:0], //reg_dll0_1_deskew[3:0],  reg_dll0_0_deskew[3:0]
    _RV32_2(0x110da2, 0x696B),  //reg_dll0_7_deskew[3:0],  reg_dll0_6_deskew[3:0], //reg_dll0_5_deskew[3:0],  reg_dll0_4_deskew[3:0]
    _RV32_2(0x110da4, 0x7024),  //reg_dll0_11_deskew[3:0], reg_dll0_10_deskew[3:0],//reg_dll0_9_deskew[3:0],  reg_dll0_8_deskew[3:0]
    _RV32_2(0x110da6, 0x4042),  //reg_dll0_15_deskew[3:0], reg_dll0_14_deskew[3:0],//reg_dll0_13_deskew[3:0], reg_dll0_12_deskew[3:0]

    //DLL DQ deskew (high word)
    _RV32_2(0x110da8, 0x5908),  //reg_dll1_3_deskew[3:0],  reg_dll1_2_deskew[3:0], //reg_dll1_1_deskew[3:0],  reg_dll1_0_deskew[3:0]
    _RV32_2(0x110daa, 0x6668),  //reg_dll1_7_deskew[3:0],  reg_dll1_6_deskew[3:0], //reg_dll1_5_deskew[3:0],  reg_dll1_4_deskew[3:0]
    _RV32_2(0x110dac, 0x7326),  //reg_dll1_11_deskew[3:0], reg_dll1_10_deskew[3:0],//reg_dll1_9_deskew[3:0],  reg_dll1_8_deskew[3:0]
    _RV32_2(0x110dae, 0x4061),  //reg_dll1_15_deskew[3:0], reg_dll1_14_deskew[3:0],//reg_dll1_13_deskew[3:0], reg_dll1_12_deskew[3:0]
#endif
    //RX DQSx Phase select
    _RV32_2(0x110d70, 0x0000),  //[11]    : 'h   0 : dline_gated_control
    _RV32_2(0x110d6c, 0x1515),  //[ 6: 0] : 'h   f : reg_dll0_ph //[14: 8] : 'h   f : reg_dll1_ph
    _RV32_2(0x110d6e, 0x1314),  //[ 6: 0] : 'h   f : reg_dll2_ph //[14: 8] : 'h   f : reg_dll3_ph
    ...
    _RV32_2(0x110d34, 0x2004),  //reg_DDRPLL_LOOP_DIV_SECOND	: [15:14]	divide by 3
    _RV32_2(0x110d30, 0xEC0D),  //set pll to 780 MHz
    //KKK _RV32_2(0x110d32, 0x0030),
    _RV32_2(0x110d32, 0x0030),
    _RV32_2(0x110d24, 0x1000),  //Avoid DDRPLL unknown(MCLK05X & MCLK025X) by resset ddrat[28]
    // delay 10ms
    _RV32_2(0x110d24, 0x0000),
    _RV32_2(0x110d22, 0x0004),
    ...
    //KKK_RV32_2(0x101228, 0x40D0),  //reg_pack_en
    ...
    //KKK_RV32_2(0x110d3a, 0x4040),  //reg_clkph_cmd         0       : [3:0]
    _RV32_2(0x110d3a, 0x0000),  //reg_clkph_cmd         0       : [3:0]
                                //reg_clkph_dqsm        0       : [7:4]
                                //reg_clkph_sp0         0       : [11:8]
                                //reg_clkph_sp1         0       : [15:12]

    //KKK _RV32_2(0x110d4a, 0x4040),  //reg_clkph_cmd         0       : [3:0]
    _RV32_2(0x110d4a, 0x0000),  //reg_clkph_cmd         0       : [3:0]
                                //reg_clkph_dqsm        0       : [7:4]
                                //reg_clkph_sp0         0       : [11:8]
                                //reg_clkph_sp1         0       : [15:12]
    ...
    //RX DQSx Phase select
    _RV32_2(0x110d70, 0x0000),  //[11]    : 'h   0 : dline_gated_control
    _RV32_2(0x110d6c, 0x2020),  //[ 6: 0] : 'h   f : reg_dll0_ph //[14: 8] : 'h   f : reg_dll1_ph
    _RV32_2(0x110d6e, 0x2020),  //[ 6: 0] : 'h   f : reg_dll2_ph //[14: 8] : 'h   f : reg_dll3_ph
    _RV32_2(0x110d70, 0x0800),  //[11]    : 'h   1 : dline_gated_control
...
const MS_REG_INIT MIU1_DDR_Init[] =
{
    ...
    _RV32_2(0x16163a, 0x0000),  //reg_clkph_cmd         0       : [3:0]
                                //reg_clkph_dqsm        0       : [7:4]
                                //reg_clkph_sp0         0       : [11:8]
                                //reg_clkph_sp1         0       : [15:12]

    _RV32_2(0x16164a, 0x0000),  //reg_clkph_cmd         0       : [3:0]
                                //reg_clkph_dqsm        0       : [7:4]
                                //reg_clkph_sp0         0       : [11:8]
                                //reg_clkph_sp1         0       : [15:12]
...
#if 1
    //DLL DQ deskew (low word)
    _RV32_2(0x1616a0, 0x6705),  //reg_dll0_3_deskew[3:0],  reg_dll0_2_deskew[3:0], //reg_dll0_1_deskew[3:0],  reg_dll0_0_deskew[3:0]
    _RV32_2(0x1616a2, 0x6859),  //reg_dll0_7_deskew[3:0],  reg_dll0_6_deskew[3:0], //reg_dll0_5_deskew[3:0],  reg_dll0_4_deskew[3:0]
    _RV32_2(0x1616a4, 0x6145),  //reg_dll0_11_deskew[3:0], reg_dll0_10_deskew[3:0],//reg_dll0_9_deskew[3:0],  reg_dll0_8_deskew[3:0]
    _RV32_2(0x1616a6, 0x4043),  //reg_dll0_15_deskew[3:0], reg_dll0_14_deskew[3:0],//reg_dll0_13_deskew[3:0], reg_dll0_12_deskew[3:0]

    //DLL DQ deskew (high word)
    _RV32_2(0x1616a8, 0x6804),  //reg_dll1_3_deskew[3:0],  reg_dll1_2_deskew[3:0], //reg_dll1_1_deskew[3:0],  reg_dll1_0_deskew[3:0]
    _RV32_2(0x1616aa, 0x5557),  //reg_dll1_7_deskew[3:0],  reg_dll1_6_deskew[3:0], //reg_dll1_5_deskew[3:0],  reg_dll1_4_deskew[3:0]
    _RV32_2(0x1616ac, 0x5223),  //reg_dll1_11_deskew[3:0], reg_dll1_10_deskew[3:0],//reg_dll1_9_deskew[3:0],  reg_dll1_8_deskew[3:0]
    _RV32_2(0x1616ae, 0x4041),  //reg_dll1_15_deskew[3:0], reg_dll1_14_deskew[3:0],//reg_dll1_13_deskew[3:0], reg_dll1_12_deskew[3:0]
#endif

    //RX DQSx Phase select
    _RV32_2(0x161670, 0x0000),  //[11]    : 'h   0 : dline_gated_control
    _RV32_2(0x16166c, 0x1515),  //[ 6: 0] : 'h   f : reg_dll0_ph //[14: 8] : 'h   f : reg_dll1_ph
    _RV32_2(0x16166e, 0x1314),  //[ 6: 0] : 'h   f : reg_dll2_ph //[14: 8] : 'h   f : reg_dll3_ph
    ...
    _RV32_2(0x161634, 0x2004),  //reg_DDRPLL_LOOP_DIV_SECOND    : [15:14]   divide by 3
    _RV32_2(0x161630, 0xEC0D),  //set pll to 780 MHz
    //KKK _RV32_2(0x161632, 0x0030),
    _RV32_2(0x161632, 0x0030),
    _RV32_2(0x161624, 0x1000),  //Avoid DDRPLL unknown(MCLK05X & MCLK025X) by resset ddrat[28]
    // delay 10ms
    _RV32_2(0x161624, 0x0000),
    _RV32_2(0x161622, 0x0004),
    ...
    _RV32_2(0x100628, 0x40C0),  //reg_pack_en
    //KKK _RV32_2(0x100628, 0x40D0),  //reg_pack_en
    _RV32_2(0x10062c, 0x0000),  //reg_addr_balance
    _RV32_2(0x10062a, 0x4040),  //reduce 2t latency off
    ...
    //KKK_RV32_2(0x16163a, 0x4040),  //reg_clkph_cmd         0       : [3:0]
    _RV32_2(0x16163a, 0x0000),  //reg_clkph_cmd         0       : [3:0]
                                //reg_clkph_dqsm        0       : [7:4]
                                //reg_clkph_sp0         0       : [11:8]
                                //reg_clkph_sp1         0       : [15:12]

    //KKK_RV32_2(0x16164a, 0x4040),  //reg_clkph_cmd         0       : [3:0]
    _RV32_2(0x16164a, 0x0000),  //reg_clkph_cmd         0       : [3:0]
                                //reg_clkph_dqsm        0       : [7:4]
                                //reg_clkph_sp0         0       : [11:8]
                                //reg_clkph_sp1         0       : [15:12]
    ...
    //set (TX DQ/DQM phase)
    //set region
    _RV32_2(0x16162e, 0x2100),  //reg_ddrpll2_region_sel_dq_l   2   :[14:12]
    //_RV32_2(0x16162e, 0x1100),  //reg_ddrpll2_region_sel_dq_l   2   :[14:12]
                                //reg_ddrpll2_region_sel_dq_h   2   :[10:8]
                                //reg_ddrpll1_ictrl     0    [6:4]
                                //reg_ddrpll2_ictrl     0    [2:0]
    ...
    //RX DQSx Phase select
    _RV32_2(0x161670, 0x0000),  //[11]    : 'h   0 : dline_gated_control
    _RV32_2(0x16166c, 0x2020),  //[ 6: 0] : 'h   f : reg_dll0_ph //[14: 8] : 'h   f : reg_dll1_ph
    _RV32_2(0x16166e, 0x2020),  //[ 6: 0] : 'h   f : reg_dll2_ph //[14: 8] : 'h   f : reg_dll3_ph
    _RV32_2(0x161670, 0x0800),  //[11]    : 'h   1 : dline_gated_control
