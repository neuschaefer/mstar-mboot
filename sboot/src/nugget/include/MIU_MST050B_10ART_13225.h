...
#define _MIU_MST050B_10ART_13225_H_
//#define _MIU_4X_MODE

#if (ENABLE_MSTAR_BD_MST050B_10ART_13225)
...
const MS_REG_INIT MIU0_DDR_Init[] =
{
    ...
    _RV32_2(0x110d2e, 0x0800),
    _RV32_2(0x110d2c, 0x0300),
    _RV32_2(0x101200, 0x801f),      // dram odt on
    _RV32_2(0x101202, 0x03a3),      //ck/addr/data/cke/data swap/Nx/col/bank/bus width/dram type => 0x2a2=ddr2+16bits+8banks+10col+4x
    ...
    _RV32_2(0x110d00, 0x1021),     //for MIU0 = Emerald package
#endif
...
#endif  //ENABLE_MSTAR_BD_MST050B_10ART_13225

#endif /* _MIU_MST050B_10ART_13225_H_ */
