...
#define _MIU_NUGGET_LOADBOARD_H_
//#define _MIU_4X_MODE

#if (ENABLE_MSTAR_BD_NUGGET_LOADBOARD)
...
const MS_REG_INIT MIU1_DDR_Init[] =
{
    ...
    _RV32_2(0x110d84, 0x0080),
    _RV32_2(0x110d94, 0x1111),
    _RV32_2(0x110dbc, 0x0155),
    _RV32_2(0x110dbe, 0x1011),
    _RV32_2(0x110dcc, 0x1144),
    _RV32_2(0x110dd0, 0x1111),
    _RV32_2(0x110db8, 0x0044),
    _RV32_2(0x110dba, 0x2021),
    _RV32_2(0x110dc8, 0x0044),
    _RV32_2(0x110dca, 0x0000),
    _RV32_2(0x110dd2, 0x0000),
    _RV32_2(0x110dd4, 0x0000),     //1T mode
    _RV32_2(0x110dec, 0x5555),
    _RV32_2(0x110dee, 0x6788),
...
#endif  //ENABLE_MSTAR_NUGGET_LOADBOARD_S

#endif /* _MIU_BD_NUGGET_LOADBOARD_H_ */
