...
#define _MIU_MST180E_D01A_S_H_
//#define _MIU_4X_MODE

#if (ENABLE_MSTAR_BD_MST180E_D01A_S)
...
const MS_REG_INIT MIU0_DDR_Init[] =
{
    ...
    _RV32_2(0x110d50, 0x1111),
    _RV32_2(0x110d54, 0xc000),       //2T mode
...
const MS_REG_INIT MIU1_DDR_Init[] =
{
    ...
    _RV32_2(0x100606, 0x0430),      //2T mode
    ...
    _RV32_2(0x110dc8, 0x0044),
    _RV32_2(0x110dca, 0x0000),
    _RV32_2(0x110dd2, 0x0066),
    _RV32_2(0x110dd4, 0xc000),   //2T mode
    _RV32_2(0x110dec, 0x5555),
    _RV32_2(0x110dee, 0x6787),
...
#endif  //ENABLE_MSTAR_BD_MST180E_D01A_S

#endif /* _MIU_MST180E_D01A_S_H_ */
