...
#define _MapBase_nonPM_EINSTEIN3      (RIU_MAP + 0x200000)
#define _MapBase_PM_EINSTEIN3         RIU_MAP
#else
#define _MapBase_nonPM_EINSTEIN3      0xA0200000
#define _MapBase_PM_EINSTEIN3         0xA0000000
#endif
