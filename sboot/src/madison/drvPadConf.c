...
#define _MapBase_nonPM_MADISON      (RIU_MAP + 0x00200000)
#define _MapBase_PM_MADISON         RIU_MAP
#else
#define _MapBase_nonPM_MADISON      0xa0200000
#define _MapBase_PM_MADISON         0xa0000000
#endif
...
#if (PIN_FLASH_WP0)
#if ((MS_BOARD_TYPE_SEL == BD_MST176A_D01A_S_MADISON) || \
     (MS_BOARD_TYPE_SEL == BD_MST198A_D01A_S_MADISON) || \
     (MS_BOARD_TYPE_SEL == BD_MST198B_D01A_S_MADISON) || \
    (MS_BOARD_TYPE_SEL == BD_MSD062B_10AVV_14033_MADISON)||\
     (MS_BOARD_TYPE_SEL == BD_MST064B_10AVXM_14065_MADISON))
    _RVM1(0x0e21, BIT2, BIT2),          //Output Value of PM10
    _RVM1(0x0e1f, 0, BIT2),             //Output Enable of PM10
#elif (MS_BOARD_TYPE_SEL == BD_FPGA_MADISON)
#else
