...
#define _MIU_MSD062B_10AVV_14033_MADISON_H_

#if ((ENABLE_MSTAR_BD_MSD062B_10AVV_14033_MADISON == 1))
...
const MS_REG_INIT MIU1_DDR_Init[] =
{
    ...
    _RV32_2(0x100602, 0xf3a3),  //ck/addr/data/cke/data swap/Nx/col/bank/bus width/dram type => 0x2a2=ddr2+16bits+8banks+10col+4x
    _RV32_2(0x100604, 0x000e),  //if I64Mode =0x8b else =0x0b
...
#endif  //ENABLE_MSTAR_BD_MSD062B_10AVV_14033_MADISON

#endif /* _MIU_MSD062B_10AVV_14033_MADISON_H_ */
