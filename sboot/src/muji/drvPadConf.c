...
#define _MapBase_nonPM_MUJI      (RIU_MAP + 0x200000)
#define _MapBase_PM_MUJI         RIU_MAP
#else
#define _MapBase_nonPM_MUJI      0xA0200000
#define _MapBase_PM_MUJI         0xA0000000
#endif
