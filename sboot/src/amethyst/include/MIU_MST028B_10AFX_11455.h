...
#define _MIU_MST028B_10AFX_11455_H_

#if (ENABLE_MSTAR_BD_MST028B_10AFX_11455)
...
const MS_REG_INIT MIU0_DDR_Init[] =
{
    ...
    _RV32_2(0x110d36, 0x4001),      // mclk1x_clkph_ck0 / input div_1st/loop_div_1st
    _RV32_2(0x110d34, 0x0300),      // loop_div/input_div
    ...
    _RV32_2(0x101216, 0x2935),      //MR3
    _RV32_2(0x101228, 0x0090),
    _RV32_2(0x10122c, 0x2935),      // Address Balance Mode
    _RV32_2(0x110d54, 0x0000),      //miu_0_atop  start
...
const MS_REG_INIT MIU1_DDR_Init[] =
{
    ...
    _RV32_2(0x110dba, 0x5050),      // mclk1x_skew cmd phase /dqsmask0 /mclk /dqsmask1 phase select
   ...
   // _RV32_2(0x110dba, 0x0000),
    ...
    _RV32_2(0x110db4, 0x0300),      // loop_div/input_div
    _RV32_2(0x110db6, 0x4001),      // mclk1x_clkph_ck0 / input div_1st/loop_div_1st
    ...
    _RV32_2(0x100616, 0xC000),      //MR3
    _RV32_2(0x100628, 0x0090),
    _RV32_2(0x10062c, 0x2935),      // Address Balance Mode
    _RV32_2(0x110dd4, 0x0000),      //miu_0_atop  start
...
#endif  //ENABLE_MSTAR_BD_MST028B_10AFX_11455

#endif /* _MIU_MST028B_10AFX_11455_H_ */
