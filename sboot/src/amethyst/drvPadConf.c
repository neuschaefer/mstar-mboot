...
#define _ENBEDED_FLASH_                     0       // 1: with enbeded flash, 0: without enbeded flash

#if defined (MIPS_CHAKRA) || defined(MSOS_TYPE_LINUX)
#define _MapBase_PM             RIU_MAP
#define _MapBase_nonPM          (RIU_MAP + 0x200000)
#define _MapBase_nonPM_EXT11    (RIU_MAP + 0x220000)
#define _MapBase_nonPM_EXT12    (RIU_MAP + 0x240000)
#else
#define _MapBase_PM             0xA0000000
#define _MapBase_nonPM          0xA0200000
#define _MapBase_nonPM_EXT11    0xA0220000
#define _MapBase_nonPM_EXT12    0xA0240000
#endif

#define _MEMMAP_PM_             _RVM1(0x0000, 0x00, 0xFF)
#define _MEMMAP_nonPM_          _RVM1(0x0000, 0x10, 0xFF)
#define _MEMMAP_nonPM_EXT11_    _RVM1(0x0000, 0x11, 0xFF)
#define _MEMMAP_nonPM_EXT12_    _RVM1(0x0000, 0x12, 0xFF)
...
//---------------------------------------------------------------------
    ...
    //reg_gpio_pm_lock
    _RVM1(0x0e24,  0xbe, 0xFF),   //reg[0e24] = 'hbe
    _RVM1(0x0e25,  0xba, 0xFF),   //reg[oe25] = 'hba
    #endif
...
_MEMMAP_nonPM_,    
    ...
    //_RVM1(0x1e24, 0, BIT2 | BIT1 | BIT0 ),   //reg[101e24]#2 ~ #0 = 000b
    //reg_test_out_mode[2:0]
    //_RVM1(0x1e24, 0, 0x7E ),  //reg[101e24]#6~#2 = 000b
    //reg_pwm0_mode
    ...
    //reg_test_in_mode[2:0]
    //_RVM1(0x1e24, UNKNOWN, BIT2 | BIT1 | BIT0),   //reg[101e24]#2~#0
    //reg_test_out_mode[2:0]
    //_RVM1(0x1e24, 0, BIT6 | BIT5 | BIT4 ),   //reg[101e24]#6 ~ #4 = 000b
    //reg_nand_mode[1:0]
...
#if 0
    #if(PAD_mini_LVDS0_IS_GPIO != GPIO_NONE)
    #define PAD_mini_LVDS0_OEN (PAD_mini_LVDS0_IS_GPIO == GPIO_IN ? BIT3: 0)
    #define PAD_mini_LVDS0_OUT (PAD_mini_LVDS0_IS_GPIO == GPIO_OUT_HIGH ? BIT3: 0)
    _RVM1(0x329f, PAD_mini_LVDS0_OUT, BIT3),
    _RVM1(0x32a3, PAD_mini_LVDS0_OEN, BIT3),
    ...
    #if(PAD_mini_LVDS1_IS_GPIO != GPIO_NONE)
    #define PAD_mini_LVDS1_OEN (PAD_mini_LVDS1_IS_GPIO == GPIO_IN ? BIT2: 0)
    #define PAD_mini_LVDS1_OUT (PAD_mini_LVDS1_IS_GPIO == GPIO_OUT_HIGH ? BIT2: 0)
    _RVM1(0x329f, PAD_mini_LVDS1_OUT, BIT2),
    _RVM1(0x32a3, PAD_mini_LVDS1_OEN, BIT2),
    //reg_output_conf[11:10]
    _RVM1(0x32db, 0, BIT3|BIT2 ),   //reg[1032db]#3~#2 = 00b
    //reg_ext_data_en[10]
    ...
    #if(PAD_mini_LVDS2_IS_GPIO != GPIO_NONE)
    #define PAD_mini_LVDS2_OEN (PAD_mini_LVDS2_IS_GPIO == GPIO_IN ? BIT1: 0)
    #define PAD_mini_LVDS2_OUT (PAD_mini_LVDS2_IS_GPIO == GPIO_OUT_HIGH ? BIT1: 0)
    _RVM1(0x329f, PAD_mini_LVDS2_OUT, BIT1),
    _RVM1(0x32a3, PAD_mini_LVDS2_OEN, BIT1),
    //reg_output_conf[9:8]
    ...
    #if(PAD_mini_LVDS3_IS_GPIO != GPIO_NONE)
    #define PAD_mini_LVDS3_OEN (PAD_mini_LVDS3_IS_GPIO == GPIO_IN ? BIT0: 0)
    #define PAD_mini_LVDS3_OUT (PAD_mini_LVDS3_IS_GPIO == GPIO_OUT_HIGH ? BIT0: 0)
    _RVM1(0x329f, PAD_mini_LVDS3_OUT, BIT0),
    _RVM1(0x32a3, PAD_mini_LVDS3_OEN, BIT0),
    //reg_output_conf[9:8]
    _RVM1(0x32db, 0, BIT1|BIT0 ),   //reg[1032db]#1~#0 = 00b
    //reg_ext_data_en[8]
    ...
    #if(PAD_mini_LVDS4_IS_GPIO != GPIO_NONE)
    #define PAD_mini_LVDS4_OEN (PAD_mini_LVDS4_IS_GPIO == GPIO_IN ? BIT7: 0)
    #define PAD_mini_LVDS4_OUT (PAD_mini_LVDS4_IS_GPIO == GPIO_OUT_HIGH ? BIT7: 0)
    _RVM1(0x329e, PAD_mini_LVDS4_OUT, BIT7),
    _RVM1(0x32a2, PAD_mini_LVDS4_OEN, BIT7),
    //reg_output_conf[7:6]
    ...
    #if(PAD_mini_LVDS5_IS_GPIO != GPIO_NONE)
    #define PAD_mini_LVDS5_OEN (PAD_mini_LVDS5_IS_GPIO == GPIO_IN ? BIT6: 0)
    #define PAD_mini_LVDS5_OUT (PAD_mini_LVDS5_IS_GPIO == GPIO_OUT_HIGH ? BIT6: 0)
    _RVM1(0x329e, PAD_mini_LVDS5_OUT, BIT6),
    _RVM1(0x32a2, PAD_mini_LVDS5_OEN, BIT6),
    //reg_output_conf[7:6]
    _RVM1(0x32da, 0, BIT7|BIT6 ),   //reg[1032da]#7~#6 = 00b
    //reg_ext_data_en[6]
    ...
    #if(PAD_mini_LVDS6_IS_GPIO != GPIO_NONE)
    #define PAD_mini_LVDS6_OEN (PAD_mini_LVDS6_IS_GPIO == GPIO_IN ? BIT5: 0)
    #define PAD_mini_LVDS6_OUT (PAD_mini_LVDS6_IS_GPIO == GPIO_OUT_HIGH ? BIT5: 0)
    _RVM1(0x329e, PAD_mini_LVDS6_OUT, BIT5),
    _RVM1(0x32a2, PAD_mini_LVDS6_OEN, BIT5),
    //reg_output_conf[5:4]
    ...
    #if(PAD_mini_LVDS7_IS_GPIO != GPIO_NONE)
    #define PAD_mini_LVDS7_OEN (PAD_mini_LVDS7_IS_GPIO == GPIO_IN ? BIT4: 0)
    #define PAD_mini_LVDS7_OUT (PAD_mini_LVDS7_IS_GPIO == GPIO_OUT_HIGH ? BIT4: 0)
    _RVM1(0x329e, PAD_mini_LVDS7_OUT, BIT4),
    _RVM1(0x32a2, PAD_mini_LVDS7_OEN, BIT4),
    //reg_output_conf[5:4]
    _RVM1(0x32da, 0, BIT5|BIT4 ),   //reg[1032da]#5~#4 = 00b
    //reg_ext_data_en[4]
    ...
    //reg_sd_config2
    _RVM1(0x1e3d, 0, BIT0 ),   //reg[101e3d]#0 = 0b
    //reg_ld_spi1_config
...
_MEMMAP_nonPM_EXT12_,        
    _RVM1(0x1033, PAD_TCON0_OUT, BIT0),
    _RVM1(0x1033, PAD_TCON0_OEN, BIT1),
_MEMMAP_nonPM_,    
    //reg_test_out_mode[2:0]
    //_RVM1(0x1e24, 0, BIT6 | BIT5 | BIT4 ),   //reg[101e24]#6~#4 = 000b
    //reg_pwm5_mode
    ...
    _RVM1(0x1e3c, 0, BIT2 | BIT1 ),   //reg[101e3c]#2~ #1 = 00b
    #endif
...
_MEMMAP_nonPM_EXT12_,        
    _RVM1(0x1032, PAD_TCON1_OUT, BIT0),
    _RVM1(0x1032, PAD_TCON1_OEN, BIT1),
_MEMMAP_nonPM_,    
    //reg_test_out_mode[2:0]
    //_RVM1(0x1e24, 0, BIT6 | BIT5 | BIT4 ),   //reg[101e24]#6~#4 = 000b
    //reg_tconconfig1
...
_MEMMAP_nonPM_EXT12_,        
    _RVM1(0x1035, PAD_TCON2_OUT, BIT0),
    _RVM1(0x1035, PAD_TCON2_OEN, BIT1),
_MEMMAP_nonPM_,    
    //reg_test_out_mode[2:0]
    //_RVM1(0x1e24, 0, BIT6 | BIT5 | BIT4 ),   //reg[101e24]#6~#4 = 000b
    //reg_tconconfig2
...
_MEMMAP_nonPM_EXT12_,        
    _RVM1(0x1034, PAD_TCON3_OUT, BIT0),
    _RVM1(0x1034, PAD_TCON3_OEN, BIT1),
_MEMMAP_nonPM_,    
    //reg_test_out_mode[2:0]
    //_RVM1(0x1e24, 0, BIT6 | BIT5 | BIT4 ),   //reg[101e24]#6~#4 = 000b
    //reg_tconconfig3
...
_MEMMAP_nonPM_EXT12_,        
    _RVM1(0x1037, PAD_TCON4_OUT, BIT0),
    _RVM1(0x1037, PAD_TCON4_OEN, BIT1),
_MEMMAP_nonPM_,    
    //reg_test_out_mode[2:0]
    //_RVM1(0x1e24, 0, BIT6 | BIT5 | BIT4 ),   //reg[101e24]#6~#4 = 000b
    //reg_tconconfig4
...
_MEMMAP_nonPM_EXT12_,        
    _RVM1(0x1036, PAD_TCON5_OUT, BIT0),
    _RVM1(0x1036, PAD_TCON5_OEN, BIT1),
_MEMMAP_nonPM_,    
    //reg_test_out_mode[2:0]
    //_RVM1(0x1e24, 0, BIT6 | BIT5 | BIT4 ),   //reg[101e24]#6~#4 = 000b
    //reg_tconconfig5
...
_MEMMAP_nonPM_EXT12_,        
    _RVM1(0x1039, PAD_TCON6_OUT, BIT0),
    _RVM1(0x1039, PAD_TCON6_OEN, BIT1),
_MEMMAP_nonPM_,    
    //reg_test_out_mode[2:0]
    //_RVM1(0x1e24, 0, BIT6 | BIT5 | BIT4 ),   //reg[101e24]#6~#4 = 000b
    //reg_tconconfig6
...
_MEMMAP_nonPM_EXT12_,        
    _RVM1(0x1038, PAD_TCON7_OUT, BIT0),
    _RVM1(0x1038, PAD_TCON7_OEN, BIT1),
_MEMMAP_nonPM_,    
    //reg_test_out_mode[2:0]
    //_RVM1(0x1e24, 0, BIT6 | BIT5 | BIT4 ),   //reg[101e24]#6~#4 = 000b
    //reg_tconconfig7
    ...
    #if(PAD_EMMC_CDZ_IS_GPIO != GPIO_NONE)
    #define PAD_EMMC_CDZ_OEN (PAD_EMMC_CDZ_IS_GPIO == GPIO_IN ? BIT1: 0)
    #define PAD_EMMC_CDZ_OUT (PAD_EMMC_CDZ_IS_GPIO == GPIO_OUT_HIGH ? BIT0: 0)
_MEMMAP_nonPM_EXT12_,        
    _RVM1(0x1040, PAD_EMMC_CDZ_OUT, BIT0),
    _RVM1(0x1040, PAD_EMMC_CDZ_OEN, BIT1),
_MEMMAP_nonPM_,    
    //reg_emmc_config
    _RVM1(0x1ebb, 0, BIT7 | BIT6 ),   //reg[101ebb]#7~#6 = 000b
    #endif
...
_MEMMAP_nonPM_EXT12_,        
    _RVM1(0x1041, PAD_EMMC_CLK_OUT, BIT0),
    _RVM1(0x1041, PAD_EMMC_CLK_OEN, BIT1),
_MEMMAP_nonPM_,    
    //reg_emmc_config
    _RVM1(0x1ebb, 0, BIT7 | BIT6 ),   //reg[101ebb]#7~#6 = 000b
    #endif
...
_MEMMAP_nonPM_EXT12_,        
    _RVM1(0x1042, PAD_EMMC_CMD_OUT, BIT0),
    _RVM1(0x1042, PAD_EMMC_CMD_OEN, BIT1),
_MEMMAP_nonPM_,    
    //reg_emmc_config
    _RVM1(0x1ebb, 0, BIT7 | BIT6 ),   //reg[101ebb]#7~#6 = 000b
    #endif
...
#if 0
    #if(PAD_ONE_RPN_IS_GPIO != GPIO_NONE)
    #define PAD_ONE_RPN_OEN (PAD_ONE_RPN_IS_GPIO == GPIO_IN ? BIT7: 0)
    #define PAD_ONE_RPN_OUT (PAD_ONE_RPN_IS_GPIO == GPIO_OUT_HIGH ? BIT7: 0)
    _RVM1(0x1e8a, PAD_ONE_RPN_OUT, BIT7),
    _RVM1(0x1e8c, PAD_ONE_RPN_OEN, BIT7),
    _RVM1(0x1edf, BIT6, BIT6),
    #endif

    #if(PAD_ONE_RDY_IS_GPIO != GPIO_NONE)
    #define PAD_ONE_RDY_OEN (PAD_ONE_RDY_IS_GPIO == GPIO_IN ? BIT0: 0)
    #define PAD_ONE_RDY_OUT (PAD_ONE_RDY_IS_GPIO == GPIO_OUT_HIGH ? BIT0: 0)
    _RVM1(0x1e8b, PAD_ONE_RDY_OUT, BIT0),
    _RVM1(0x1e8d, PAD_ONE_RDY_OEN, BIT0),
    _RVM1(0x1edf, BIT6, BIT6),
    #endif
#endif
#endif
...
#define NAND_MODE   ((PADS_NAND_MODE == PCM_A) ? BIT1: \
                     (PADS_NAND_MODE == PCM_D) ? BIT0 : 0)
...
#define FLAG_3D_CONFIG   ((PADS_3D_FLAG_CONFIG == PAD_SPDIF_IN) ? BIT6 : \
                          (PADS_3D_FLAG_CONFIG == PAD_GPIO16) ? BIT7 : \
                          (PADS_3D_FLAG_CONFIG == PAD_I2S_IN_SD) ? BIT7|BIT6 : 0)
        _RVM1(0x1EB3, FLAG_3D_CONFIG, BIT7|BIT6),
#endif
...
#define MIIC_MODE0  ((PADS_MIIC_MODE0 == PAD_GPIO18) ? BIT0:  \
                     (PADS_MIIC_MODE0 == PAD_GPIO17) ? BIT0:  \
...
#define TCON_CONFIG TCON0|TCON1|TCON2|TCON3|TCON4|TCON5|TCON6|TCON7
    _RVM3(0x1EB9, TCON_CONFIG, 0xFF),
#endif

#if (PADS_SD_MODE != Unknown_pad_mux)
#define SD_MODE   ((PADS_SD_MODE == ENABLE) ? BIT3:  \
        _RVM1(0x1EC2, SD_MODE, BIT3),
#endif

#if (PADS_EMMC_MODE != Unknown_pad_mux)
#define EMMC_MODE   ((PADS_EMMC_MODE == ENABLE) ? BIT6:  \
...
#if (PIN_FLASH_WP0)
      #if (MS_BOARD_TYPE_SEL == BD_MST142B_D01A_S)
