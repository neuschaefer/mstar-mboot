...
#define __MIU_INIT_BD_MST036B_EDISON_CUS28_AP_H__

#if (ENABLE_MSTAR_BD_MST036B_EDISON_CUS28_AP)
...
const MS_REG_INIT MIU0_DDR_Init[] =
{
	...
	_RV32_2( 0x101206, 0x0460  ),  //refresh cycle=0x50 ,TURN_ON_SCRAMBLE=0x8450
	...
	_RV32_2( 0x10122c, 0x0000  ),
		    #if(MS_BOARD_TYPE_SEL == BD_MST036B_EDISON_CUS28_AP)
	...
	_RV32_2( 0x110d00, 0x3e11 ),
	#endif
	#if(MIU_CONFIG == DDR3_MIU0_32_MIU1_16_16BIT_TMODE)
	_RV32_2( 0x110d00, 0x3e12 ),
	#endif
    ...
    _RV32_2( 0x110d4c, 0x0100  ),
        ...
        _RV32_2( 0x110d3a, 0x8000  ),
        _RV32_2( 0x110d4a, 0x8092  ),
        _RV32_2( 0x110d3c, 0x0134  ),
...
const MS_REG_INIT MIU1_DDR_Init[] =
{
	...
	#elif(ENABLE_MEM1600MHz)
	_RV32_2( 0x100606, 0x0460  ),  //refresh cycle=0x50 ,TURN_ON_SCRAMBLE=0x8450
	...
	#if(MIU_CONFIG == DDR3_MIU0_32_MIU1_16_8BIT_FLYBY)
	_RV32_2( 0x110d80, 0x3e11 ),
	#endif
	#if(MIU_CONFIG == DDR3_MIU0_32_MIU1_16_16BIT_TMODE)
	_RV32_2( 0x110d80, 0x3e12 ),
	#endif
...
#endif /* ENABLE_MSTAR_BD_MST036B_EDISON_CUS28_AP */
#endif /* __MIU_INIT_BD_MST036B_EDISON_CUS28_AP_H__*/
