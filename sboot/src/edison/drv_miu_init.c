...
#include "MIU_INIT_BD_MST159A_D01A_S.h"
#endif

#ifndef __MIU_INIT_BD_MST147A_D01B_S_H__
#include "MIU_INIT_BD_MST147A_D01B_S.h"
#endif

#ifndef __MIU_INIT_BD_MST036B_EDISON_H__
#include "MIU_INIT_BD_MST036B_EDISON.h"
#endif

#ifndef __MIU_INIT_BD_MST036B_EDISON_CUS36_H__
#include "MIU_INIT_BD_MST036B_EDISON_CUS36.h"
#endif

#ifndef __MIU_INIT_BD_MST036B_EDISON_CUS28_H__
#include "MIU_INIT_BD_MST036B_EDISON_CUS28.h"
#endif

#ifndef __MIU_INIT_BD_MST036B_EDISON_CUS28_AP_H__
#include "MIU_INIT_BD_MST036B_EDISON_CUS28_AP.h"
#endif

#ifndef __MIU_INIT_BD_MST036B_EDISON_CUS36_AP_H__
#include "MIU_INIT_BD_MST036B_EDISON_CUS36_AP.h"
#endif

#ifndef __MIU_INIT_BD_MST036B_EDISON_CUS18_ATSC_H__
#include "MIU_INIT_BD_MST036B_EDISON_CUS18_ATSC.h"
#endif

#ifndef __MIU_INIT_BD_MST036B_EDISON_CUS19_H__
#include "MIU_INIT_BD_MST036B_EDISON_CUS19.h"
#endif


const MS_REG_INIT MIU0_PreInit[] =
{
    //MIU0 Software reset
    ...
    _RV32_2(0x110d36, 0x4002),  //reg_DDRPLL_LOOP_DIV_FIRST	: [15:14]	divide by 4
#endif
#if(MIU_CONFIG == DDR3_MIU0_32_MIU1_16_16BIT_TMODE)
    _RV32_2(0x110d36, 0x4000),  //reg_DDRPLL_LOOP_DIV_FIRST	: [15:14]	divide by 4
#endif
    _RV32_2(0x110d34, 0x0300),  //reg_DDRPLL_LOOP_DIV_SECOND	: [15:14]	divide by 3
    _RV32_2(0x110d30, 0xeb85),  //set pll to 780 MHz
...
const MS_REG_INIT MIU1_PreInit[] =
{
    //MIU1 Software reset
...
#if(MIU_CONFIG == DDR3_MIU0_32_MIU1_16_8BIT_FLYBY)
    _RV32_2(0x110db6, 0x4001),  //reg_DDRPLL_LOOP_DIV_FIRST : [15:14]   divide by 4
#endif
#if(MIU_CONFIG == DDR3_MIU0_32_MIU1_16_16BIT_TMODE)
    _RV32_2(0x110db6, 0x4000),  //reg_DDRPLL_LOOP_DIV_FIRST : [15:14]   divide by 4
#endif
    _RV32_2(0x110db4, 0x0300),  //reg_DDRPLL_LOOP_DIV_SECOND    : [15:14]   divide by 3
    _RV32_2(0x110db0, 0xeb85),  //set pll to 780 MHz
...
const MS_REG_INIT MIU_PostInit[] =
{
    ...
    _RV32_2(0x10121e, 0x1808),  //SW initial done and turn on arbitor


    _RV32_2(0x10061e, 0x1808),  //SW initial done and turn on arbitor


#if (ENABLE_MSTAR_EDISON_MMAP_512MB_256MB == 1)
    _RV32_2(0x1012C0, 0x8000),  
    _RV32_2(0x1006C0, 0x7000),  
#elif (ENABLE_MSTAR_EDISON_MMAP_512MB_512MB == 1)
    _RV32_2(0x1012C0, 0x8000),  
    _RV32_2(0x1006C0, 0x8000),
#else
