...
#define __MIU_INIT_BD_MST036B_EDISON_CUS28_H__

#if (ENABLE_MSTAR_BD_MST036B_EDISON_CUS28)
...
const MS_REG_INIT MIU0_DDR_Init[] =
{
	...
	_RV32_2( 0x10122c, 0x0000  ),
		    #if(MS_BOARD_TYPE_SEL == BD_MST036B_EDISON_CUS28)
...
#endif /* ENABLE_MSTAR_BD_MST036B_EDISON_CUS28 */
#endif /* __MIU_INIT_BD_MST036B_EDISON_CUS28_H__*/
