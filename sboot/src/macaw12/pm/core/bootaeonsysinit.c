...
void MDrv_Power_TurnOffStandby(void)
{
#if(MS_BOARD_TYPE_SEL == BD_MST149A_D01A_S)
    mdrv_gpio_set_low(PAD_INT);
#elif(MS_BOARD_TYPE_SEL == BD_MST149B_D01A_S)
    mdrv_gpio_set_low(PAD_GPIO11);
#elif((MS_BOARD_TYPE_SEL == BD_MST149C_D01A_S)||(MS_BOARD_TYPE_SEL == BD_MST149D_D01A_S))
    mdrv_gpio_set_low(PAD_GPIO_PM4);
