...
#ifndef __MIU_BD_MST181C_D01A_S_H__
#define __MIU_BD_MST181C_D01A_S_H__

#if (ENABLE_MSTAR_BD_MST181C_D01A_S)
...
const MS_REG_INIT MIU0_DDR_Init[] =
{
    ...
    _RV32_2(0x110d30, 0xEC8E),  //set pll to 780 MHz
    ...
    _RV32_2(0x101206, 0x162B),  //tREFRESH		2b	: [7:0] * 16
    ...
    _RV32_2(0x110d48, 0x0000),  //reg_clkph_dq2         4       : [3:0]
                                //reg_clkph_dq3         4       : [7:4]
    ...
    _RV32_2(0x110d4a, 0x5052),  //reg_clkph_cmd         0       : [3:0]
                                //reg_clkph_dqsm        0       : [7:4]
                                //reg_clkph_sp0         0       : [11:8]
                                //reg_clkph_sp1         0       : [15:12]
    ...
    _RV32_2(0x110da0, 0x5524),  //reg_dll0_3_deskew[3:0],  reg_dll0_2_deskew[3:0], //reg_dll0_1_deskew[3:0],  reg_dll0_0_deskew[3:0]
    _RV32_2(0x110da2, 0x3424),  //reg_dll0_7_deskew[3:0],  reg_dll0_6_deskew[3:0], //reg_dll0_5_deskew[3:0],  reg_dll0_4_deskew[3:0]
    _RV32_2(0x110da4, 0x4140),  //reg_dll0_11_deskew[3:0], reg_dll0_10_deskew[3:0],//reg_dll0_9_deskew[3:0],  reg_dll0_8_deskew[3:0]
    _RV32_2(0x110da6, 0x4152),  //reg_dll0_15_deskew[3:0], reg_dll0_14_deskew[3:0],//reg_dll0_13_deskew[3:0], reg_dll0_12_deskew[3:0]

    //DLL DQ deskew (high word)
    _RV32_2(0x110da8, 0x5425),  //reg_dll1_3_deskew[3:0],  reg_dll1_2_deskew[3:0], //reg_dll1_1_deskew[3:0],  reg_dll1_0_deskew[3:0]
    _RV32_2(0x110daa, 0x4233),  //reg_dll1_7_deskew[3:0],  reg_dll1_6_deskew[3:0], //reg_dll1_5_deskew[3:0],  reg_dll1_4_deskew[3:0]
    _RV32_2(0x110dac, 0x2231),  //reg_dll1_11_deskew[3:0], reg_dll1_10_deskew[3:0],//reg_dll1_9_deskew[3:0],  reg_dll1_8_deskew[3:0]
    _RV32_2(0x110dae, 0x2042),  //reg_dll1_15_deskew[3:0], reg_dll1_14_deskew[3:0],//reg_dll1_13_deskew[3:0], reg_dll1_12_deskew[3:0]
#endif

    //RX DQSx Phase select
    _RV32_2(0x110d70, 0x0000),  //[11]    : 'h   0 : dline_gated_control
    _RV32_2(0x110d6c, 0x1212),  //[ 6: 0] : 'h   f : reg_dll0_ph //[14: 8] : 'h   f : reg_dll1_ph
    ...
    _RV32_2(0x110d00, 0x2010),  //reg_pkg_sel      1   : [0]
                                //reg_odt_en       1   : [12:9]
...
const MS_REG_INIT MIU1_DDR_Init[] =
{
    ...
    _RV32_2(0x161630, 0xEC8E),  //set pll to 780 MHz
    ...
    _RV32_2(0x100606, 0x162B),  //tREFRESH		2b	: [7:0] * 16
    ...
    _RV32_2(0x161648, 0x0000),  //reg_clkph_dq2         4       : [3:0]
                                //reg_clkph_dq3         4       : [7:4]
                                //reg_clkph_dqs2        0       : [11:8]
                                //reg_clkph_dqs3        0       : [15:12]
    ...
    _RV32_2(0x16164a, 0x6062),  //reg_clkph_cmd         0       : [3:0]
                                //reg_clkph_dqsm        0       : [7:4]
                                //reg_clkph_sp0         0       : [11:8]
                                //reg_clkph_sp1         0       : [15:12]
...
#if 1
    //DLL DQ deskew (low word)
    _RV32_2(0x1616a0, 0x4402),  //reg_dll0_3_deskew[3:0],  reg_dll0_2_deskew[3:0], //reg_dll0_1_deskew[3:0],  reg_dll0_0_deskew[3:0]
    _RV32_2(0x1616a2, 0x2204),  //reg_dll0_7_deskew[3:0],  reg_dll0_6_deskew[3:0], //reg_dll0_5_deskew[3:0],  reg_dll0_4_deskew[3:0]
    _RV32_2(0x1616a4, 0x6455),  //reg_dll0_11_deskew[3:0], reg_dll0_10_deskew[3:0],//reg_dll0_9_deskew[3:0],  reg_dll0_8_deskew[3:0]
    _RV32_2(0x1616a6, 0x5262),  //reg_dll0_15_deskew[3:0], reg_dll0_14_deskew[3:0],//reg_dll0_13_deskew[3:0], reg_dll0_12_deskew[3:0]

    //DLL DQ deskew (high word)
    _RV32_2(0x1616a8, 0x6400),  //reg_dll1_3_deskew[3:0],  reg_dll1_2_deskew[3:0], //reg_dll1_1_deskew[3:0],  reg_dll1_0_deskew[3:0]
    _RV32_2(0x1616aa, 0x2223),  //reg_dll1_7_deskew[3:0],  reg_dll1_6_deskew[3:0], //reg_dll1_5_deskew[3:0],  reg_dll1_4_deskew[3:0]
    _RV32_2(0x1616ac, 0x7576),  //reg_dll1_11_deskew[3:0], reg_dll1_10_deskew[3:0],//reg_dll1_9_deskew[3:0],  reg_dll1_8_deskew[3:0]
    _RV32_2(0x1616ae, 0x5477),  //reg_dll1_15_deskew[3:0], reg_dll1_14_deskew[3:0],//reg_dll1_13_deskew[3:0], reg_dll1_12_deskew[3:0]
#endif

    //RX DQSx Phase select
    _RV32_2(0x161670, 0x0000),  //[11]    : 'h   0 : dline_gated_control
    _RV32_2(0x16166c, 0x1111),  //[ 6: 0] : 'h   f : reg_dll0_ph //[14: 8] : 'h   f : reg_dll1_ph
    _RV32_2(0x16166e, 0x1414),  //[ 6: 0] : 'h   f : reg_dll2_ph //[14: 8] : 'h   f : reg_dll3_ph
    ...
    _RV32_2(0x161600, 0x2010),  //reg_pkg_sel      1   : [0]
                                //reg_odt_en       1   : [12:9]
...
#endif /* ENABLE_MSTAR_BD_MST181C_D01A_S */
#endif /* __MIU_INIT_BD_MST181C_D01A_S_H__*/
