...
#define _MapBase_nonPM_EINSTEIN      (RIU_MAP + 0x200000)
#define _MapBase_PM_EINSTEIN         RIU_MAP
#else
#define _MapBase_nonPM_EINSTEIN      0xA0200000
#define _MapBase_PM_EINSTEIN         0xA0000000
#endif
