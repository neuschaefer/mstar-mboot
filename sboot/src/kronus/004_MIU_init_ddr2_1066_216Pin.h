...
_RV32_2( 0x110d30, 0xE781 ),  // ddfset
_RV32_2( 0x110d32, 0x0026 ),  // ddrpll_reset/ddrpll_porst/ddrpl_pd
#endif
#if (ENABLE_MEM800MHz)
...
#endif
_RV32_2(0x101204, 0x008c),   //if I64Mode =0x8b else =0x0b
_RV32_2(0x101206, 0x0428),   //jc_db: should be 0x3420? //refresh cycle=0x20 ,TURN_ON_SCRAMBLE=0x8420
#if (ENABLE_MEM800MHz)
_RV32_2(0x101208, 0x1666),   //jc_db: should be 0x1877? //reg_tRCD
_RV32_2(0x10120a, 0x1c56),   //jc_db: should be 0x1F46? //reg_tRRD
#endif
#if (ENABLE_MEM1066MHz)
...
_RV32_2(0x110d3c, 0x2100),   //jc_db: should be 0x0200?
_RV32_2(0x110d3e, 0x0022),   //jc_db: should be 0x0000?
#if (ENABLE_MEM800MHz)
_RV32_2(0x110d0e, 0x01e7),   // 1/2 reg_en_mask
_RV32_2(0x110d0e, 0x01a7),   // 2/2 reg_en_mask clr bit6 eg_dqsm_rst_sel
#endif
#if (ENABLE_MEM1066MHz)
_RV32_2( 0x110d0e, 0x00e7),   // 1/2 reg_en_mask
_RV32_2( 0x110d0e, 0x00a7),   // 2/2 reg_en_mask clr bit6 eg_dqsm_rst_sel
#endif
_RV32_2( 0x110d6e, 0x0088),   //jc_db: should be 0x0088? //reg_dll0_ph //
...
#if (ENABLE_MEM1066MHz)
_RV32_2( 0x110d18, 0x8600 ),  //
_RV32_2( 0x110d36, 0x4004 ),  //
_RV32_2( 0x110d38, 0x0044 ),  //
_RV32_2( 0x110d3A, 0x8080 ),  //
_RV32_2( 0x110d3C, 0x2000 ),  //
_RV32_2( 0x110d5C, 0x3333 ),  //
_RV32_2( 0x110d5E, 0x3333 ),  //
_RV32_2( 0x110d74, 0x7777 ),  //
_RV32_2( 0x110d6E, 0x0066 ),  //0x0066
#endif
//enable miu_0
_RV32_2(0x10121e, 0x0c01),
_RV32_2(0x10121e, 0x0c08),  //

//WAIT 0.001s   // delay 1ms
...
//WAIT 0.0010s   //check reg_101200 //15 for wait initial done // delay 10ms
//open all mask
