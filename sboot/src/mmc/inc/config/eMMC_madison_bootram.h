...
#define REG_BANK_PORTSTATUS     0x280
#define PORTSTATUS_BASE         GET_REG_ADDR(RIU_BASE, REG_BANK_PORTSTATUS)
#define DEBUG_REG_SYS_L1        GET_REG_ADDR(PORTSTATUS_BASE, 0xC)
#define DEBUG_REG_SYS_L2        GET_REG_ADDR(PORTSTATUS_BASE, 0xD)
...
//#define eMMC_ROM_ReLoadImages    1
#define BOOT_SRAM_START_ADDRESS  0x1FC00000
#define Total_SRAM_SIZE          0x4000//8K*2 Bytes
...
extern  U32 eMMC_ROM_LoadImages_Addr(void);
