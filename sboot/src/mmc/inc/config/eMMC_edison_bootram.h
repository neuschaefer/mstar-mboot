...
#include "../../../../inc/edison/board/Board.h"
...
#define eMMC_RST_L()             {\
	                                     ...
	                                     REG_FCIE_R(reg_emmc_config,u16_reg_chiptop_0x6E_val);\
	                                     REG_FCIE_SETBIT(reg_fcie2macro_sd_bypass, BIT8);\
                                         REG_FCIE_CLRBIT(reg_emmc_config,BIT6|BIT7);\
...
#define eMMC_RST_H()             {\
										 ...
										 REG_FCIE_W(reg_emmc_config,u16_reg_chiptop_0x6E_val);\
...
#define drvEMMC_software_reset(TimerCount)
