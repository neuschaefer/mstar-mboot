...
#define _EMERALD_ENBEDED_FLASH_      0       // 1: with enbeded flash, 0: without enbeded flash

#if defined (MIPS_CHAKRA) || defined(MSOS_TYPE_LINUX)
#define _MapBase_nonPM_EMERALD      (RIU_MAP + 0x200000)
#define _MapBase_PM_EMERALD         RIU_MAP
#else
#define _MapBase_nonPM_EMERALD      0xA0200000
#define _MapBase_PM_EMERALD         0xA0000000
#endif
...
//---------------------------------------------------------------------
    ...
    _RVM1(0x0e25,  0xba, 0xFFFF),   //reg[oe25] = 'hba
    #endif
...
//---------------------------------------------------------------------
    ...
    #if (PIN_FLASH_WP0)
      #if ((MS_BOARD_TYPE_SEL == BD_MST157A_D01A_S) || \
           (MS_BOARD_TYPE_SEL == BD_MST157B_D01A_S) || \
           (MS_BOARD_TYPE_SEL == BD_MST157C_D01A_S) || \
           (MS_BOARD_TYPE_SEL == BD_MST157E_D01A_S) || \
           (MS_BOARD_TYPE_SEL == BD_MST157E_D01B_S) || \
           (MS_BOARD_TYPE_SEL == BD_MST157E_D01C_S) || \
           (MS_BOARD_TYPE_SEL == BD_MST157E_D01D_S) || \
           (MS_BOARD_TYPE_SEL == BD_MST157F_D01A_S) || \
           (MS_BOARD_TYPE_SEL == BD_MST157I_D01A_S))
      _RVM1(0x0e20, BIT0, BIT0), //PM0
      _RVM1(0x0E1E,    0, BIT0),
      #elif (MS_BOARD_TYPE_SEL == BD_MST157A_D01A_S)
