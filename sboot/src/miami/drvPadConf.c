...
//=============================================================================
    ...
    #define _CONFIG_NAND_CS1_EN ((PADS_NAND_CS1_EN == ENABLE) ? BIT5 : 0)
        ...
        _RVM1(0x1e1a, BITMASK(7:0), BITMASK(7:0)),
        _RVM1(0x1e1b, BITMASK(7:0), BITMASK(7:0)),
        _RVM1(0x1e18, BITMASK(7:4), BITMASK(7:4)),
    #else
        _RVM1(0x1e1a, 0, BITMASK(7:0)),
        _RVM1(0x1e1b, 0, BITMASK(7:0)),
        _RVM1(0x1e18, 0, BITMASK(7:4)),
    #endif
#endif
...
//=============================================================================
    ...
    #if (PADS_EMMC_RSTN_EN == ENABLE)
        _RVM1(0x1e9e, BIT2, BIT2),
    #else
        _RVM1(0x1e9e, 0, BIT2),
    #endif
#endif
...
#ifdef PADS_EMMC_PE
    #if (PADS_EMMC_PE == ENABLE)
        _RVM1(0x1edd, BITMASK(2:0), BITMASK(2:0)),
    #else
        _RVM1(0x1edd, 0, BITMASK(2:0)),
    #endif
#endif
...
//=============================================================================
    ...
    #if (PADS_PCM_CONFIG != UNKNOWN_PAD_MUX)
    #define _PADS_PCM_CONFIG    ((PADS_PCM_CONFIG == ENABLE) ? BIT1 : 0)
        _RVM1(0x1ef6, _PADS_PCM_CONFIG, BIT1),
    #endif
#endif
...
//=============================================================================
    ...
    #define _CONFIG_TS0_CONFIG  ((PADS_TS0_CONFIG == PARALLEL_IN) ? BIT0 : \
                                 (PADS_TS0_CONFIG == SERIAL_IN) ? BIT1 : \
                                 (PADS_TS0_CONFIG == PARALLEL_IN_SCARD) ? (BIT1 | BIT0) : \
                                 (PADS_TS0_CONFIG == PARALLEL_IN_MCARD) ? BIT2 : \
                                 (PADS_TS0_CONFIG == TS_MSPI) ? (BIT2 | BIT0) : 0)
    ...
    #if (PADS_TS_OUT_MODE != UNKNOWN_PAD_MUX)
    #define _CONFIG_TS_OUT_MODE ((PADS_TS_OUT_MODE == PARALLEL_OUT) ? BIT1 : \
                                 (PADS_TS_OUT_MODE == PARALLEL_OUT_MCARD) ? BIT3 : \
                                 (PADS_TS_OUT_MODE == PARALLEL_OUT_S2P) ? (BIT3 | BIT1) : 0)
        _RVM1(0x1edd, _CONFIG_TS_OUT_MODE, (BIT3 | BIT2 | BIT1)),
    #endif
#endif

#ifdef PADS_TSO_EVD_MODE
    #if (PADS_TSO_EVD_MODE == ENABLE)
        _RVM1(0x1e21, BIT1, BIT1),
    #else
        _RVM1(0x1e21, 0, BIT1),
    #endif
#endif
    ...
    #define _CONFIG_TS2_CONFIG  ((PADS_TS2_CONFIG == SERIAL_IN) ? BIT4 : \
                                 (PADS_TS2_CONFIG == PARALLEL_IN) ? BIT7 : 0)
        _RVM1(0x1eb5, _CONFIG_TS2_CONFIG, (BIT7 | BIT6 | BIT5)),
    #endif
#endif

#ifdef PADS_TS3_CONFIG
    #if (PADS_TS3_CONFIG != UNKNOWN_PAD_MUX)
    #define _CONFIG_TS3_CONFIG  ((PADS_TS3_CONFIG == PARALLEL_IN) ? BIT3 : \
                                 (PADS_TS3_CONFIG == PARALLEL_OUT) ? BIT4 : \
                                 (PADS_TS3_CONFIG == SERIAL_IN) ? (BIT4 | BIT3) : 0)
        _RVM1(0x1ec0, _CONFIG_TS3_CONFIG, (BIT4 | BIT3)),
    #endif
#endif

#ifdef PADS_TS3_OUT_MODE
    #if (PADS_TS3_OUT_MODE != UNKNOWN_PAD_MUX)
    #define _CONFIG_TS3_OUT_MODE ((PADS_TS3_OUT_MODE == PARALLEL_OUT) ? BIT0 : \
                                  (PADS_TS3_OUT_MODE == PARALLEL_OUT_S2P) ? BIT2 : 0)
        _RVM1(0x1ec0, _CONFIG_TS3_OUT_MODE, (BIT2 | BIT1 | BIT0)),
    #endif
#endif

#ifdef PADS_TS4_CONFIG
    #if (PADS_TS4_CONFIG != UNKNOWN_PAD_MUX)
    #define _CONFIG_TS4_CONFIG  ((PADS_TS4_CONFIG == SERIAL_IN) ? BIT5 : \
                                 (PADS_TS4_CONFIG == PARALLEL_IN) ? BIT6 : 0)
        _RVM1(0x1ec0, _CONFIG_TS4_CONFIG, (BIT6 | BIT5)),
    #endif
#endif

#ifdef PADS_TS5_CONFIG
    #if (PADS_TS5_CONFIG != UNKNOWN_PAD_MUX)
    #define _CONFIG_TS5_CONFIG  ((PADS_TS5_CONFIG == SERIAL_IN) ? BIT7 : 0)
        _RVM1(0x1ec0, _CONFIG_TS5_CONFIG, (BIT7)),
    #endif
#endif

#ifdef PADS_TSERROUT_CONFIG
    #if (PADS_TSERROUT_CONFIG != UNKNOWN_PAD_MUX)
    #define _CONFIG_TSERROUT_CONFIG     ((PADS_TSERROUT_CONFIG == PAD_I2S_IN_SD) ? BIT2 : \
                                         (PADS_TSERROUT_CONFIG == PAD_GPIO7) ? BIT3 : \
                                         (PADS_TSERROUT_CONFIG == PAD_PWM4) ? (BIT3 | BIT2) : 0)
        _RVM1(0x1ec9, _CONFIG_TSERROUT_CONFIG, (BIT3 | BIT2)),
    #endif
#endif
...
#ifdef PADS_TS2_PE
    #if (PADS_TS2_PE == ENABLE)
        _RVM1(0x1ed0, BITMASK(7:2), BITMASK(7:2)),
        _RVM1(0x1ed1, BITMASK(4:0), BITMASK(4:0)),
    #else
        _RVM1(0x1ed0, 0, BITMASK(7:2)),
        _RVM1(0x1ed1, 0, BITMASK(4:0)),
    #endif
#endif

#ifdef PADS_TS3_PE
    #if (PADS_TS1_PE == ENABLE)
        _RVM1(0x1ed2, BITMASK(7:1), BITMASK(7:1)),
        _RVM1(0x1ed3, BITMASK(3:0), BITMASK(3:0)),
    #else
        _RVM1(0x1ed2, 0, BITMASK(7:1)),
        _RVM1(0x1ed3, 0, BITMASK(3:0)),
    #endif
#endif
...
//=============================================================================
    ...
    #define _CONFIG_SD_MODE     ((PADS_SD_MODE == CONFIG_SD_MODE0) ? BIT0 : \
                                 (PADS_SD_MODE == CONFIG_SD_MODE1) ? BIT1 : \
                                 (PADS_SD_MODE == CONFIG_SD_MODE2) ? (BIT1 | BIT0) : 0)
        _RVM1(0x1eb5, _CONFIG_SD_MODE, (BIT1 | BIT0)),
    #endif
#endif

#ifdef PADS_SD2_MODE
    #if (PADS_SD2_MODE != UNKNOWN_PAD_MUX)
    #define _CONFIG_SD2_MODE     ((PADS_SD_MODE == CONFIG_SD2_MODE0) ? BIT2 : \
                                  (PADS_SD_MODE == CONFIG_SD2_MODE1) ? BIT3 : \
                                  (PADS_SD_MODE == CONFIG_SD2_MODE2) ? (BIT3 | BIT2) : 0)
        _RVM1(0x1eb5, _CONFIG_SD2_MODE, (BIT3 | BIT2)),
    #endif
#endif

#ifdef PADS_SDIO_MODE
    #if (PADS_SDIO_MODE != UNKNOWN_PAD_MUX)
    #define _CONFIG_SDIO_MODE   ((PADS_SDIO_MODE == CONFIG_SDIO_MODE0) ? BIT3: \
                                 (PADS_SDIO_MODE == CONFIG_SDIO_MODE1) ? BIT4: \
                                 (PADS_SDIO_MODE == CONFIG_SDIO_MODE2) ? (BIT4 | BIT3) : \
                                 (PADS_SDIO_MODE == CONFIG_SDIO_MODE4) ? BIT4 : 0)
        _RVM1(0x1ef6, _CONFIG_SDIO_MODE, (BIT5 | BIT4 | BIT3)),
    #endif
#endif

//=============================================================================
#ifdef PADS_PCM1_CTRL_CONFIG
    #if (PADS_PCM1_CTRL_CONFIG != UNKNOWN_PAD_MUX)
    #define _CONFIG_PCM1_CTRL_CONFIG    ((PADS_PCM1_CTRL_CONFIG == PAD_PCM1) ? BIT6 : \
                                         (PADS_PCM1_CTRL_CONFIG == PAD_PCM_MMODE) ? BIT7 : 0)
        _RVM1(0x1ec8, _CONFIG_PCM1_CTRL_CONFIG, (BIT7 | BIT6)),
    #endif
#endif

#ifdef PADS_PCM1_AD_CONFIG
    #if (PADS_PCM1_AD != UNKNOWN_PAD_MUX)
    #define _CONFIG_PCM1_AD_CONFIG      ((PADS_PCM1_AD_CONFIG == PAD_PCM1) ? BIT4 : \
                                         (PADS_PCM1_AD_CONFIG == PAD_PCM_SMODE) ? BIT5 : \
                                         (PADS_PCM1_AD_CONFIG == PAD_PCM_MMODE) ? (BIT5 | BIT4) :0)
        _RVM1(0x1ec8, _CONFIG_PCM1_AD_CONFIG, (BIT5 | BIT4)),
    #endif
#endif

#ifdef PADS_PCM2_CTRL_CONFIG
    #if (PADS_PCM2_CTRL_CONFIG != UNKNOWN_PAD_MUX)
    #define _CONFIG_PCM2_CTRL_CONFIG    ((PADS_PCM2_CTRL_CONFIG == PAD_PCM2) ? BIT3 : 0)
        _RVM1(0x1ec8, _CONFIG_PCM2_CTRL_CONFIG, BIT3),
    #endif
#endif

#ifdef PADS_PCM2_CDN_ENABLE
    #if (PADS_PCM2_CDN_ENABLE != UNKNOWN_PAD_MUX)
    #define _CONFIG_PCM2_CDN_ENABLE     ((PADS_PCM2_CDN_ENABLE == PAD_PCM2) ? BIT0 : 0)
        _RVM1(0x1e9e, _CONFIG_PCM2_CDN_ENABLE, BIT0),
    #endif
#endif
...
//=============================================================================
    ...
    #define _CONFIG_I2S_IN  ((PADS_I2S_IN == ENABLE) ? BIT2 : 0)
        ...
        _RVM1(0x1eae, BIT4, BIT4),
        #if (PADS_I2S_OUT == PAD_I2S_OUT_SD)
            _RVM1(0x1eae, BIT5, BIT5),
        #elif (PADS_I2S_OUT == PAD_I2S_OUT_SD1)
            _RVM1(0x1eb3, BIT3, BIT3),
        #elif (PADS_I2S_OUT == PAD_I2S_OUT_SD2)
            _RVM1(0x1eb3, BIT4, BIT4),
        #elif (PADS_I2S_OUT == PAD_I2S_OUT_SD3)
            _RVM1(0x1eb3, BIT5, BIT5),
        #else
            _RVM1(0x1eae, BIT5, BIT5),
        #endif
    #endif
    ...
    #if (PADS_I2S_OUT_IN_TCON != UNKNOWN_PAD_MUX)
    #define _CONFIG_I2S_OUT_IN_TCON ((PADS_I2S_OUT_IN_TCON == ENABLE) ? BIT0 : 0)
        _RVM1(0x1e3c, _CONFIG_I2S_OUT_IN_TCON, BIT0),
    #endif
#endif
...
#ifdef PADS_SPDIF2_OUT
    #if (PADS_SPDIF2_OUT != UNKNOWN_PAD_MUX)
    #define _CONFIG_SPDIF2_OUT  ((PADS_SPDIF2_OUT == ENABLE) ? BIT0 : 0)
        _RVM1(0x1eb3, _CONFIG_SPDIF2_OUT, BIT0),
    #endif
#endif
...
//=============================================================================
#ifdef PADS_VSYNC_LIKE_MODE
    #if (PADS_VSYNC_LIKE_MODE != UNKNOWN_PAD_MUX)
    #define _CONFIG_VSYNC_LIKE_MODE     ((PADS_VSYNC_LIKE_MODE == ENABLE) ? BIT6 : 0)
        _RVM1(0x1eb4, _CONFIG_VSYNC_LIKE_MODE, (BIT7 | BIT6)),
    #endif
#endif

//=============================================================================
#ifdef PADS_LD_SPI_MODE
    #if (PADS_LD_SPI_MODE != UNKNOWN_PAD_MUX)
    #define _CONFIG_LD_SPI_MODE     ((PADS_LD_SPI_MODE == LD_SPI_MODE0) ? BIT0 : \
                                     (PADS_LD_SPI_MODE == LD_SPI_MODE1) ? BIT1 : \
                                     (PADS_LD_SPI_MODE == LD_SPI_MODE2) ? BIT2 : \
                                     (PADS_LD_SPI_MODE == LD_SPI_MODE3) ? BIT3 : 0)
        _RVM1(0x1eb4, _CONFIG_LD_SPI_MODE, (BIT3 | BIT2 | BIT1 | BIT0)),
    #endif
#endif

#ifdef PADS_FRC_LD_SPI_MODE
    #if (PADS_FRC_LD_SPI_MODE != UNKNOWN_PAD_MUX)
    #define _CONFIG_FRC_LD_SPI_MODE ((PADS_FRC_LD_SPI_MODE == FRC_LD_SPI_MODE0) ? BIT0 : \
                                     (PADS_FRC_LD_SPI_MODE == FRC_LD_SPI_MODE1) ? BIT1 : \
                                     (PADS_FRC_LD_SPI_MODE == FRC_LD_SPI_MODE2) ? BIT2 : 0)
        _RVM1(0x1ee2, _CONFIG_FRC_LD_SPI_MODE, (BIT2 | BIT1 | BIT0)),
    #endif
#endif

#ifdef PADS_DIM_MODE
    #if (PADS_DIM_MODE != UNKNOWN_PAD_MUX)
    #define _CONFIG_DIM_MODE        ((PADS_DIM_MODE == ENABLE) ? BIT0 : 0)
        _RVM1(0x1ef6, _CONFIG_DIM_MODE, BIT0),
    #endif
#endif
...
//=============================================================================
    ...
    #define _CONFIG_UART3_MODE      ((PADS_UART3_MODE == PAD_GPIO6) ? BIT2 : \
    ...
    #define _CONFIG_UART4_MODE      ((PADS_UART4_MODE == PAD_TS2) ? BIT6 : \
                                     (PADS_UART4_MODE == PAD_GPIO11) ? BIT7 : \
    ...
    #define _CONFIG_UART5_MODE      ((PADS_UART5_MODE == PAD_DIM2) ? BIT6 : \
                                     (PADS_UART5_MODE == PAD_GPIO8) ? BIT7 : 0)
    ...
    #define _CONFIG_UART6_MODE      ((PADS_UART6_MODE == PAD_GPIO35) ? BIT6 : \
                                     (PADS_UART6_MODE == PAD_TS3) ? BIT7 : 0)
    ...
    #define _CONFIG_FAST_UART_MODE  ((PADS_FAST_UART_MODE == PAD_GPIO1) ? BIT4 : 
                                     ...
                                     (PADS_FAST_UART_MODE == PAD_GPIO13) ? (BIT5 | BIT4) : 0)
...
//=============================================================================
    ...
    #define _CONFIG_OD_UART2_MODE   ((PADS_OD_UART2_MODE == PAD_TS0) ? BIT0 : \
                                     (PADS_OD_UART2_MODE == PAD_PCM2) ? BIT1 : \
    ...
    #define _CONFIG_OD_UART3_MODE   ((PADS_OD_UART3_MODE == PAD_GPIO6) ? BIT2 : \
                                     (PADS_OD_UART3_MODE == PAD_I2S) ? BIT3 : \
                                     (PADS_OD_UART3_MODE == PAD_PCM2) ? (BIT3 | BIT2) : 0)
    ...
    #define _CONFIG_OD_UART4_MODE   ((PADS_OD_UART4_MODE == PAD_TS2) ? BIT4 : \
                                     (PADS_OD_UART4_MODE == PAD_GPIO11) ? BIT5 : \
                                     (PADS_OD_UART4_MODE == PAD_I2S) ? (BIT5 | BIT4) : 0)
    ...
    #define _CONFIG_OD_UART5_MODE   ((PADS_OD_UART5_MODE == PAD_DIM2) ? BIT4 : \
                                     (PADS_OD_UART5_MODE == PAD_GPIO8) ? BIT5 : 0)
        _RVM1(0x1ea9, _CONFIG_OD_UART5_MODE, (BIT5 | BIT4)),
    #endif
#endif

#ifdef PADS_OD_UART6_MODE
    #if (PADS_OD_UART6_MODE != UNKNOWN_PAD_MUX)
    #define _CONFIG_OD_UART6_MODE   ((PADS_OD_UART6_MODE == PAD_GPIO35) ? BIT6 : \
                                     (PADS_OD_UART6_MODE == PAD_TS3) ? BIT7 : 0)
        _RVM1(0x1ea9, _CONFIG_OD_UART6_MODE, (BIT7 | BIT6)),
    #endif
#endif

#ifdef PADS_OD_FAST_UART_MODE
    #if (PADS_OD_FAST_UART_MODE != UNKNOWN_PAD_MUX)
    #define _CONFIG_OD_FAST_UART_MODE   ((PADS_OD_FAST_UART_MODE == PAD_GPIO1) ? BIT6 : \
                                         (PADS_OD_FAST_UART_MODE == PAD_TCON) ? BIT7 : \
                                         (PADS_OD_FAST_UART_MODE == PAD_GPIO13) ? (BIT7 | BIT6) : 0)
...
#define _CONFIG_ENABLE_FAST_UART_INV_MODE   ((PADS_FAST_UART_INV_MODE == ENABLE) ? BIT7 : 0)
    ...
    _RVM1(0x1ea8, ((UART5_SRC_SEL << 4) | UART4_SRC_SEL), BITMASK(7:0)),
     ...
     (UART5_SRC_SEL == UART6_SRC_SEL) || \
     (UART6_SRC_SEL == UART0_SRC_SEL) || \
     (UART6_SRC_SEL == UART1_SRC_SEL) || \
     (UART6_SRC_SEL == UART2_SRC_SEL) || \
     (UART6_SRC_SEL == UART3_SRC_SEL) || \
     (UART6_SRC_SEL == UART4_SRC_SEL) || \
     (UART6_SRC_SEL == UART5_SRC_SEL))
...
//=============================================================================
    ...
    #define _CONFIG_PWM1_MODE   ((PADS_PWM1_MODE == ENABLE) ? BIT0:  0)
        _RVM1(0x1ec9, _CONFIG_PWM1_MODE, BIT0),
    #endif
#endif

#ifdef PADS_PWM2_MODE
    #if (PADS_PWM2_MODE != UNKNOWN_PAD_MUX)
    #define _CONFIG_PWM2_MODE   ((PADS_PWM2_MODE == ENABLE) ? BIT1:  0)
        _RVM1(0x1ec9, _CONFIG_PWM2_MODE, BIT1),
    #endif
#endif
...
//=============================================================================
#ifdef PADS_IRE_MODE
    #if (PADS_IRE_MODE != UNKNOWN_PAD_MUX)
    #define _CONFIG_IRE_MODE    ((PADS_IRE_MODE == PAD_IRE_MODE0) ? BIT4 : \
                                 (PADS_IRE_MODE == PAD_IRE_MODE1) ? BIT5 : \
                                 (PADS_IRE_MODE == PAD_IRE_MODE2) ? (BIT5 | BIT4) : 0)
        _RVM1(0x1edf, _CONFIG_IRE_MODE, (BIT5 | BIT4)),
    #endif
#endif
...
//=============================================================================
        ...
        #if (PADS_MIIC_MODE0 == PAD_GPIO20)
            _RVM1(0x1edc, BIT0, BIT0),
        #elif (PADS_MIIC_MODE0 == PAD_TS2)
            _RVM1(0x1eda, BIT4, BIT4),
        #else
            _RVM1(0x1edc, BIT0, BIT0),
        #endif
    #endif
    ...
    #define _CONFIG_MIIC_MODE1  ((PADS_MIIC_MODE1 == PAD_TGPIO2) ? BIT2 : 0)
        ...
        #if (PADS_MIIC_MODE2 == PAD_I2S)
            _RVM1(0x1edc, BIT2, BIT2),
        #elif (PADS_MIIC_MODE2 == PAD_GPIO36)
            _RVM1(0x1edc, BIT3, BIT3),
        #elif (PADS_MIIC_MODE2 == PAD_TS3)
            _RVM1(0x1eda, BIT5, BIT5),
        #else
            _RVM1(0x1edc, BIT2, BIT2),
        #endif
    #endif
        ...
        #if (PADS_MIIC_MODE4 == PAD_GPIO30)
            _RVM1(0x1ede, BIT0, BIT0),
        #elif (PADS_MIIC_MODE4 == PAD_TS2)
            _RVM1(0x1eda, BIT6, BIT6),
        #else
            _RVM1(0x1ede, BIT0, BIT0),
        #endif
    #endif
        ...
        #if (PADS_MIIC_MODE5 == PAD_GPIO32)
            _RVM1(0x1ede, BIT1, BIT1),
        #elif (PADS_MIIC_MODE5 == PAD_TS2)
            _RVM1(0x1eda, BIT3, BIT7),
        #else
            _RVM1(0x1ede, BIT1, BIT1),
        #endif
    #endif
...
//=============================================================================
    ...
    #if (PADS_SM_CONFIG != UNKNOWN_PAD_MUX)
    #define _CONFIG_SM_CONFIG   ((PADS_SM_CONFIG == PAD_PCM) ? BIT4 : \
                                 (PADS_SM_CONFIG == PAD_TS1) ? BIT5 : 0)
        _RVM1(0x1edc, _CONFIG_SM_CONFIG, (BIT5 | BIT4)),
    #endif
#endif
...
#ifdef PADS_TCON11_MODE
    #if (PADS_TCON11_MODE != UNKNOWN_PAD_MUX)
    #define _CONFIG_TCON11_MODE     ((PADS_TCON11_MODE == ENABLE) ? BIT3 : 0)
        _RVM1(0x1ea1, _CONFIG_TCON11_MODE, BIT3),
    #endif
#endif

#ifdef PADS_TCON12_MODE
    #if (PADS_TCON12_MODE != UNKNOWN_PAD_MUX)
    #define _CONFIG_TCON12_MODE     ((PADS_TCON12_MODE == ENABLE) ? BIT4 : 0)
        _RVM1(0x1ea1, _CONFIG_TCON12_MODE, BIT4),
    #endif
#endif

#ifdef PADS_TCON13_MODE
    #if (PADS_TCON13_MODE != UNKNOWN_PAD_MUX)
    #define _CONFIG_TCON13_MODE     ((PADS_TCON13_MODE == ENABLE) ? BIT5 : 0)
        _RVM1(0x1ea1, _CONFIG_TCON13_MODE, BIT5),
    #endif
#endif

//=============================================================================
#ifdef PADS_TCON2_0_MODE
    #if (PADS_TCON2_0_MODE != UNKNOWN_PAD_MUX)
    #define _CONFIG_TCON2_0_MODE      ((PADS_TCON2_0_MODE == ENABLE) ? BIT0 : 0)
        _RVM1(0x1ece, _CONFIG_TCON2_0_MODE, BIT0),
    #endif
#endif

#ifdef PADS_TCON2_1_MODE
    #if (PADS_TCON2_1_MODE != UNKNOWN_PAD_MUX)
    #define _CONFIG_TCON2_1_MODE      ((PADS_TCON2_1_MODE == ENABLE) ? BIT1 : 0)
        _RVM1(0x1ece, _CONFIG_TCON2_1_MODE, BIT1),
    #endif
#endif

#ifdef PADS_TCON2_2_MODE
    #if (PADS_TCON2_2_MODE != UNKNOWN_PAD_MUX)
    #define _CONFIG_TCON2_2_MODE      ((PADS_TCON2_2_MODE == ENABLE) ? BIT2 : 0)
        _RVM1(0x1ece, _CONFIG_TCON2_2_MODE, BIT2),
    #endif
#endif

#ifdef PADS_TCON2_3_MODE
    #if (PADS_TCON2_3_MODE != UNKNOWN_PAD_MUX)
    #define _CONFIG_TCON2_3_MODE      ((PADS_TCON2_3_MODE == ENABLE) ? BIT3 : 0)
        _RVM1(0x1ece, _CONFIG_TCON2_3_MODE, BIT3),
    #endif
#endif

#ifdef PADS_TCON2_4_MODE
    #if (PADS_TCON2_4_MODE != UNKNOWN_PAD_MUX)
    #define _CONFIG_TCON2_4_MODE      ((PADS_TCON2_4_MODE == ENABLE) ? BIT4 : 0)
        _RVM1(0x1ece, _CONFIG_TCON2_4_MODE, BIT4),
    #endif
#endif

#ifdef PADS_TCON2_5_MODE
    #if (PADS_TCON2_5_MODE != UNKNOWN_PAD_MUX)
    #define _CONFIG_TCON2_5_MODE      ((PADS_TCON2_5_MODE == ENABLE) ? BIT5 : 0)
        _RVM1(0x1ece, _CONFIG_TCON2_5_MODE, BIT5),
    #endif
#endif

#ifdef PADS_TCON2_6_MODE
    #if (PADS_TCON2_6_MODE != UNKNOWN_PAD_MUX)
    #define _CONFIG_TCON2_6_MODE      ((PADS_TCON2_6_MODE == ENABLE) ? BIT6 : 0)
        _RVM1(0x1ece, _CONFIG_TCON2_6_MODE, BIT6),
    #endif
#endif

#ifdef PADS_TCON2_7_MODE
    #if (PADS_TCON2_7_MODE != UNKNOWN_PAD_MUX)
    #define _CONFIG_TCON2_7_MODE      ((PADS_TCON2_7_MODE == ENABLE) ? BIT7 : 0)
        _RVM1(0x1ece, _CONFIG_TCON2_7_MODE, BIT7),
    #endif
#endif

#ifdef PADS_TCON2_8_MODE
    #if (PADS_TCON2_8_MODE != UNKNOWN_PAD_MUX)
    #define _CONFIG_TCON2_8_MODE      ((PADS_TCON2_8_MODE == ENABLE) ? BIT0 : 0)
        _RVM1(0x1ecf, _CONFIG_TCON2_8_MODE, BIT0),
    #endif
#endif

#ifdef PADS_TCON2_9_MODE
    #if (PADS_TCON2_9_MODE != UNKNOWN_PAD_MUX)
    #define _CONFIG_TCON2_9_MODE      ((PADS_TCON2_9_MODE == ENABLE) ? BIT1 : 0)
        _RVM1(0x1ecf, _CONFIG_TCON2_9_MODE, BIT1),
    #endif
#endif

#ifdef PADS_TCON2_10_MODE
    #if (PADS_TCON2_10_MODE != UNKNOWN_PAD_MUX)
    #define _CONFIG_TCON2_10_MODE     ((PADS_TCON2_10_MODE == ENABLE) ? BIT2 : 0)
        _RVM1(0x1ecf, _CONFIG_TCON2_10_MODE, BIT2),
    #endif
#endif
...
#if (PIN_FLASH_WP0)
#if (MS_BOARD_TYPE_SEL == BD_MST206A_D01A_S_MIAMI)
    _RVM1(0x0f06, BIT1, BIT1),          //Output Value of PM3
    _RVM1(0x0f06, 0, BIT0),             //Output Enable of PM3
#elif  (MS_BOARD_TYPE_SEL == BD_MST206B_D01A_S_MIAMI)
    _RVM1(0x0f1a, BIT1, BIT1),          //Output Value of PM13
    _RVM1(0x0f1a, 0, BIT0),             //Output Enable of PM13
...
//=================================================================================================
    ...
    _RVM1(0x0f1a, BIT1, BIT1),          //Output Value of PM13
    _RVM1(0x0f1a, 0, BIT0),             //Output Enable of PM13
#elif (MS_BOARD_TYPE_SEL == BD_MST206A_D01A_S_MIAMI)
    _RVM1(0x0f06, BIT1, BIT1),          //Output Value of PM3
    _RVM1(0x0f06, 0, BIT0),             //Output Enable of PM3
#elif (MS_BOARD_TYPE_SEL == BD_FPGA_MIAMI)
#else
