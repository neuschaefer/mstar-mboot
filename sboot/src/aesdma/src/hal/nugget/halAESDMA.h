...
#define CONFIG_XIU_BASE_ADDRESS     0xBF600000
#define CONFIG_EMMC_BASE_ADDRESS    0xBF400000
...
#define SECURE_RSA_OUT_DRAM_ADDRESS          (0x80109000)
#define SECURE_SHA_OUT_DRAM_ADDRESS          (0x80109100)
#define SECURE_RSA_OUT_SRAM_ADDRESS          (0xBF403500)
#define SECURE_SHA_OUT_SRAM_ADDRESS          (0xBF403600)
#define SECURE_WB_FIFO_OUT_ADDRESS           (0xBF401C00)
