...
#define AESDMA_BASE_ADDR     (0x100C00)
#define SHARNG_BASE_ADDR     (0x113C00)
#define RSA_BASE_ADDR        (0x113C00)
...
#define SECURE_RSA_OUT_SRAM_ADDRESS          (0x1FC02500)
#define SECURE_SHA_OUT_SRAM_ADDRESS          (0x1FC02600)
