...
#define _MapBase_nonPM_NIKE         (RIU_MAP + 0x200000)
#define _MapBase_PM_NIKE            RIU_MAP
#else
#define _MapBase_nonPM_NIKE         0xA0200000
#define _MapBase_PM_NIKE            0xA0000000
#endif
...
//---------------------------------------------------------------------
    _MEMMAP_PM_,
        ...
        _RVM1(0x0e25, 0xBA, 0xFF),  //reg[oe25]#7 ~ #0 = 10111010b
    #endif
    ...
    _MEMMAP_nonPM_,
        ...
        //reg_bt656_ctrl[1:0]
        _RVM1(0x1edf, 0, BIT7 | BIT6),   //reg[101edf]#7 ~ #6 = 0b
        //reg_p1_enable_b0
        ...
        //reg_od2nduart[1:0]
        _RVM1(0x1eb6, 0, BIT1 | BIT0),   //reg[101eb6]#1 ~ #0 = 0b
        //reg_odfastuart[1:0]
        _RVM1(0x1eb6, 0, BIT7 | BIT6),   //reg[101eb6]#7 ~ #6 = 0b
        //reg_bt656_ctrl[1:0]
        _RVM1(0x1edf, 0, BIT7 | BIT6),   //reg[101edf]#7 ~ #6 = 0b
        //reg_p1_enable_b3
        ...
        //reg_od3rduart[1:0]
        _RVM1(0x1eb6, 0, BIT3 | BIT2),   //reg[101eb6]#3 ~ #2 = 0b
        //reg_pdtracectrl[1:0]
        _RVM1(0x1e9f, 0, BIT1 | BIT0),   //reg[101e9f]#1 ~ #0 = 0b
        //reg_allpad_in
        //_RVM1(0x1ea1, 0, BIT7),   //reg[101ea1]#7 = 0b
        ...
        //reg_od4thuart[1:0]
        _RVM1(0x1eb6, 0, BIT5 | BIT4),   //reg[101eb6]#5 ~ #4 = 0b
        //reg_pdtracectrl[1:0]
        _RVM1(0x1e9f, 0, BIT1 | BIT0),   //reg[101e9f]#1 ~ #0 = 0b
        //reg_allpad_in
        //_RVM1(0x1ea1, 0, BIT7),   //reg[101ea1]#7 = 0b
        ...
        _RVM1(0x1eb1, 0, BIT7 | BIT6),   //reg[101eb1]#7 ~ #6 = 0b
        //reg_tserrout[1:0]
        _RVM1(0x1ea2, 0, BIT7 | BIT6),   //reg[101ea2]#7 ~ #6 = 0b
        //reg_allpad_in
        //_RVM1(0x1ea1, 0, BIT7),   //reg[101ea1]#7 = 0b
    #endif
        ...
        //reg_led_mode[1:0]
        _RVM1(0x1eb4, 0, BIT5 | BIT4),   //reg[101eb4]#5 ~ #4 = 0b
        //reg_et_test_mode[1:0]
        //_RVM1(0x1edf, 0, BIT3 | BIT2),   //reg[101edf]#3 ~ #2 = 0b
        //reg_et_test_mode[1:0]
        //_RVM1(0x1edf, 0, BIT3 | BIT2),   //reg[101edf]#3 ~ #2 = 0b
        //reg_seconduartmode[1:0]
        _RVM1(0x1e05, 0, BIT1 | BIT0),   //reg[101e05]#1 ~ #0 = 0b
        ...
        //_RVM1(0x1e06, 0, BIT7 | BIT6),   //reg[101e06]#7 ~ #6 = 0b
        ...
        //reg_pwm5_mode[1:0]
        _RVM1(0x1eb2, 0, BIT1 | BIT0),   //reg[101eb2]#1 ~ #0 = 0b
        //reg_pwm7_dim_mode
        ...
        _RVM1(0x1eb4, 0, BIT2),   //reg[101eb4]#2 = 0b
        //reg_pwm4_mode[1:0]
        _RVM1(0x1ea2, 0, BIT5 | BIT4),   //reg[101ea2]#5 ~ #4 = 0b
        //reg_pwm6_dim_mode
        ...
        _RVM1(0x1eb2, 0, BIT4 | BIT3),   //reg[101eb2]#4 ~ #3 = 0b
        //reg_ld_spi1cz_config[1:0]
        _RVM1(0x1eb2, 0, BIT4 | BIT3),   //reg[101eb2]#4 ~ #3 = 0b
        //reg_ld_spi1cz_config[1:0]
        _RVM1(0x1eb2, 0, BIT4 | BIT3),   //reg[101eb2]#4 ~ #3 = 0b
        ...
        //reg_sdio_config[1:0]
        _RVM1(0x1eb7, 0, BIT3 | BIT2),   //reg[101eb7]#3 ~ #2 = 0b
        //reg_extint0
        ...
        _RVM1(0x1e9f, 0, BIT5),   //reg[101e9f]#5 = 0b
        //reg_sd_config[1:0]
        _RVM1(0x1eb7, 0, BIT1 | BIT0),   //reg[101eb7]#1 ~ #0 = 0b
        //reg_sd_config[1:0]
        _RVM1(0x1eb7, 0, BIT1 | BIT0),   //reg[101eb7]#1 ~ #0 = 0b
        //reg_sdio_config[1:0]
        _RVM1(0x1eb7, 0, BIT3 | BIT2),   //reg[101eb7]#3 ~ #2 = 0b
        ...
        //reg_sm_config[1:0]
        _RVM1(0x1e17, 0, BIT3 | BIT2),   //reg[101e17]#3 ~ #2 = 0b
        //reg_allpad_in
        //_RVM1(0x1ea1, 0, BIT7),   //reg[101ea1]#7 = 0b
    #endif
        ...
        _RVM1(0x1eb2, 0, BIT7 | BIT6),   //reg[101eb2]#7 ~ #6 = 0b
        //reg_ld_spi1cz_tconfig[1:0]
        _RVM1(0x1eb2, 0, BIT7 | BIT6),   //reg[101eb2]#7 ~ #6 = 0b
        //reg_allpad_in
        //_RVM1(0x1ea1, 0, BIT7),   //reg[101ea1]#7 = 0b
        ...
        //_RVM1(0x1e24, 0, BIT6 | BIT5 | BIT4),   //reg[101e24]#6 ~ #4 = 00b
        //reg_ts0_config[1:0]
        _RVM1(0x1ea3, 0, BIT3 | BIT2),   //reg[101ea3]#3 ~ #2 = 0b
        //reg_ts0_config[1:0]
        _RVM1(0x1ea3, 0, BIT3 | BIT2),   //reg[101ea3]#3 ~ #2 = 0b
        //reg_allpad_in
        //_RVM1(0x1ea1, 0, BIT7),   //reg[101ea1]#7 = 0b
        ...
        //_RVM1(0x1e24, 0, BIT2 | BIT1 | BIT0),   //reg[101e24]#2 ~ #0 = 00b
        //reg_ts1_config[1:0]
        _RVM1(0x1ea3, 0, BIT5 | BIT4),   //reg[101ea3]#5 ~ #4 = 0b
        //reg_ts1_config[1:0]
        _RVM1(0x1ea3, 0, BIT5 | BIT4),   //reg[101ea3]#5 ~ #4 = 0b
        //reg_ts1_config[1:0]
        _RVM1(0x1ea3, 0, BIT5 | BIT4),   //reg[101ea3]#5 ~ #4 = 0b
        //reg_ts_out_mode[1:0]
        _RVM1(0x1ea3, 0, BIT1 | BIT0),   //reg[101ea3]#1 ~ #0 = 0b
        //reg_ts_out_mode[1:0]
        _RVM1(0x1ea3, 0, BIT1 | BIT0),   //reg[101ea3]#1 ~ #0 = 0b
        //reg_bt656_ctrl[1:0]
        _RVM1(0x1edf, 0, BIT7 | BIT6),   //reg[101edf]#7 ~ #6 = 0b
...
#if (PIN_FLASH_WP0)
#if ((MS_BOARD_TYPE_SEL == BD_MST176A_D01A_S_NIKE) || \
     (MS_BOARD_TYPE_SEL == BD_MST176A_D01A_S_NIKEU) || \
     (MS_BOARD_TYPE_SEL == BD_MST176A_D01A_S_NIKEC))
    _RVM1(0x0e21, BIT2, BIT2),          //Output Value of PM10
    _RVM1(0x0e1f, 0, BIT2),             //Output Enable of PM10
#elif (MS_BOARD_TYPE_SEL == BD_FPGA_NIKE)
#else
