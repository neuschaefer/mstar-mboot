...
#define _MapBase_nonPM_MILAN      (RIU_MAP + 0x200000)
#define _MapBase_PM_MILAN         RIU_MAP
#else
#define _MapBase_nonPM_MILAN      0xA0200000
#define _MapBase_PM_MILAN         0xA0000000
#endif
...
#if (PIN_FLASH_WP0)
  #if ((MS_BOARD_TYPE_SEL == BD_MST999A_D01A_S))//PAD_PWM0
        _RVM1(0x1e40,    0,  BIT4), //reg[101e40]#4 = 0b
        _RVM1(0x1e85, BIT4,  BIT4), //output high
        _RVM1(0x1e87,    0,  BIT4), //oen: output(0)
  #elif (MS_BOARD_TYPE_SEL == BD_MILAN_FPGA)
        _RVM1(0x1e40,    0,  BIT4), //reg[101e40]#4 = 0b
        _RVM1(0x1e85, BIT4,  BIT4), //output high
        _RVM1(0x1e87,    0,  BIT4), //oen: output(0)
  #else
