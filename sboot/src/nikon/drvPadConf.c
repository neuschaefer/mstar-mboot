...
#define _NIKON_ENBEDED_FLASH_      0       // 1: with enbeded flash, 0: without enbeded flash

#if defined (MIPS_CHAKRA) || defined(MSOS_TYPE_LINUX)
#define _MapBase_nonPM_NIKON      (RIU_MAP + 0x200000)
#define _MapBase_PM_NIKON         RIU_MAP
#else
#define _MapBase_nonPM_NIKON      0xA0200000
#define _MapBase_PM_NIKON         0xA0000000
#endif
...
//---------------------------------------------------------------------
    _MEMMAP_nonPM_,
        ...
        //reg_ej_config[1:0] = 00b
        _RVM1(0x1ee2, 0, BIT1 | BIT0),   //reg[101ee2]#1~#0 = 00b
        //reg_tconconfig[0] = 0b
...
//        #define PAD_TESTPIN_OEN (PAD_TESTPIN_IS_GPIO == GPIO_IN ? BIT: 0)
//        #define PAD_TESTPIN_OUT (PAD_TESTPIN_IS_GPIO == GPIO_OUT_HIGH ? BIT: 0)
//        _RVM1(0x, PAD_TESTPIN_OUT, BIT),
//        _RVM1(0x, PAD_TESTPIN_OEN, BIT),
//    #endif
    ...
    _MEMMAP_nonPM_,
        ...
        //reg_spi_gpio_oen[0] = 0b
        _RVM1(0x1e8f, 0, BIT0),   //reg[101e8f]#0 = 0b
    #endif
        ...
        _RVM1(0x1e8f, 0, BIT1),   //reg[101e8f]#0 = 0b
    #endif
        ...
        _RVM1(0x1e43, PAD_NAND_WPZ_OUT, BIT5),
        _RVM1(0x1e47, PAD_NAND_WPZ_OEN, BIT5),
        //reg_test_in_mode[1:0] = 00b
        //_RVM1(0x1e24, 0, BIT1 | BIT0),   //reg[101e24]#1~#0 = 00b
        //reg_test_out_mode[1:0] = 00b
        //_RVM1(0x1e24, 0, BIT5 | BIT4),   //reg[101e24]#5~#4 = 00b
        ...
        #define PAD_NAND_WEZ_OEN (PAD_NAND_WEZ_IS_GPIO == GPIO_IN ? BIT6: 0)
        #define PAD_NAND_WEZ_OUT (PAD_NAND_WEZ_IS_GPIO == GPIO_OUT_HIGH ? BIT6: 0)
        _RVM1(0x1e43, PAD_NAND_WEZ_OUT, BIT6),
        _RVM1(0x1e47, PAD_NAND_WEZ_OEN, BIT6),
        //reg_test_in_mode[1:0] = 00b
        //_RVM1(0x1e24, 0, BIT1 | BIT0),   //reg[101e24]#1~#0 = 00b
        //reg_test_out_mode[1:0] = 00b
        //_RVM1(0x1e24, 0, BIT5 | BIT4),   //reg[101e24]#5~#4 = 00b
        ...
        _RVM1(0x1e43, PAD_NAND_RBZ_OUT, BIT7),
        _RVM1(0x1e47, PAD_NAND_RBZ_OEN, BIT7),
        //reg_test_in_mode[1:0] = 00b
        //_RVM1(0x1e24, 0, BIT1 | BIT0),   //reg[101e24]#1~#0 = 00b
        //reg_test_out_mode[1:0] = 00b
        //_RVM1(0x1e24, 0, BIT5 | BIT4),   //reg[101e24]#5~#4 = 00b
        ...
        #define PADA_VSYNC1_OEN (PADA_VSYNC1_IS_GPIO == GPIO_IN ? BIT4: 0)
...
#define SPDIF_OUT2  ((PADS_SPDIF_OUT == PAD_PWM1) ? BIT5 : \
                         ...
                         (PADS_SPDIF_OUT == PAD_PM_SPI_CZ1) ? BIT7 : 0)
...
#if (PADS_SPI_NOR_MODE != Unknown_pad_mux)
        _RVM1(0x1E08, BIT3, BIT3 ),   //reg[1E08]#3 = 1b
#endif

#if (PADS_SPI_NAND_MODE != Unknown_pad_mux)
        _RVM1(0x1E08, 0, BIT3 ),   //reg[1E08]#3 = 0b
        _RVM1(0x1E08, BIT4, BIT4 ),   //reg[1E08]#4 = 1b
#endif

#if (PADS_NAND_MODE != Unknown_pad_mux)
        _RVM1(0x1E08, 0, BIT4|BIT3 ),   //reg[1E08]#4 ~ #3 = 00b
        _RVM1(0x1E4E, BIT0, BIT1|BIT0 ),   //reg[1E4E]#1 ~ #0 = 1b
#endif
...
#if (PIN_FLASH_WP0)
  #if ((MS_BOARD_TYPE_SEL == BD_MST186A_D01A_S))//PAD_PWM0
        _RVM1(0x1e40,    0,  BIT4), //reg[101e40]#4 = 0b
        _RVM1(0x1e85, BIT4,  BIT4), //output high
        _RVM1(0x1e87,    0,  BIT4), //oen: output(0)
  #elif ((MS_BOARD_TYPE_SEL == BD_MST186B_D01A_S))//PAD_GPIO3 (optional, default : 0) => been used by Audio_en
        //reg_ddcrmode[3:0] = 0000b
        _RVM1(0x1ef6, 0, BIT3|BIT2|BIT1|BIT0 ), //reg[101ef6]#3 ~#0 = 0000b
        _RVM1(0x1e7a, BIT3, BIT3), //output high
        _RVM1(0x1e7e,    0, BIT3), //oen: output(0)
  #elif ((MS_BOARD_TYPE_SEL == BD_MST186C_D01A_S))//PAD_GPIO3 (optional, default : 0) => been used by Audio_en
        //reg_ddcrmode[3:0] = 0000b
        _RVM1(0x1ef6, 0, BIT3|BIT2|BIT1|BIT0 ), //reg[101ef6]#3 ~#0 = 0000b
        _RVM1(0x1e7a, BIT3, BIT3), //output high
        _RVM1(0x1e7e,    0, BIT3), //oen: output(0)
  #elif ((MS_BOARD_TYPE_SEL == BD_MST186D_D01A_S))//PAD_GPIO3 (optional, default : 0) => been used by Audio_en
        //reg_ddcrmode[3:0] = 0000b
        _RVM1(0x1ef6, 0, BIT3|BIT2|BIT1|BIT0 ), //reg[101ef6]#3 ~#0 = 0000b
        _RVM1(0x1e7a, BIT3, BIT3), //output high
        _RVM1(0x1e7e,    0, BIT3), //oen: output(0)
  #elif ((MS_BOARD_TYPE_SEL == BD_MST186E_D01A_S))//PAD_GPIO3 (optional, default : 0) => been used by Audio_en
        //reg_ddcrmode[3:0] = 0000b
        _RVM1(0x1ef6, 0, BIT3|BIT2|BIT1|BIT0 ), //reg[101ef6]#3 ~#0 = 0000b
        _RVM1(0x1e7a, BIT3, BIT3), //output high
        _RVM1(0x1e7e,    0, BIT3), //oen: output(0)        
  #elif ((MS_BOARD_TYPE_SEL == BD_MST052B_10AYBC_13264))//PAD_GPIO3 (optional, default : 0) => been used by Audio_en
        //reg_ddcrmode[3:0] = 0000b
        _RVM1(0x1ef6, 0, BIT3|BIT2|BIT1|BIT0 ), //reg[101ef6]#3 ~#0 = 0000b
        _RVM1(0x1e7a, BIT3, BIT3), //output high
        _RVM1(0x1e7e,    0, BIT3), //oen: output(0)
  #elif ((MS_BOARD_TYPE_SEL == BD_MST053B_10AYU_13264))//PAD_GPIO3 (optional, default : 0) => been used by Audio_en
        //reg_ddcrmode[3:0] = 0000b
        _RVM1(0x1ef6, 0, BIT3|BIT2|BIT1|BIT0 ), //reg[101ef6]#3 ~#0 = 0000b
        _RVM1(0x1e7a, BIT3, BIT3), //output high
        _RVM1(0x1e7e,    0, BIT3), //oen: output(0)
  #elif ((MS_BOARD_TYPE_SEL == BD_MST054B_10AYB_13264))//PAD_GPIO3 (optional, default : 0) => been used by Audio_en
        //reg_ddcrmode[3:0] = 0000b
        _RVM1(0x1ef6, 0, BIT3|BIT2|BIT1|BIT0 ), //reg[101ef6]#3 ~#0 = 0000b
        _RVM1(0x1e7a, BIT3, BIT3), //output high
        _RVM1(0x1e7e,    0, BIT3), //oen: output(0)    
  #elif ((MS_BOARD_TYPE_SEL == BD_MST057B_10AYFT_13443))//PAD_GPIO3 (optional, default : 0) => been used by Audio_en
        //reg_ddcrmode[3:0] = 0000b
        _RVM1(0x1ef6, 0, BIT3|BIT2|BIT1|BIT0 ), //reg[101ef6]#3 ~#0 = 0000b
        _RVM1(0x1e7a, BIT3, BIT3), //output high
        _RVM1(0x1e7e,    0, BIT3), //oen: output(0)  
