...
#if ( (ENABLE_MSTAR_MARIA10_BD_MST109A_D01A_S)          \
   || (ENABLE_MSTAR_MARIA10_BD_MST109C_D01A_S)          \
   || (ENABLE_MSTAR_MARIA10_BD_MST136A_D01A_S)          \
   || (ENABLE_MSTAR_MARIA10_BD_MST109E_D01A_S)          \
   || (ENABLE_MSTAR_MARIA10_BD_MST006B_10AVS_10315)     \
   || (ENABLE_MSTAR_MARIA10_BD_MST006B_20AVS_10313)     \
    )
    #define MIU_SPEED       DDR2_800MHz

#elif ( (ENABLE_MSTAR_MARIA10_BD_MST109D_D01A_S)        \
     || (ENABLE_MSTAR_MARIA10_BD_MST109F_D01A_S)        \
     || (ENABLE_MSTAR_MARIA10_BD_MST004B_20AVS_10306)   \
     || (ENABLE_MSTAR_MARIA10_BD_MST6M181_TCL)          \
      )
...
static const MS_REG_INIT MIU_ATOP_Init[]=
{
    ...
    _RV32_2( ( RIUBASE_MIU_ATOP + 0x3A ) , 0x0080),
      ...
      #elif (ENABLE_MSTAR_MARIA10_BD_MST136A_D01A_S)
      _RV32_2( ( RIUBASE_MIU_ATOP + 0x36 ) , 0x4003), // 0x4000 -> 0x4004
      #else
...
{
#if (MIU_SPEED == DDR2_800MHz)
    #if defined(CONFIG_MSTAR_MARIA10_MMAP_32MB)
  ...
  #else
    _RV32_2( 0x110d38, 0x2266 ),  // 0x0033 -> 0x3366 -> 0x2266(Kimi.Liu)
  #endif

    _RV32_2( 0x110d3a, 0x0010 ),  // 0x0000 -> 0x0010
  #if (ENABLE_MSTAR_MARIA10_BD_MST136A_D01A_S)
    _RV32_2( 0x110d3a, 0x6060 ),  // 0x0000 -> 0x0010
  #endif
    _RV32_2( 0x110d3c, 0x2100 ),  // 0x2000 -> 0x2100
  #if (ENABLE_MSTAR_MARIA10_BD_MST136A_D01A_S)
    _RV32_2( 0x110d3c, 0x2000 ),  // 0x0000 -> 0x0010
  #endif
  ...
  #if (ENABLE_MSTAR_MARIA10_BD_MST109C_D01A_S) || (ENABLE_MSTAR_MARIA10_BD_MST136A_D01A_S)
    ...
    _RV32_2( 0x110d38, 0x0055 ),  // 0x33 -> 0x55(Kimi.Liu)
