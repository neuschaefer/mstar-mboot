...
static void MDrv_Digital_PowerDown(void)
{
...

    {
        ...
        MDrv_Write2Byte(0x101246, MDrv_Read2Byte(0x101246) | BIT11);  // g0
...

    {
        ...
        MDrv_Write2Byte(0x101246, MDrv_Read2Byte(0x101246) | BIT12);  // g0
    ...
    //ve dac
    MDrv_WriteRegBit(0x100b4a, 1, BIT0);
    ...
    {
        // evd
        MDrv_Write2Byte(0x160b02, MDrv_Read2Byte(0x160b02) | BIT0);
        MDrv_Write2Byte(0x101266, MDrv_Read2Byte(0x101266) | BIT2); //g1
        MDrv_Write2Byte(0x101286, MDrv_Read2Byte(0x101286) | BIT0); //g2
        MDrv_WriteRegBit(0x100b69, 1, BIT0);
        MDrv_WriteRegBit(0x100b67, 1, BIT0);
    }

    {
        ...
        MDrv_Write2Byte(0x101246, MDrv_Read2Byte(0x101246) | (BIT6|BIT5));  // g0
        MDrv_WriteRegBit(0x100b60, 1, BIT0);
    }

    {//demod
        MDrv_Write2Byte(0x101286, MDrv_Read2Byte(0x101286) | (BIT13|BIT12));   //g2
    ...
    //MDrv_WriteRegBit(0x100b21, 0, BIT0);//clk_mcu : ON
    ...
    //MDrv_WriteRegBit(0x100b2c, 0, BIT0); //clk_spi : ON
    MDrv_WriteRegBit(0x100b34, 1, BIT0);
    MDrv_WriteRegBit(0x100b35, 1, BIT0);
    MDrv_WriteRegBit(0x100b24, 1, BIT0);
    //MDrv_WriteRegBit(0x100b25, 0, BIT0); //clk_mps_aeon : ON
    ...
    
    {
        ...
        MDrv_Write2Byte(0x101266, MDrv_Read2Byte(0x101266) | (BIT0|BIT1));   //g1
...
{
    MDrv_WriteRegBit( 0x000e98, 0, 0x01);//Invert:N, ON
    MDrv_WriteRegBit( 0x1109c0, 1, 0x20);
    MDrv_WriteRegBit( 0x1109c0, 1, 0x80);
    MDrv_WriteRegBit( 0x000e97, 1, 0x01);
    MDrv_WriteRegBit( 0x000e97, 0, 0x02);//Invert:N, ON
    MDrv_WriteRegBit( 0x000e94, 0, 0x40);//Invert:N, ON
    ...
    MDrv_WriteRegBit( 0x000e97, 0, 0x38);//Invert:N, ON
    MDrv_WriteRegBit( 0x1027E8, 1, 0x02);//Invert:Y, ON 
...
static void MDrv_Demod_PowerDown(void) //OK
{
    ...
    MDrv_WriteRegBit(0x11286C,	0, 0x10);//Invert:Y, OFF
    MDrv_WriteRegBit(0x11286C,	0, 0x01);//Invert:Y, OFF 
...
{
    MDrv_WriteRegBit(0x102503, 0, 0x40);//Invert:Y, OFF
    ...
    MDrv_WriteRegBit(0x102505, 0, 0x01);//Invert:Y, OFF
    MDrv_WriteRegBit(0x102505, 0, 0x02);//Invert:Y, OFF
    MDrv_WriteRegBit(0x102570, 0, 0x02);//Invert:Y, OFF
    MDrv_WriteRegBit(0x102570, 0, 0x01);//Invert:Y, OFF
    MDrv_WriteRegBit(0x102590, 0, 0x08);//Invert:Y, OFF
    MDrv_WriteRegBit(0x103D00, 0, 0x10);//Invert:Y, OFF
    #if 1//turn on all hsync comp settings compared differently to M-series chips before
    MDrv_WriteRegBit(0x10250B, 0, 0x01);//Invert:N, ON
    MDrv_WriteRegBit(0x10250B, 0, 0x02);//Invert:N, ON
    MDrv_WriteRegBit(0x10250B, 0, 0x04);//Invert:N, ON
    #endif
    ...
    MDrv_WriteRegBit(0x1025B4, 1, 0x20);
    MDrv_WriteRegBit(0x1025B4, 1, 0x40);
    MDrv_WriteRegBit(0x1025B4, 1, 0x80);
...
static void MDrv_LPLL_PowerDown(void)//OK
{
    ...
    //MDrv_WriteRegBit(0x1031d9, 1, 0x10);
}

static void MDrv_MOD_PowerDown(void)//OK
{
    MDrv_WriteRegBit(0x1032F0, 1, 0x01);
    MDrv_WriteRegBit(0x1032F1, 0, 0x01);//Invert:Y, OFF
    MDrv_WriteRegBit(0x1032EE, 0, 0x01);//Invert:Y, OFF
    MDrv_WriteRegBit(0x1032EE, 0, 0x02);//Invert:Y, OFF
    MDrv_WriteRegBit(0x1032EE, 0, 0x04);//Invert:Y, OFF
    MDrv_WriteRegBit(0x1032EE, 0, 0x08);//Invert:Y, OFF
    MDrv_WriteRegBit(0x1032EE, 0, 0x10);//Invert:Y, OFF
}
...
static void MDrv_USBPLL_PowerDown(void)
{
    ...
    MDrv_WriteRegBit(0x103a80, 1, 0x02);
    ...
    //USB_ATOP1
    MDrv_WriteRegBit(0x103a08, 1, 0x80);
    MDrv_WriteRegBit(0x103a01, 1, 0x80);
    MDrv_WriteRegBit(0x103a01, 1, 0x40);
    MDrv_WriteRegBit(0x103a01, 1, 0x20);
    MDrv_WriteRegBit(0x103a01, 1, 0x10);
    MDrv_WriteRegBit(0x103a01, 1, 0x08);
    MDrv_WriteRegBit(0x103a01, 1, 0x04);
    MDrv_WriteRegBit(0x103a01, 1, 0x02);
    MDrv_WriteRegBit(0x103a01, 1, 0x01);
    MDrv_WriteRegBit(0x103a00, 1, 0x80);
    MDrv_WriteRegBit(0x103a00, 1, 0x40);
    MDrv_WriteRegBit(0x103a00, 1, 0x04);
    MDrv_WriteRegBit(0x103a00, 1, 0x02);
    MDrv_WriteRegBit(0x103a00, 1, 0x01);
    #if 1
    MDrv_WriteByte(0x103a02, 0x80);
    MDrv_WriteByte(0x103a03, 0x90);
    MDrv_WriteByte(0x100780, 0x00);
    MDrv_WriteByte(0x100782, 0x00);
    #endif

    // usb
    MDrv_Write2Byte(0x102408, MDrv_Read2Byte(0x102408) | BIT1);
    MDrv_Write2Byte(0x100d08, MDrv_Read2Byte(0x100d08) | BIT1);
    MDrv_Write2Byte(0x101286, MDrv_Read2Byte(0x101286) | (BIT7|BIT6)); //g2
...
static void MDrv_DDRPLL_PowerDown(void)//OK
{
    ...
    MDrv_WriteRegBit(0x110d7d, 1, 0xff);
    MDrv_WriteRegBit(0x110d01, 0, 0x06);//Invert:Y, OFF
    MDrv_WriteRegBit(0x110d01, 0, 0x18);//Invert:Y, OFF
    MDrv_WriteRegBit(0x110d54, 1, 0x70);
    MDrv_WriteRegBit(0x110d08, 0, 0x1f);//Invert:Y, OFF
    MDrv_WriteRegBit(0x110d60, 1, 0x02);
    MDrv_WriteRegBit(0x110d33, 1, 0x80);
}

static void MDrv_MPLL_PowerDown(void)//OK
{
    MDrv_WriteByte(0x100b2c, 0x00); // patch for power saving (MPLL disable issue)
    MDrv_WriteRegBit(0x000f41, 0, BIT6); // patch for power saving (MPLL disable issue)
    ...
    #if ENABLE_UART2
    MDrv_WriteRegBit(0x110c03, 0, BIT0);
    #else
	MDrv_WriteRegBit(0x110c03, 1, BIT0);
    #endif
	MDrv_WriteRegBit(0x110c03, 1, BIT1);
	MDrv_WriteRegBit(0x110c03, 1, BIT2);
}
