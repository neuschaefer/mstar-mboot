...
INTERFACE U32 volatile  gOutVsyncCount;
...
INTERFACE void ProcessSysTrap(MHAL_SavedRegisters *pHalReg, U32 vector);
INTERFACE void MDrv_ISR_Init(void);
INTERFACE void MDrv_Timer_ISR_Register(void);
INTERFACE void MDrv_Timer_Init(void);
INTERFACE void MDrv_Interrupt_Init(void);
