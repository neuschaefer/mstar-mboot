...
#define REG_TOP_CHIP_VERSION        0x0067
    ...
    #define IRQ_VIVALDI_DMA_INTR2               (0x1 << (E_IRQ_VIVALDI_DMA_INTR2 - E_IRQL_START) )
    #define IRQ_VIVALDI_DMA_INTR1               (0x1 << (E_IRQ_VIVALDI_DMA_INTR1 - E_IRQL_START) )
    ...
    #define IRQ_MHLCBUS_PM                      (0x1 << (E_IRQ_MHLCBUS_PM   - E_IRQL_START) )
    #define IRQ_MHLCBUS_WAKEUP                  (0x1 << (E_IRQ_MHLCBUS_WAKEUP - E_IRQL_START) )
    ...
    #define IRQEXPL_SYNC_DET                    (0x1 << (E_IRQEXPL_SYNC_DET         - E_IRQEXPL_START) )
    #define IRQEXPL_INT                         (0x1 << (E_IRQEXPL_INT              - E_IRQEXPL_START) )
    ...
    #define IRQEXPH_FSP                         (0x1 << (E_IRQEXPH_FSP              - E_IRQEXPH_START) )
    ...
    #define IRQEXPH_PWM_RP_L                    (0x1 << (E_IRQEXPH_PWM_RP_L         - E_IRQEXPH_START) )
    #define IRQEXPH_PWM_FP_L                    (0x1 << (E_IRQEXPH_PWM_FP_L         - E_IRQEXPH_START) )
    #define IRQEXPH_PWM_RP_R                    (0x1 << (E_IRQEXPH_PWM_RP_R         - E_IRQEXPH_START) )
    #define IRQEXPH_PWM_FP_R                    (0x1 << (E_IRQEXPH_PWM_FP_R         - E_IRQEXPH_START) )
    ...
    #define FIQEXPL_AEON_TO_R2M                 (0x1 << (E_FIQEXPL_AEON_TO_R2M      - E_FIQEXPL_START) )
    #define FIQEXPL_R2M_TO_AEON                 (0x1 << (E_FIQEXPH_R2M_TO_AEON      - E_FIQEXPL_START) )


    #define FIQEXPH_MASK                        0xFFFF
    #define FIQEXPH_DVI_DET                     (0x1 << (E_FIQEXPH_DVI_DET          - E_FIQEXPH_START) )
    #define FIQEXPH_PM_GPIO0                    (0x1 << (E_FIQEXPH_PM_GPIO0         - E_FIQEXPH_START) )
    #define FIQEXPH_PM_GPIO1                    (0x1 << (E_FIQEXPH_PM_GPIO1         - E_FIQEXPH_START) )
    #define FIQEXPH_PM_GPIO2                    (0x1 << (E_FIQEXPH_PM_GPIO2         - E_FIQEXPH_START) )
    #define FIQEXPH_PM_GPIO3                    (0x1 << (E_FIQEXPH_PM_GPIO3         - E_FIQEXPH_START) )
    #define FIQEXPH_PM_XIU_TIMEOUT              (0x1 << (E_FIQEXPH_PM_XIU_TIMEOUT   - E_FIQEXPH_START) )
    #define FIQEXPH_DMA_DONE                    (0x1 << (E_FIQEXPH_DMA_DONE         - E_FIQEXPH_START) )
