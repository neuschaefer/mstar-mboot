...
#define _MapBase_nonPM_NADAL        (RIU_MAP + 0x200000)
#define _MapBase_PM_NADAL           RIU_MAP
#else
#define _MapBase_nonPM_NADAL        0xA0200000
#define _MapBase_PM_NADAL           0xA0000000
#endif
...
//---------------------------------------------------------------------
    ...
    _MEMMAP_nonPM_,
        ...
        _RVM1(0x1e43, BIT1, BIT1),   //reg[101e43] #1 = 1b
        //reg_test_in_mode[2:0]
        //_RVM1(0x1e24, 0, BIT2 | BIT1 | BIT0),   //reg[101e24]#2 ~ #0 = 00b
        //reg_test_out_mode[2:0]
        //_RVM1(0x1e24, 0, BIT6 | BIT5 | BIT4),   //reg[101e24]#6 ~ #4 = 00b
