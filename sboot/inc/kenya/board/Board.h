...
// Kenya
#define BD_KENYA_FPGA       0x0A70
#define BD_MST188A_D01A_S   0x0A71
#define BD_MST188B_D01A_S   0x0A72
#define BD_MST188A_D01A     0x0A73


#ifndef MS_BOARD_TYPE_SEL
#if defined (CONFIG_MSTAR_KENYA_BD_FPGA)
    #define MS_BOARD_TYPE_SEL       BD_KENYA_FPGA
#elif defined (CONFIG_MSTAR_KENYA_BD_MST188A_D01A_S)
    #define MS_BOARD_TYPE_SEL       BD_MST188A_D01A_S
#elif defined (CONFIG_MSTAR_KENYA_BD_MST188A_D01A)
    #define MS_BOARD_TYPE_SEL       BD_MST188A_D01A
#elif defined (CONFIG_MSTAR_KENYA_BD_MST188B_D01A_S)
    #define MS_BOARD_TYPE_SEL       BD_MST188B_D01A_S
#else
...
#if  (MS_BOARD_TYPE_SEL == BD_KENYA_FPGA)
    #include "BD_KENYA_FPGA.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST188A_D01A_S)
    #include "BD_MST188A_D01A_S.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST188A_D01A)
    #include "BD_MST188A_D01A.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST188B_D01A_S)
