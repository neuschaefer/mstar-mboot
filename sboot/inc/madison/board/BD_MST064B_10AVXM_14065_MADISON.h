...
//------ PANEL RELATED ---------------------------------------------------------
#define Panel_VCC_ON()                          mdrv_gpio_set_high(BALL_AC21)
#define Panel_VCC_OFF()                         mdrv_gpio_set_low(BALL_AC21)
#define Panel_Backlight_VCC_ON()                mdrv_gpio_set_high(BALL_J5)
#define Panel_Backlight_VCC_OFF()               mdrv_gpio_set_low(BALL_J5)
