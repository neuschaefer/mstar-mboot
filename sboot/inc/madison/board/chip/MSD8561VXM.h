...
#ifndef _MSD8561VXM_NANYA_H_
#define _MSD8561VXM_NANYA_H_

#define PAD_NC   9999
#define PAD_GND  0

#define BALL_L5 PAD_CEC
#define PAD_CEC 6
...
#define PAD_CEC_IS_GPIO BALL_L5_IS_GPIO
#endif

#define BALL_C2 PAD_DDCA_DA
...
#define PAD_DDCA_DA_IS_GPIO BALL_C2_IS_GPIO
#endif

#define BALL_B1 PAD_DDCA_CK
...
#define PAD_DDCA_CK_IS_GPIO BALL_B1_IS_GPIO
#endif

#define BALL_A5 PAD_IRIN
#define PAD_IRIN 5
...
#define PAD_IRIN_IS_GPIO BALL_A5_IS_GPIO
#endif

#define BALL_D6 PAD_DDCDD_CK
...
#define PAD_DDCDD_CK_IS_GPIO BALL_D6_IS_GPIO
#endif

#define BALL_D5 PAD_DDCDD_DA
...
#define PAD_DDCDD_DA_IS_GPIO BALL_D5_IS_GPIO
#endif
...
#define PAD_ARC0_IS_GPIO BALL_C1_IS_GPIO
#endif

#define BALL_AE6 PAD_HOTPLUGC
...
#define PAD_HOTPLUGC_IS_GPIO BALL_AE6_IS_GPIO
#endif

#define BALL_AA6 PAD_DDCDC_CK
...
#define PAD_DDCDC_CK_IS_GPIO BALL_AA6_IS_GPIO
#endif

#define BALL_AB6 PAD_DDCDC_DA
...
#define PAD_DDCDC_DA_IS_GPIO BALL_AB6_IS_GPIO
#endif
...
#define PAD_TGPIO2_IS_GPIO BALL_AB3_IS_GPIO
#endif

#define BALL_Y2 PAD_TGPIO1
...
#define PAD_TGPIO1_IS_GPIO BALL_Y2_IS_GPIO
#endif
...
#define PAD_PCM_D0_IS_GPIO BALL_W7_IS_GPIO
#endif

#define BALL_AB4 PAD_PCM_D1
...
#define PAD_PCM_D1_IS_GPIO BALL_AB4_IS_GPIO
#endif

#define BALL_T5 PAD_PCM_D2
...
#define PAD_PCM_D2_IS_GPIO BALL_T5_IS_GPIO
#endif

#define BALL_T6 PAD_PCM_D3
...
#define PAD_PCM_D3_IS_GPIO BALL_T6_IS_GPIO
#endif

#define BALL_U6 PAD_PCM_D4
...
#define PAD_PCM_D4_IS_GPIO BALL_U6_IS_GPIO
#endif

#define BALL_V5 PAD_PCM_D5
...
#define PAD_PCM_D5_IS_GPIO BALL_V5_IS_GPIO
#endif

#define BALL_V6 PAD_PCM_D6
...
#define PAD_PCM_D6_IS_GPIO BALL_V6_IS_GPIO
#endif

#define BALL_U5 PAD_PCM_D7
...
#define PAD_PCM_D7_IS_GPIO BALL_U5_IS_GPIO
#endif

#define BALL_Y9 PAD_PCM_A8
...
#define PAD_PCM_A8_IS_GPIO BALL_Y9_IS_GPIO
#endif
...
#define PAD_PCM_A9_IS_GPIO BALL_Y4_IS_GPIO
#endif
...
#define PAD_PCM_A10_IS_GPIO BALL_W5_IS_GPIO
#endif

#define BALL_AC11 PAD_TS0_VLD
...
#define PAD_TS0_VLD_IS_GPIO BALL_AC11_IS_GPIO
#endif

#define BALL_W6 PAD_PCM_A11
...
#define PAD_PCM_A11_IS_GPIO BALL_W6_IS_GPIO
#endif

#define BALL_AA11 PAD_TS0_CLK
...
#define PAD_TS0_CLK_IS_GPIO BALL_AA11_IS_GPIO
#endif

#define BALL_AD10 PAD_PCM_A12
...
#define PAD_PCM_A12_IS_GPIO BALL_AD10_IS_GPIO
#endif

#define BALL_AE11 PAD_TS0_SYNC
...
#define PAD_TS0_SYNC_IS_GPIO BALL_AE11_IS_GPIO
#endif
...
#define PAD_TS0_D0_IS_GPIO BALL_Y12_IS_GPIO
#endif

#define BALL_AA9 PAD_PCM_A14
...
#define PAD_PCM_A14_IS_GPIO BALL_AA9_IS_GPIO
#endif
...
#define PAD_TS0_D2_IS_GPIO BALL_AB12_IS_GPIO
#endif

#define BALL_Y7 PAD_PCM_CE_N
...
#define PAD_PCM_CE_N_IS_GPIO BALL_Y7_IS_GPIO
#endif

#define BALL_AA12 PAD_TS0_D3
...
#define PAD_TS0_D3_IS_GPIO BALL_AA12_IS_GPIO
#endif

#define BALL_Y6 PAD_PCM_IORD_N
...
#define PAD_PCM_IORD_N_IS_GPIO BALL_Y6_IS_GPIO
#endif

#define BALL_AA8 PAD_PCM_IOWR_N
...
#define PAD_PCM_IOWR_N_IS_GPIO BALL_AA8_IS_GPIO
#endif

#define BALL_AB13 PAD_TS0_D4
...
#define PAD_TS0_D4_IS_GPIO BALL_AB13_IS_GPIO
#endif

#define BALL_AE10 PAD_PCM_IRQA_N
...
#define PAD_PCM_IRQA_N_IS_GPIO BALL_AE10_IS_GPIO
#endif
...
#define PAD_PCM_WE_N_IS_GPIO BALL_AB8_IS_GPIO
#endif
...
#define PAD_PCM_CD_N_IS_GPIO BALL_AA5_IS_GPIO
#endif

#define BALL_AA13 PAD_TS0_D7
...
#define PAD_TS0_D7_IS_GPIO BALL_AA13_IS_GPIO
#endif

#define BALL_AA7 PAD_PCM_RESET
...
#define PAD_PCM_RESET_IS_GPIO BALL_AA7_IS_GPIO
#endif

#define BALL_AD11 PAD_TS1_D0
...
#define PAD_TS1_D0_IS_GPIO BALL_AD11_IS_GPIO
#endif

#define BALL_AB7 PAD_PCM_WAIT_N
...
#define PAD_PCM_WAIT_N_IS_GPIO BALL_AB7_IS_GPIO
#endif

#define BALL_AD12 PAD_TS1_D1
...
#define PAD_TS1_D1_IS_GPIO BALL_AD12_IS_GPIO
#endif

#define BALL_Y8 PAD_PCM_REG_N
...
#define PAD_PCM_REG_N_IS_GPIO BALL_Y8_IS_GPIO
#endif

#define BALL_AC12 PAD_TS1_D2
...
#define PAD_TS1_D2_IS_GPIO BALL_AC12_IS_GPIO
#endif

#define BALL_Y18 PAD_PCM2_WAIT_N
...
#define PAD_PCM2_WAIT_N_IS_GPIO BALL_Y18_IS_GPIO
#endif
...
#define PAD_TS1_D3_IS_GPIO BALL_AE13_IS_GPIO
#endif
...
#define PAD_TS1_D4_IS_GPIO BALL_AC13_IS_GPIO
#endif
...
#define PAD_TS1_D6_IS_GPIO BALL_AE14_IS_GPIO
#endif

#define BALL_AD17 PAD_NAND_ALE
...
#define PAD_NAND_ALE_IS_GPIO BALL_AD17_IS_GPIO
#endif
...
#define PAD_NAND_WPZ_IS_GPIO BALL_AC19_IS_GPIO
#endif

#define BALL_AD14 PAD_TS1_CLK
...
#define PAD_TS1_CLK_IS_GPIO BALL_AD14_IS_GPIO
#endif

#define BALL_AC16 PAD_NAND_WEZ
...
#define PAD_NAND_WEZ_IS_GPIO BALL_AC16_IS_GPIO
#endif
...
#define PAD_NAND_REZ_IS_GPIO BALL_AE16_IS_GPIO
#endif
...
#define PAD_NAND_CLE_IS_GPIO BALL_AD16_IS_GPIO
#endif
...
#define PAD_PWM5_IS_GPIO BALL_AD21_IS_GPIO
#endif

#define BALL_AC18 PAD_NAND_CEZ1
...
#define PAD_NAND_CEZ1_IS_GPIO BALL_AC18_IS_GPIO
#endif

#define BALL_AC22 PAD_PWM4
#define PAD_PWM4 141
...
#define PAD_PWM4_IS_GPIO BALL_AC22_IS_GPIO
#endif

#define BALL_AE19 PAD_EMMC_CMD
...
#define PAD_EMMC_CMD_IS_GPIO BALL_AE19_IS_GPIO
#endif

#define BALL_Y19 PAD_PWM3
#define PAD_PWM3 140
...
#define PAD_PWM3_IS_GPIO BALL_Y19_IS_GPIO
#endif

#define BALL_AC20 PAD_EMMC_CLK
...
#define PAD_EMMC_CLK_IS_GPIO BALL_AC20_IS_GPIO
#endif

#define BALL_AC21 PAD_PWM2
#define PAD_PWM2 139
...
#define PAD_PWM2_IS_GPIO BALL_AC21_IS_GPIO
#endif

#define BALL_AD19 PAD_EMMC_RSTN
...
#define PAD_EMMC_RSTN_IS_GPIO BALL_AD19_IS_GPIO
#endif
...
#define PAD_PCM_A0_IS_GPIO BALL_Y17_IS_GPIO
#endif

#define BALL_AA17 PAD_PWM0
#define PAD_PWM0 137
...
#define PAD_PWM0_IS_GPIO BALL_AA17_IS_GPIO
#endif

#define BALL_Y15 PAD_PCM_A1
...
#define PAD_PCM_A1_IS_GPIO BALL_Y15_IS_GPIO
#endif

#define BALL_AA20 PAD_DDCR_CK
...
#define PAD_DDCR_CK_IS_GPIO BALL_AA20_IS_GPIO
#endif
...
#define PAD_DDCR_DA_IS_GPIO BALL_Y20_IS_GPIO
#endif
...
#define PAD_TCON0_IS_GPIO BALL_Y21_IS_GPIO
#endif

#define BALL_AB15 PAD_PCM_A4
...
#define PAD_PCM_A4_IS_GPIO BALL_AB15_IS_GPIO
#endif

#define BALL_AA21 PAD_TCON1
...
#define PAD_TCON1_IS_GPIO BALL_AA21_IS_GPIO
#endif
...
#define PAD_TCON2_IS_GPIO BALL_AB21_IS_GPIO
#endif

#define BALL_AA16 PAD_PCM_A6
...
#define PAD_PCM_A6_IS_GPIO BALL_AA16_IS_GPIO
#endif
...
#define PAD_PCM_A7_IS_GPIO BALL_AA14_IS_GPIO
#endif

#define BALL_AB22 PAD_TCON4
...
#define PAD_TCON4_IS_GPIO BALL_AB22_IS_GPIO
#endif
...
#define PAD_TCON5_IS_GPIO BALL_AA22_IS_GPIO
#endif

#define BALL_Y22 PAD_TCON6
...
#define PAD_TCON6_IS_GPIO BALL_Y22_IS_GPIO
#endif

#define BALL_W22 PAD_TCON7
...
#define PAD_TCON7_IS_GPIO BALL_W22_IS_GPIO
#endif
...
#define PAD_I2S_IN_WS_IS_GPIO BALL_G12_IS_GPIO
#endif

#define BALL_E13 PAD_I2S_IN_BCK
...
#define PAD_I2S_IN_BCK_IS_GPIO BALL_E13_IS_GPIO
#endif
...
#define BALL_F7 PAD_I2S_OUT_MCK
...
#define PAD_I2S_OUT_MCK_IS_GPIO BALL_F7_IS_GPIO
#endif
...
#define PAD_I2S_OUT_SD_IS_GPIO BALL_F9_IS_GPIO
#endif
...
#define PAD_GPIO16_IS_GPIO BALL_AD20_IS_GPIO
#endif
...
#define PAD_GPIO3_IS_GPIO BALL_AB19_IS_GPIO
#endif

#define BALL_AB18 PAD_GPIO4
#define PAD_GPIO4 50
...
#define PAD_GPIO4_IS_GPIO BALL_AB18_IS_GPIO
#endif
...
#define PAD_GPIO19_IS_GPIO BALL_B5_IS_GPIO
#endif
...
#define PAD_SAR4_IS_GPIO BALL_C3_IS_GPIO
#endif

#define BALL_F5 PAD_VID0
#define PAD_VID0 41
...
#define PAD_VID0_IS_GPIO BALL_F5_IS_GPIO
#endif

#define BALL_E6 PAD_VID1
#define PAD_VID1 42
...
#define PAD_VID1_IS_GPIO BALL_E6_IS_GPIO
#endif
...
#define PAD_GPIO_PM2_IS_GPIO BALL_J4_IS_GPIO
#endif

#define BALL_B4 PAD_GPIO_PM1
...
#define PAD_GPIO_PM1_IS_GPIO BALL_B4_IS_GPIO
#endif
...
#define PAD_GPIO_PM10_IS_GPIO BALL_J6_IS_GPIO
#endif
...
#define PAD_GPIO_PM8_IS_GPIO BALL_H5_IS_GPIO
#endif

#define BALL_C6 PAD_GPIO_PM7
...
#define PAD_GPIO_PM7_IS_GPIO BALL_C6_IS_GPIO
#endif
...
#define PAD_PM_SPI_CZ_IS_GPIO BALL_F12_IS_GPIO
#endif
...
#define PAD_GPIO_PM0_IS_GPIO BALL_H6_IS_GPIO
#endif
