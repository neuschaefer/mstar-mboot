...
#define BOARD_NAME                  "BD_MST195C_D01A_S"
...
#define PIN_56_IS_GPIO              GPIO_OUT_HIGH   //GPIO46: TUNER_NRESET
#define PIN_95_IS_GPIO              GPIO_OUT_HIGH   //LCK: SW_PVCC    //Panel 13V H:On L:Off
#define PIN_96_IS_GPIO              GPIO_IN   //LDE: STB_CHECK    //H:STB Initial L:STB Ready
...
#define PIN_103_IS_GPIO             GPIO_OUT_HIGH   //TCON4: AMP_RESET //H: Normal, L: Reset
...
#define PIN_114_IS_GPIO             GPIO_OUT_LOW    //GPIO97: SW_INVERTER H: BL off, L: BL on
#define PIN_116_IS_GPIO             GPIO_IN   //GPIO98: MODE_SEL2 //H: HD panel, L:FHD panel
#define PIN_117_IS_GPIO             GPIO_IN   //GPIO99: MODE_SEL0 //H: VESA, L:Jeida
...
#define INPUT_YPBPR_MUX             INPUT_PORT_YMUX_G0//INPUT_PORT_ANALOG1
...
#define Panel_VCC_ON()                  _FUNC_NOT_USED()//mdrv_gpio_set_low( PIN_95 )
#define Panel_VCC_OFF()                 _FUNC_NOT_USED()//mdrv_gpio_set_high( PIN_95 )

#define Panel_Backlight_VCC_ON()        _FUNC_NOT_USED()//mdrv_gpio_set_low( PIN_95 )
#define Panel_Backlight_VCC_OFF()       _FUNC_NOT_USED()//mdrv_gpio_set_high( PIN_95 )
