...
#define BD_XL3_MEGA_NASA            0x08D7
...
#if defined (CONFIG_MSTAR_NASA_BD_MST195A_D01A_S)
    #define MS_BOARD_TYPE_SEL       BD_MST195A_D01A_S_NASA
#elif defined (CONFIG_MSTAR_NASA_BD_MST195B_D01A_S)
    #define MS_BOARD_TYPE_SEL       BD_MST195B_D01A_S_NASA
#elif defined (CONFIG_MSTAR_NASA_BD_MST195C_D01A_S)
    #define MS_BOARD_TYPE_SEL       BD_MST195C_D01A_S_NASA
#elif defined (CONFIG_MSTAR_NASA_BD_MST186A_D01A_S)
    #define MS_BOARD_TYPE_SEL       BD_MST186A_D01A_S_NASA
#elif defined (CONFIG_MSTAR_NASA_BD_MST186E_D01A_S)
    #define MS_BOARD_TYPE_SEL       BD_MST186E_D01A_S_NASA
#elif defined (CONFIG_MSTAR_NASA_BD_MST060B_10AZBT_S)
    #define MS_BOARD_TYPE_SEL       BD_MST060B_10AZBT_13502
#elif defined (CONFIG_MSTAR_NASA_BD_MST061B_10AZU_S)
    #define MS_BOARD_TYPE_SEL       BD_MST061B_10AZU_14014
#elif defined (CONFIG_MSTAR_NASA_BD_XL3_MEGA)
    #define MS_BOARD_TYPE_SEL       BD_XL3_MEGA_NASA
#else
