...
#define PADS_MHL_VBUS               MHL_VBUS_MODE4 //PAD_PWM1
...
#define PIN_143_IS_GPIO             GPIO_OUT_HIGH   //GPIO104: EEPROM_WP, Low: Protect/High:Unprotect

#define PIN_146_IS_GPIO             GPIO_OUT_HIGH   //GPIO73: Panel On: Low / Off: High

#define PIN_56_IS_GPIO              GPIO_IN         //GPIO44: Tuner_SDA
#define PIN_57_IS_GPIO              GPIO_IN         //GPIO45: Tuner_SCL
#define PIN_58_IS_GPIO              GPIO_OUT_LOW    //GPIO46: MHL VBUS Enable (L:Enable)

#define PIN_59_IS_GPIO              GPIO_OUT_LOW    //GPIO47: AUDIO-EN (H:Enable)
#define PIN_60_IS_GPIO              GPIO_OUT_HIGH   //GPIO48: Audio Mute(H:Mute -> set low)
#define PIN_100_IS_GPIO             GPIO_OUT_LOW    //GPIO61: MUTE_S(L:Mute -> set high)

#define PIN_112_IS_GPIO             GPIO_OUT_HIGH   //GPIO64: PWR_ON/OFF

#define PIN_63_IS_GPIO              GPIO_IN         //GPIO50: USB Port 0 Over Current Detect

//------Chip Type---------------------------------------------------------------
#include "chip/MSD8324Z1.h"
...
#define Panel_VCC_ON()                  mdrv_gpio_set_low( PIN_146 )
#define Panel_VCC_OFF()                 mdrv_gpio_set_high( PIN_146 )

#define Panel_Backlight_VCC_ON()        mdrv_gpio_set_low( PIN_146 )
#define Panel_Backlight_VCC_OFF()       mdrv_gpio_set_high( PIN_146 )
