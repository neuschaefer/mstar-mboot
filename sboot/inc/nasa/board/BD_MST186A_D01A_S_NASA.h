...
#define BOARD_NAME                  "BD_MST186A_D01A_S"
...
#define PIN_82_IS_GPIO              GPIO_OUT_HIGH       //GPIO3: Panel On: Low / Off: High

#define PIN_49_IS_GPIO              GPIO_IN             //GPIO44: Tuner_SDA
#define PIN_50_IS_GPIO              GPIO_IN             //GPIO45: Tuner_SCL

#define PIN_87_IS_GPIO              GPIO_OUT_LOW        //PWM1: AUDIO-EN (H:Enable)
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_high( PIN_87 )
#define Audio_Amplifier_OFF()           mdrv_gpio_set_low( PIN_87 )

#define Adj_Volume_On()                 mdrv_gpio_set_high( PIN_83 )
#define Adj_Volume_Off()                mdrv_gpio_set_low( PIN_83 )
