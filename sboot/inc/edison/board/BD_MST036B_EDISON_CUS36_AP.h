...
#define BOARD_NAME                  "BD_MST036B_CUS36_AP"
...
#define BALL_G9_IS_GPIO     GPIO_OUT_LOW           // LED Red
#define BALL_F6_IS_GPIO     GPIO_OUT_HIGH          // Demod Reset
//#define BALL_L5_IS_GPIO     GPIO_OUT_LOW           // USB Hub Reset
#define BALL_A6_IS_GPIO     GPIO_OUT_HIGH          // AVOUT MUTE
#define BALL_AJ4_IS_GPIO    GPIO_OUT_HIGH          // AMP Reset
...
#define Audio_Amplifier_RST_ON()                mdrv_gpio_set_high( BALL_AJ4  )
#define Audio_Amplifier_RST_OFF()                 mdrv_gpio_set_low( BALL_AJ4  )
