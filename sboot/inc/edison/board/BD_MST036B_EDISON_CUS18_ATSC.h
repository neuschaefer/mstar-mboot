...
#define BOARD_NAME                  "BD_MST036B_Edison"

//------Function to PIN mapping (PAD_MUX) --------------------------------------
#define PIN_SPI_CZ1                 BALL_D4
#define PIN_SPI_CZ2                 BALL_E4
#define PIN_SPI_CZ3                 0
#define PIN_FLASH_WP0               BALL_B3
#define PIN_FLASH_WP1               BALL_D6
...
#define SMART_SOURCE                SMART_CARD_VCC_3P3V
...
#else
#define PADS_NAND_MODE              TS2_PADs//PCM_D // ready
#endif
...
#define PADS_I2S_IN                 Unknown_pad_mux //PAD_I2S_IN_WS   // ready
...
#define PADS_DDCR_MODE              Unknown_pad_mux//IIC_PADs        // ready//SW IIC
...
#define PADS_MSPI_MODE              SPI_PAD3
//------GPIO setting(default GPIO pin level) ------------------------------------

#define BALL_K5_IS_GPIO     GPIO_OUT_HIGH           // Panel_ON-P1
#define BALL_J4_IS_GPIO     GPIO_OUT_HIGH           // LCD backlight
#define BALL_D6_IS_GPIO     GPIO_IN                // Headphone in detect
#define BALL_AK3_IS_GPIO    GPIO_OUT_HIGH          // Class D enable
#define BALL_AL3_IS_GPIO    GPIO_IN                // SD card 1 detect
#define BALL_AJ4_IS_GPIO    GPIO_OUT_HIGH          // LD_EN
#define BALL_C6_IS_GPIO     GPIO_OUT_HIGH          // EEPROM write protect
#define BALL_B6_IS_GPIO     GPIO_OUT_HIGH          // 3D EN
#define BALL_A6_IS_GPIO     GPIO_OUT_HIGH          // Bluetooth wake up
#define BALL_L6_IS_GPIO     GPIO_OUT_LOW           // Mute speaker
#define BALL_B7_IS_GPIO     GPIO_OUT_HIGH          // CI power enable
#define BALL_C8_IS_GPIO     GPIO_OUT_HIGH          // Class D Amp enable
#define BALL_C7_IS_GPIO     GPIO_IN                // wifi device wake up host
#define BALL_AG2_IS_GPIO    GPIO_OUT_LOW           // IF_AGC
#define BALL_AG3_IS_GPIO    GPIO_OUT_HIGH          // USB 3.0 EN
#define BALL_AL1_IS_GPIO    GPIO_OUT_HIGH          // I2CM_SCL
#define BALL_AL2_IS_GPIO    GPIO_OUT_HIGH          // I2CM_SDA
#define BALL_F4_IS_GPIO     GPIO_OUT_HIGH          // I2C_SDA
#define BALL_F5_IS_GPIO     GPIO_OUT_HIGH          // I2C_SCL
#define BALL_G9_IS_GPIO     GPIO_OUT_HIGH          // LED Red
#define BALL_F6_IS_GPIO     GPIO_OUT_HIGH          // Demod Reset
#define BALL_G8_IS_GPIO     GPIO_OUT_HIGH          // AMP RESET
#define BALL_E5_IS_GPIO     GPIO_OUT_HIGH          // MEMC_EN/6M30_RST
#define BALL_AC31_IS_GPIO   GPIO_IN      // Headphone insert detect
#define BALL_L5_IS_GPIO     GPIO_IN      // device wake up host
#define BALL_AC30_IS_GPIO   GPIO_IN      // HDMI detect
#define BALL_AE30_IS_GPIO   GPIO_IN      // HDMI detect
#define BALL_AD30_IS_GPIO   GPIO_IN      // HDMI detect
#define BALL_AG28_IS_GPIO   GPIO_IN      // HDMI detect

#ifdef CONFIG_MSTAR_VID_ENABLE
//PAD_GPIO_PM[10](VID1)   Voltage(VDDC)
//        0               1.20 -> FF
//        1               1.23 -> TT 
//        1               1.23 -> SS 
// Read eFuse(SIDD[9:0])           to set the GPIO level , SIDD[9:0] address = 0x00200e[5:0](MSB), 0x00200d[7:4](LSB)
//  eFuse < 10'b 120               to set 1.23 Voltage(VDDC) SS
//  10'b 120 <= eFuse < 10'b 175   to set 1.23 Voltage(VDDC) TT
//  eFuse >= 10'b 175              to set 1.20 Voltage(VDDC) FF
#include "chip/gpio.h"
#define BALL_E4_IS_GPIO	 GPIO_OUT_HIGH  // PAD_GPIO_PM[10](VID1)
#define SIDD_MSB         0x00200E
#define SIDD_LSB         0x00200C
#define SS_THRESHOLD		 120   // 24mAx5
#define FF_THRESHOLD     175   // 35mAx5
#define VID1_REG         PAD_GPIO_PM10_OUT_REG
#define VID1_REG_MASK    PAD_GPIO_PM10_OUT_MASK
#endif

//------Chip Type---------------------------------------------------------------
#include "chip/MSD8560IV.h"
...
#define MIU_CONFIG                      DDR3_MIU0_32_MIU1_16_16BIT_TMODE
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_low(BALL_C8)
#define Audio_Amplifier_OFF()           mdrv_gpio_set_high(BALL_C8)

#define Audio_Amplifier_RST_OFF()        mdrv_gpio_set_high(BALL_G8)
#define Audio_Amplifier_RST_ON()         mdrv_gpio_set_low(BALL_G8)

#define Adj_Volume_Off()                _FUNC_NOT_USED()
#define Adj_Volume_On()                 _FUNC_NOT_USED()

#define Panel_VCC_ON()                  mdrv_gpio_set_low( BALL_K5 )   // Y9->Y10
#define Panel_VCC_OFF()                 mdrv_gpio_set_high( BALL_K5 )  // Y9->Y10
#define Panel_Backlight_VCC_ON()        mdrv_gpio_set_low( BALL_J4 )
#define Panel_Backlight_VCC_OFF()       mdrv_gpio_set_high( BALL_J4 )
...
#define PCMCIA_VCC_ON()                 mdrv_gpio_set_high( BALL_B7 )
#define PCMCIA_VCC_OFF()                mdrv_gpio_set_low( BALL_B7 )
...
#define KEYPAD_CH1_LB                   0xE7
#define KEYPAD_CH2_UB                   0xFF
#define KEYPAD_CH2_LB                   0xE7
#define KEYPAD_CH3_UB                   0xFF
#define KEYPAD_CH3_LB                   0xE7
#define KEYPAD_CH4_UB                   0xFF
#define KEYPAD_CH4_LB                   0xE7

#define ADC_KEY_LEVEL                   8
#define ADC_KEY_L0                      0x10 
#define ADC_KEY_L1                      0x2F 
#define ADC_KEY_L2                      0x4D 
#define ADC_KEY_L3                      0x71 
...
#define ADC_KEY_LEVEL_TOLERANCE         0x20
...
#define ADC_KEY_1_L0                    0x1B//0x27    
#define ADC_KEY_1_L1                    0x4F//0x47
#define ADC_KEY_1_L2                    0x81//0x63
#define ADC_KEY_1_L3                    0xCC//0x7B
...
#define ADC_KEY_3_L0                    0x27//0x27
#define ADC_KEY_3_L1                    0x46//0x47
#define ADC_KEY_3_L2                    0x63//0x63
#define ADC_KEY_3_L3                    0x7A//0x7B
#define ADC_KEY_3_L4                    0x00//RFU
#define ADC_KEY_3_L5                    0x00//RFU
#define ADC_KEY_3_L6                    0x00//RFU
#define ADC_KEY_3_L7                    0x00//RFU

#define ADC_KEY_4_L0                    0x37//0x27
#define ADC_KEY_4_L1                    0x68//0x47
#define ADC_KEY_4_L2                    0xBF//0x63
#define ADC_KEY_4_L3                    0x7A//0x7B
#define ADC_KEY_4_L4                    0x00//RFU
#define ADC_KEY_4_L5                    0x00//RFU
#define ADC_KEY_4_L6                    0x00//RFU
#define ADC_KEY_4_L7                    0x00//RFU
...
#define ADC_KEY_1_L0_FLAG               IRKEY_KEYPAD_POWER
#define ADC_KEY_1_L1_FLAG               IRKEY_KEYPAD_CHANNEL_PLUS
#define ADC_KEY_1_L2_FLAG               IRKEY_KEYPAD_VOLUME_PLUS
#define ADC_KEY_1_L3_FLAG               IRKEY_KEYPAD_MENU 
...
#define ADC_KEY_2_L0_FLAG               IRKEY_DUMY//RFU
#define ADC_KEY_2_L1_FLAG               IRKEY_DUMY//RFU
#define ADC_KEY_2_L2_FLAG               IRKEY_DUMY//RFU
#define ADC_KEY_2_L3_FLAG               IRKEY_DUMY//RFU
#define ADC_KEY_2_L4_FLAG               IRKEY_DUMY//RFU
#define ADC_KEY_2_L5_FLAG               IRKEY_DUMY//RFU
#define ADC_KEY_2_L6_FLAG               IRKEY_DUMY//RFU
#define ADC_KEY_2_L7_FLAG               IRKEY_DUMY//RFU

#define ADC_KEY_3_L0_FLAG               IRKEY_DUMY//RFU
#define ADC_KEY_3_L1_FLAG               IRKEY_DUMY//RFU
#define ADC_KEY_3_L2_FLAG               IRKEY_DUMY//RFU
#define ADC_KEY_3_L3_FLAG               IRKEY_DUMY//RFU
#define ADC_KEY_3_L4_FLAG               IRKEY_DUMY//RFU
#define ADC_KEY_3_L5_FLAG               IRKEY_DUMY//RFU
#define ADC_KEY_3_L6_FLAG               IRKEY_DUMY//RFU
#define ADC_KEY_3_L7_FLAG               IRKEY_DUMY//RFU

#define ADC_KEY_4_L0_FLAG               IRKEY_KEYPAD_CHANNEL_MINUS//RFU
#define ADC_KEY_4_L1_FLAG               IRKEY_KEYPAD_VOLUME_MINUS//RFU
#define ADC_KEY_4_L2_FLAG               IRKEY_KEYPAD_INPUT_SOURCE//RFU
#define ADC_KEY_4_L3_FLAG               IRKEY_DUMY//RFU
#define ADC_KEY_4_L4_FLAG               IRKEY_DUMY//RFU
#define ADC_KEY_4_L5_FLAG               IRKEY_DUMY//RFU
#define ADC_KEY_4_L6_FLAG               IRKEY_DUMY//RFU
#define ADC_KEY_4_L7_FLAG               IRKEY_DUMY//RFU
