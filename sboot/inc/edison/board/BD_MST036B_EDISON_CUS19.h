...
#define BOARD_NAME                  "BD_MST036B_Edison_CUS19"
...
#define PADS_SPDIF_IN               Unknown_pad_mux // ready
...
#define PADS_UART3_MODE             PAD_I2S_IN_WS//Unknown_pad_mux // ready
...
#define BALL_K5_IS_GPIO     GPIO_OUT_LOW          // Panel_ON-P1
#define BALL_J4_IS_GPIO     GPIO_OUT_LOW           // LCD backlight
#define BALL_D6_IS_GPIO     GPIO_OUT_HIGH          // TCL reset chip on/off
#define BALL_AK3_IS_GPIO    GPIO_OUT_HIGH          // Class D enable, MHL detect
#define BALL_AL3_IS_GPIO    GPIO_OUT_LOW           // MHL power enable
#define BALL_AJ4_IS_GPIO    GPIO_IN                // SD card 2 detect
#define BALL_C6_IS_GPIO     GPIO_OUT_LOW          // 3D DIM switch

#if (ENABLE_SET_4K2K_MODE == 1)
#define BALL_B6_IS_GPIO     GPIO_OUT_LOW           // set 3D Enable low for TCL 4K2K
#else
#define BALL_B6_IS_GPIO     GPIO_OUT_HIGH          // PRE_AMP
#endif

#define BALL_A6_IS_GPIO     GPIO_OUT_HIGH          // SD card 1 write protect
#define BALL_L6_IS_GPIO     GPIO_IN                // HDMI3 detect
#define BALL_B7_IS_GPIO     GPIO_OUT_LOW           // CI power enable
#define BALL_C8_IS_GPIO     GPIO_OUT_HIGH          // SD card 2 write protect
#define BALL_C7_IS_GPIO     GPIO_OUT_LOW           // Class D mute
#define BALL_AG2_IS_GPIO    GPIO_OUT_LOW           // IF_AGC
#define BALL_AG3_IS_GPIO    GPIO_OUT_LOW           // TCL WIFI dongle power enable
...
#define BALL_G8_IS_GPIO     GPIO_OUT_LOW		//9687 reset
#define BALL_G9_IS_GPIO     GPIO_OUT_HIGH           // TCL led control on/off in stanby mode or normal mode
#define BALL_F6_IS_GPIO     GPIO_OUT_HIGH          // Demod Reset
#define BALL_N5_IS_GPIO     GPIO_OUT_LOW           // 3D glass sync signal
//#define BALL_B3_IS_GPIO     GPIO_OUT_LOW           // nor flasch wp
#define BALL_C4_IS_GPIO     GPIO_OUT_LOW           // TCL dimming control
#define BALL_G6_IS_GPIO     GPIO_OUT_LOW           // MK971
#define BALL_L5_IS_GPIO     GPIO_OUT_LOW           // MK971
#define BALL_A3_IS_GPIO     GPIO_OUT_LOW           // MK971

#define BALL_AG28_IS_GPIO   GPIO_OUT_HIGH          //USB 3.0 power control

#define TCL_POWER_RESET_PIN BALL_D6
#define TCL_POWER_LED_PIN   BALL_G9
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_high( BALL_C7  )
#define Audio_Amplifier_OFF()           mdrv_gpio_set_low( BALL_C7  )
...
#define Panel_VCC_ON()                  mdrv_gpio_set_high( BALL_K5 )   // Y9->Y10
#define Panel_VCC_OFF()                 mdrv_gpio_set_low ( BALL_K5 )  // Y9->Y10
#define Panel_Backlight_VCC_ON()        mdrv_gpio_set_high( BALL_J4 )
#define Panel_Backlight_VCC_OFF()       mdrv_gpio_set_low( BALL_J4 )
...
// LED Control
#define LED_FLICK_WHEN_SW_UPDATE        1

#if (1 == LED_FLICK_WHEN_SW_UPDATE)
#define LED_RED_ON()                    mdrv_gpio_set_low(TCL_POWER_LED_PIN);
#define LED_RED_OFF()                   mdrv_gpio_set_high(TCL_POWER_LED_PIN);
#else
...
#define ADC_KEY_L0                      0x1c
#define ADC_KEY_L1                      0x38
#define ADC_KEY_L2                      0x5D
#define ADC_KEY_L3                      0x82
#define ADC_KEY_L4                      0xA7
#define ADC_KEY_L5                      0xCB
#define ADC_KEY_L6                      0xE5
#define ADC_KEY_L7                      0x00
...
#define ADC_CH1_LEVELS                  7//### must be <= ADC_KEY_LEVEL
...
#define ADC_KEY_1_L4_FLAG               IRKEY_VOLUME_PLUS
...
#define USB_MBOOT_CURRENT_VERSION         "V8-MS90101-LB1V005"
