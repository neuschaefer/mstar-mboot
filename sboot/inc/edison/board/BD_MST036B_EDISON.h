...
#define PADS_I2S_OUT_SD				Unknown_pad_mux
...
#define BALL_B6_IS_GPIO     GPIO_OUT_LOW           // PRE_AMP
...
#define BALL_AG28_IS_GPIO   GPIO_OUT_LOW          //USB 3.0 power control
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_low( BALL_D6  )
#define Audio_Amplifier_OFF()           mdrv_gpio_set_high( BALL_D6  )
