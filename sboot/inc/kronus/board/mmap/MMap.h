...
//------ SYSTEM MEMORY MAP ---------------------------------------------------------
#if defined(CONFIG_MSTAR_TITANIA_MMAP_32MB)||defined(CONFIG_MSTAR_KRONUS_MMAP_32MB)
    #include "mmap_32mb.h"
#elif defined(CONFIG_MSTAR_TITANIA_MMAP_64MB)||defined(CONFIG_MSTAR_KRONUS_MMAP_64MB)
    #include "mmap_64mb.h"
#elif defined(CONFIG_MSTAR_TITANIA_MMAP_128MB)||defined(CONFIG_MSTAR_KRONUS_MMAP_128MB)
