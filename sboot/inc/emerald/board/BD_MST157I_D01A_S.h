...
#define BOARD_NAME                  "BD_MST157I_D01A_S"

#define PIN_SPI_CZ1                 BALL_B3
#define PIN_SPI_CZ2                 BALL_C3
#define PIN_SPI_CZ3                 0
#define PIN_FLASH_WP0               BALL_H6
#define PIN_FLASH_WP1               BALL_G6
#define PIN_I2S_IN                  0
...
#define BALL_C5_IS_GPIO             GPIO_OUT_LOW    //I2S_out_mute #Mute: high 
#define BALL_H6_IS_GPIO             GPIO_OUT_HIGH	//SPI_FLASH1 write protect #Protect: Low
#define BALL_G6_IS_GPIO             GPIO_OUT_HIGH   //SPI_FLASH2 write protect #Protect: Low
#define BALL_C1_IS_GPIO             GPIO_IN         //MHL cable detect #Cable in: High
#define BALL_C2_IS_GPIO             GPIO_OUT_LOW    //Supply 5V to MHL device #Suply 5V: Low
#define BALL_B6_IS_GPIO             GPIO_IN         //MHL Over Current Detect
#define BALL_B12_IS_GPIO            GPIO_OUT_LOW    //Panel power on/off #off: High
#define BALL_A12_IS_GPIO            GPIO_OUT_HIGH   //USB0 power Enable #Enable: High
#define BALL_F12_IS_GPIO            GPIO_OUT_LOW    //LCD Backlight control #Off: High
#define BALL_E4_IS_GPIO             GPIO_IN         //Keypad SAR0 in
#define BALL_F5_IS_GPIO             GPIO_IN         //Keypad SAR3 in
#define BALL_H17_IS_GPIO            GPIO_OUT_HIGH   //Class D Amp Enable #Enable: High
#define BALL_T5_IS_GPIO             GPIO_IN         //H/W I2C_SCL pin (TUNER)
#define BALL_U5_IS_GPIO             GPIO_IN         //H/W I2C_SDA pin (TUNER)
#define BALL_G16_IS_GPIO            GPIO_IN         //PM I2C EEPROM SDA
#define BALL_G17_IS_GPIO            GPIO_IN         //PM I2C EEPROM SCL

//------Chip Type---------------------------------------------------------------
#include "chip/MSD894KCM.h"
