...
#define BALL_M5_IS_GPIO             GPIO_IN      	//SD Card 1 Card detect #Card in: Low
#define BALL_K6_IS_GPIO             GPIO_OUT_LOW    //I2S_out_mute #Mute: high 
#define BALL_L5_IS_GPIO             GPIO_OUT_HIGH	//SPI_FLASH1 write protect #Protect: Low
#define BALL_M4_IS_GPIO             GPIO_IN         //SD Card 1 Card write protect #Protect: Low
#define BALL_M7_IS_GPIO             GPIO_OUT_HIGH   //SPI_FLASH2 write protect #Protect: Low
#define BALL_M6_IS_GPIO             GPIO_IN         //SD Card 2 Card detect #Card in: Low
#define BALL_K4_IS_GPIO             GPIO_IN         //PM I2C EEPROM SDA
#define BALL_L6_IS_GPIO             GPIO_IN         //PM I2C EEPROM SCL
#define BALL_N6_IS_GPIO             GPIO_IN         //SD Card 2 Card write protect #Protect: Low
#define BALL_E2_IS_GPIO             GPIO_IN         //MHL cable detect #Cable in: High
#define BALL_E3_IS_GPIO             GPIO_OUT_LOW    //Supply 5V to MHL device #Suply 5V: Low
#define BALL_F5_IS_GPIO             GPIO_OUT_HIGH   //DE-POP_Line_out 
#define BALL_D5_IS_GPIO             GPIO_OUT_HIGH   //Class D Amp Enable #Enable: High
#define BALL_V6_IS_GPIO             GPIO_OUT_LOW    //Panel power on/off #off: High
#define BALL_W7_IS_GPIO             GPIO_OUT_HIGH   //USB0 power Enable #Enable: High
#define BALL_B8_IS_GPIO             GPIO_OUT_HIGH   //CI power on/off #Enable: High
#define BALL_A8_IS_GPIO             GPIO_OUT_HIGH   //USB1 power Enable #Enable: High
#define BALL_A9_IS_GPIO             GPIO_OUT_LOW    //LCD Backlight control #Off: High
#define BALL_B4_IS_GPIO             GPIO_OUT_HIGH   //PHY LED0
#define BALL_C4_IS_GPIO             GPIO_OUT_HIGH   //PHY LED1
#define BALL_G5_IS_GPIO             GPIO_IN         //Keypad SAR0 in
#define BALL_H5_IS_GPIO             GPIO_IN         //Keypad SAR1 in
#define BALL_AC3_IS_GPIO            GPIO_OUT_LOW    //AGC control #ATV: High / DTV: Low
#define BALL_AC4_IS_GPIO            GPIO_IN         //H/W I2C_SCL pin (TUNER)
#define BALL_AD4_IS_GPIO            GPIO_IN         //H/W I2C_SDA pin (TUNER)
#define BALL_W21_IS_GPIO            GPIO_OUT_LOW    //SD card power control #Enable: Low

//------Chip Type---------------------------------------------------------------
#include "chip/MSD894SKX.h"
...
#define Panel_VCC_ON()                  mdrv_gpio_set_low( BALL_V6 )
#define Panel_VCC_OFF()                 mdrv_gpio_set_high( BALL_V6 ) 
#define Panel_Backlight_VCC_ON()        mdrv_gpio_set_low( BALL_A9 )
#define Panel_Backlight_VCC_OFF()       mdrv_gpio_set_high( BALL_A9 )
