...
//Emerald
#define BD_MST157A_D01A_S               0x0762
#define BD_MST157B_D01A_S               0x0763
#define BD_MST157C_D01A_S               0x0764
#define BD_MST157E_D01A_S               0x0765
#define BD_MST157E_D01B_S               0x0766
#define BD_MST157E_D01C_S               0x0767
#define BD_MST157E_D01D_S               0x0768
#define BD_MST157F_D01A_S               0x0769
#define BD_MST157I_D01A_S               0x076a
#define BD_EMERALD_FPGA          		0x076F
...
#if defined(CONFIG_MSTAR_BD_MST157A_D01A_S)
    #define MS_BOARD_TYPE_SEL           BD_MST157A_D01A_S
#elif defined(CONFIG_MSTAR_BD_MST157B_D01A_S)
    #define MS_BOARD_TYPE_SEL           BD_MST157B_D01A_S
#elif defined(CONFIG_MSTAR_BD_MST157C_D01A_S)
    #define MS_BOARD_TYPE_SEL           BD_MST157C_D01A_S
#elif defined(CONFIG_MSTAR_BD_MST157E_D01A_S)
    #define MS_BOARD_TYPE_SEL           BD_MST157E_D01A_S
#elif defined(CONFIG_MSTAR_BD_MST157E_D01B_S)
    #define MS_BOARD_TYPE_SEL           BD_MST157E_D01B_S
#elif defined(CONFIG_MSTAR_BD_MST157E_D01C_S)
    #define MS_BOARD_TYPE_SEL           BD_MST157E_D01C_S
#elif defined(CONFIG_MSTAR_BD_MST157E_D01D_S)
    #define MS_BOARD_TYPE_SEL           BD_MST157E_D01D_S
#elif defined(CONFIG_MSTAR_BD_MST157F_D01A_S)
    #define MS_BOARD_TYPE_SEL           BD_MST157F_D01A_S
#elif defined(CONFIG_MSTAR_BD_MST157I_D01A_S)
    #define MS_BOARD_TYPE_SEL           BD_MST157I_D01A_S
#else
...
// SW feature configure header file
    ...
    #include "BD_MST157A_D01A_S.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST157B_D01A_S)
    #include "BD_MST157B_D01A_S.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST157C_D01A_S)
    #include "BD_MST157C_D01A_S.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST157E_D01A_S)
    #include "BD_MST157E_D01A_S.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST157E_D01B_S)
    #include "BD_MST157E_D01B_S.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST157E_D01C_S)
    #include "BD_MST157E_D01C_S.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST157E_D01D_S)
    #include "BD_MST157E_D01D_S.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST157F_D01A_S)
    #include "BD_MST157F_D01A_S.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST157I_D01A_S)
    #include "BD_MST157I_D01A_S.h"
#elif (MS_BOARD_TYPE_SEL == BD_EMERALD_FPGA)
    #include "BD_EMERALD_FPGA.h"
#else
