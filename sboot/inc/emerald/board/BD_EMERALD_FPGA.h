...
#define BOARD_NAME                  "BD_EMERALD_FPGA"

#define PIN_SPI_CZ1                 BALL_C7
#define PIN_SPI_CZ2                 BALL_D5
#define PIN_SPI_CZ3                 0
#define PIN_FLASH_WP0               BALL_E5
#define PIN_FLASH_WP1               BALL_F5

#define PIN_UART2                   0               // RX1/TX1
#define PIN_UART3                   0               // RX2/TX2
#define PIN_UART3_IN_TCON           0
#define PIN_UART4                   0               // RX3/TX3
#define PIN_FAST_UART               0               // RTS0/CTS0
#define PIN_FAST_UART               0
#define PIN_I2S_OUT_MUTE            0
#define PIN_TS1_IS_OUT              0
#define PIN_TS1_IS_TCON             0
#define PIN_PF                      0               // NAND and PCMCIA(CI) share the address line
...
#define PIN_BT656_IN                0
#define BT656_CLK_INV               0   // BIT5
#define BT656_DATA_INV              0   // BIT7
#define PIN_VSYNC_VIF_OUT           0
#define UART2_ECO                   0
#define UART3_ECO                   0
#define UART4_ECO                   0
...
//------Chip Type---------------------------------------------------------------
#include "chip/MST_EMERALD_FPGA.h"
