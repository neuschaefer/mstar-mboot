...
#define BOARD_NAME                  "BD_MST157A_D01A_S"

#define PIN_SPI_CZ1                 BALL_C2
#define PIN_SPI_CZ2                 BALL_C1
#define PIN_SPI_CZ3                 0
#define PIN_FLASH_WP0               BALL_J6
#define PIN_FLASH_WP1               BALL_L5
#define PIN_I2S_IN                  BALL_D9
#define PIN_I2S_OUT                 BALL_C9
#define PIN_SPDIF_OUT               BALL_D6
...
#define PADS_MSPI_MODE              Unknown_pad_mux

//------GPIO setting(default GPIO pin level) ??? ------------------------------------
#define BALL_H5_IS_GPIO             GPIO_OUT_LOW	//LCD Backlight control #Off: High
#define BALL_K6_IS_GPIO             GPIO_IN      	//SD Card 1 Card detect #Card in: Low
#define BALL_K5_IS_GPIO             GPIO_OUT_LOW    //I2S_out_mute #Mute: high 
#define BALL_J6_IS_GPIO             GPIO_OUT_HIGH	//SPI_FLASH1 write protect #Protect: Low
#define BALL_L6_IS_GPIO             GPIO_IN         //SD Card 1 Card write protect #Protect: Low
#define BALL_L5_IS_GPIO             GPIO_OUT_HIGH   //SPI_FLASH2 write protect #Protect: Low
#define BALL_M6_IS_GPIO             GPIO_IN         //SD Card 2 Card detect #Card in: Low
#define BALL_M5_IS_GPIO             GPIO_OUT_LOW    //VGA EDID EPROM  write protect #Protect: High
#define BALL_M4_IS_GPIO             GPIO_OUT_LOW    //System Run code information #Run Code: High
#define BALL_D3_IS_GPIO             GPIO_IN         //SD Card 2 Card write protect #Protect: Low
#define BALL_W6_IS_GPIO             GPIO_IN         //MHL cable detect #Cable in: High
#define BALL_Y7_IS_GPIO             GPIO_OUT_HIGH   //Supply 5V to MHL device #Suply 5V: Low
#define BALL_U5_IS_GPIO             GPIO_OUT_HIGH   //DE-POP_Line_out
#define BALL_D4_IS_GPIO             GPIO_OUT_HIGH   //USB0 power Enable #Enable: High
#define BALL_E7_IS_GPIO             GPIO_OUT_HIGH   //Class D Amp Enable #Enable: High
#define BALL_F7_IS_GPIO             GPIO_OUT_LOW    //Panel power on/off #Off: High
#define BALL_B8_IS_GPIO             GPIO_OUT_HIGH   //USB1 power Enable #Enable: High
#define BALL_AB5_IS_GPIO            GPIO_OUT_HIGH   //CI power on/off #Enable: High
#define BALL_B4_IS_GPIO             GPIO_OUT_HIGH   //PHY LED0
#define BALL_C4_IS_GPIO             GPIO_OUT_HIGH   //PHY LED1
#define BALL_H6_IS_GPIO             GPIO_IN         //Keypad SAR0 in
#define BALL_G5_IS_GPIO             GPIO_IN         //Keypad SAR1 in
#define BALL_AC2_IS_GPIO            GPIO_OUT_LOW    //AGC control
#define BALL_AE6_IS_GPIO            GPIO_IN         //H/W I2C_SCL pin (TUNER)
#define BALL_AD6_IS_GPIO            GPIO_IN         //H/W I2C_SDA pin (TUNER)
#define BALL_P24_IS_GPIO            GPIO_IN         //H/W I2C_SDA pin (EEPROM)
#define BALL_P23_IS_GPIO            GPIO_IN         //H/W I2C_SCL pin (EEPROM)
#define BALL_R20_IS_GPIO            GPIO_OUT_LOW    //SD card power control

//------Chip Type---------------------------------------------------------------
#include "chip/MSD804KKX.h"
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_high( BALL_E7 )
#define Audio_Amplifier_OFF()           mdrv_gpio_set_low( BALL_E7 )

#define Adj_Volume_Off()                mdrv_gpio_set_high( BALL_K5 )
#define Adj_Volume_On()                 mdrv_gpio_set_low( BALL_K5 )

#define Panel_VCC_ON()                  mdrv_gpio_set_low( BALL_F7 )
#define Panel_VCC_OFF()                 mdrv_gpio_set_high( BALL_F7 )
#define Panel_Backlight_VCC_ON()        mdrv_gpio_set_low( BALL_H5 )
#define Panel_Backlight_VCC_OFF()       mdrv_gpio_set_high( BALL_H5 )
