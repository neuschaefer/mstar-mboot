...
#define BOARD_NAME                  "BD_MST157E_D01C_S"

#define PIN_SPI_CZ1                 BALL_A6
#define PIN_SPI_CZ2                 BALL_E4
#define PIN_SPI_CZ3                 0
#define PIN_FLASH_WP0               BALL_G6
#define PIN_FLASH_WP1               0
#define PIN_I2S_IN                  BALL_H11
#define PIN_I2S_OUT                 BALL_A5
#define PIN_SPDIF_OUT               BALL_A2
...
#define BALL_J6_IS_GPIO             GPIO_OUT_LOW    //Mute On: High / Off: Low
#define BALL_K6_IS_GPIO             GPIO_OUT_LOW    //Scart Audio Pre_amp: Low / Disable: High
#define BALL_M5_IS_GPIO             GPIO_OUT_LOW    //Ear Phone De-Pop Function: Low / Disable: High
#define BALL_M6_IS_GPIO             GPIO_IN         //Test Pin
#define BALL_U7_IS_GPIO             GPIO_IN         //MHL cable detect #Cable in: High
#define BALL_V7_IS_GPIO             GPIO_OUT_LOW    //Supply 5V to MHL device: Low / Disable: High
#define BALL_U8_IS_GPIO             GPIO_IN         //MHL Charger Over Current Protect
#define BALL_F6_IS_GPIO             GPIO_OUT_LOW	//Panel On: Low / Off: High
#define BALL_E5_IS_GPIO             GPIO_OUT_LOW	//Backlight On: Low / Off: High
#define BALL_F4_IS_GPIO             GPIO_IN         //Type In: Keypad SAR0 in
#define BALL_F5_IS_GPIO             GPIO_IN         //Type In: Keypad SAR1 in
#define BALL_G6_IS_GPIO             GPIO_OUT_HIGH	//SPI_FLASH1 write protect: Low / Unprotect: High
#define BALL_V3_IS_GPIO             GPIO_OUT_HIGH   //Tuner Reset: Low / Unreset: High
#define BALL_Y1_IS_GPIO             GPIO_OUT_HIGH   //CI Power on: High / Off: Low
#define BALL_W4_IS_GPIO             GPIO_IN         //H/W I2C_SCL pin (TUNER)
#define BALL_W5_IS_GPIO             GPIO_IN         //H/W I2C_SDA pin (TUNER)
#define BALL_H6_IS_GPIO             GPIO_OUT_LOW    //Class D Amp Enable: Low / Disable: High
#define BALL_U6_IS_GPIO             GPIO_OUT_HIGH   //MCP DEMOD Reset control: Low / Disable: High
#define BALL_V4_IS_GPIO             GPIO_IN         //H/W I2C_SCL pin (MCP DEMOD/DVBT-2_Edinburgh)
#define BALL_W3_IS_GPIO             GPIO_IN         //H/W I2C_SDA pin (MCP DEMOD/DVBT-2_Edinburgh)
#define BALL_M17_IS_GPIO            GPIO_IN         //Mspi1_sdi(t_mux)
#define BALL_M18_IS_GPIO            GPIO_IN         //mspi1_sck(t_mux)
#define BALL_L18_IS_GPIO            GPIO_IN         //mspi1_sdo(t_mux)
#define BALL_L17_IS_GPIO            GPIO_IN         //mspi1_scz(t_mux)

//------Chip Type---------------------------------------------------------------
#include "chip/MSD8121KT.h"
...
#define INPUT_YPBPR_VIDEO_COUNT     2
#ifdef ATSC_SYSTEM
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_low( BALL_H6 )
#define Audio_Amplifier_OFF()           mdrv_gpio_set_high( BALL_H6 )

#define Adj_Volume_Off()                mdrv_gpio_set_high( BALL_J6 )
#define Adj_Volume_On()                 mdrv_gpio_set_low( BALL_J6 )

#define Panel_VCC_ON()                  mdrv_gpio_set_low( BALL_F6 )  
#define Panel_VCC_OFF()                 mdrv_gpio_set_high( BALL_F6 )
#define Panel_Backlight_VCC_ON()        mdrv_gpio_set_low( BALL_E5 )
#define Panel_Backlight_VCC_OFF()       mdrv_gpio_set_high( BALL_E5 )
...
#define PCMCIA_VCC_ON()                 mdrv_gpio_set_high( BALL_J25 )
#define PCMCIA_VCC_OFF()                mdrv_gpio_set_low( BALL_J25 )
...
#define PANEL_CTL_Off()                 //Panel_VCC_OFF() //fix me later
