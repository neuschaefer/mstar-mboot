...
#define BOARD_NAME                  "BD_MST157F_D01A_S"

#define PIN_SPI_CZ1                 BALL_B3
#define PIN_SPI_CZ2                 BALL_A3
#define PIN_SPI_CZ3                 0
#define PIN_FLASH_WP0               BALL_A11
#define PIN_FLASH_WP1               BALL_C11
#define PIN_I2S_IN                  0
...
#define BALL_G5_IS_GPIO             GPIO_IN      	//SD Card 1 Card detect #Card in: Low
#define BALL_D6_IS_GPIO             GPIO_OUT_LOW    //I2S_out_mute #Mute: high 
#define BALL_A11_IS_GPIO            GPIO_OUT_HIGH	//SPI_FLASH1 write protect #Protect: Low
#define BALL_E6_IS_GPIO             GPIO_IN         //SD Card 1 Card write protect #Protect: Low
#define BALL_C11_IS_GPIO            GPIO_OUT_HIGH   //SPI_FLASH2 write protect #Protect: Low
#define BALL_F6_IS_GPIO             GPIO_IN         //SD Card 2 Card detect #Card in: Low
#define BALL_G6_IS_GPIO             GPIO_IN         //PM I2C EEPROM SDA
#define BALL_B6_IS_GPIO             GPIO_IN         //PM I2C EEPROM SCL
#define BALL_C6_IS_GPIO             GPIO_IN         //SD Card 2 Card write protect #Protect: Low
#define BALL_D5_IS_GPIO             GPIO_IN         //MHL cable detect #Cable in: High
#define BALL_E4_IS_GPIO             GPIO_OUT_LOW    //Supply 5V to MHL device #Suply 5V: Low
#define BALL_E5_IS_GPIO             GPIO_OUT_HIGH   //DE-POP_Line_out 
#define BALL_D13_IS_GPIO            GPIO_OUT_HIGH   //Class D Amp Enable #Enable: High
#define BALL_F12_IS_GPIO            GPIO_OUT_LOW    //Panel power on/off #off: High
#define BALL_F11_IS_GPIO            GPIO_OUT_HIGH   //USB0 power Enable #Enable: High
#define BALL_A18_IS_GPIO            GPIO_OUT_HIGH   //USB1 power Enable #Enable: High
#define BALL_A17_IS_GPIO            GPIO_OUT_LOW    //LCD Backlight control #Off: High
#define BALL_B9_IS_GPIO             GPIO_OUT_HIGH   //PHY LED0
#define BALL_C9_IS_GPIO             GPIO_OUT_HIGH   //PHY LED1
#define BALL_D8_IS_GPIO             GPIO_IN         //Keypad SAR0 in
#define BALL_E8_IS_GPIO             GPIO_IN         //Keypad SAR1 in
#define BALL_Y11_IS_GPIO            GPIO_OUT_LOW    //AGC control #ATV: High / DTV: Low
#define BALL_Y13_IS_GPIO            GPIO_IN         //H/W I2C_SCL pin (TUNER)
#define BALL_AA13_IS_GPIO           GPIO_IN         //H/W I2C_SDA pin (TUNER)
#define BALL_J19_IS_GPIO            GPIO_OUT_LOW    //SD card power control #Enable: Low

//------Chip Type---------------------------------------------------------------
#include "chip/MSD892SKTM.h"
