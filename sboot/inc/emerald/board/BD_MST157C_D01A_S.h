...
#define BALL_B7_IS_GPIO             GPIO_OUT_HIGH	//SPI_FLASH1 write protect: Low / Unprotect: High
#define BALL_E8_IS_GPIO             GPIO_OUT_LOW	//Panel On: Low / Off: High
#define BALL_F8_IS_GPIO             GPIO_OUT_LOW	//Backlight On: Low / Off: High
#define BALL_D5_IS_GPIO             GPIO_IN         //SD card detect Low: detect
#define BALL_B6_IS_GPIO             GPIO_IN         //Type In: Keypad SAR0 in
#define BALL_C5_IS_GPIO             GPIO_OUT_LOW    //Mute On: High / Off: Low
#define BALL_E4_IS_GPIO             GPIO_IN	        //Type In: Atsc Tuner AFT
#define BALL_D8_IS_GPIO             GPIO_IN         //Type: In: Keypad SAR1 in
#define BALL_J25_IS_GPIO            GPIO_OUT_HIGH   //CI Power on: High / Off: Low
#define BALL_J24_IS_GPIO            GPIO_OUT_LOW    //Class D Amp Enable: Low / Disable: High
#define BALL_H24_IS_GPIO            GPIO_IN         //H/W I2C_SDA pin (EEPROM)
#define BALL_J23_IS_GPIO            GPIO_IN         //H/W I2C_SCL pin (EEPROM)
#define BALL_AC2_IS_GPIO            GPIO_IN         //Type In: Silicon tuner TDA18273 Vsync in
#define BALL_AD5_IS_GPIO            GPIO_OUT_HIGH   //Tuner Reset: Low / Unreset: High
#define BALL_AE3_IS_GPIO            GPIO_IN         //H/W I2C_SCL pin (TUNER)
#define BALL_AD3_IS_GPIO            GPIO_IN         //H/W I2C_SDA pin (TUNER)
#define BALL_B5_IS_GPIO             GPIO_OUT_LOW    //Piano Enable: Low / Disable: High

//------Chip Type---------------------------------------------------------------
#include "chip/MSD8820KT.h"
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_high( BALL_J24 )
#define Audio_Amplifier_OFF()           mdrv_gpio_set_low( BALL_J24 )

#define Adj_Volume_Off()                mdrv_gpio_set_low( BALL_C5 )
#define Adj_Volume_On()                 mdrv_gpio_set_high( BALL_C5 )

#define Panel_VCC_ON()                  mdrv_gpio_set_low( BALL_E8 )  
#define Panel_VCC_OFF()                 mdrv_gpio_set_high( BALL_E8 )
#define Panel_Backlight_VCC_ON()        mdrv_gpio_set_low( BALL_F8 )
#define Panel_Backlight_VCC_OFF()       mdrv_gpio_set_high( BALL_F8 )
