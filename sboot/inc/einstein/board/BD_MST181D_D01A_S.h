...
#define BOARD_NAME                  "BD_MST181D_D01A_S"
...
#define BALL_G1_IS_GPIO             GPIO_OUT_HIGH            // Type Out:LED RED control(standby) High :system standby
#define BALL_F3_IS_GPIO             GPIO_OUT_LOW           // Type Out:LED green control(power up) High :system wake up
...
#define INPUT_VGA_SYNC_MUX          INPUT_PORT_NONE_PORT //SYNC port of VGA. There is a case which data and sync use different port.
#define INPUT_YPBPR_MUX             INPUT_PORT_ANALOG1
#define INPUT_TV_YMUX               INPUT_PORT_NONE_PORT //INPUT_PORT_YMUX_CVBS2
...
#define Panel_VCC_ON()                  mdrv_gpio_set_low( BALL_K6 )
#define Panel_VCC_OFF()                 mdrv_gpio_set_high( BALL_K6 )
#define Panel_Backlight_VCC_ON()        mdrv_gpio_set_low( BALL_K5 )
#define Panel_Backlight_VCC_OFF()       mdrv_gpio_set_high( BALL_K5 )
