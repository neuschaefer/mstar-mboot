...
#define BOARD_NAME                  "BD_MST181A_D01A_S"
...
#define BALL_AC9_IS_GPIO            GPIO_OUT_LOW            // AMP_EN: Piano enable, Low: Enable
#define BALL_AE8_IS_GPIO            GPIO_OUT_HIGH           // Mute-POP: High: not-mute, Low: mute
#define BALL_AD8_IS_GPIO            GPIO_OUT_LOW            // FLASH-WPN2: 2nd SPI_FLASH write protect, Low :protect
#define BALL_T6_IS_GPIO             GPIO_OUT_HIGH           // POWER_SW: Board 12V Power On/Off H:On
//#define BALL_C4_IS_GPIO             GPIO_OUT_LOW            // SPI-CS1N: SPI_FLASH1 Chip select, Low :select
#define BALL_G4_IS_GPIO             GPIO_OUT_LOW            // VBLCTRL-P2: Panel Backlight On/Off H:Off
#define BALL_AC8_IS_GPIO            GPIO_OUT_LOW            // Panel_ON-P1: Panel power on/off, Low :On
#define BALL_B5_IS_GPIO             GPIO_OUT_LOW            // SPI-CS2N: SPI_FLASH2 Chip select, Low :select
#define BALL_AD9_IS_GPIO            GPIO_OUT_LOW            // FLASH-WPN1: SPI_FLASH1 write protect, Low :protect
#define BALL_R6_IS_GPIO             GPIO_OUT_LOW            // MHL_VBUS_EN: MHL VBUS Enable L:Enable
#define BALL_G5_IS_GPIO             GPIO_OUT_LOW            // AUMUTE_OUT: I2S Audio Mute H:Mute
#define BALL_H6_IS_GPIO             GPIO_IN                 // SAR0: Keypad SAR0 in
#define BALL_H5_IS_GPIO             GPIO_IN                 // SAR3: Keypad SAR1 in
#define BALL_C5_IS_GPIO             GPIO_OUT_HIGH           // PCM_PWR_CTL: PCM Power Control H:Power enable
#define BALL_D6_IS_GPIO             GPIO_OUT_LOW            // USB_PWR_CTL: USB Power Control L:Power Enable
#define BALL_E7_IS_GPIO             GPIO_OUT_HIGH           // USB3.0_EN: USB3.0 Power Control H:Power Enable
#define BALL_AF9_IS_GPIO            GPIO_IN                 // I2CM_SCL: H/W I2C_SCL pin (TUNER)
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_high( BALL_AC9 )
#define Audio_Amplifier_OFF()           mdrv_gpio_set_low( BALL_AC9  )

#define Adj_Volume_Off()                _FUNC_NOT_USED()
#define Adj_Volume_On()                 _FUNC_NOT_USED()

#define Panel_VCC_ON()                  mdrv_gpio_set_low( BALL_AC8 )
#define Panel_VCC_OFF()                 mdrv_gpio_set_high( BALL_AC8 )
