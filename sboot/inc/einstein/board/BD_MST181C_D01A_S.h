...
#define BOARD_NAME                  "BD_MST181C_D01A_S"
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_high( BALL_A3 )
#define Audio_Amplifier_OFF()           mdrv_gpio_set_low( BALL_A3  )
