...
#define BOARD_NAME                              "BD_MSTCUS28_800C_EAGLE"
...
#define BALL_F6_IS_GPIO                         GPIO_OUT_HIGH	//Panel On: High / Off: Low
...
#define Adj_Volume_Off()                        mdrv_gpio_set_low( BALL_G6 )
#define Adj_Volume_On()                         mdrv_gpio_set_high( BALL_G6 )
