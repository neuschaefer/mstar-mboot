...
#define BOARD_NAME                              "BD_MST028B_10AFX_EAGLE"
...
#define PADS_TS_OUT                             ENABLE
#define PADS_TS0_PE                             ENABLE
#define PADS_TS1_PE                             ENABLE
...
#endif
#ifdef CONFIG_MMC
#define PADS_EMMC_MODE                          NAND_DATA
#else
...
#define BALL_B3_IS_GPIO                         GPIO_OUT_HIGH	//AMP On: Low / Off: High
#define BALL_A3_IS_GPIO                         GPIO_OUT_HIGH	//Backlight On: Low / Off: High
#define BALL_V24_IS_GPIO                        GPIO_OUT_LOW   //Panel On: High / Off: Llow

#define BALL_AD2_IS_GPIO                        GPIO_OUT_LOW	//RFAGC_CTRL (High: ATV  Low: DTV)
#define BALL_AA3_IS_GPIO                        GPIO_OUT_HIGH	//IFAGC_CTRL (High: ATV  Low: DTV)
...
#define BALL_J5_IS_GPIO                         GPIO_OUT_LOW   //FLASH-WPN1 (SPI_FLASH1 Write Protect)
//#define BALL_D1_IS_GPIO                       GPIO_OUT_HIGH   //FLASH-WPN2 (SPI_FLASH2 Write Protect)

#define BALL_C5_IS_GPIO                       GPIO_OUT_HIGH   //POWER_SW
#define BALL_G6_IS_GPIO                       GPIO_OUT_HIGH   //Led-R
#define BALL_G7_IS_GPIO                       GPIO_OUT_HIGH  //PCM_PWR_CTL On: High / Off: Low
#define BALL_G8_IS_GPIO                       GPIO_OUT_HIGH   //Eeprom wp
...
#define PAD_SAR0_IS_GPIO                        GPIO_OUT_HIGH   

//Register Address of VID0
#define REG_VID0_GPIO_CONTROL                   (MS_BUS_RIU_ADDR + (0x001424 << 1)) 
...
#define REG_VID1_GPIO_CONTROL                   (MS_BUS_RIU_ADDR + (0x001424 << 1))     

//GPIO Control Bit of VID1 (bit0 ~ bit15)       
#define REG_VID1_GPIO_MASK                      (0x0001 << 3)   //GPIO Control Bit of VID1 (bit0 ~ bit15)
#endif

#endif

//------Chip Type---------------------------------------------------------------
#include "chip/MSD8560HX.h"
...
#define FRONTEND_TUNER_TYPE                     NUTUNE_FK1602_TUNER  //SAMSUNG_DVTA50_TUNER //SAMSUNG_S205_TUNER////SHARP_VA1G5BF2009_TUNERPHILIPS_TDA1316_TUNER //PHILIPS_FQD1216_TUNER
...
// Audio Amplifier
#define Audio_Amplifier_ON()                    mdrv_gpio_set_low( BALL_B3 )
#define Audio_Amplifier_OFF()                   mdrv_gpio_set_high( BALL_B3 )

#define Adj_Volume_Off()                        _FUNC_NOT_USED()//mdrv_gpio_set_high( BALL_B3)
#define Adj_Volume_On()                        _FUNC_NOT_USED() //mdrv_gpio_set_low( BALL_B3)

//------ PANEL RELATED ---------------------------------------------------------
#define Panel_VCC_ON()                          mdrv_gpio_set_high( BALL_V24)   // Y9->Y10
#define Panel_VCC_OFF()                         mdrv_gpio_set_low( BALL_V24 )  // Y9->Y10
...
// LED Control
#define LED_RED_ON()                            mdrv_gpio_set_high(BALL_G6)
#define LED_RED_OFF()                           mdrv_gpio_set_low(BALL_G6)
...
#define ADC_KEY_L2                              0x5B
#define ADC_KEY_L3                              0x7F
#define ADC_KEY_L4                              0x8D
#define ADC_KEY_L5                              0xA7
...
#define ADC_KEY_1_L1_FLAG                       IRKEY_UP
#define ADC_KEY_1_L2_FLAG                       IRKEY_DOWN
#define ADC_KEY_1_L3_FLAG                       IRKEY_RIGHT
#define ADC_KEY_1_L4_FLAG                       IRKEY_LEFT
...
#define ADC_KEY_2_L2_FLAG                       IRKEY_DOWN
#define ADC_KEY_2_L3_FLAG                       IRKEY_RIGHT
#define ADC_KEY_2_L4_FLAG                       IRKEY_LEFT
#define ADC_KEY_2_L5_FLAG                       IRKEY_SELECT
#define ADC_KEY_2_L6_FLAG                       IRKEY_INPUT_SOURCE
#define ADC_KEY_2_L7_FLAG                       IRKEY_MENU
