...
#define BOARD_NAME                              "BD_MST038B_10AHT_EAGLE"
...
#define PADS_EMMC_MODE                          NAND_CTRL // ENABLE conflict with PCM and NAND pad

#define PADS_MIIC_MODE                          Unknown_pad_mux
#define PADS_TS2_CONFIG                         Unknown_pad_mux

//------GPIO setting(default GPIO pin level) ------------------------------------
#define BALL_F6_IS_GPIO                         GPIO_OUT_LOW	//Panel On: High / Off: Llow
#define BALL_E7_IS_GPIO                         GPIO_OUT_LOW	//Backlight On: High / Off: Low
//#define BALL_AD2_IS_GPIO                      GPIO_OUT_LOW	//RFAGC_CTRL (High: ATV  Low: DTV)

#define BALL_J18_IS_GPIO                        GPIO_OUT_HIGH         //DDCR_CK : EEPROM I2C_SCL
#define BALL_H19_IS_GPIO                        GPIO_OUT_HIGH         //DDCR_DA : EEPROM I2C_SDA
#define BALL_W1_IS_GPIO                         GPIO_IN         //TGPIO2 : Tuner I2C_SCL
#define BALL_V2_IS_GPIO                         GPIO_IN         //TGPIO3 : Tuner I2C_SDA

#define BALL_G6_IS_GPIO                         GPIO_OUT_HIGH    //Pre-AMP On: Low / Off: High
...
//#define BALL_M17_IS_GPIO                      GPIO_OUT_HIGH   //PCM_PWR_CTL (PCM power control)
#define BALL_F7_IS_GPIO                         GPIO_OUT_HIGH   //POWER_SW
#define BALL_D7_IS_GPIO                         GPIO_OUT_HIGH//led-R

#define BALL_M17_IS_GPIO                      GPIO_OUT_HIGH   ///3D enable On:Low/off:High
#define BALL_G19_IS_GPIO                      GPIO_OUT_HIGH   ///EEPROM wp On:High/off:Low
...
#define PAD_SAR2_IS_GPIO                        GPIO_OUT_HIGH   
...
#define PAD_SAR3_IS_GPIO                        GPIO_NONE       
...
#else
#define ENABLE_SCART_VIDEO                      DISABLE
#endif
...
#define AUDIO_SOURCE_DVI                        AUDIO_NULL_INPUT
...
#define Adj_Volume_Off()                        _FUNC_NOT_USED()//mdrv_gpio_set_high( BALL_G6 )
#define Adj_Volume_On()                        _FUNC_NOT_USED()//mdrv_gpio_set_low( BALL_G6 )

//------ PANEL RELATED ---------------------------------------------------------
#define Panel_VCC_ON()                           mdrv_gpio_set_high( BALL_F6 )   // Y9->Y10
#define Panel_VCC_OFF()                          mdrv_gpio_set_low( BALL_F6 )  // Y9->Y10
#define Panel_Backlight_VCC_ON()                 mdrv_gpio_set_high( BALL_E7 )
#define Panel_Backlight_VCC_OFF()                mdrv_gpio_set_low( BALL_E7 )
...
#define PCMCIA_VCC_ON()                         _FUNC_NOT_USED() //mdrv_gpio_set_high( BALL_M17 )
#define PCMCIA_VCC_OFF()                        _FUNC_NOT_USED() //mdrv_gpio_set_low( BALL_M17 )
...
// LED Control
#define LED_RED_ON()                              mdrv_gpio_set_high(BALL_D7);
#define LED_RED_OFF()                            mdrv_gpio_set_low(BALL_D7);
...
#define ADC_KEY_L0                              0x0F
#define ADC_KEY_L1                              0x2D
#define ADC_KEY_L2                              0x4C
#define ADC_KEY_L3                              0x70
#define ADC_KEY_L4                      0x8C
#define ADC_KEY_L5                      0xA6
#define ADC_KEY_L6                      0xC4
...
#define ADC_KEY_1_L0                            0x2A//0x2A
#define ADC_KEY_1_L1                            0x4A//0x4A
#define ADC_KEY_1_L2                            0x67//0x67
#define ADC_KEY_1_L3                            0x80//0x80
#define ADC_KEY_1_L4                            0x00//RFU
#define ADC_KEY_1_L5                            0x00//RFU
#define ADC_KEY_1_L6                            0x00//RFU
#define ADC_KEY_1_L7                            0x00//RFU

#define ADC_KEY_2_L0                            0x12//0x12
#define ADC_KEY_2_L1                            0x36//0x36
#define ADC_KEY_2_L2                            0x56//0x56
#define ADC_KEY_2_L3                            0x72//0x72
...
#define ADC_KEY_2_L3_FLAG                       IRKEY_VOLUME_PLUS
