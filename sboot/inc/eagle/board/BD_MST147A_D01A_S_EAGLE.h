...
#define BOARD_NAME                              "BD_MST147A_D01A_S_EAGLE"
...
#define BALL_C3_IS_GPIO             GPIO_OUT_HIGH   //POWER_SW
...
#define PAD_SAR1_IS_GPIO                        GPIO_OUT_HIGH   
...
#define PAD_GPIO_PM10_IS_GPIO_IS_GPIO           GPIO_OUT_HIGH 

//Register Address of VID1
#define REG_VID1_GPIO_CONTROL                   (MS_BUS_RIU_ADDR + (0x000e20 << 1))     

//GPIO Control Bit of VID1 (bit0 ~ bit15)       
#define REG_VID1_GPIO_MASK                      (0x0001 << 10)   //GPIO Control Bit of VID1 (bit0 ~ bit15)
#endif

#endif

//------Chip Type---------------------------------------------------------------
#include "chip/MSD8580HV.h"
...
#define PWS_INPUT_HDMI1_PATH        _HDMI2_
#define PWS_INPUT_HDMI2_PATH        _HDMI1_
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_low( BALL_AK3 )
#define Audio_Amplifier_OFF()           mdrv_gpio_set_high( BALL_AK3 )

#define Adj_Volume_Off()                mdrv_gpio_set_high( BALL_L6 )
#define Adj_Volume_On()                 mdrv_gpio_set_low( BALL_L6 )
