...
#define BOARD_NAME                  "BD_MST145A_D01A1_S"
...
#define BALL_B3_IS_GPIO     GPIO_OUT_LOW
#define BALL_F5_IS_GPIO     GPIO_OUT_HIGH
#define BALL_B5_IS_GPIO     GPIO_OUT_LOW
#define BALL_H5_IS_GPIO     GPIO_OUT_HIGH
#define BALL_AA20_IS_GPIO   GPIO_OUT_HIGH //Panel VCC
#define BALL_AA21_IS_GPIO   GPIO_OUT_HIGH //Back light
#define BALL_AC21_IS_GPIO   GPIO_OUT_HIGH
#define BALL_W4_IS_GPIO     GPIO_OUT_HIGH
#define BALL_AE3_IS_GPIO    GPIO_IN
#define BALL_AD2_IS_GPIO    GPIO_IN

//------Chip Type---------------------------------------------------------------
#include "chip/MSD9870EV.h"
...
#define EXT_RF_AGC_ON()                 mdrv_gpio_set_high( BALL_W4 ) // ATV mode: external RF AGC
#define EXT_RF_AGC_OFF()                mdrv_gpio_set_low( BALL_W4 )  // DTV mode: internal RF AGC
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_high( BALL_B3 )
#define Audio_Amplifier_OFF()           mdrv_gpio_set_low( BALL_B3  )

#define Adj_Volume_Off()                _FUNC_NOT_USED()
#define Adj_Volume_On()                 _FUNC_NOT_USED()

#define Panel_VCC_ON()                  mdrv_gpio_set_low( BALL_AA20 )   // Y9->Y10
#define Panel_VCC_OFF()                 mdrv_gpio_set_high( BALL_AA20 )  // Y9->Y10
#define Panel_Backlight_VCC_ON()        mdrv_gpio_set_low( BALL_AA21 )
#define Panel_Backlight_VCC_OFF()       mdrv_gpio_set_high( BALL_AA21 )
