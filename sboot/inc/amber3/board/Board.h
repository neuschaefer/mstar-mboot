...
#define BD_AMBER3_FPGA          		0x0770
#define BD_MST129F_D01A1_S              0x0771
#define BD_MST145A_D01A1_S              0x0772
#define BD_MST142A_D01A_S_A3            0x0773
#define BD_MST145B_D01A_S               0x0774
#define BD_MST028B_10AFX_A3             0x0775
#define BD_MST029B_10AFVA_A3             0x0776
#define BD_MS801_MAA2XG_A3             0x0777
#define BD_MST029B_CUS37_A3             0x0778
#define BD_MST029B_CUS18_A3             0x0779
#define BD_MSTCUS23_6A801_A3             0x0780
#define BD_MST029B_CUS36_A3             0x0781
#define BD_MST032B_10AFX_A3             0x0782
#define BD_CUS28_6A800                  0x0783
#define BD_CUS28_6A801                  0x0784
#define BD_MST029B_CUS18_A3_ATSC        0x0785
#define BD_MST029B_BOX_A3				0x0786
...
#elif defined (CONFIG_MSTAR_TITANIA_BD_MST129F_D01A1_S)
    #define MS_BOARD_TYPE_SEL       BD_MST129F_D01A1_S
#elif defined (CONFIG_MSTAR_TITANIA_BD_MST145A_D01A1_S)
    #define MS_BOARD_TYPE_SEL       BD_MST145A_D01A1_S
#elif defined (CONFIG_MSTAR_TITANIA_BD_MST142A_D01A_S_A3)
    #define MS_BOARD_TYPE_SEL       BD_MST142A_D01A_S_A3
#elif defined (CONFIG_MSTAR_TITANIA_BD_MST145B_D01A_S)
    #define MS_BOARD_TYPE_SEL       BD_MST145B_D01A_S
#elif defined (CONFIG_MSTAR_TITANIA_BD_MST028B_10AFX_A3)
    #define MS_BOARD_TYPE_SEL       BD_MST028B_10AFX_A3
#elif defined (CONFIG_MSTAR_TITANIA_BD_MST029B_10AFVA_A3)
    #define MS_BOARD_TYPE_SEL       BD_MST029B_10AFVA_A3
#elif defined (CONFIG_MSTAR_TITANIA_BD_MS801_MAA2XG_A3)
    #define MS_BOARD_TYPE_SEL       BD_MS801_MAA2XG_A3
#elif defined (CONFIG_MSTAR_TITANIA_BD_MST029B_CUS37_A3)
    #define MS_BOARD_TYPE_SEL       BD_MST029B_CUS37_A3
#elif defined (CONFIG_MSTAR_TITANIA_BD_MST029B_CUS18_A3)
    #define MS_BOARD_TYPE_SEL       BD_MST029B_CUS18_A3
#elif defined (CONFIG_MSTAR_TITANIA_BD_MST029B_CUS18_A3_ATSC)
    #define MS_BOARD_TYPE_SEL       BD_MST029B_CUS18_A3_ATSC
#elif defined (CONFIG_MSTAR_TITANIA_BD_MSTCUS23_6A801_A3)
    #define MS_BOARD_TYPE_SEL       BD_MSTCUS23_6A801_A3
#elif defined (CONFIG_MSTAR_TITANIA_BD_MST029B_CUS36_A3)
    #define MS_BOARD_TYPE_SEL       BD_MST029B_CUS36_A3
#elif defined (CONFIG_MSTAR_TITANIA_BD_MST032B_10AFX_A3)
    #define MS_BOARD_TYPE_SEL       BD_MST032B_10AFX_A3
#elif defined (CONFIG_MSTAR_TITANIA_BD_CUS28_6A800)
    #define MS_BOARD_TYPE_SEL       BD_CUS28_6A800
#elif defined (CONFIG_MSTAR_TITANIA_BD_CUS28_6A801)
    #define MS_BOARD_TYPE_SEL       BD_CUS28_6A801
#elif defined (CONFIG_MSTAR_TITANIA_BD_MST029B_BOX_A3)
    #define MS_BOARD_TYPE_SEL       BD_MST029B_BOX_A3    
...
// SW feature configure header file
    ...
    #include "BD_AMBER3_FPGA.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST129F_D01A1_S)
    #include "BD_MST129F_D01A1_S.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST145A_D01A1_S)
    #include "BD_MST145A_D01A1_S.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST142A_D01A_S_A3)
    #include "BD_MST142A_D01A_S_A3.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST145B_D01A_S)
    #include "BD_MST145B_D01A_S.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST028B_10AFX_A3)
    #include "BD_MST028B_10AFX_A3.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST029B_10AFVA_A3)
    #include "BD_MST029B_10AFVA_A3.h"
#elif (MS_BOARD_TYPE_SEL == BD_MS801_MAA2XG_A3)
    #include "BD_MS801_MAA2XG_A3.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST029B_CUS37_A3)
    #include "BD_MST029B_CUS37_A3.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST029B_CUS18_A3)
    #include "BD_MST029B_CUS18_A3.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST029B_CUS18_A3_ATSC)
    #include "BD_MST029B_CUS18_A3_ATSC.h"
#elif (MS_BOARD_TYPE_SEL == BD_MSTCUS23_6A801_A3)
    #include "BD_MSTCUS23_6A801_A3.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST029B_CUS36_A3)
    #include "BD_MST029B_CUS36_A3.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST032B_10AFX_A3)
    #include "BD_MST032B_10AFX_A3.h"
#elif (MS_BOARD_TYPE_SEL == BD_CUS28_6A800)
    #include "BD_CUS28_6A800.h"
#elif (MS_BOARD_TYPE_SEL == BD_CUS28_6A801)
    #include "BD_CUS28_6A801.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST029B_BOX_A3)
    #include "BD_MST029B_BOX_A3.h"
#else
