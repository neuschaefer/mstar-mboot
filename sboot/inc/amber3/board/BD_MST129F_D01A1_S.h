...
#define BALL_T28_IS_GPIO    GPIO_OUT_LOW
#define BALL_T27_IS_GPIO    GPIO_OUT_HIGH //Back light
#define BALL_U28_IS_GPIO    GPIO_OUT_LOW
#define BALL_R28_IS_GPIO    GPIO_OUT_HIGH //Panel VCC
#define BALL_AF8_IS_GPIO    GPIO_IN
#define BALL_AG7_IS_GPIO    GPIO_IN
#define BALL_D7_IS_GPIO     GPIO_IN
#define BALL_F8_IS_GPIO     GPIO_OUT_LOW
#define BALL_E7_IS_GPIO     GPIO_IN
#define BALL_F6_IS_GPIO     GPIO_IN
#define BALL_A6_IS_GPIO     GPIO_IN
#define BALL_C8_IS_GPIO     GPIO_OUT_LOW
#define BALL_B6_IS_GPIO     GPIO_OUT_LOW
#define BALL_H6_IS_GPIO     GPIO_OUT_LOW
#define BALL_G5_IS_GPIO     GPIO_IN
#define BALL_G4_IS_GPIO     GPIO_IN
#define BALL_AF11_IS_GPIO   GPIO_OUT_HIGH
#define BALL_AG10_IS_GPIO   GPIO_OUT_HIGH

//------Chip Type---------------------------------------------------------------
#include "chip/MSD997SEV.h"
...
#define AUDIO_PATH_LINEOUT          AUDIO_T3_PATH_AUOUT2    /* AUDIO_T3_PATH_AUOUT2 or AUDIO_T3_PATH_AUOUT3 depends on J27/J28 */
...
#define AUDIO_OUTPUT_LINEOUT       AUDIO_AUOUT2_OUTPUT    /* AUDIO_T3_PATH_AUOUT2 or AUDIO_T3_PATH_AUOUT3 depends on J27/J28 */
...
//#else
#define SECAM_L_PRIME_ON()              mdrv_gpio_set_high( BALL_AG10 ) //GPIO60_SET(1)//_FUNC_NOT_USED()
#define SECAM_L_PRIME_OFF()             mdrv_gpio_set_low( BALL_AG10 ) //GPIO60_SET(0)//_FUNC_NOT_USED()
#define EXT_RF_AGC_ON()                 mdrv_gpio_set_high( BALL_AF11 ) // ATV mode: external RF AGC
#define EXT_RF_AGC_OFF()                mdrv_gpio_set_low( BALL_AF11 )  // DTV mode: internal RF AGC
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_high( BALL_T28 )
#define Audio_Amplifier_OFF()           mdrv_gpio_set_low( BALL_T28  )

#define Adj_Volume_Off()                mdrv_gpio_set_high( BALL_U28 )
#define Adj_Volume_On()                 mdrv_gpio_set_low( BALL_U28 )
...
#define PCMCIA_VCC_ON()                 mdrv_gpio_set_high( BALL_B6 )
#define PCMCIA_VCC_OFF()                mdrv_gpio_set_low( BALL_B6 )
