...
#define BOARD_NAME                  "BD_MSTCUS23_6A801_A3"
...
#define PIN_FLASH_WP1              0//  BALL_D6
...
#define BALL_D6_IS_GPIO     GPIO_OUT_HIGH                 // AMP MUTE
...
#define BALL_L6_IS_GPIO     GPIO_OUT_LOW           //AMP RESET
...
#define BALL_AG3_IS_GPIO    GPIO_OUT_LOW //GPIO_OUT_HIGH          // RF_AGC SEL
...
#define BALL_B3_IS_GPIO    GPIO_OUT_HIGH          // FLASH WP
#define BALL_F6_IS_GPIO    GPIO_OUT_HIGH          // DEMOD RESET
#define BALL_AG2_IS_GPIO    GPIO_OUT_LOW           // IF_AGC SEL
#define BALL_AD30_IS_GPIO    GPIO_IN           // BODY
#define BALL_G7_IS_GPIO     GPIO_OUT_HIGH   //PANEL_S1
#define BALL_AD31_IS_GPIO     GPIO_OUT_HIGH   //PANEL_S2 FOR 3D
...
#define DIGITAL_I2S_SELECT              AUDIO_I2S_TAS5707
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_high( BALL_L6 )
#define Audio_Amplifier_OFF()           mdrv_gpio_set_low( BALL_L6  )
...
// SAR boundary define
//------------------------------------------------------------------------------
#if 1 // Customize for Haier key pad wake up function
#define KEYPAD_CH1_UB                   0xFF
#define KEYPAD_CH1_LB                   0xCF
#define KEYPAD_CH2_UB                   0xFF
#define KEYPAD_CH2_LB                   0xCF
#define KEYPAD_CH3_UB                   0xFF
#define KEYPAD_CH3_LB                   0xCF
#define KEYPAD_CH4_UB                   0xFF
#define KEYPAD_CH4_LB                   0xCF

#define ADC_KEY_LEVEL                   8
#define ADC_KEY_L0                      0x1E
#define ADC_KEY_L1                      0x5C
#define ADC_KEY_L2                      0x9A
#define ADC_KEY_L3                      0xCF
...
#define ADC_KEY_1_L0_FLAG               IRKEY_MENU
