...
#define BOARD_NAME                  "BD_MST145B_D01A_S"
...
#define BALL_AK3_IS_GPIO    GPIO_OUT_LOW          // Class D enable
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_high( BALL_AK3 )
#define Audio_Amplifier_OFF()           mdrv_gpio_set_low( BALL_AK3  )
