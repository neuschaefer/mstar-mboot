...
#define BOARD_NAME                  "BD_CUS28_6A800"

//------Select Konka 800 TV type --------------------------------------
#define KONKA_TV_TYPE_SMART         1
#define KONKA_TV_TYPE_PORTABLE      2
#ifndef KONKA_TV_TYPE
#define KONKA_TV_TYPE               KONKA_TV_TYPE_SMART
#endif

//------Function to PIN mapping (PAD_MUX) --------------------------------------
#define PIN_SPI_CZ1                             BALL_A5
...
#define PADS_I2S_OUT                Unknown_pad_mux//MULTI_CH_I2S_OUT // ready
...
#define BALL_B3_IS_GPIO                         GPIO_OUT_HIGH	//MUTE_EN
#define BALL_A3_IS_GPIO                         GPIO_OUT_HIGH	//Backlight On: Low / Off: High
#define BALL_AD2_IS_GPIO                        GPIO_OUT_LOW	//RFAGC_CTRL (High: ATV  Low: DTV)
#define BALL_U24_IS_GPIO                        GPIO_IN         //DDCR_CK : EEPROM I2C_SCL
#define BALL_U23_IS_GPIO                        GPIO_IN         //DDCR_DA : EEPROM I2C_SDA
#define BALL_Y2_IS_GPIO                         GPIO_IN         //TGPIO2 : Tuner I2C_SCL
#define BALL_W3_IS_GPIO                         GPIO_IN         //TGPIO3 : Tuner I2C_SDA
//#define BALL_G6_IS_GPIO                         GPIO_OUT_LOW    //IR_OUT //Pre-AMP On: Low / Off: High,
#define BALL_V23_IS_GPIO                        GPIO_OUT_LOW    //PCM_PWR_CTL
#define BALL_L4_IS_GPIO                         GPIO_OUT_LOW    //Mute On: Low / Off: High

#define BALL_J5_IS_GPIO                         GPIO_OUT_HIGH   //FLASH-WPN1 (SPI_FLASH1 Write Protect)
//#define BALL_D1_IS_GPIO                       GPIO_OUT_HIGH   //FLASH-WPN2 (SPI_FLASH2 Write Protect)
//#define BALL_U5_IS_GPIO                       GPIO_OUT_HIGH   //MUTE-POP
#define BALL_V24_IS_GPIO                        GPIO_OUT_HIGH   //PCM_PWR_CTL (PCM power control)

#define BALL_C5_IS_GPIO                         GPIO_OUT_HIGH   //POWER_SW

#if (KONKA_TV_TYPE == KONKA_TV_TYPE_SMART)
#define BALL_E5_IS_GPIO                         GPIO_OUT_LOW    //3D_EN
#define BALL_E4_IS_GPIO                         GPIO_OUT_LOW    //Local diming
//#define BALL_E7_IS_GPIO                         GPIO_OUT_LOW    //3D flag
#define BALL_D4_IS_GPIO                         GPIO_OUT_HIGH   //USB power
#define BALL_F4_IS_GPIO                         GPIO_OUT_LOW    //LED_GREEN
#define BALL_D6_IS_GPIO                         GPIO_IN         //3D_SWITCH/3D_SYNC
#define BALL_D5_IS_GPIO                         GPIO_OUT_LOW    //USB power
#define BALL_E6_IS_GPIO                         GPIO_OUT_HIGH   //Vcore-0
#define BALL_F6_IS_GPIO                         GPIO_OUT_HIGH   //Vcore-1
#define BALL_AA3_IS_GPIO                        GPIO_OUT_HIGH   //DEMOD_RST
#elif (KONKA_TV_TYPE == KONKA_TV_TYPE_PORTABLE)
#define BALL_K6_IS_GPIO                         GPIO_OUT_LOW    //Camera on
#endif
//------Chip Type---------------------------------------------------------------
#include "chip/MSD8570FV.h"
...
#define EXT_RF_AGC_ON()                         mdrv_gpio_set_high(BALL_AD2) // ATV mode: external RF AGC
#define EXT_RF_AGC_OFF()                        mdrv_gpio_set_low(BALL_AD2)  // DTV mode: internal RF AGC
...
// Audio Amplifier
#define Audio_Amplifier_ON()                    mdrv_gpio_set_low( BALL_V23 )
#define Audio_Amplifier_OFF()                   mdrv_gpio_set_high( BALL_V23 )

#define Adj_Volume_Off()                        mdrv_gpio_set_high( BALL_L4 )
#define Adj_Volume_On()                         mdrv_gpio_set_low( BALL_L4 )

#define Panel_VCC_ON()                          mdrv_gpio_set_low( BALL_B3 )   // Y9->Y10
#define Panel_VCC_OFF()                         mdrv_gpio_set_high( BALL_B3 )  // Y9->Y10
#define Panel_Backlight_VCC_ON()                mdrv_gpio_set_low( BALL_A3 )
#define Panel_Backlight_VCC_OFF()               mdrv_gpio_set_high( BALL_A3 )
...
#define PCMCIA_VCC_ON()                         mdrv_gpio_set_high( BALL_V24 )
#define PCMCIA_VCC_OFF()                        mdrv_gpio_set_low( BALL_V24 )
...
#define ENABLE_KPDCHAN_3                ENABLE
...
#define ADC_KEY_L0                      0x1A
#define ADC_KEY_L1                      0x4A
#define ADC_KEY_L2                      0x71
#define ADC_KEY_L3                      0x92
#define ADC_KEY_L4                      0xB0
#define ADC_KEY_L5                      0xCE
#define ADC_KEY_L6                      0xEE
...
#define ADC_KEY_1_L4_FLAG               IRKEY_CHANNEL_PLUS
#define ADC_KEY_1_L5_FLAG               IRKEY_MENU
