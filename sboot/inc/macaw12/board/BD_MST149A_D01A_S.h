...
#define BOARD_NAME                  "BD_MST149A_D01A_S"

#define PIN_FLASH_WP0               PIN_80
...
#define PIN_71_IS_GPIO              GPIO_OUT_LOW  //GPIO0, PANEL_ON/OFF + VBL_CTRL
#define PIN_44_IS_GPIO              GPIO_OUT_LOW  //GPIO57, AUDIO_EN + MUTE_AMP + PreAMP_EN
#define PIN_80_IS_GPIO              GPIO_OUT_LOW  //GPIO25, SPI_WP (EEPROM-WP)
#define PIN_42_IS_GPIO              GPIO_IN       //GPIO55, Tuner_SCL, EEPROM_SCL
#define PIN_43_IS_GPIO              GPIO_IN       //GPIO56, Tuner_SDA, EEPROM_SDA
#define PIN_70_IS_GPIO              GPIO_OUT_HIGH //GPIO65, PWR-ON_OFF

//------Chip Type---------------------------------------------------------------
#include "chip/MST6820XP.h"
...
//============================================
#define AUDIO_SOURCE_DTV            AUDIO_NULL_INPUT
...
#define FRONTEND_TUNER_TYPE             TCL_F20WT_3DD_E//PHILIPS_TDA1316_TUNER //PHILIPS_FQD1216_TUNER

#define FRONTEND_IF_MIXER_TYPE          XUGUANG_T126CWADC //PHILIPS_FQD1216_TUNER
#define FRONTEND_IF_DEMODE_TYPE         MSTAR_INTERN_VIF  //PHILIPS_TDA9886 //MSTAR_VIF_MSB1210 //MSTAR_VIF
#endif
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_low( PIN_44 )
#define Audio_Amplifier_OFF()           mdrv_gpio_set_high( PIN_44 )
#define Adj_Volume_On()                 mdrv_gpio_set_low( PIN_44 )
#define Adj_Volume_Off()                mdrv_gpio_set_high( PIN_44 )

#define Panel_VCC_ON()                  mdrv_gpio_set_low( PIN_71 )
#define Panel_VCC_OFF()                 mdrv_gpio_set_high( PIN_71 )
#define Panel_Backlight_VCC_ON()        mdrv_gpio_set_low( PIN_71 )
#define Panel_Backlight_VCC_OFF()       mdrv_gpio_set_high( PIN_71 )
...
#define EEPROM_WP_On()                  mdrv_gpio_set_high(PIN_80)
#define EEPROM_WP_Off()                 mdrv_gpio_set_low(PIN_80)
