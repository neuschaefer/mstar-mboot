...
// M12
#define BD_MST149A_D01A_S           0x0850
#define BD_MST149B_D01A_S           0x0851
#define BD_MST149C_D01A_S           0x0852
#define BD_MST149D_D01A_S           0x0853
#define BD_MST149E_D01A_S           0x0854
...
#if defined (CONFIG_MSTAR_MACAW12_BD_MST149A_D01A_S)
    #define MS_BOARD_TYPE_SEL       BD_MST149A_D01A_S
#elif defined (CONFIG_MSTAR_MACAW12_BD_MST149B_D01A_S)
    #define MS_BOARD_TYPE_SEL       BD_MST149B_D01A_S
#elif defined (CONFIG_MSTAR_MACAW12_BD_MST149C_D01A_S)
    #define MS_BOARD_TYPE_SEL       BD_MST149C_D01A_S
#elif defined (CONFIG_MSTAR_MACAW12_BD_MST149D_D01A_S)
    #define MS_BOARD_TYPE_SEL       BD_MST149D_D01A_S
#elif defined (CONFIG_MSTAR_MACAW12_BD_MST149E_D01A_S)
    #define MS_BOARD_TYPE_SEL       BD_MST149E_D01A_S
#else
...
#elif (MS_BOARD_TYPE_SEL == BD_MST149A_D01A_S)
    #include "BD_MST149A_D01A_S.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST149B_D01A_S)
    #include "BD_MST149B_D01A_S.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST149C_D01A_S)
    #include "BD_MST149C_D01A_S.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST149D_D01A_S)
    #include "BD_MST149D_D01A_S.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST149E_D01A_S)
    #include "BD_MST149E_D01A_S.h"
#else
