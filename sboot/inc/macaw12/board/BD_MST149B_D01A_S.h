...
#define BOARD_NAME                  "BD_MST149B_D01A_S"

#define PIN_FLASH_WP0               PIN_93
...
#define PADS_TS_IN_S_CFG            TS_IN_S_MODE(5)

//------GPIO setting(default GPIO pin level)------------------------------------
#define PIN_112_IS_GPIO             GPIO_OUT_LOW //GPIO73, PANEL_ON/OFF + VBL_CTRL
#define PIN_106_IS_GPIO             GPIO_OUT_LOW //GPIO25, EEPROM-WP
#define PIN_88_IS_GPIO              GPIO_OUT_LOW //GPIO65, AUDIO_EN + MUTE_AMP + PreAMP_EN
#define PIN_93_IS_GPIO              GPIO_OUT_LOW //GPIO24, SPI_WP
#define PIN_57_IS_GPIO              GPIO_IN      //GPIO55, Tuner_SCL, EEPROM_SCL
#define PIN_58_IS_GPIO              GPIO_IN      //GPIO56, Tuner_SDA, EEPROM_SDA
#define PIN_103_IS_GPIO             GPIO_OUT_HIGH//GPIO64, PWR-ON_OFF

//------Chip Type---------------------------------------------------------------
#include "chip/MST6831XP.h"
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_low( PIN_88 )
#define Audio_Amplifier_OFF()           mdrv_gpio_set_high( PIN_88 )
#define Adj_Volume_On()                 mdrv_gpio_set_low( PIN_88 )
#define Adj_Volume_Off()                mdrv_gpio_set_high( PIN_88 )

#define Panel_VCC_ON()                  mdrv_gpio_set_low( PIN_112 )
#define Panel_VCC_OFF()                 mdrv_gpio_set_high( PIN_112 )
#define Panel_Backlight_VCC_ON()        mdrv_gpio_set_low( PIN_112 )
#define Panel_Backlight_VCC_OFF()       mdrv_gpio_set_high( PIN_112 )
...
#define EEPROM_WP_On()                  mdrv_gpio_set_high(PIN_106)
#define EEPROM_WP_Off()                 mdrv_gpio_set_low(PIN_106)
