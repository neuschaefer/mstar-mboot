...
#elif defined(CONFIG_MSTAR_MACAW12_MMAP_128MB) || defined(CONFIG_MSTAR_MACAW12_MMAP_128MB_DDR3)
    #include "mmap_128mb.h"
#elif defined(CONFIG_MSTAR_MACAW12_MMAP_64MB)
    #include "mmap_64mb.h"
#elif defined(CONFIG_MSTAR_MACAW12_MMAP_32MB)
    #include "mmap_32mb.h"
#else
