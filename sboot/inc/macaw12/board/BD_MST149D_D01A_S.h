...
#define BOARD_NAME                  "BD_MST149D_D01A_S"

#define PIN_FLASH_WP0               BALL_H12
...
#define PADS_TCON_CONFIG            Unknown_pad_mux //0x000FFF //TCON0~TCON11 conflicted with PADS_TS_IN_P_CFG
...
#define PADS_SPDIF_IN               Unknown_pad_mux //PAD_GPIO6 conflicted with TS_VLD(PADS_TS_IN_P_CFG)
...
#define PADS_TS_IN_P_CFG            TS_IN_P_MODE(2) //(TS_VLD, SPDIF_IN)=(1,0)
#define PADS_TS_IN_S_CFG            Unknown_pad_mux

//------GPIO setting(default GPIO pin level)------------------------------------
#define BALL_F6_IS_GPIO             GPIO_OUT_LOW  //GPIO70, MUTE_AMP
#define BALL_D5_IS_GPIO             GPIO_OUT_HIGH //GPIO68, PWR-ON_OFF
#define BALL_F5_IS_GPIO             GPIO_OUT_LOW  //GPIO69, VBL-CTRL
#define BALL_C5_IS_GPIO             GPIO_IN       //GPIO73, USB0_OCD_N
#define BALL_R7_IS_GPIO             GPIO_OUT_LOW  //GPIO56, PreAMP_EN
#define BALL_H11_IS_GPIO            GPIO_OUT_LOW  //GPIO67, PANEL_ON/OFF
#define BALL_N7_IS_GPIO             GPIO_OUT_LOW  //GPIO59, AUDIO_EN
#define BALL_H12_IS_GPIO            GPIO_OUT_LOW  //GPIO66, SPI_WP
#define BALL_J13_IS_GPIO            GPIO_IN       //GPIO63, Tuner_SCL, EEPROM_SCL
#define BALL_G13_IS_GPIO            GPIO_IN       //GPIO64, Tuner_SDA, EEPROM_SDA

//------Chip Type---------------------------------------------------------------
#include "chip/MST6833XPT.h"
...
#define FRONTEND_DEMOD_TYPE              MSTAR_MSB1210_DEMOD//LEGEND_8G80_DEMOD //ZARLINK_ZL10353_DEMODE //alex_tung###
#define FRONTEND_TUNER_TYPE              TCL_F20WT_3DD_E//TCL_F20WT_3DD_E//XUGUANG_HFT_8B1_V116H_TUNER//PHILIPS_TDA1316_TUNER //PHILIPS_FQD1216_TUNER
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_low( BALL_N7 )
#define Audio_Amplifier_OFF()           mdrv_gpio_set_high( BALL_N7 )
#define Adj_Volume_On()                 mdrv_gpio_set_low( BALL_R7 )
#define Adj_Volume_Off()                mdrv_gpio_set_high( BALL_R7 )

#define Panel_VCC_ON()                  mdrv_gpio_set_low( BALL_H11 )
#define Panel_VCC_OFF()                 mdrv_gpio_set_high( BALL_H11 )
#define Panel_Backlight_VCC_ON()       mdrv_gpio_set_low( BALL_F5 )
#define Panel_Backlight_VCC_OFF()      mdrv_gpio_set_high( BALL_F5 )
