...
#define PADS_3D_FLAG_CONFIG         PAD_SPDIF_IN
...
#define BALL_D2_IS_GPIO             GPIO_OUT_HIGH	//Backlight On: Low / Off: High
//#define BALL_AD2_IS_GPIO            GPIO_OUT_HIGH       //IFAGC
//#define BALL_AD3_IS_GPIO            GPIO_OUT_HIGH	//RFAGC_CTRL (High: ATV  Low: DTV)
#define BALL_U24_IS_GPIO            GPIO_IN         //DDCR_CK : EEPROM I2C_SCL
#define BALL_U23_IS_GPIO            GPIO_IN         //DDCR_DA : EEPROM I2C_SDA
#define BALL_AD6_IS_GPIO            GPIO_IN         //TGPIO2 : Tuner I2C_SCL
#define BALL_AC7_IS_GPIO            GPIO_IN         //TGPIO3 : Tuner I2C_SDA
//#define BALL_G6_IS_GPIO             GPIO_OUT_LOW    //Pre-AMP On: Low / Off: High
//#define BALL_Y22_IS_GPIO            GPIO_OUT_LOW    //Audio On: Low / Off: High
#define BALL_V24_IS_GPIO            GPIO_OUT_LOW    //Mute On: High / Off: Low
#define BALL_AE17_IS_GPIO           GPIO_OUT_LOW    //AMP_RESET
#define BALL_AE19_IS_GPIO           GPIO_OUT_LOW    //HP Mute On: High / Off: Low

#define BALL_A3_IS_GPIO             GPIO_OUT_HIGH   //FLASH-WPN1 (SPI_FLASH1 Write Protect)
#define BALL_D1_IS_GPIO             GPIO_OUT_HIGH   //FLASH-WPN2 (SPI_FLASH2 Write Protect)
#define BALL_U5_IS_GPIO             GPIO_OUT_HIGH   //MUTE-POP
#define BALL_Y21_IS_GPIO            GPIO_OUT_HIGH   //PCM_PWR_CTL (PCM power control)

//------Chip Type---------------------------------------------------------------
#include "chip/MSD8840EX.h"
...
#define AUDIO_SOURCE_SCART2         AUDIO_AUIN0_INPUT
...
#define EXT_RF_AGC_ON()                 mdrv_gpio_set_high(BALL_AD3) // ATV mode: external RF AGC
#define EXT_RF_AGC_OFF()                mdrv_gpio_set_low(BALL_AD3)  // DTV mode: internal RF AGC
...
// Audio Amplifier
#define Audio_Amplifier_ON()            _FUNC_NOT_USED()    //mdrv_gpio_set_high( BALL_Y22 )
#define Audio_Amplifier_OFF()           _FUNC_NOT_USED()    //mdrv_gpio_set_low( BALL_Y22 )

#define Adj_Volume_Off()                mdrv_gpio_set_high( BALL_V24 )
#define Adj_Volume_On()                 mdrv_gpio_set_low( BALL_V24 )

#define Panel_VCC_ON()                  mdrv_gpio_set_low( BALL_B3 )   // Y9->Y10
#define Panel_VCC_OFF()                 mdrv_gpio_set_high( BALL_B3 )  // Y9->Y10
#define Panel_Backlight_VCC_ON()        mdrv_gpio_set_low( BALL_D2 )
#define Panel_Backlight_VCC_OFF()       mdrv_gpio_set_high( BALL_D2 )
...
#define PCMCIA_VCC_ON()                 mdrv_gpio_set_high( BALL_Y21 )
#define PCMCIA_VCC_OFF()                mdrv_gpio_set_low( BALL_Y21 )
...
#define	CONFIG_LOGO_GOP_SETTINGS "1"
#endif // _MSBOARD_H_
