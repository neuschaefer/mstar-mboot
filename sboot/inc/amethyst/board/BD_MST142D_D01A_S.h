...
#define BOARD_NAME                  "BD_MST142D_D01A_S"

#define PIN_SPI_CZ1                 BALL_C2
#define PIN_SPI_CZ2                 BALL_D3
#define PIN_SPI_CZ3                 0
#define PIN_FLASH_WP0               BALL_L5
#define PIN_FLASH_WP1               BALL_M7
...
#define BALL_U22_IS_GPIO            GPIO_OUT_LOW	//Panel On: Low / Off: High
#define BALL_T22_IS_GPIO            GPIO_OUT_LOW	//Backlight On: Low / Off: High
#define BALL_AD3_IS_GPIO            GPIO_OUT_LOW	//SIF_CTL
#define BALL_AD2_IS_GPIO            GPIO_OUT_LOW	//RFAGC_CTRL (High: ATV  Low: DTV)
#define BALL_R24_IS_GPIO            GPIO_IN         //DDCR_CK : EEPROM I2C_SCL
#define BALL_R25_IS_GPIO            GPIO_IN         //DDCR_DA : EEPROM I2C_SDA
#define BALL_AC6_IS_GPIO            GPIO_IN         //TGPIO2 : Tuner I2C_SCL
#define BALL_AE5_IS_GPIO            GPIO_IN         //TGPIO3 : Tuner I2C_SDA
#define BALL_AB22_IS_GPIO           GPIO_OUT_LOW    //Pre-AMP On: Low / Off: High
#define BALL_E4_IS_GPIO             GPIO_OUT_LOW    //Audio On: Low / Off: High
#define BALL_W21_IS_GPIO            GPIO_OUT_LOW    //Mute On: Low / Off: High
#define BALL_K6_IS_GPIO             GPIO_OUT_LOW    //AUMUTE_OUT (Transfer I2S for audio output)

#define BALL_D6_IS_GPIO             GPIO_IN         //USB_OCD
#define BALL_A8_IS_GPIO             GPIO_IN         //USB1_OCD
#define BALL_L5_IS_GPIO             GPIO_OUT_HIGH   //FLASH-WPN1 (SPI_FLASH1 Write Protect)
#define BALL_M7_IS_GPIO             GPIO_OUT_HIGH   //FLASH-WPN2 (SPI_FLASH2 Write Protect)
#define BALL_A9_IS_GPIO             GPIO_OUT_HIGH   //MUTE-POP
#define BALL_B8_IS_GPIO             GPIO_OUT_HIGH   //PCM_PWR_CTL (PCM power control)

//------Chip Type---------------------------------------------------------------
#include "chip/MSD894SEX.h"
...
#define Switch_DVI4()               MApi_XC_DVI_SwitchSrc(INPUT_HDMI4_MUX)
...
#define FRONTEND_TUNER_TYPE             TCL_DT91WT_2_E_TUNER //LG_TDTC_G311D_TUNER//PHILIPS_TDA1316_TUNER //PHILIPS_FQD1216_TUNER
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_low( BALL_E4 )
#define Audio_Amplifier_OFF()           mdrv_gpio_set_high( BALL_E4 )

#define Adj_Volume_Off()                mdrv_gpio_set_high( BALL_W21 )
#define Adj_Volume_On()                 mdrv_gpio_set_low( BALL_W21 )

#define Panel_VCC_ON()                  mdrv_gpio_set_low( BALL_U22 )   // Y9->Y10
#define Panel_VCC_OFF()                 mdrv_gpio_set_high( BALL_U22 )  // Y9->Y10
#define Panel_Backlight_VCC_ON()        mdrv_gpio_set_low( BALL_T22 )
#define Panel_Backlight_VCC_OFF()       mdrv_gpio_set_high( BALL_T22 )
...
#define D_DMD_IF_DVBT_8M 4000
#define D_DMD_IF_DVBT_7M 3500
