...
#define BOARD_NAME                  "BD_MST142C_D01A_S"
...
#define BALL_AD3_IS_GPIO            GPIO_OUT_LOW	//RFAGC_CTRL (High: ATV  Low: DTV)
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_low( BALL_Y22 )
#define Audio_Amplifier_OFF()           mdrv_gpio_set_high( BALL_Y22 )
