...
#define BOARD_NAME                              "BD_MST142E_D01A_S"
...
#define BALL_B3_IS_GPIO                         GPIO_OUT_LOW	//Panel On: Low / Off: High
#define BALL_A3_IS_GPIO                         GPIO_OUT_LOW	//Backlight On: Low / Off: High
...
#define BALL_W2_IS_GPIO                         GPIO_IN         //TGPIO3 : Tuner I2C_SDA
#define BALL_G6_IS_GPIO                         GPIO_OUT_LOW    //Pre-AMP On: Low / Off: High
#define BALL_V23_IS_GPIO                        GPIO_OUT_LOW    //Audio On: Low / Off: High
...
#define FRONTEND_TUNER_TYPE                     NUTUNE_FK1602_TUNER //TCL_DA91WT_13_E_TUNER //SAMSUNG_DVTA50_TUNER //SAMSUNG_S205_TUNER////SHARP_VA1G5BF2009_TUNERPHILIPS_TDA1316_TUNER //PHILIPS_FQD1216_TUNER
...
#define FRONTEND_TUNER_TYPE                     NUTUNE_FK1602_TUNER //TCL_DT91WT_2_E_TUNER //LG_TDTC_G311D_TUNER//PHILIPS_TDA1316_TUNER //PHILIPS_FQD1216_TUNER
...
#define SECAM_L_PRIME_ON()                      _FUNC_NOT_USED() //mdrv_gpio_set_high( BALL_F4 ) //GPIO60_SET(1)//_FUNC_NOT_USED()
#define SECAM_L_PRIME_OFF()                     _FUNC_NOT_USED() //mdrv_gpio_set_low( BALL_F4 ) //GPIO60_SET(0)//_FUNC_NOT_USED()
#define EXT_RF_AGC_ON()                         _FUNC_NOT_USED() //mdrv_gpio_set_high(BALL_AD2) // ATV mode: external RF AGC
#define EXT_RF_AGC_OFF()                        _FUNC_NOT_USED() //mdrv_gpio_set_low(BALL_AD2)  // DTV mode: internal RF AGC

//------Info------------------------------------------------------------------
#define PANEL_INFO                              PANEL_TYPE_SEL
#define TUNER_INFO                              FRONTEND_TUNER_TYPE
...
#define Adj_Volume_Off()                        mdrv_gpio_set_high( BALL_V23 )
#define Adj_Volume_On()                         mdrv_gpio_set_low( BALL_V23 )
