...
//Amethyst
#define BD_MST142A_D01A_S               0x0760
#define BD_MST142B_D01A_S               0x0761
#define BD_MST142C_D01A_S               0x0762
#define BD_MST142D_D01A_S               0x0763
#define BD_MST015B_10ABX                0x0764
#define BD_MST015B_10ABX_ISDB           0x0765
#define BD_MST569M_10HVT                0x0766
#define BD_MST015B_10ABX_DVB            0x0767
#define BD_MST017B_10ABT                0x0768
#define BD_MST028B_10AFX_11455_DVB      0x0769
#define BD_MST028B_10AFX_11455          0x076A
#define BD_MST142E_D01A_S               0x076B
#define BD_MST028B_10AFX_11455_ISDB     0x076C
#define BD_MST208D_D01A_S               0x076D
#define BD_AMETHYST_FPGA                0x076F
...
#if defined(CONFIG_MSTAR_BD_MST142A_D01A_S)
    #define MS_BOARD_TYPE_SEL           BD_MST142A_D01A_S
#elif defined(CONFIG_MSTAR_BD_MST142B_D01A_S)
    #define MS_BOARD_TYPE_SEL           BD_MST142B_D01A_S
#elif defined(CONFIG_MSTAR_BD_MST142C_D01A_S)
    #define MS_BOARD_TYPE_SEL           BD_MST142C_D01A_S
#elif defined(CONFIG_MSTAR_BD_MST142D_D01A_S)
    #define MS_BOARD_TYPE_SEL           BD_MST142D_D01A_S
#elif defined(CONFIG_MSTAR_BD_MST142E_D01A_S)
    #define MS_BOARD_TYPE_SEL           BD_MST142E_D01A_S
#elif defined (CONFIG_MSTAR_TITANIA_BD_FPGA)
    #define MS_BOARD_TYPE_SEL           BD_AMETHYST_FPGA
#elif defined(CONFIG_MSTAR_BD_MST015B_10ABX)
    #define MS_BOARD_TYPE_SEL           BD_MST015B_10ABX
#elif defined(CONFIG_MSTAR_BD_MST015B_10ABX_DVB)
    #define MS_BOARD_TYPE_SEL           BD_MST015B_10ABX_DVB
#elif defined(CONFIG_MSTAR_BD_MST015B_10ABX_ISDB)
    #define MS_BOARD_TYPE_SEL           BD_MST015B_10ABX_ISDB
#elif defined(CONFIG_MSTAR_BD_MST017B_10ABT)
    #define MS_BOARD_TYPE_SEL           BD_MST017B_10ABT
#elif defined(CONFIG_MSTAR_BD_MST569M_10HVT)
    #define MS_BOARD_TYPE_SEL           BD_MST569M_10HVT
#elif defined(CONFIG_MSTAR_BD_MST028B_10AFX_11455_DVB)
    #define MS_BOARD_TYPE_SEL           BD_MST028B_10AFX_11455_DVB
#elif defined(CONFIG_MSTAR_BD_MST028B_10AFX_11455_ISDB)
    #define MS_BOARD_TYPE_SEL           BD_MST028B_10AFX_11455_ISDB
#elif defined(CONFIG_MSTAR_BD_MST028B_10AFX_11455)
    #define MS_BOARD_TYPE_SEL           BD_MST028B_10AFX_11455
#elif defined(CONFIG_MSTAR_BD_MST208D_D01A_S)
    #define MS_BOARD_TYPE_SEL           BD_MST208D_D01A_S
#else
...
#if (MS_BOARD_TYPE_SEL == BD_MST142A_D01A_S)
    #include "BD_MST142A_D01A_S.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST142B_D01A_S)
    #include "BD_MST142B_D01A_S.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST142C_D01A_S)
    #include "BD_MST142C_D01A_S.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST142D_D01A_S)
    #include "BD_MST142D_D01A_S.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST142E_D01A_S)
    #include "BD_MST142E_D01A_S.h"
#elif (MS_BOARD_TYPE_SEL == BD_AMETHYST_FPGA)
    #include "BD_AMETHYST_FPGA.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST015B_10ABX)
    #include "BD_MST015B_10ABX.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST015B_10ABX_ISDB)
    #include "BD_MST015B_10ABX_ISDB.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST015B_10ABX_DVB)
    #include "BD_MST015B_10ABX_DVB.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST017B_10ABT)
    #include "BD_MST017B_10ABT.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST569M_10HVT)
    #include "BD_MST569M_10HVT.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST028B_10AFX_11455_DVB)
    #include "BD_MST028B_10AFX_11455_DVB.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST028B_10AFX_11455_ISDB)
    #include "BD_MST028B_10AFX_11455_ISDB.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST028B_10AFX_11455)
    #include "BD_MST028B_10AFX_11455.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST208D_D01A_S)
    #include "BD_MST208D_D01A_S.h"
#else
