...
#define BOARD_NAME                  "BD_MST017B_10ABT"

#define PIN_SPI_CZ1                 BALL_B6
#define PIN_SPI_CZ2                 BALL_A6
#define PIN_SPI_CZ3                 0
#define PIN_FLASH_WP0               BALL_C2
...
#define PADS_VSYNC_VIF_OUT_EN       ENABLE//Unknown_pad_mux
...
#define BALL_D7_IS_GPIO             GPIO_OUT_LOW	//Panel On: Low / Off: High
#define BALL_A2_IS_GPIO             GPIO_OUT_LOW	//Backlight On: Low / Off: High
#define BALL_W6_IS_GPIO             GPIO_OUT_HIGH	//RFAGC_CTRL (High: ATV  Low: DTV)
#define BALL_M17_IS_GPIO            GPIO_IN         //DDCR_CK : EEPROM I2C_SCL
#define BALL_M18_IS_GPIO            GPIO_IN         //DDCR_DA : EEPROM I2C_SDA

#define BALL_D6_IS_GPIO             GPIO_OUT_LOW	// 3D Flag
#define BALL_J21_IS_GPIO             GPIO_OUT_LOW	// Demod reset
#define BALL_Y5_IS_GPIO             GPIO_OUT_LOW	// IF AGC select
#define BALL_K21_IS_GPIO             GPIO_OUT_LOW	// AMP MUTE
#define BALL_C1_IS_GPIO             GPIO_OUT_LOW	// LED-G
#define BALL_F5_IS_GPIO             GPIO_OUT_LOW	// LED-R
#define BALL_C2_IS_GPIO             GPIO_OUT_HIGH	// FLASH WP
#define BALL_E4_IS_GPIO             GPIO_OUT_HIGH   //POWER_SW
#define BALL_F6_IS_GPIO             GPIO_OUT_HIGH	//EEPROM WP

//------Chip Type---------------------------------------------------------------
#include "chip/MSD802KBT.h"
...
#define EXT_RF_AGC_ON()                 mdrv_gpio_set_high(BALL_W6) // ATV mode: external RF AGC
#define EXT_RF_AGC_OFF()                mdrv_gpio_set_low(BALL_W6)  // DTV mode: internal RF AGC
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_low( BALL_C1 )
#define Audio_Amplifier_OFF()           mdrv_gpio_set_high( BALL_C1 )

#define Adj_Volume_Off()                mdrv_gpio_set_high( BALL_C1 )
#define Adj_Volume_On()                 mdrv_gpio_set_low( BALL_C1 )

#define Panel_VCC_ON()                  mdrv_gpio_set_low( BALL_A2 )   // Y9->Y10
#define Panel_VCC_OFF()                 mdrv_gpio_set_high( BALL_A2 )  // Y9->Y10
...
#define PCMCIA_VCC_ON()                 _FUNC_NOT_USED() //mdrv_gpio_set_high( BALL_Y21 )
#define PCMCIA_VCC_OFF()                _FUNC_NOT_USED() //mdrv_gpio_set_low( BALL_Y21 )
