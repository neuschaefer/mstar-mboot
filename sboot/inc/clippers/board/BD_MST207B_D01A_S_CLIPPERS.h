...
#define PADS_UART2_MODE                         UNKNOWN_PAD_MUX //Option: PAD_SPDIF_OUT/PAD_SPDIF_IN, PAD_I2S_OUT_SD1/PAD_I2S_OUT_SD2, PAD_GPIO0/PAD_GPIO1
#define PADS_UART3_MODE                         UNKNOWN_PAD_MUX //Option: PAD_I2S_OUT_SD3/PAD_I2S_OUT_MUTE, PAD_SM_CLK/PAD_SM_RST, PAD_EJ_TDO/PAD_EJ_TDI
#define PADS_UART4_MODE                         UNKNOWN_PAD_MUX //Option: PAD_TS_D3/PAD_TS_D4, PAD_GPIO0/PAD_GPIO1
#define PADS_UART5_MODE                         UNKNOWN_PAD_MUX //Option: PAD_GPIO2/PAD_GPIO3, PAD_GPIO4/PAD_GPIO5
#define PADS_UART6_MODE                         UNKNOWN_PAD_MUX //Option: PAD_GPIO6/PAD_GPIO7
#define PADS_FAST_UART_MODE                     UNKNOWN_PAD_MUX //Option: PAD_I2S_IN_WS/PAD_I2S_IN_BCK, PAD_TS_D5/PAD_TS_D6, PAD_I2CM_CK/PAD_I2CM_DA

#define PADS_OD_UART2_MODE                      UNKNOWN_PAD_MUX //Option: PAD_SPDIF_OUT/PAD_SPDIF_IN, PAD_I2S_OUT_SD1/PAD_I2S_OUT_SD2, PAD_GPIO0/PAD_GPIO1
#define PADS_OD_UART3_MODE                      UNKNOWN_PAD_MUX //Option: PAD_I2S_OUT_SD3/PAD_I2S_OUT_MUTE, PAD_SM_CLK/PAD_SM_RST, PAD_EJ_TDO/PAD_EJ_TDI
#define PADS_OD_UART4_MODE                      UNKNOWN_PAD_MUX //Option: PAD_TS_D3/PAD_TS_D4, PAD_GPIO0/PAD_GPIO1
#define PADS_OD_UART5_MODE                      UNKNOWN_PAD_MUX //Option: PAD_GPIO2/PAD_GPIO3, PAD_GPIO4/PAD_GPIO5
#define PADS_OD_UART6_MODE                      UNKNOWN_PAD_MUX //Option: PAD_GPIO6/PAD_GPIO7
#define PADS_OD_FAST_UART_MODE                  UNKNOWN_PAD_MUX //Option: PAD_I2S_IN_WS/PAD_I2S_IN_BCK, PAD_TS_D5/PAD_TS_D6, PAD_I2CM_CK/PAD_I2CM_DA
...
#define PADS_DDCR_MODE                          UNKNOWN_PAD_MUX // PAD_IIC   HDMI patch    //Option: PAD_DDCR / PAD_IIC

#define PADS_MIIC_MODE0                         PAD_GPIO28 //Option: PAD_GPIO17 / PAD_GPIO18 / PAD_TS1_CLK / PAD_TS1_SYNC
...
#define PADS_SM_MODE                            CONFIG_SMART_CARD_PCM //Option: CONFIG_SMART_CARD_PWM / CONFIG_SMART_CARD_TS1 / CONFIG_SMART_CARD_PCM

#define PADS_EXT_GPIO_INT0                      UNKNOWN_PAD_MUX //Option: ENABLE / DISABLE
#define PADS_EXT_GPIO_INT1                      UNKNOWN_PAD_MUX //Option: ENABLE / DISABLE
#define PADS_EXT_GPIO_INT2                      UNKNOWN_PAD_MUX //Option: ENABLE / DISABLE
#define PADS_EXT_GPIO_INT3                      UNKNOWN_PAD_MUX //Option: ENABLE / DISABLE
#define PADS_EXT_GPIO_INT4                      UNKNOWN_PAD_MUX //Option: ENABLE / DISABLE
#define PADS_EXT_GPIO_INT5                      UNKNOWN_PAD_MUX //Option: ENABLE / DISABLE
#define PADS_EXT_GPIO_INT6                      UNKNOWN_PAD_MUX //Option: ENABLE / DISABLE
#define PADS_EXT_GPIO_INT7                      UNKNOWN_PAD_MUX //Option: ENABLE / DISABLE
#define PADS_EXT_GPIO_INT8                      UNKNOWN_PAD_MUX //Option: ENABLE / DISABLE
#define PADS_EXT_GPIO_INT9                      UNKNOWN_PAD_MUX //Option: ENABLE / DISABLE

#define PADS_PM51_PORT1_GPIO0                   UNKNOWN_PAD_MUX //Option: ENABLE / DISABLE
#define PADS_PM51_PORT1_GPIO1                   UNKNOWN_PAD_MUX //Option: ENABLE / DISABLE
#define PADS_PM51_PORT1_GPIO2                   UNKNOWN_PAD_MUX //Option: ENABLE / DISABLE
#define PADS_PM51_PORT1_GPIO3                   UNKNOWN_PAD_MUX //Option: ENABLE / DISABLE
#define PADS_PM51_PORT1_GPIO4                   UNKNOWN_PAD_MUX //Option: ENABLE / DISABLE
#define PADS_PM51_PORT1_GPIO5                   UNKNOWN_PAD_MUX //Option: ENABLE / DISABLE
#define PADS_PM51_PORT1_GPIO6                   UNKNOWN_PAD_MUX //Option: ENABLE / DISABLE
#define PADS_PM51_PORT1_GPIO7                   UNKNOWN_PAD_MUX //Option: ENABLE / DISABLE

//=============================================================================// very important Start
//Die Domain
#define BALL_P21_IS_GPIO                        GPIO_OUT_HIGH   //PAD_GPIO0  Front end Reset  Demod broad reset
#define BALL_M18_IS_GPIO                        GPIO_OUT_LOW    //PAD_GPIO1  SD card power SW    (Enable=L)
#define BALL_N20_IS_GPIO                        GPIO_OUT_LOW    //PAD_GPIO2  AVDD_SDIO power SW  (Enable=L)
#define BALL_N18_IS_GPIO                        GPIO_OUT_LOW    //PAD_GPIO3  WiFi power SW       (Enable=L)
#define BALL_N19_IS_GPIO                        GPIO_OUT_HIGH   //PAD_GPIO4  USB1 power Enable   (Enable=H)
#define BALL_P18_IS_GPIO                        GPIO_OUT_HIGH   //PAD_GPIO5  USB2 power Enable   (Enable=H)
#define BALL_P19_IS_GPIO                        GPIO_IN         //PAD_GPIO6  AV plug in detector (Plug in=L)
                                                                //PAD_GPIO7  No use

#define BALL_N17_IS_GPIO                        GPIO_OUT_HIGH   //PAD_SPI2_DI  AVDD_SDIO 3.3V SW (Enable=L)
#define BALL_M20_IS_GPIO                        GPIO_OUT_HIGH   //PAD_SPI2_CK  AVDD_SDIO 1.8V SW (Enable=H)
#define BALL_B12_IS_GPIO                        GPIO_OUT_HIGH   //PAD_LED0  Ethernet LED0, Green (Enable=H)
#define BALL_C12_IS_GPIO                        GPIO_OUT_HIGH   //PAD_LED1  Ethernet LED1, Yellow (Enable=H)
#define BALL_C20_IS_GPIO                        GPIO_OUT_HIGH   //PAD_I2S_OUT_MUTE  I2S audio mute (Enable=H)
//PM Domain
#define BALL_K21_IS_GPIO                        GPIO_IN         //PAD_SAR1  USB0 over current protect over current=0
#define BALL_K22_IS_GPIO                        GPIO_IN         //PAD_SAR2  USB1 over current protect over current=0
#define BALL_M23_IS_GPIO                        GPIO_IN         //PAD_SAR3  USB2 over current protect over current=0
#define BALL_M22_IS_GPIO                        GPIO_OUT_HIGH   //PAD_SAR4  USB0 power Enable (Enable=H)
//#define BALL_J22_IS_GPIO                      GPIO_OUT_HIGH   //PAD_SAR5  not find
//#define BALL_P22_IS_GPIO                      GPIO_OUT_HIGH   //PAD_GPIO_PM[2]   SPI FLASH Write protect,
#define BALL_U18_IS_GPIO                        GPIO_OUT_HIGH   //PAD_GPIO_PM[4]   Power Down control.Power Down=0 STR
#define BALL_V18_IS_GPIO                        GPIO_OUT_LOW    //PAD_GPIO_PM[5]   1.1V Core power control GPO
//#define BALL_W20_IS_GPIO                      GPIO_OUT_LOW    //PAD_GPIO_PM[6]   SPI Flash Chip select
//#define BALL_Y20_IS_GPIO                      GPIO_IN         //PAD_GPIO_PM[7]   SD CDZ
#define BALL_W19_IS_GPIO                        GPIO_OUT_LOW    //PAD_GPIO_PM[8]   LED1_CTL ON=H, OFF=L
#define BALL_C15_IS_GPIO                        GPIO_IN         //PAD_GPIO_PM[9]   HDMI HPD

#define BALL_R22_IS_GPIO                        GPIO_OUT_LOW    //PAD_PM_SPI_CZ   HDMI HPD


//HDMI patch
#define BALL_B13_IS_GPIO                        GPIO_IN    //PAD_DDC_CK   hdmi patch
#define BALL_A13_IS_GPIO                        GPIO_IN    //PAD_DDC_DA   hdmi patch
...
#define PAD_GPIO_PM5_IS_GPIO                    GPIO_OUT_LOW

//Register Address of VID0
#define REG_VID0_GPIO_CONTROL                   (MS_BUS_RIU_ADDR + (0x000f0a << 1))
...
#define PAD_PM_SPI_CZ_IS_GPIO                   GPIO_OUT_LOW

//Register Address of VID1
#define REG_VID1_GPIO_CONTROL                   (MS_BUS_RIU_ADDR + (0x000f2e << 1))

//GPIO Control Bit of VID1 (bit0 ~ bit15)
#define REG_VID1_GPIO_MASK                      (0x0001 << 1)   //GPIO Control Bit of VID1 (bit0 ~ bit15)
#else
#define PAD_VID1_IS_GPIO                        GPIO_NONE
#endif

#define CONFIG_SIDD_THRESHOLD_CPU_L0            182     //0x0000FFFF: Unused
#define CONFIG_SIDD_THRESHOLD_CPU_L1            0xFFFF  //0x0000FFFF: Unused
#define CONFIG_SIDD_THRESHOLD_CPU_L2            0xFFFF  //0x0000FFFF: Unused

#define CONFIG_OSC_THRESHOLD_CPU_L0             103     //0x0000FFFF: Unused
#define CONFIG_OSC_THRESHOLD_CPU_L1             0xFFFF //0x0000FFFF: Unused
#define CONFIG_OSC_THRESHOLD_CPU_L2             0xFFFF  //0x0000FFFF: Unused

#define CONFIG_SIDD_THRESHOLD_CORE_L0           182     //0x0000FFFF: Unused
...
#define CONFIG_OSC_THRESHOLD_CORE_L0            103     //0x0000FFFF: Unused
...
// ----- HDMITX HPD pin --------------------------------------------------------
#define HDMITX_HPD_PM_GPIO          10 // GPIO 0 ~ 12
