...
//Die Domain
#define BALL_H20_IS_GPIO                        GPIO_OUT_HIGH   //PAD_GPIO0  Front end Reset  Demod broad reset
#define BALL_K18_IS_GPIO                        GPIO_OUT_LOW    //PAD_GPIO1  SD card power SW    (Enable=L)
#define BALL_L19_IS_GPIO                        GPIO_OUT_LOW    //PAD_GPIO2  AVDD_SDIO power SW  (Enable=L)
#define BALL_L20_IS_GPIO                        GPIO_OUT_LOW    //PAD_GPIO3  WiFi power SW       (Enable=L)
#define BALL_C14_IS_GPIO                        GPIO_OUT_HIGH   //PAD_GPIO4  USB1 power Enable   (Enable=H)
#define BALL_F18_IS_GPIO                        GPIO_OUT_HIGH   //PAD_GPIO5  USB2 power Enable   (Enable=H)
                                                                //PAD_GPIO6  No use
#define BALL_N20_IS_GPIO                        GPIO_OUT_HIGH   //PAD_GPIO7  Tuner antenna power control

#define BALL_K19_IS_GPIO                        GPIO_OUT_HIGH   //PAD_SPI2_DI  AVDD_SDIO 3.3V SW (Enable=L)
#define BALL_J19_IS_GPIO                        GPIO_OUT_HIGH   //PAD_SPI2_CK  AVDD_SDIO 1.8V SW (Enable=H)
#define BALL_C11_IS_GPIO                        GPIO_OUT_HIGH   //PAD_LED0  Ethernet LED0, Green (Enable=H)
#define BALL_B10_IS_GPIO                        GPIO_OUT_HIGH   //PAD_LED1  Ethernet LED1, Yellow (Enable=H)
#define BALL_D17_IS_GPIO                        GPIO_OUT_HIGH   //PAD_I2S_OUT_MUTE  I2S audio mute (Enable=H)
//PM Domain
#define BALL_J22_IS_GPIO                        GPIO_IN         //PAD_SAR1  USB0 over current protect over current=0
#define BALL_J23_IS_GPIO                        GPIO_IN         //PAD_SAR2  USB1 over current protect over current=0
#define BALL_L21_IS_GPIO                        GPIO_IN         //PAD_SAR3  USB2 over current protect over current=0
#define BALL_L22_IS_GPIO                        GPIO_OUT_HIGH   //PAD_SAR4  USB0 power Enable Enable=H
//#define BALL_J22_IS_GPIO                      GPIO_OUT_HIGH   //PAD_SAR5  not find
//#define BALL_M21_IS_GPIO                      GPIO_OUT_HIGH   //PAD_GPIO_PM[2]   SPI FLASH Write protect,
#define BALL_R19_IS_GPIO                        GPIO_OUT_HIGH   //PAD_GPIO_PM[4]   Power Down control.Power Down=0 STR
#define BALL_T20_IS_GPIO                        GPIO_OUT_LOW    //PAD_GPIO_PM[5]   1.1V Core power control GPO
//#define BALL_R21_IS_GPIO                      GPIO_OUT_LOW    //PAD_GPIO_PM[6]   SPI Flash Chip select
//#define BALL_AA22_IS_GPIO                     GPIO_IN         //PAD_GPIO_PM[7]   SD CDZ
#define BALL_AA23_IS_GPIO                       GPIO_OUT_LOW    //PAD_GPIO_PM[8]   LED1_CTL ON=H, OFF=L
#define BALL_C13_IS_GPIO                        GPIO_IN         //PAD_GPIO_PM[9]   HDMI HPD

#define BALL_M22_IS_GPIO                        GPIO_OUT_LOW    //PAD_PM_SPI_CZ   HDMI HPD
