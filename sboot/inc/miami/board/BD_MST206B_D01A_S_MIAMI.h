...
#define BOARD_NAME                              "BD_MST206B_D01A_S_MIAMI"
...
//=============================================================================
#define BALL_AC8_IS_GPIO                        GPIO_OUT_LOW    //Panel (Low: On / High: Off)
#define BALL_G4_IS_GPIO                         GPIO_OUT_LOW    //Backlight (Low: On / High: Off)

#define BALL_AC9_IS_GPIO                        GPIO_OUT_HIGH   //Audio (Low: Off / High: On)
#define BALL_G5_IS_GPIO                         GPIO_OUT_LOW    //Mute (Low: Active / High: Mute)
#define BALL_AE8_IS_GPIO                        GPIO_OUT_HIGH   //MUTE-POP

#define BALL_Y25_IS_GPIO                        GPIO_IN         //DDCR_CK: EEPROM I2C_SCL
#define BALL_W24_IS_GPIO                        GPIO_IN         //DDCR_DA: EEPROM I2C_SDA
#define BALL_AE9_IS_GPIO                        GPIO_IN         //TGPIO2: Tuner I2C_SCL
#define BALL_AF9_IS_GPIO                        GPIO_IN         //TGPIO3: Tuner I2C_SDA

#define BALL_AD9_IS_GPIO                        GPIO_OUT_HIGH   //FLASH-WPN1 (SPI_FLASH1 Write Protect)
#define BALL_AD8_IS_GPIO                        GPIO_OUT_HIGH   //FLASH-WPN2 (SPI_FLASH2 Write Protect)

#define BALL_T5_IS_GPIO                         GPIO_IN         //MHL-CB-DET
#define BALL_R6_IS_GPIO                         GPIO_OUT_HIGH   //MHL-VBUS-EN

#define BALL_C5_IS_GPIO                         GPIO_OUT_LOW    //PCM_PWR_CTL (Low: Off / High: On)
#define BALL_T6_IS_GPIO                         GPIO_OUT_HIGH   //POWER_SW (Low: Off / High: On)

#define BALL_D6_IS_GPIO                         GPIO_OUT_HIGH   //USB_CTL (Low: Disable / High: Enable)
#define BALL_E7_IS_GPIO                         GPIO_OUT_HIGH   //USB3_CTL (Low: Disable / High: Enable)
...
#define Adj_Volume_Off()                        mdrv_gpio_set_high(BALL_G5)
#define Adj_Volume_On()                         mdrv_gpio_set_low(BALL_G5)
