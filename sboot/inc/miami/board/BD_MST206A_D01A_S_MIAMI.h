...
#define PARALLEL_IN_SCARD                       0x04
#define PARALLEL_IN_MCARD                       0x05
#define TS_MSPI                                 0x06
...
#define BALL_J5_IS_GPIO                         GPIO_OUT_LOW    //Backlight (Low: On / High: Off)
...
#define BALL_F8_IS_GPIO                         GPIO_OUT_HIGH   //USB3.0 Port0 Power Control (Low: Disable / High: Enable)
#define BALL_E7_IS_GPIO                         GPIO_OUT_HIGH   //USB3.0 Port1 Power Control (Low: Disable / High: Enable)
...
#define REG_USB30_GPIO_OFFSET                   0x88 //bit0~bit7 offset addr
...
#define REG_USB30_PORT2_GPIO_OFFSET             0x89 //bit0~bit7 offset addr
#define REG_USB30_PORT2_GPIO_BIT                0x0  //bit8~bit10 bit count
#define REG_USB30_PORT2_GPIO_LOW_ACTIVE         0x1  //Turn on 5V  (0: GPIO High Active / 1: GPIO Low Active)
//=============================================================================
