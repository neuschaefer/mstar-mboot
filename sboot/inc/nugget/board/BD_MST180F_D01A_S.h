...
#define BOARD_NAME                  "BD_MST180F_D01A_S"

#define PIN_SPI_CZ1                 0
#define PIN_SPI_CZ2                 0
#define PIN_SPI_CZ3                 0
#define PIN_FLASH_WP0               BALL_G7
...
#define BALL_L17_IS_GPIO            GPIO_IN         //H/W I2C_SCL pin (EEPROM)
#define BALL_L18_IS_GPIO            GPIO_IN         //H/W I2C_SDA pin (EEPROM)
#define BALL_G7_IS_GPIO             GPIO_OUT_HIGH   //SPI_FLASH1 write protect #Protect: Low
#define BALL_E3_IS_GPIO             GPIO_IN         //MHL cable detect #Cable in: High
#define BALL_V10_IS_GPIO            GPIO_OUT_LOW    //MFC RESET //elaine.chen bootlogo
#define BALL_J20_IS_GPIO            GPIO_OUT_LOW    //Panel power on/off #Off: High (O) 
#define BALL_K18_IS_GPIO            GPIO_OUT_HIGH    //LCD Backlight control #Off: High 
#define BALL_K17_IS_GPIO            GPIO_OUT_HIGH    //USB1 enable 
#define BALL_V23_IS_GPIO            GPIO_OUT_LOW        //BACKLIGHT_DIM (O) 
#define BALL_D3_IS_GPIO             GPIO_OUT_HIGH   //I2S_out_mute #Mute: low

#define BALL_Y9_IS_GPIO             GPIO_OUT_LOW //LED1
#define BALL_W3_IS_GPIO             GPIO_OUT_LOW //LED2
#define BALL_E5_IS_GPIO             GPIO_IN         //Keypad SAR0 in
#define BALL_G22_IS_GPIO            GPIO_OUT_HIGH //3D ENABLE
#define BALL_AC10_IS_GPIO           GPIO_OUT_LOW    //S2_RESET Satellite IC Reset

//------Chip Type---------------------------------------------------------------
#include "chip/MSD8852RKM2.h"
...
//MB100_BRINGUP
#define IR_TYPE_SEL                                     IR_TYPE_CUS08_VL//IR_TYPE_MSTAR_DTV   // IR_TYPE_MSTAR_DTV // IR_TYPE_CUS03_DTV // IR_TYPE_NEW
...
// Audio Amplifier
//#define Audio_Amplifier_ON()            mdrv_gpio_set_low( BALL_V10 )
//#define Audio_Amplifier_OFF()           mdrv_gpio_set_high( BALL_V10 )

#define GPIO_MFC_RESET_NORMAL() mdrv_gpio_set_low(BALL_V10); 
#define GPIO_MFC_RESET_RESET()   mdrv_gpio_set_high(BALL_V10);

#define Panel_VCC_ON()                  mdrv_gpio_set_high( BALL_J20 )
#define Panel_VCC_OFF()                 mdrv_gpio_set_low( BALL_J20 ) 
#define Panel_Backlight_VCC_ON()        mdrv_gpio_set_low( BALL_K18 ) 
#define Panel_Backlight_VCC_OFF()       mdrv_gpio_set_high( BALL_K18 ) 
#define GPIO_SET_3D_ON()         mdrv_gpio_set_low(BALL_G22) 
#define GPIO_SET_3D_OFF()        mdrv_gpio_set_high(BALL_G22) 
