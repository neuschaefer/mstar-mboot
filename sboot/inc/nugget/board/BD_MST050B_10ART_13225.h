...
#define BOARD_NAME                  "BD_MST050B_10ART_13225"

#define PIN_SPI_CZ1                 BALL_B11
#define PIN_SPI_CZ2                 0
#define PIN_SPI_CZ3                 0
#define PIN_FLASH_WP0               BALL_A7
...
#define BALL_A7_IS_GPIO             GPIO_OUT_HIGH   //SPI_FLASH1 write protect #Protect: Low
#define BALL_F4_IS_GPIO             GPIO_IN         //MHL cable detect #Cable in: High
#define BALL_F5_IS_GPIO             GPIO_OUT_LOW    //MHL VBUS Enable #Enable: Low
#define BALL_F6_IS_GPIO             GPIO_IN         //Keypad SAR0 in
#define BALL_E4_IS_GPIO             GPIO_IN         //Keypad SAR3 in
#define BALL_F7_IS_GPIO             GPIO_IN         //Keypad SAR2 in
#define BALL_E5_IS_GPIO             GPIO_OUT_HIGH   //I2S_out_mute #Mute: low
#define BALL_C10_IS_GPIO            GPIO_OUT_LOW    //Panel power on/off #Off: High
#define BALL_C7_IS_GPIO             GPIO_OUT_LOW    //Panel Backlight on/off #Off: High
#define BALL_K17_IS_GPIO            GPIO_OUT_HIGH   //PCM Power Control #Enable: High
#define BALL_K18_IS_GPIO            GPIO_OUT_HIGH   //Class D Amp Enable #Enable: Low
#define BALL_D9_IS_GPIO             GPIO_OUT_HIGH   //Audio_mute #Mute: High
#define BALL_Y3_IS_GPIO             GPIO_IN         //H/W I2C_SCL pin (TUNER)
#define BALL_W2_IS_GPIO             GPIO_IN         //H/W I2C_SDA pin (TUNER)
#define BALL_B20_IS_GPIO            GPIO_IN         //H/W I2C_SDA pin (EEPROM)
#define BALL_B21_IS_GPIO            GPIO_IN         //H/W I2C_SCL pin (EEPROM)

#define BALL_E12_IS_GPIO            GPIO_IN

#define BALL_D6_IS_GPIO            GPIO_OUT_LOW   //Class D Amp Enable #Enable: Low
#define BALL_E6_IS_GPIO             GPIO_OUT_LOW   //Audio_mute #Mute: High
//------Chip Type---------------------------------------------------------------
#include "chip/MSD8831RKM2.h"
...
//----------------------------------------------------
#define TUNER_IIC_BUS               E_I2C_BUS_DDCA0
#define DEMOD_IIC_BUS               E_I2C_BUS_DDCA1
...
#define AUDIO_PATH_MAIN_SPEAKER     AUDIO_T3_PATH_AUOUT2
...
#define AUDIO_OUTPUT_MAIN_SPEAKER   AUDIO_AUOUT2_OUTPUT
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_low( BALL_K18 )
#define Audio_Amplifier_OFF()           mdrv_gpio_set_high( BALL_K18 )

#define Adj_Volume_Off()                mdrv_gpio_set_low( BALL_D9 )
#define Adj_Volume_On()                 mdrv_gpio_set_high( BALL_D9 )

#define Panel_VCC_ON()                   mdrv_gpio_set_high( BALL_D6 )
#define Panel_VCC_OFF()                mdrv_gpio_set_low( BALL_D6 )
#define Panel_Backlight_VCC_ON()        mdrv_gpio_set_high( BALL_E6 )
#define Panel_Backlight_VCC_OFF()       mdrv_gpio_set_low( BALL_E6 )
...
#define PCMCIA_VCC_ON()                 mdrv_gpio_set_high( BALL_K17 )
#define PCMCIA_VCC_OFF()                mdrv_gpio_set_low( BALL_K17 )
...
#define ADC_KEY_1_L2_FLAG               IRKEY_RIGHT
