...
#define BOARD_NAME                  "BD_MST180E_D01A_S"
...
#define BALL_AB4_IS_GPIO            GPIO_IN         //H/W I2C_SCL pin (TUNER)
#define BALL_AC4_IS_GPIO            GPIO_IN         //H/W I2C_SDA pin (TUNER)
...
#define BALL_J20_IS_GPIO            GPIO_OUT_LOW    //Panel power on/off #Off: High 
#define BALL_K18_IS_GPIO            GPIO_OUT_HIGH    //LCD Backlight control #Off: High
#define BALL_K17_IS_GPIO            GPIO_OUT_HIGH    //USB1 enable 
#define BALL_V23_IS_GPIO            GPIO_OUT_LOW        //BACKLIGHT_DIM 
#define BALL_G22_IS_GPIO            GPIO_OUT_HIGH     // 3D_ENABLE
#define BALL_AC10_IS_GPIO           GPIO_OUT_LOW     //S2_RESET Satellite IC Reset


//------Chip Type---------------------------------------------------------------
#include "chip/MSD8842RKM2.h"
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_low( BALL_W10 )
#define Audio_Amplifier_OFF()           mdrv_gpio_set_high( BALL_W10 )

#define Adj_Volume_Off()                mdrv_gpio_set_low( BALL_W10 )
#define Adj_Volume_On()                 mdrv_gpio_set_high( BALL_W10 )
