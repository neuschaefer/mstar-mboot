...
#define BOARD_NAME                  "BD_MST180B_D01A_S"

#define PIN_SPI_CZ1                 BALL_B3
#define PIN_SPI_CZ2                 BALL_Y5
#define PIN_SPI_CZ3                 0
#define PIN_FLASH_WP0               BALL_AA3
#define PIN_FLASH_WP1               BALL_W5
...
#define BALL_AA3_IS_GPIO            GPIO_OUT_HIGH   //SPI_FLASH1 write protect #Protect: Low
#define BALL_W5_IS_GPIO             GPIO_OUT_HIGH   //SPI_FLASH2 write protect #Protect: Low
#define BALL_W10_IS_GPIO            GPIO_IN         //MHL cable detect #Cable in: High
#define BALL_Y10_IS_GPIO            GPIO_OUT_LOW    //MHL VBUS Enable #Enable: Low
#define BALL_W11_IS_GPIO            GPIO_IN         //MHL Over Current Detect
#define BALL_D5_IS_GPIO             GPIO_IN         //Keypad SAR0 in
#define BALL_E6_IS_GPIO             GPIO_IN         //Keypad SAR3 in
#define BALL_U6_IS_GPIO             GPIO_OUT_HIGH   //I2S_out_mute #Mute: low
#define BALL_V6_IS_GPIO             GPIO_OUT_LOW    //Audio_mute #Mute: high
#define BALL_E8_IS_GPIO             GPIO_OUT_LOW    //Panel power on/off #Off: High
#define BALL_D7_IS_GPIO             GPIO_OUT_LOW	//LCD Backlight control #Off: High
#define BALL_U8_IS_GPIO             GPIO_IN         //USB0 Over Current Detect
#define BALL_T7_IS_GPIO             GPIO_OUT_HIGH   //USB0 power Enable #Enable: High
#define BALL_U7_IS_GPIO             GPIO_IN         //USB1 Over Current Detect
#define BALL_V7_IS_GPIO             GPIO_OUT_HIGH   //USB1 power Enable #Enable: High
#define BALL_J18_IS_GPIO            GPIO_OUT_HIGH   //PCM Power Control #Enable: High
#define BALL_K18_IS_GPIO            GPIO_OUT_LOW    //Class D Amp Enable #Enable: Low
#define BALL_L18_IS_GPIO            GPIO_OUT_LOW    //Audio_mute #Mute: low
#define BALL_AA4_IS_GPIO            GPIO_IN         //H/W I2C_SCL pin (TUNER)
#define BALL_Y4_IS_GPIO             GPIO_IN         //H/W I2C_SDA pin (TUNER)
#define BALL_J15_IS_GPIO            GPIO_IN         //H/W I2C_SDA pin (EEPROM)
#define BALL_K17_IS_GPIO            GPIO_IN         //H/W I2C_SCL pin (EEPROM)
#define BALL_K16_IS_GPIO            GPIO_OUT_HIGH   //Panel Backlight Dimming Adjust

//------Chip Type---------------------------------------------------------------
#include "chip/MSD804KRTM.h"
...
#define Panel_Backlight_VCC_ON()        mdrv_gpio_set_low( BALL_D7 )
#define Panel_Backlight_VCC_OFF()       mdrv_gpio_set_high( BALL_D7 )
