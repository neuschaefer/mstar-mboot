...
#define BOARD_NAME                  "BD_NUGGET_LOADBOARD"
...
#define BALL_J18_IS_GPIO            GPIO_OUT_HIGH   //Panel Backlight Dimming Adjust
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_high( BALL_K18 )
#define Audio_Amplifier_OFF()           mdrv_gpio_set_low( BALL_K18 )

#define Adj_Volume_Off()                mdrv_gpio_set_low( BALL_D9 )
#define Adj_Volume_On()                 mdrv_gpio_set_high( BALL_D9 )

#define Panel_VCC_ON()                  mdrv_gpio_set_low( BALL_C10 )
#define Panel_VCC_OFF()                 mdrv_gpio_set_high( BALL_C10 ) 
#define Panel_Backlight_VCC_ON()        mdrv_gpio_set_low( BALL_C7 )
#define Panel_Backlight_VCC_OFF()       mdrv_gpio_set_high( BALL_C7 )
