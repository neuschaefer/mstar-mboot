...
#define BOARD_NAME                  "BD_MST180A_D01A_S"

#define PIN_SPI_CZ1                 BALL_D3
#define PIN_SPI_CZ2                 BALL_D4
#define PIN_SPI_CZ3                 0
#define PIN_FLASH_WP0               BALL_M5
#define PIN_FLASH_WP1               BALL_L7
...
#define PADS_TS1_CLK                TS1_CLK_8MA
#define PADS_TS_OUT                 Unknown_pad_mux
#define PADS_NAND_MODE              NAND_AD_DQS
...
#define BALL_K6_IS_GPIO             GPIO_OUT_LOW    //I2S_out_mute #Mute: high
#define BALL_M5_IS_GPIO             GPIO_OUT_HIGH   //SPI_FLASH1 write protect #Protect: Low
#define BALL_L7_IS_GPIO             GPIO_OUT_HIGH   //SPI_FLASH2 write protect #Protect: Low
#define BALL_M6_IS_GPIO             GPIO_IN         //SD Card 2 Card detect #Card in: Low
#define BALL_N7_IS_GPIO             GPIO_IN         //SD Card 2 Card write protect #Protect: Low
#define BALL_E2_IS_GPIO             GPIO_IN         //MHL cable detect #Cable in: High
#define BALL_E3_IS_GPIO             GPIO_OUT_HIGH   //Supply 5V to MHL device #Suply 5V: Low
#define BALL_G5_IS_GPIO             GPIO_IN         //MHL Over Current Detect
#define BALL_AA5_IS_GPIO            GPIO_OUT_LOW    //DE-POP_Line_out #DE-POP: High
#define BALL_D5_IS_GPIO             GPIO_OUT_HIGH   //Class D Amp Enable #Enable: High
#define BALL_F8_IS_GPIO             GPIO_OUT_LOW    //Panel power on/off #Off: High
#define BALL_E8_IS_GPIO             GPIO_OUT_LOW   //USB0 power Enable #Enable: Low
#define BALL_P21_IS_GPIO            GPIO_OUT_HIGH   //CI power on/off #Enable: High
#define BALL_P20_IS_GPIO            GPIO_OUT_LOW   //USB1 power Enable #Enable: High
#define BALL_AD8_IS_GPIO            GPIO_OUT_LOW	//LCD Backlight control #Off: Low
#define BALL_H5_IS_GPIO             GPIO_IN         //Keypad SAR0 in
#define BALL_J5_IS_GPIO             GPIO_IN         //Keypad SAR1 in
#define BALL_AD5_IS_GPIO            GPIO_OUT_LOW    //AGC control
#define BALL_AE5_IS_GPIO            GPIO_IN         //H/W I2C_SCL pin (TUNER)
#define BALL_AC6_IS_GPIO            GPIO_IN         //H/W I2C_SDA pin (TUNER)
#define BALL_T21_IS_GPIO            GPIO_IN         //H/W I2C_SDA pin (EEPROM)
#define BALL_T22_IS_GPIO            GPIO_IN         //H/W I2C_SCL pin (EEPROM)
#define BALL_R20_IS_GPIO            GPIO_OUT_LOW    //SD card power control
#define BALL_R24_IS_GPIO            GPIO_OUT_HIGH   //Panel Backlight Dimming Adjust

//------Chip Type---------------------------------------------------------------
#include "chip/MSD894SRX.h"
