...
#define BOARD_NAME                  "BD_MST043B_10BLB_12413"
...
#define PIN_58_IS_GPIO              GPIO_IN       //GPIO44, Tuner_SDA, EEPROM_SDA
#define PIN_59_IS_GPIO              GPIO_IN       //GPIO45, Tuner_SCL, EEPROM_SCL
#define PIN_61_IS_GPIO              GPIO_OUT_HIGH  //GPIO47, MUTE_AMP(I2S)
#define PIN_109_IS_GPIO              GPIO_OUT_LOW//GPIO48, PANEL BL ON/OFF
...
#endif
//------Chip Type---------------------------------------------------------------
#include "chip/MSD8220LB_156_WB.h"
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_low( PIN_61 )
#define Audio_Amplifier_OFF()           mdrv_gpio_set_high( PIN_61 )
#define Adj_Volume_On()                 mdrv_gpio_set_low( PIN_61 )
#define Adj_Volume_Off()                mdrv_gpio_set_high( PIN_61 )

#define Panel_VCC_ON()                  mdrv_gpio_set_high( PIN_121 )
#define Panel_VCC_OFF()                 mdrv_gpio_set_low( PIN_121 )
#define Panel_Backlight_VCC_ON()        mdrv_gpio_set_high( PIN_109 )
#define Panel_Backlight_VCC_OFF()       mdrv_gpio_set_low( PIN_109 )
