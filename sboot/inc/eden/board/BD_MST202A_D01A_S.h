...
#define BOARD_NAME                  "BD_MST202A_D01A_S"
...
#define PIN_48_IS_GPIO              GPIO_IN       //GPIO44, Tuner_SDA, EEPROM_SDA
#define PIN_49_IS_GPIO              GPIO_IN       //GPIO45, Tuner_SCL, EEPROM_SCL
#define PIN_86_IS_GPIO              GPIO_OUT_HIGH //GPIO0,  NORMAL_PWR-ON_OFF
#define PIN_50_IS_GPIO              GPIO_OUT_LOW  //GPIO46, AUDIO-EN (OFF)
#define PIN_85_IS_GPIO              GPIO_OUT_LOW  //GPIO1,  PreAMP_EN (ON)
#define PIN_82_IS_GPIO              GPIO_OUT_LOW  //GPIO5,  MUTE_S (ON)
#define PIN_83_IS_GPIO              GPIO_IN       //GPIO4,  USB OCD_N
#define PIN_84_IS_GPIO              GPIO_OUT_HIGH //GPIO2,  PANEL BL(PWR) ON/OFF (OFF)
#if HDCP_HPD_INVERSE
#define PIN_87_IS_GPIO              GPIO_OUT_HIGH //HOTPLUG A
#define PIN_120_IS_GPIO             GPIO_OUT_HIGH //HOTPLUG B
#else
#define PIN_87_IS_GPIO              GPIO_OUT_LOW  //HOTPLUG A
#define PIN_120_IS_GPIO             GPIO_OUT_LOW  //HOTPLUG B
#endif

//------Chip Type---------------------------------------------------------------
#include "chip/MSD8222LUM.h"
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_high( PIN_50 )
#define Audio_Amplifier_OFF()           mdrv_gpio_set_low( PIN_50 )
#define Adj_Volume_On()                 mdrv_gpio_set_high( PIN_82 )
#define Adj_Volume_Off()                mdrv_gpio_set_low( PIN_82 )

#define Panel_VCC_ON()                  _FUNC_NOT_USED()
#define Panel_VCC_OFF()                 _FUNC_NOT_USED()
#define Panel_Backlight_VCC_ON()        mdrv_gpio_set_low( PIN_84 )
#define Panel_Backlight_VCC_OFF()       mdrv_gpio_set_high( PIN_84 )
