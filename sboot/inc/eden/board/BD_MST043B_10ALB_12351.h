...
#define BOARD_NAME                  "BD_MST043B_10ALB_12351"
...
#define PIN_57_IS_GPIO              GPIO_IN       //GPIO44, Tuner_SDA, EEPROM_SDA
#define PIN_58_IS_GPIO              GPIO_IN       //GPIO45, Tuner_SCL, EEPROM_SCL
#define PIN_60_IS_GPIO              GPIO_OUT_HIGH  //GPIO47, MUTE_AMP(I2S)
#define PIN_61_IS_GPIO              GPIO_OUT_LOW//GPIO48, PANEL BL ON/OFF
#define PIN_133_IS_GPIO             GPIO_OUT_HIGH //GPIO54, PWR_ON/OFF
#define PIN_121_IS_GPIO             GPIO_OUT_LOW//GPIO64, PANEL PWR ON/OFF
#define PIN_130_IS_GPIO             GPIO_IN       //GPIO73, MHL_OCD
#if HDCP_HPD_INVERSE
#define PIN_108_IS_GPIO             GPIO_OUT_HIGH//HOTPLUG_A
#define PIN_141_IS_GPIO             GPIO_OUT_LOW//HOTPLUG_B
#define PIN_107_IS_GPIO             GPIO_OUT_HIGH//HOTPLUG_C
#else
#define PIN_108_IS_GPIO             GPIO_OUT_LOW//HOTPLUG_A
#define PIN_141_IS_GPIO             GPIO_OUT_HIGH//HOTPLUG_B
#define PIN_107_IS_GPIO             GPIO_OUT_LOW//HOTPLUG_C
#endif

//------Chip Type---------------------------------------------------------------
#include "chip/MSD8220LB.h"
...
#define INPUT_AV_YMUX               INPUT_PORT_YMUX_G1
...
#define AUDIO_PATH_MONITOROUT		AUDIO_PATH_1
...
#define AUDIO_OUTPUT_MONITOROUT		AUDIO_AUOUT1_OUTPUT
...
#define FRONTEND_TUNER_TYPE             SILAB_2158_TUNER_A20//SI2158_TUNER //NXP_TDA18273_TUNER
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_low( PIN_60 )
#define Audio_Amplifier_OFF()           mdrv_gpio_set_high( PIN_60 )
#define Adj_Volume_On()                 mdrv_gpio_set_low( PIN_60 )
#define Adj_Volume_Off()                mdrv_gpio_set_high( PIN_60 )

#define Panel_VCC_ON()                  mdrv_gpio_set_high( PIN_121 )
#define Panel_VCC_OFF()                 mdrv_gpio_set_low( PIN_121 )
#define Panel_Backlight_VCC_ON()        mdrv_gpio_set_high( PIN_61 )
#define Panel_Backlight_VCC_OFF()       mdrv_gpio_set_low( PIN_61 )
