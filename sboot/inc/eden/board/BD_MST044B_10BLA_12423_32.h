...
#define BOARD_NAME                  "BD_MST044B_10BLA_12423_32"

#define PIN_FLASH_WP0               0 //(Optional, default : PIN66)
...
#define PADS_SPDIF_OUT              PAD_GPIO5//Unknown_pad_mux //PAD_GPIO5,PAD_PWM1,PAD_GPIO10,PAD_INT
#define PADS_INT_GPIO               Unknown_pad_mux
#define PADS_PWM0_MODE              Unknown_pad_mux
#define PADS_PWM1_MODE              PAD_PWM1 //PAD_PWM1
...
#define PIN_40_IS_GPIO              GPIO_IN       //GPIO44, Tuner_SDA, EEPROM_SDA
#define PIN_41_IS_GPIO              GPIO_IN       //GPIO45, Tuner_SCL, EEPROM_SCL
#define PIN_43_IS_GPIO              GPIO_OUT_HIGH //GPIO47, AUDIO-EN/AMP_MUTE
#define PIN_44_IS_GPIO              GPIO_IN       //GPIO49, MHL_OCD
#define PIN_64_IS_GPIO              GPIO_OUT_HIGH //GPIO59, PWR_ON/OFF
#define PIN_66_IS_GPIO              GPIO_OUT_LOW //GPIO15, SPI_WP0N/USB-OCD
#define PIN_76_IS_GPIO              GPIO_OUT_LOW //GPIO64, PANEL BL(PWR) ON/OFF
#define PIN_88_IS_GPIO              GPIO_OUT_LOW //HOTPLUB

//------Chip Type---------------------------------------------------------------
#include "chip/MSD8220LA.h"
...
#define FLASH_SIZE                  FLASH_SIZE_2MB
...
#define AUDIO_PATH_SRC              AUDIO_PATH_1
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_low( PIN_43 )
#define Audio_Amplifier_OFF()           mdrv_gpio_set_high( PIN_43 )
#define Adj_Volume_On()                 mdrv_gpio_set_low( PIN_43 )
#define Adj_Volume_Off()                mdrv_gpio_set_high( PIN_43 )

#define Panel_VCC_ON()                  mdrv_gpio_set_high( PIN_76 )
#define Panel_VCC_OFF()                 mdrv_gpio_set_low( PIN_76 )
