...
#define BOARD_NAME                  "BD_MST042B_10BLU_12423_32"
...
#define PIN_FLASH_WP0               0//PIN_58 (Optional, default : 0) => because been used by Audio_en
...
#define PIN_55_IS_GPIO              GPIO_IN       //GPIO44, Tuner_SDA, EEPROM_SDA
#define PIN_56_IS_GPIO              GPIO_IN       //GPIO45, Tuner_SCL, EEPROM_SCL
#define PIN_58_IS_GPIO              GPIO_OUT_HIGH //GPIO47, AUDIO-EN/AMP_MUTE/[SPI_WP0N]
#define PIN_59_IS_GPIO              GPIO_OUT_HIGH //GPIO48, PWR_ON/OFF
#define PIN_82_IS_GPIO              GPIO_OUT_LOW//GPIO14, PANEL BL(PWR) ON/OFF
#define PIN_94_IS_GPIO              GPIO_OUT_LOW//GPIO64,  panel ON /OFF
#define PIN_102_IS_GPIO            GPIO_OUT_LOW// LED
#define PIN_103_IS_GPIO            GPIO_IN//ARC DETCTOR
#if HDCP_HPD_INVERSE
#define PIN_81_IS_GPIO            GPIO_OUT_HIGH// HOTPLUG A
#define PIN_113_IS_GPIO            GPIO_OUT_LOW// hotplug B
#define PIN_80_IS_GPIO            GPIO_OUT_HIGH// HOTPLUG C
#else
#define PIN_81_IS_GPIO            GPIO_OUT_LOW// HOTPLUG A
#define PIN_113_IS_GPIO            GPIO_OUT_HIGH// hotplug B
#define PIN_80_IS_GPIO            GPIO_OUT_LOW// HOTPLUG C
#endif

//------Chip Type---------------------------------------------------------------
#include "chip/MSD8220LU.h"
...
#define KEYPAD_TYPE_SEL                 KEYPAD_TYPE_ORIG
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_low( PIN_58 )
#define Audio_Amplifier_OFF()           mdrv_gpio_set_high( PIN_58 )
#define Adj_Volume_On()                 mdrv_gpio_set_low( PIN_58 )
#define Adj_Volume_Off()                mdrv_gpio_set_high( PIN_58 )

#define Panel_VCC_ON()                  mdrv_gpio_set_high( PIN_94 )
#define Panel_VCC_OFF()                 mdrv_gpio_set_low( PIN_94 )
#define Panel_Backlight_VCC_ON()        mdrv_gpio_set_high( PIN_82 )
#define Panel_Backlight_VCC_OFF()       mdrv_gpio_set_low( PIN_82 )
...
// LED Control
#define LED_RED_ON()                    mdrv_gpio_set_low( PIN_102 )
#define LED_RED_OFF()                   mdrv_gpio_set_high( PIN_102 )
#define LED_GREEN_ON()                 mdrv_gpio_set_high( PIN_102 )
#define LED_GREEN_OFF()                mdrv_gpio_set_low( PIN_102 )
