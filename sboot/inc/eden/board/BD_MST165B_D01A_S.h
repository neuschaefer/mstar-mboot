...
#define BOARD_NAME                  "BD_MST165B_D01A_S"
...
#define PIN_60_IS_GPIO              GPIO_IN       //GPIO49, MHL_OCD
#define PIN_82_IS_GPIO              GPIO_OUT_LOW  //GPIO14, EEPROM_WP
#define PIN_94_IS_GPIO              GPIO_OUT_HIGH //GPIO64, PANEL BL(PWR) ON/OFF
#if HDCP_HPD_INVERSE
...
#define Panel_Backlight_VCC_ON()        mdrv_gpio_set_low( PIN_94 )
#define Panel_Backlight_VCC_OFF()       mdrv_gpio_set_high( PIN_94 )
