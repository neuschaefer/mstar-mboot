...
#define BOARD_NAME                  "BD_MST165A_D01B_S"

#define PIN_FLASH_WP0               PIN_66 //(Optional, default : PIN66)
...
#define PADS_SPDIF_OUT              Unknown_pad_mux //PAD_GPIO5
...
#define PIN_66_IS_GPIO              GPIO_OUT_HIGH //GPIO15, SPI_WP0N/USB-OCD
#define PIN_76_IS_GPIO              GPIO_OUT_HIGH //GPIO64, PANEL BL(PWR) ON/OFF
...
#define Panel_Backlight_VCC_ON()        mdrv_gpio_set_low( PIN_76 )
#define Panel_Backlight_VCC_OFF()       mdrv_gpio_set_high( PIN_76 )
