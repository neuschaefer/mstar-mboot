...
#define BOARD_NAME                  "BD_MST165C_D01A_S"
...
#define PADS_SPDIF_IN               PAD_GPIO7 //PAD_GPIO7
...
#define PIN_60_IS_GPIO              GPIO_OUT_LOW  //GPIO47, MUTE_AMP(I2S)
#define PIN_61_IS_GPIO              GPIO_OUT_HIGH //GPIO48, PANEL BL ON/OFF
#define PIN_63_IS_GPIO              GPIO_OUT_LOW  //GPIO50, AUDIO-EN/WS_OUT
#define PIN_65_IS_GPIO              GPIO_IN       //GPIO52, USB OCD/BCK OUT
#define PIN_66_IS_GPIO              GPIO_OUT_LOW  //GPIO53, PreAMP EN/SD OUT
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_high( PIN_63 )
#define Audio_Amplifier_OFF()           mdrv_gpio_set_low( PIN_63 )
...
#define Panel_Backlight_VCC_ON()        mdrv_gpio_set_low( PIN_61 )
#define Panel_Backlight_VCC_OFF()       mdrv_gpio_set_high( PIN_61 )
