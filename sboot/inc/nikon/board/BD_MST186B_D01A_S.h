...
#define BOARD_NAME                  "BD_MST186B_D01A_S"

#define PIN_SPI_CZ1                 PIN_129
#define PIN_SPI_CZ2                 0
#define PIN_SPI_CZ3                 0
#define PIN_FLASH_WP0               PIN_100
...
#define PADS_SPDIF_OUT              PAD_PWM1 //PAD_GPIO5,PAD_PWM1,PAD_GPIO10,PAD_INT
...
#define PIN_99_IS_GPIO          	GPIO_OUT_LOW	//Panel On: Low / Off: High
#define PIN_29_IS_GPIO          	GPIO_OUT_HIGH	//PADA_VSYNC1: output:High for audio

#define PIN_54_IS_GPIO              GPIO_IN       	//GPIO54, Tuner_SDA
#define PIN_55_IS_GPIO              GPIO_IN       	//GPIO55, Tuner_SCL

#define PIN_57_IS_GPIO              GPIO_OUT_HIGH  	//GPIO47, AUDIO-EN (H:Enable)
#define PIN_58_IS_GPIO              GPIO_OUT_LOW  	//GPIO48, PreAMP_EN(H:Mute -> set low)
#define PIN_62_IS_GPIO              GPIO_OUT_HIGH 	//GPIO51, MUTE_S(L:Mute -> set high)

#define PIN_145_IS_GPIO             GPIO_OUT_HIGH 	//PWR_ON/OFF
#define PIN_100_IS_GPIO             GPIO_OUT_HIGH   //FLASH-WPN1 (SPI_FLASH1 Write Protect)

#define PIN_61_IS_GPIO              GPIO_OUT_HIGH   //GPIO50: USB Power

//------Chip Type---------------------------------------------------------------
#include "chip/MSD8321Y1.h"
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_low( PIN_57 )
#define Audio_Amplifier_OFF()           mdrv_gpio_set_high( PIN_57 )
