...
#define BOARD_NAME                  "BD_MST052B_10AYBC_13264"
...
#define PADS_I2S_OUT                I2S_OUT_MODE4 
...
#define PIN_99_IS_GPIO          	GPIO_OUT_LOW	//Panel On: High / Off: Low
#define PIN_140_IS_GPIO             GPIO_OUT_LOW 	//VBL_CTRL/OFF

#define PIN_54_IS_GPIO              GPIO_IN       	//GPIO54, M_SDA
#define PIN_55_IS_GPIO              GPIO_IN       	//GPIO55, M_SCL
...
#define PIN_29_IS_GPIO              GPIO_OUT_HIGH 	//GPIO51, AMP_MUTE(H:Mute)
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_low( PIN_29 )
#define Audio_Amplifier_OFF()           mdrv_gpio_set_high( PIN_29 )
