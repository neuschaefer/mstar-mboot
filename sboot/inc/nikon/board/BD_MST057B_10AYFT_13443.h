...
#define BOARD_NAME                  "BD_MST186E_D01A_S"

#define PIN_SPI_CZ1                 PIN_136
#define PIN_SPI_CZ2                 0
#define PIN_SPI_CZ3                 0
#define PIN_FLASH_WP0               0//PIN_135
...
#define PADS_TCON_CONFIG            Unknown_pad_mux//PAD_TCON_7 //TCON0~TCON6
...
#define PADS_SPDIF_OUT              PAD_PM_SPI_CZ1 //PAD_GPIO5,PAD_PWM1,PAD_GPIO10,PAD_INT
...
#define PIN_135_IS_GPIO          	GPIO_OUT_LOW	//Panel On: Low / Off: High
#define PIN_149_IS_GPIO          	GPIO_OUT_LOW	//Panel On: Low / Off: High
#define PIN_32_IS_GPIO          	GPIO_OUT_HIGH	//PADA_VSYNC1: output:High for audio

#define PIN_58_IS_GPIO              GPIO_IN       	//GPIO44, Tuner_SDA
#define PIN_59_IS_GPIO              GPIO_IN       	//GPIO45, Tuner_SCL

#define PIN_61_IS_GPIO              GPIO_OUT_HIGH  	//GPIO47, AUDIO-EN (H:Enable)
#define PIN_62_IS_GPIO              GPIO_OUT_LOW  	//GPIO48, PreAMP_EN(H:Mute -> set low)
#define PIN_103_IS_GPIO             GPIO_OUT_HIGH 	//GPIO61, MUTE_S(L:Mute -> set high)

#define PIN_115_IS_GPIO             GPIO_OUT_HIGH 	//PWR_ON/OFF
//#define PIN_135_IS_GPIO             GPIO_OUT_HIGH   //FLASH-WP0N (SPI_FLASH0 Write Protect)

#define PIN_65_IS_GPIO              GPIO_OUT_HIGH   //GPIO50: USB Power

//------Chip Type---------------------------------------------------------------
#include "chip/MSD8324Y1.h"
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_low( PIN_32 )
#define Audio_Amplifier_OFF()           mdrv_gpio_set_high( PIN_32 )

#define Adj_Volume_On()                 mdrv_gpio_set_low( PIN_58 )
#define Adj_Volume_Off()                mdrv_gpio_set_high( PIN_58 )

#define Panel_VCC_ON()                  mdrv_gpio_set_high( PIN_135 )
#define Panel_VCC_OFF()                 mdrv_gpio_set_low( PIN_135 )

#define Panel_Backlight_VCC_ON()        mdrv_gpio_set_high( PIN_149 )
#define Panel_Backlight_VCC_OFF()       mdrv_gpio_set_low( PIN_149 )
