...
//Nikon
#define BD_MST186A_D01A_S               0x0762
#define BD_MST186B_D01A_S               0x0763
#define BD_MST186C_D01A_S               0x0764
#define BD_MST186D_D01A_S               0x0765
#define BD_MST052B_10AYBC_13264         0x0766
#define BD_MST053B_10AYU_13264          0x0767
#define BD_MST054B_10AYB_13264          0x0768
#define BD_MST186E_D01A_S               0x0769
#define BD_MST057B_10AYFT_13443         0x076A
#define BD_NIKON_FPGA          		    0x076F
...
#if defined(CONFIG_MSTAR_BD_MST186A_D01A_S)
    #define MS_BOARD_TYPE_SEL           BD_MST186A_D01A_S
#elif defined(CONFIG_MSTAR_BD_MST186B_D01A_S)
    #define MS_BOARD_TYPE_SEL           BD_MST186B_D01A_S
#elif defined(CONFIG_MSTAR_BD_MST186C_D01A_S)
    #define MS_BOARD_TYPE_SEL           BD_MST186C_D01A_S
#elif defined(CONFIG_MSTAR_BD_MST186D_D01A_S)
    #define MS_BOARD_TYPE_SEL           BD_MST186D_D01A_S
#elif defined(CONFIG_MSTAR_BD_MST186E_D01A_S)
    #define MS_BOARD_TYPE_SEL           BD_MST186E_D01A_S
#elif defined(CONFIG_MSTAR_BD_MST052B_10AYBC_13264)
    #define MS_BOARD_TYPE_SEL           BD_MST052B_10AYBC_13264
#elif defined(CONFIG_MSTAR_BD_MST053B_10AYU_13264)
    #define MS_BOARD_TYPE_SEL           BD_MST053B_10AYU_13264    
#elif defined(CONFIG_MSTAR_BD_MST054B_10AYB_13264)
    #define MS_BOARD_TYPE_SEL           BD_MST054B_10AYB_13264
#elif defined(CONFIG_MSTAR_BD_MST057B_10AYFT_13443)
    #define MS_BOARD_TYPE_SEL           BD_MST057B_10AYFT_13443
#elif defined(CONFIG_MSTAR_TITANIA_BD_FPGA)
    #define MS_BOARD_TYPE_SEL           BD_NIKON_FPGA
#else
...
#if (MS_BOARD_TYPE_SEL == BD_MST186A_D01A_S)
    #include "BD_MST186A_D01A_S.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST186B_D01A_S)
    #include "BD_MST186B_D01A_S.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST186C_D01A_S)
    #include "BD_MST186C_D01A_S.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST186D_D01A_S)
    #include "BD_MST186D_D01A_S.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST186E_D01A_S)
    #include "BD_MST186E_D01A_S.h"    
#elif (MS_BOARD_TYPE_SEL == BD_MST052B_10AYBC_13264)
    #include "BD_MST052B_10AYBC_13264.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST053B_10AYU_13264)
    #include "BD_MST053B_10AYU_13264.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST054B_10AYB_13264)
    #include "BD_MST054B_10AYB_13264.h"    
#elif (MS_BOARD_TYPE_SEL == BD_MST057B_10AYFT_13443)
    #include "BD_MST057B_10AYFT_13443.h"   
#elif (MS_BOARD_TYPE_SEL == BD_NIKON_FPGA)
    #include "BD_NIKON_FPGA.h"
#else
