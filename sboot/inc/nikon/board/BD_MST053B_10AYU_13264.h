...
#define BOARD_NAME                  "BD_MST053B_10AYU_13264"
...
#define PADS_SPDIF_OUT              PAD_TCON0 //PAD_GPIO5,PAD_PWM1,PAD_GPIO10,PAD_INT
...
#define PIN_109_IS_GPIO             GPIO_OUT_LOW 	//VBL_CTRL/OFF
...
#define PIN_98_IS_GPIO              GPIO_OUT_HIGH 	//GPIO5, AMP_MUTE(H:Mute)
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_low( PIN_98 )
#define Audio_Amplifier_OFF()           mdrv_gpio_set_high( PIN_98 )
