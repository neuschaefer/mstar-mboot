...
#define BOARD_NAME                  "BD_MST186D_D01A_S"

#define PIN_SPI_CZ1                 PIN_121
#define PIN_SPI_CZ2                 0
#define PIN_SPI_CZ3                 0
#define PIN_FLASH_WP0               PIN_96
...
#define PIN_57_IS_GPIO              GPIO_IN       	//GPIO44, Tuner_SDA
#define PIN_58_IS_GPIO              GPIO_IN       	//GPIO45, Tuner_SCL

#define PIN_60_IS_GPIO              GPIO_OUT_LOW  	//GPIO47, AUDIO-EN (H:Enable)
#define PIN_61_IS_GPIO              GPIO_OUT_LOW  	//GPIO48, PreAMP_EN(H:Mute -> set low)
#define PIN_65_IS_GPIO              GPIO_OUT_HIGH 	//GPIO51, MUTE_S(L:Mute -> set high)

#define PIN_98_IS_GPIO              GPIO_OUT_HIGH 	//PWR_ON/OFF
#define PIN_96_IS_GPIO              GPIO_OUT_HIGH   //FLASH-WPN1 (SPI_FLASH1 Write Protect)

#define PIN_64_IS_GPIO              GPIO_OUT_HIGH   //GPIO50: USB Power

//------Chip Type---------------------------------------------------------------
#include "chip/MSD8323Y1.h"
