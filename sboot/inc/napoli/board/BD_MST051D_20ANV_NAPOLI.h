...
#define BOARD_NAME                  "BD_MST051D_20ANV_NAPOLI"

//------Function to PIN mapping (PAD_MUX) --------------------------------------
#define PIN_SPI_CZ1                 BALL_M1
#define PIN_SPI_CZ2                 0
#define PIN_SPI_CZ3                 0
#define PIN_FLASH_WP0               BALL_N1
...
#define SPI_PAD0                    0x01
#define SPI_PAD1                    0x02
#define SPI_PAD2                    0x04
#define SPI_PAD3                    0x08
...
#define BALL_K6_IS_GPIO             GPIO_OUT_LOW            // Panel_ON-P1: Panel power on/off, Low :On
#define BALL_C2_IS_GPIO             GPIO_OUT_HIGH           // POWER_SW: DC power on/off, Low :off
#define BALL_K5_IS_GPIO             GPIO_OUT_LOW            // VBLCTRL-P2: LCD Backlight control, High :off
//#define BALL_M1_IS_GPIO             GPIO_OUT_LOW          // SPI-CS1N: SPI_FLASH1 Chip select, Low :select
#define BALL_P5_IS_GPIO             GPIO_IN                 // SDIO-CDZ: SD card 1 detect
//#define BALL_C1_IS_GPIO             GPIO_IN               // HP_DET: Headphone IN detect
#define BALL_P4_IS_GPIO             GPIO_IN                 // SDIO-CDZ: SD card 2 detect ??
#define BALL_N3_IS_GPIO             GPIO_OUT_LOW            // MUTE_POP: Type Out: Ear phone de-POP High mute
#define BALL_C4_IS_GPIO             GPIO_OUT_LOW            // PreAMP_EN: Type Out: Pre AMP EN High Mute
#define BALL_B4_IS_GPIO             GPIO_IN                 // GPIO4: SD Card 1 Card write protect
#define BALL_G1_IS_GPIO             GPIO_IN                 // SAR0: Keypad SAR0 in
#define BALL_F3_IS_GPIO             GPIO_OUT_HIGH           // AMP_SD: Type Out:Class D AMP Enable, Low :Mute
#define BALL_D3_IS_GPIO             GPIO_IN                 // ATSC-AFT: Type In: Atsc Tuner AFT
//#define BALL_G2_IS_GPIO             GPIO_IN                 // SAR3: Keypad SAR1 in
#define BALL_J4_IS_GPIO             GPIO_OUT_HIGH           // PCM_PWR_CTL: CI power on/off (high/low)
#define BALL_J6_IS_GPIO             GPIO_OUT_LOW            // MHL OC: Type Out: MHL OCP Detectlow: enable
#define BALL_D1_IS_GPIO             GPIO_OUT_LOW            // BRI_ADJ-PWM2-C: Type Out: Brightness control
#define BALL_J5_IS_GPIO             GPIO_OUT_LOW            // SD Card Power Enable: Low Enable
#define BALL_H8_IS_GPIO             GPIO_IN                 // I2C-SCL: Type: Out=> H/W I2C_SCL pin
#define BALL_H7_IS_GPIO             GPIO_IN                 // I2C-SDA: Type: I/O=> H/W I2C_SDA pin

#define BALL_C5_IS_GPIO				GPIO_OUT_HIGH			// for core power control
#define BALL_B5_IS_GPIO				GPIO_OUT_HIGH			// for core power control
#define BALL_AK6_IS_GPIO			GPIO_OUT_HIGH			// Tuner I2C TUNER_SCL
#define BALL_AM6_IS_GPIO			GPIO_IN					// Tuner I2C TUNER_SDA
#define BALL_AF6_IS_GPIO			GPIO_OUT_HIGH			// DTMB I2C DTMB_SCL
#define BALL_AF7_IS_GPIO			GPIO_IN					// DTMB I2C DTMB_SDA
#define BALL_AM7_IS_GPIO            GPIO_OUT_HIGH			// TGPIO1 Cashmere Slave Address

//#define BALL_W5_IS_GPIO				GPIO_IN					// HDMI CEC
#define BALL_P6_IS_GPIO				GPIO_IN					// MHL CDZ
#define BALL_P7_IS_GPIO				GPIO_OUT_LOW			// MHL Vbus_EN
#define BALL_H6_IS_GPIO				GPIO_IN					// 3D flag 
#define BALL_C1_IS_GPIO				GPIO_OUT_HIGH			// 3D_LR IN From Panel
#define BALL_D2_IS_GPIO				GPIO_OUT_HIGH			// PWM control 3D Glasses
#define BALL_N2_IS_GPIO				GPIO_OUT_HIGH			// USB 3.0 EN
#define BALL_J3_IS_GPIO				GPIO_OUT_LOW			// PCM control

#define BALL_AD25_IS_GPIO           GPIO_IN                 //I2CS_SCL: Cashmere I2C_SCL
#define BALL_AE25_IS_GPIO           GPIO_IN                 //I2CS_SDA: Cashmere I2C_SDA
#define BALL_AB13_IS_GPIO           GPIO_OUT_LOW            //Cashmere Reset
#define BALL_P15_IS_GPIO            GPIO_OUT_HIGH           // Low: cashmere reset
...
#define REG_USB30_GPIO_BANK                   		0x002E
#define REG_USB30_GPIO_OFFSET                   	0x82 //bit0~bit7 offset addr 
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_low( BALL_F3 )
#define Audio_Amplifier_OFF()           mdrv_gpio_set_high( BALL_F3  )

#define Adj_Volume_Off()                _FUNC_NOT_USED()
#define Adj_Volume_On()                 _FUNC_NOT_USED()

#define Panel_VCC_ON()                  mdrv_gpio_set_high( BALL_K6 )
#define Panel_VCC_OFF()                 mdrv_gpio_set_low( BALL_K6 )
#define Panel_Backlight_VCC_ON()        mdrv_gpio_set_high( BALL_K5 )
#define Panel_Backlight_VCC_OFF()       mdrv_gpio_set_low( BALL_K5 )
...
#define PCMCIA_VCC_ON()                 mdrv_gpio_set_low( BALL_J3 )
#define PCMCIA_VCC_OFF()                mdrv_gpio_set_high( BALL_J3 )
