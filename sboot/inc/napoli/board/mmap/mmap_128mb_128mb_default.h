...
#ifndef _MS_MMAP_128MB_128MB_DEFAULT_PROJ_OBAMA_H_
#define _MS_MMAP_128MB_128MB_DEFAULT_PROJ_OBAMA_H_
...
#define COP_CODE_LEN				    (0x200000)

// Linux kernel space
#define LINUX_MEM_AVAILABLE		        (COP_CODE_START+COP_CODE_LEN+0x40000)
...
#define EMAC_MEM_LEN					(0x200000UL)
