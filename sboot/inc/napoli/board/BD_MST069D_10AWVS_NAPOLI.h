...
#define BOARD_NAME                  "BD_MST069D_10AWVS_NAPOLI"

//------Function to PIN mapping (PAD_MUX) --------------------------------------
#define PIN_SPI_CZ1                 BALL_C4
#define PIN_SPI_CZ2                 BALL_B5
#define PIN_SPI_CZ3                 0
#define PIN_FLASH_WP0               BALL_AD9
#define PIN_FLASH_WP1               BALL_AD8
...
#define PADS_TS_OUT                 Unknown_pad_mux // ready
#define PADS_MSPI_MODE              Unknown_pad_mux // ready

//------GPIO setting(default GPIO pin level) ------------------------------------

//#define BALL_AD8_IS_GPIO            GPIO_OUT_LOW            // FLASH-WPN2: 2nd SPI_FLASH write protect, Low :protect
//#define BALL_B5_IS_GPIO             GPIO_OUT_LOW            // SPI-CS2N: SPI_FLASH2 Chip select, Low :select
//#define BALL_H6_IS_GPIO             GPIO_IN                 // SAR0: Keypad SAR0 in
//#define BALL_H5_IS_GPIO             GPIO_IN                 // SAR3: Keypad SAR1 in
//#define BALL_D6_IS_GPIO             GPIO_OUT_HIGH           // USB_PWR_CTL: USB Power Control H:Power Enable
//#define BALL_E7_IS_GPIO             GPIO_OUT_LOW            // USB3.0_EN: USB3.0 Power Control H:Power Enable
//#define BALL_AE14_IS_GPIO           GPIO_IN                 // I2CM_SDA: H/W I2C_SDA pin (TUNER)
//#define BALL_AK3_IS_GPIO            GPIO_OUT_HIGH           // GPIO_PM14: Class D enable---' PAD_GPIO_PM0

#define BALL_P4_IS_GPIO             GPIO_OUT_LOW            // Panel_ON-P1: Panel power on/off, Low :On
#define BALL_T6_IS_GPIO             GPIO_OUT_HIGH           // Power on/off, H:On
#define BALL_F9_IS_GPIO             GPIO_OUT_HIGH           // Bright adjusts within panel
#define BALL_G6_IS_GPIO             GPIO_OUT_HIGH           // AMP_EN: Piano enable, AMP-MUTE, Low: Enable
#define BALL_P5_IS_GPIO             GPIO_OUT_LOW            // VBLCTRL-P2: Panel Backlight On/Off H:Off
#define BALL_B4_IS_GPIO             GPIO_OUT_HIGH           // LED red , H:on

#define BALL_W5_IS_GPIO             GPIO_IN                 // UART-RX
#define BALL_W4_IS_GPIO             GPIO_IN                 // UART-TX

#define BALL_D5_IS_GPIO             GPIO_IN                 // I2C-SDA: Master H/W I2C_SDA pin(EEPROM)
#define BALL_D4_IS_GPIO             GPIO_IN                 // I2C-SCL: Master H/W I2C_SCL pin(EEPROM)

#define BALL_AE9_IS_GPIO            GPIO_OUT_LOW            // I2CM_SCL: H/W I2C_SCL pin (TUNER)
#define BALL_AF9_IS_GPIO            GPIO_OUT_LOW            // I2CM_SDA: H/W I2C_SDA pin (TUNER)

#define BALL_AC8_IS_GPIO            GPIO_OUT_HIGH           // EEPROM write protect
#define BALL_F6_IS_GPIO             GPIO_OUT_LOW            // Audio SPDIF output
#define BALL_E6_IS_GPIO             GPIO_IN                 // 3D flag 
#define BALL_C5_IS_GPIO             GPIO_OUT_LOW            // 3D_EN
#define BALL_E4_IS_GPIO             GPIO_OUT_LOW            // PANEL 3D SYNC IN 
#define BALL_C8_IS_GPIO             GPIO_OUT_LOW            // PWM control 3D Glasses
#define BALL_AE6_IS_GPIO            GPIO_IN                 // HDMI CEC
#define BALL_AC9_IS_GPIO            GPIO_OUT_LOW            // SPI-Flash write protect
#define BALL_R6_IS_GPIO             GPIO_OUT_LOW            // MHL Vbus_EN
#define BALL_AC7_IS_GPIO            GPIO_OUT_HIGH           // HDMI1 Hot plug
#define BALL_AC6_IS_GPIO            GPIO_OUT_HIGH           // HDMI2 Hot plug
#define BALL_AD6_IS_GPIO            GPIO_OUT_HIGH           // HDMI3 Hot plug
#define BALL_U4_IS_GPIO             GPIO_IN                 // IR-in，Remote control
#define BALL_E8_IS_GPIO             GPIO_OUT_LOW            // LR_SYNC For Panel
#define BALL_AD9_IS_GPIO            GPIO_OUT_LOW            // USB 3.0 EN
#define BALL_D8_IS_GPIO             GPIO_OUT_HIGH           // PCM control
#define BALL_G4_IS_GPIO             GPIO_IN                 // Scard_CDZ
#define BALL_G5_IS_GPIO             GPIO_IN                 // Scard_WP


//#define BALL_B6_IS_GPIO             GPIO_OUT_LOW            // GPIO3: PRE_AMP enable-' PAD_GPIO_PM17
//#define BALL_C7_IS_GPIO             GPIO_OUT_LOW            // MUTE_S-C: Class D mute Enable/Disable (high/low)---' PAD_GPIO_PM2

//#define BALL_F5_IS_GPIO             GPIO_IN                 // I2C-SCL: Master H/W I2C_SCL pin(EEPROM)
//#define BALL_F4_IS_GPIO             GPIO_IN                 // I2C-SDA: Master H/W I2C_SDA pin(EEPROM)
...
#define REG_USB30_GPIO_OFFSET                   	0x8B //bit0~bit7 offset addr
...
// Audio Amplifier ,AMP-MUTE
#define Audio_Amplifier_ON()            mdrv_gpio_set_low( BALL_G6 )
#define Audio_Amplifier_OFF()           mdrv_gpio_set_high( BALL_G6  )

#define Adj_Volume_Off()                _FUNC_NOT_USED()
#define Adj_Volume_On()                 _FUNC_NOT_USED()

//#define Panel_VCC_ON()                  mdrv_gpio_set_low( BALL_P4 )
//#define Panel_VCC_OFF()                 mdrv_gpio_set_high( BALL_P4 )
//#define Panel_Backlight_VCC_ON()        mdrv_gpio_set_low( BALL_P5 )
//#define Panel_Backlight_VCC_OFF()       mdrv_gpio_set_high( BALL_P5 )
#define Panel_VCC_ON()                  mdrv_gpio_set_high( BALL_P4 )
#define Panel_VCC_OFF()                 mdrv_gpio_set_low( BALL_P4 )
#define Panel_Backlight_VCC_ON()        mdrv_gpio_set_high( BALL_P5 )
#define Panel_Backlight_VCC_OFF()       mdrv_gpio_set_low( BALL_P5 )
...
#define PCMCIA_VCC_ON()                 mdrv_gpio_set_high( BALL_C5 )
#define PCMCIA_VCC_OFF()                mdrv_gpio_set_low( BALL_C5 )
