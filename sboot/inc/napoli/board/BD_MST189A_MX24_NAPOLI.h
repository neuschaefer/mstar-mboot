...
#define BOARD_NAME                  "BD_MST189A_MX24_NAPOLI"
...
#define PADS_PWM1_MODE              PAD_PWM1        // ready
#define PADS_PWM2_MODE              Unknown_pad_mux // ready
...
#define PADS_TS_OUT                 Unknown_pad_mux // ready
#define PADS_LED_MODE               PAD_GPIO19      //Output Ethernet LED Control Option: PAD_GPIO19 / PAD_GPIO20 


//------GPIO setting(default GPIO pin level) ------------------------------------
#define BALL_AC9_IS_GPIO            GPIO_OUT_LOW            // Output Audio Amp Sleep Control:High: Audio Amp Power Down
#define BALL_AE8_IS_GPIO            GPIO_OUT_HIGH           // Output Lineout Driver Mute Control:High: Lineout Driver Mute
#define BALL_AD8_IS_GPIO            GPIO_OUT_LOW            // Output Power Indicator Green LED Control:Low: Green LED enable
#define BALL_T6_IS_GPIO             GPIO_OUT_HIGH           // Output System Power Control:High: System Power ON
//#define BALL_C4_IS_GPIO             GPIO_OUT_LOW            // SPI-CS1N: SPI_FLASH1 Chip select, Low :select
#define BALL_G4_IS_GPIO             GPIO_OUT_HIGH            // Output Backlight Control:Low: Enable Backlight
#define BALL_AC8_IS_GPIO            GPIO_OUT_LOW            // Output Panel Power Control:High: Enable Panel Power
//#define BALL_B5_IS_GPIO             GPIO_OUT_LOW            // SPI-CS2N: SPI_FLASH2 Chip select, Low :select
#define BALL_AD9_IS_GPIO            GPIO_OUT_LOW            // Power Indicator Red LED Control:Low: Red LED enable
//#define BALL_R6_IS_GPIO             GPIO_OUT_LOW            // MHL_VBUS_EN: MHL VBUS Enable L:Enable
#define BALL_G5_IS_GPIO             GPIO_OUT_LOW            // Audio Amp Mute Control:Low: Audio Amp Mute
#define BALL_H4_IS_GPIO             GPIO_IN                 // SAR0: Keypad SAR0 in
#define BALL_H5_IS_GPIO             GPIO_IN                 // SAR3: Keypad SAR1 in
#define BALL_C5_IS_GPIO             GPIO_OUT_LOW            // Output SD Card Power Control:Low: Enable SD Card Power
#define BALL_D6_IS_GPIO             GPIO_OUT_LOW           // Output USB Power Control:Low: Enable USB Power
//#define BALL_E7_IS_GPIO             GPIO_OUT_LOW            // USB3.0_EN: USB3.0 Power Control H:Power Enable
#define BALL_AE9_IS_GPIO            GPIO_IN                 // I2CM_SCL: H/W I2C_SCL pin (TUNER)
#define BALL_AF9_IS_GPIO            GPIO_IN                 // T_SCL: H/W I2C_SDA pin (TUNER)
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_low( BALL_AC9 )
#define Audio_Amplifier_OFF()           mdrv_gpio_set_high( BALL_AC9  )

#define Adj_Volume_Off()                mdrv_gpio_set_low( BALL_G5 )
#define Adj_Volume_On()                 mdrv_gpio_set_high( BALL_G5 )

#define Panel_VCC_ON()                  mdrv_gpio_set_high( BALL_AC8 )
#define Panel_VCC_OFF()                 mdrv_gpio_set_low( BALL_AC8 )
#define Panel_Backlight_VCC_ON()        mdrv_gpio_set_low( BALL_G4 )
#define Panel_Backlight_VCC_OFF()       mdrv_gpio_set_high( BALL_G4 )
