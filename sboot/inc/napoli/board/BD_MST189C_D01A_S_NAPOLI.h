...
#define BOARD_NAME                  "BD_MST189C_D01A_S_NAPOLI"

//------Function to PIN mapping (PAD_MUX) --------------------------------------
#define PIN_SPI_CZ1                 BALL_G3
#define PIN_SPI_CZ2                 0
#define PIN_SPI_CZ3                 0
#define PIN_FLASH_WP0               BALL_R4
...
#define BALL_R4_IS_GPIO             GPIO_OUT_HIGH            // FLASH-WPN1: SPI_FLASH1 write protect, Low :protect
#define BALL_R6_IS_GPIO             GPIO_OUT_HIGH           // POWER_SW: Board 12V Power On/Off
#define BALL_F4_IS_GPIO             GPIO_IN                 // SDIO-CDZ: SD Card Detect
#define BALL_G2_IS_GPIO             GPIO_OUT_HIGH           // SPI-CS2N: SPI Flash Chip Select 2
#define BALL_T2_IS_GPIO             GPIO_IN                 // SDIO_CDZ_2: SD Card Detect
#define BALL_E4_IS_GPIO             GPIO_IN                 // SAR0: Keypad SAR0 in
#define BALL_E5_IS_GPIO             GPIO_OUT_HIGH           // AMP_SD: Type Out:Class D AMP Enable, Low :Mute
#define BALL_D2_IS_GPIO             GPIO_IN                 // SAR3: Keypad SAR1 in
#define BALL_K6_IS_GPIO             GPIO_OUT_LOW            // PreAMP_EN: Type Out: Pre AMP EN High Mute
#define BALL_N6_IS_GPIO             GPIO_OUT_HIGH           // DAC Mute: Low :Mute
#define BALL_M5_IS_GPIO             GPIO_OUT_LOW            // SD_VCC_EN: SD Card Power Enable: Low Enable
#define BALL_N5_IS_GPIO             GPIO_OUT_LOW            // SD_VCC_EN_1: SD Card Power Enable: Low Enable
#define BALL_E3_IS_GPIO             GPIO_OUT_HIGH           // USB 2.0 power enable
#define BALL_M6_IS_GPIO             GPIO_OUT_LOW            // PCM_PWR_CTL: CI power on/off (high/low)
...
#define BALL_D6_IS_GPIO             GPIO_IN                 // I2C-SCL: Type: Out=> H/W I2C_SCL pin
#define BALL_E6_IS_GPIO             GPIO_IN                 // I2C-SDA: Type: I/O=> H/W I2C_SDA pin
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_high( BALL_E5 )
#define Audio_Amplifier_OFF()           mdrv_gpio_set_low( BALL_E5  )
...
#define PCMCIA_VCC_ON()                 mdrv_gpio_set_high( BALL_M6 )
#define PCMCIA_VCC_OFF()                mdrv_gpio_set_low( BALL_M6 )
