...
#define BOARD_NAME                  "BD_MSD6A801_BTQ_D3C_NAPOLI"
...
#define BALL_E3_IS_GPIO             GPIO_OUT_HIGH            // USB3.0_POWER_Control
#define BALL_J4_IS_GPIO             GPIO_OUT_LOW            // USB2.0_POWER_Control
...
#define BALL_AH29_IS_GPIO           GPIO_OUT_HIGH            // Rocket Reset : High Reset
#define PAD_GPIO_PM6_IS_GPIO        GPIO_NONE
#define BALL_D3_IS_GPIO             GPIO_OUT_LOW            // GPHY on : Low enable
#define BALL_K5_IS_GPIO             GPIO_OUT_HIGH           //Mute:select
...
#define AUDIO_ROCKET_OUTPUT_TYPE       AUDIO_ROCKER_I2S_OUT //AUDIO_ROCKER_SPDIF_OUT Unknown_pad_mux
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_low( BALL_C4 )
#define Audio_Amplifier_OFF()           mdrv_gpio_set_high( BALL_C4  )
