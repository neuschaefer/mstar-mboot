...
//Munich
#define BD_MUNICH_FPGA                  0x0784
#define BD_MST210A_D01A_S    	0x0785
...
#if defined (CONFIG_MSTAR_BD_MST210A_D01A_S)
    #define MS_BOARD_TYPE_SEL       BD_MST210A_D01A_S
#elif defined (CONFIG_MSTAR_TITANIA_BD_FPGA)
    #define MS_BOARD_TYPE_SEL       BD_MUNICH_FPGA
#else
...
#if (MS_BOARD_TYPE_SEL == BD_MST210A_D01A_S)
    #include "BD_MST210A_D01A_S.h"
#elif (MS_BOARD_TYPE_SEL == BD_MUNICH_FPGA)
    #include "BD_MUNICH_FPGA.h"
#else
