...
#define BOARD_NAME                  "BD_MST006B_10AVS_10315"
...
#define PIN_208_IS_GPIO             GPIO_OUT_HIGH   // VBL_CTRL
#define PIN_93_IS_GPIO             GPIO_OUT_LOW    // EEPROM_WP
#define PIN_211_IS_GPIO             GPIO_OUT_LOW// SPI_WP0N
#define PIN_213_IS_GPIO             GPIO_OUT_HIGH   // LED
#define PIN_214_IS_GPIO             GPIO_OUT_HIGH// M_MUTE_AMP
#define PIN_2_IS_GPIO             GPIO_OUT_HIGH   // HOTPLUGA pin
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_low( PIN_214 )
#define Audio_Amplifier_OFF()           mdrv_gpio_set_high( PIN_214 )

#define Adj_Volume_Off()                mdrv_gpio_set_high( PIN_214 )
#define Adj_Volume_On()                 mdrv_gpio_set_low( PIN_214 )

#define Panel_VCC_ON()                  mdrv_gpio_set_high( PIN_88 )
#define Panel_VCC_OFF()                 mdrv_gpio_set_low( PIN_88 )
#define Panel_Backlight_VCC_ON()       mdrv_gpio_set_low( PIN_208 )
#define Panel_Backlight_VCC_OFF()      mdrv_gpio_set_high( PIN_208 )
...
// LED Control
#define LED_RED_ON()                   mdrv_gpio_set_high( PIN_213 )
#define LED_RED_OFF()                  mdrv_gpio_set_low( PIN_213 )
#define LED_GREEN_ON()                LED_RED_OFF()
#define LED_GREEN_OFF()               LED_RED_ON()
//EEPROM WP
#define EEPROM512_WP_OFF()              mdrv_gpio_set_low( PIN_93 )
#define EEPROM512_WP_ON()               mdrv_gpio_set_high( PIN_93 )
