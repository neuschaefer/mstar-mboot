...
#define BOARD_NAME                  "BD_MST109F_D01A_S"

#define PIN_SPI_CZ1                 PIN_206
#define PIN_SPI_CZ2                 PIN_216
#define PIN_SPI_CZ3                 0
#define PIN_FLASH_WP0               PIN_213
#define PIN_FLASH_WP1               PIN_215
...
#define PIN_126_IS_GPIO             GPIO_OUT_HIGH   // PANEL_CTRL
#define PIN_127_IS_GPIO             GPIO_OUT_HIGH   // VBL_CTRL
#define PIN_93_IS_GPIO              GPIO_IN         // USB2_OCD_N
#define PIN_80_IS_GPIO              GPIO_IN         // USB0_OCD_N
//#define PIN_132_IS_GPIO             GPIO_OUT_LOW    // EEPROM_WP //PWM1 has been enabled as PWM function
#define PIN_84_IS_GPIO              GPIO_OUT_LOW    // SIF
#define PIN_81_IS_GPIO              GPIO_OUT_LOW    // RF_AGC
#define PIN_82_IS_GPIO              GPIO_IN         // TUNER_SCL
#define PIN_83_IS_GPIO              GPIO_IN         // TUNER_SDA
#define PIN_213_IS_GPIO             GPIO_OUT_HIGH   // SPI_WP0N
#define PIN_215_IS_GPIO             GPIO_OUT_HIGH   // SPI_WP1N
#define PIN_210_IS_GPIO             GPIO_IN         // PWR_DET
#define PIN_129_IS_GPIO             GPIO_OUT_LOW    // AUDIO_EN
#define PIN_89_IS_GPIO              GPIO_OUT_LOW    // PreAMP_EN
#define PIN_128_IS_GPIO             GPIO_OUT_LOW    // M_MUTE_AMP
//------Chip Type---------------------------------------------------------------
#include "chip/MSTxxxxVS.h"
...
//#else
#define SECAM_L_PRIME_ON()              mdrv_gpio_set_high(PIN_84) //GPIO60_SET(1)//_FUNC_NOT_USED()
#define SECAM_L_PRIME_OFF()             mdrv_gpio_set_low(PIN_84) //GPIO60_SET(0)//_FUNC_NOT_USED()
#define EXT_RF_AGC_ON()                 mdrv_gpio_set_high( PIN_81 ) // ATV mode: external RF AGC
#define EXT_RF_AGC_OFF()                mdrv_gpio_set_low( PIN_81 )  // DTV mode: internal RF AGC
...
#define Adj_Volume_Off()                mdrv_gpio_set_high( PIN_129 )
#define Adj_Volume_On()                 mdrv_gpio_set_low( PIN_129 )

#define Panel_VCC_ON()                  mdrv_gpio_set_low( PIN_126 )
#define Panel_VCC_OFF()                 mdrv_gpio_set_high( PIN_126 )
#define Panel_Backlight_VCC_ON()       mdrv_gpio_set_low( PIN_127 )
#define Panel_Backlight_VCC_OFF()      mdrv_gpio_set_high( PIN_127 )
...
#define EEPROM_WP_On()                  mdrv_gpio_set_high(PIN_132)
#define EEPROM_WP_Off()                 mdrv_gpio_set_low(PIN_132)
...
#define PWM2_PERIOD                     0xfd
#define INIT_PWM2_DUTY                  0x08
#endif
