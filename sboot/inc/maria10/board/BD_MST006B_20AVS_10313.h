...
#ifndef _MSBOARD_H_
#define _MSBOARD_H_
//This is  64Mb DDR2 SZ demo board
#define BOARD_NAME                  "BD_MST006B_20AVS_10313"

#define PIN_SPI_CZ1                 PIN_204
#define PIN_SPI_CZ2                 0
#define PIN_SPI_CZ3                 0
#define PIN_FLASH_WP0               PIN_211
...
#define PADS_PWM2_MODE              PAD_TC1_GPIO10
...
//#define PIN_80_IS_GPIO                  GPIO_IN         // PAD_I2S_OUT_WS
//#define PIN_81_IS_GPIO                  GPIO_OUT_LOW    // PAD_I2S_OUT_SD
#define PIN_82_IS_GPIO              GPIO_IN         // PAD_TGPIO2 - TUNER_SCL
#define PIN_83_IS_GPIO              GPIO_IN         // PAD_TGPIO3 - TUNER_SDA
#define PIN_192_IS_GPIO             GPIO_IN         // PAD_I2S_OUT_MCK - SCL
#define PIN_194_IS_GPIO             GPIO_IN         // PAD_I2S_OUT_BCK - SDA

#define PIN_84_IS_GPIO              GPIO_OUT_HIGH    // eeprom WP
#define PIN_88_IS_GPIO              GPIO_OUT_HIGH    // panel on/off
#define PIN_91_IS_GPIO              GPIO_OUT_HIGH// AMP_MUTE
#define PIN_92_IS_GPIO              GPIO_OUT_LOW    // USB0_POWER
#define PIN_93_IS_GPIO              GPIO_OUT_LOW    // USB1_POWER

//#define PIN_126_IS_GPIO                 GPIO_OUT_LOW    // PAD_CLK
//#define PIN_127_IS_GPIO                 GPIO_OUT_LOW    // PAD_LDE
//#define PIN_128_IS_GPIO                 GPIO_OUT_LOW    // PAD_LHSYNC
#define PIN_129_IS_GPIO             GPIO_OUT_LOW    // PAD_LVSYNC
//#define PIN_132_IS_GPIO                 GPIO_OUT_LOW// PAD_PWM1

#define PIN_211_IS_GPIO             GPIO_OUT_LOW// PAD_GPIO_PM1 - SPI_WP0N
#define PIN_212_IS_GPIO             GPIO_OUT_HIGH   // PAD_GPIO_PM4 - NORMAL_PWR_CTL
#define PIN_213_IS_GPIO             GPIO_OUT_HIGH   // PAD_GPIO_PM5 - PWR_DET
#define PIN_214_IS_GPIO             GPIO_OUT_LOW// PAD_GPIO_PM6 - LED R
#define PIN_207_IS_GPIO             GPIO_OUT_LOW// PAD_GPIO_PM6 - LED G

#define PIN_208_IS_GPIO             GPIO_OUT_HIGH   // HOTPLUGA pin //20100410EL
//#define PIN_2_IS_GPIO               GPIO_OUT_HIGH   // HOTPLUGB pin //20100410EL


//------Chip Type---------------------------------------------------------------
#include "chip/MST6100VS.h"
...
#define FRONTEND_TUNER_TYPE                 TCL_F17CT_6N_E_TUNER//PHILIPS_TDA1316_TUNER //PHILIPS_FQD1216_TUNER
#else
#define FRONTEND_TUNER_TYPE                 XUGUANG_HFT_8B_115CW_TUNER//PHILIPS_TDA1316_TUNER //PHILIPS_FQD1216_TUNER
#endif
...
#if (FRONTEND_DEMOD_TYPE==XUGUANG_HFT_8B_115CW_TUNER)
...
#define SECAM_L_PRIME_ON()                  _FUNC_NOT_USED()//mdrv_gpio_set_high(PIN_84)
#define SECAM_L_PRIME_OFF()                 _FUNC_NOT_USED()// mdrv_gpio_set_low(PIN_84)
#define EXT_RF_AGC_ON()                     _FUNC_NOT_USED()//mdrv_gpio_set_high( PIN_81 ) // ATV mode: external RF AGC
#define EXT_RF_AGC_OFF()                    _FUNC_NOT_USED()//mdrv_gpio_set_low( PIN_81 )  // DTV mode: internal RF AGC

//------IR & Key Setting--------------------------------------------------------
#define IR_TYPE_SEL                         IR_TYPE_MSTAR_DTV // IR_TYPE_CUS03_DTV // IR_TYPE_NEW
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_low( PIN_91)
#define Audio_Amplifier_OFF()           mdrv_gpio_set_high( PIN_91)

#define Adj_Volume_Off()                mdrv_gpio_set_high( PIN_91)
#define Adj_Volume_On()                 mdrv_gpio_set_low( PIN_91)

#define Panel_VCC_ON()                  mdrv_gpio_set_low( PIN_88)
#define Panel_VCC_OFF()                 mdrv_gpio_set_high( PIN_88 )
...
// LED Control
#define LED_RED_ON()                    mdrv_gpio_set_low( PIN_214 )
#define LED_RED_OFF()                   mdrv_gpio_set_high( PIN_214 )
#define LED_GREEN_ON()                  mdrv_gpio_set_high( PIN_207 )
#define LED_GREEN_OFF()                 mdrv_gpio_set_low( PIN_207 )
//EEPROM WP
#define EEPROM512_WP_OFF()              mdrv_gpio_set_low( PIN_84 )
#define EEPROM512_WP_ON()               mdrv_gpio_set_high( PIN_84 )
...
#define KEYPAD_CH1_LB                   0xD0//0x80
#define KEYPAD_CH2_UB                   0xFF
#define KEYPAD_CH2_LB                   0xD0//0x80
...
#define ADC_KEY_1_L0                    0x10
#define ADC_KEY_1_L1                    0x6E
#define ADC_KEY_1_L2                    0xA0
#define ADC_KEY_1_L3                    0xC8
#define ADC_KEY_1_L4                    0x00//RFU
#define ADC_KEY_1_L5                    0x00//RFU
#define ADC_KEY_1_L6                    0x00//RFU
#define ADC_KEY_1_L7                    0x00//RFU

#define ADC_KEY_2_L0                    0x10
#define ADC_KEY_2_L1                    0x6E
#define ADC_KEY_2_L2                    0xA0
#define ADC_KEY_2_L3                    0xC8
...
#define ADC_KEY_1_L0_FLAG               IRKEY_VOLUME_PLUS
#define ADC_KEY_1_L1_FLAG               IRKEY_CHANNEL_MINUS
#define ADC_KEY_1_L2_FLAG               IRKEY_CHANNEL_PLUS
#define ADC_KEY_1_L3_FLAG               IRKEY_POWER
#define ADC_KEY_1_L4_FLAG               IRKEY_DUMY//RFU
#define ADC_KEY_1_L5_FLAG               IRKEY_DUMY//RFU
#define ADC_KEY_1_L6_FLAG               IRKEY_DUMY//RFU
#define ADC_KEY_1_L7_FLAG               IRKEY_DUMY//RFU

#define ADC_KEY_2_L0_FLAG               IRKEY_VOLUME_MINUS
#define ADC_KEY_2_L1_FLAG               IRKEY_INPUT_SOURCE
#define ADC_KEY_2_L2_FLAG               IRKEY_MUTE
#define ADC_KEY_2_L3_FLAG               IRKEY_MENU
#define ADC_KEY_2_L4_FLAG               IRKEY_DUMY//RFU
#define ADC_KEY_2_L5_FLAG               IRKEY_DUMY//RFU
#define ADC_KEY_2_L6_FLAG               IRKEY_DUMY//RFU
#define ADC_KEY_2_L7_FLAG               IRKEY_DUMY//RFU
...
#define INIT_PWM0_DUTY                  0x48
#endif
#if (PADS_PWM1_MODE!=Unknown_pad_mux)
#define PWM1_PERIOD                     0xff
#define INIT_PWM1_DUTY                  0x7e
#endif
#if (PADS_PWM2_MODE!=Unknown_pad_mux) //Especially for Tuner+30V Power
#define PWM2_PERIOD                     0xA0
#define INIT_PWM2_DUTY                  0x2c
#endif
...
//DDR Related
#define MIU0_SIZE_128M                  0x4000000UL  //refine later
#define MIU0_BANK                       0x4
...
#define  MEMPLL_SEL                     MEMCLK_1066MHZ

#define ENABLE_SW_CH_FREEZE_SCREEN      0
#define _AutoNR_EN_                     0
#define TXTFONT_ZOOM2X                  1
