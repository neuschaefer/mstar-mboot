...
#ifndef _MSBOARD_H_
#define _MSBOARD_H_
//This is  32Mb DDR1 SZ demo board
#define BOARD_NAME                  "BD_MST004B_20AVS_10306"

#define PIN_SPI_CZ1                 PIN_206
#define PIN_SPI_CZ2                 0
#define PIN_SPI_CZ3                 0
#define PIN_FLASH_WP0               PIN_213
...
#define PIN_88_IS_GPIO             GPIO_OUT_LOW// PANE_CTRL
#define PIN_210_IS_GPIO             GPIO_OUT_HIGH // VBL_CTRL
#define PIN_95_IS_GPIO             GPIO_OUT_HIGH // EEPROM_WP
#define PIN_192_IS_GPIO              GPIO_IN         // TUNER_SCL
#define PIN_194_IS_GPIO              GPIO_IN          // TUNER_SDA
#define PIN_213_IS_GPIO             GPIO_OUT_HIGH // SPI_WP0N
#define PIN_215_IS_GPIO             GPIO_OUT_HIGH   // LED
#define PIN_216_IS_GPIO             GPIO_OUT_LOW// M_MUTE_AMP
#define PIN_4_IS_GPIO             GPIO_OUT_HIGH   // HOTPLUGA pin 

//------Chip Type---------------------------------------------------------------
#include "chip/MST6110VS.h"
...
#define FRONTEND_TUNER_TYPE             XUGUANG_HFT2_8C_116CW_TUNER
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_low( PIN_216 )
#define Audio_Amplifier_OFF()           mdrv_gpio_set_high( PIN_216 )

#define Adj_Volume_Off()                mdrv_gpio_set_high( PIN_216)
#define Adj_Volume_On()                 mdrv_gpio_set_low( PIN_216 )

#define Panel_VCC_ON()                  mdrv_gpio_set_high( PIN_88 )
#define Panel_VCC_OFF()                 mdrv_gpio_set_low( PIN_88 )
#define Panel_Backlight_VCC_ON()       mdrv_gpio_set_low( PIN_210)
#define Panel_Backlight_VCC_OFF()      mdrv_gpio_set_high( PIN_210)
...
// LED Control
#define LED_RED_ON()                   mdrv_gpio_set_high( PIN_215 )
#define LED_RED_OFF()                  mdrv_gpio_set_low( PIN_215 )
#define LED_GREEN_ON()                LED_RED_OFF() 
#define LED_GREEN_OFF()               LED_RED_ON()
//EEPROM WP
#define EEPROM512_WP_OFF()              mdrv_gpio_set_low( PIN_95 )
#define EEPROM512_WP_ON()               mdrv_gpio_set_high( PIN_95 )
...
#define KEYPAD_CH1_LB                   0xA0
#define KEYPAD_CH2_UB                   0xFF
#define KEYPAD_CH2_LB                   0xA0
#define KEYPAD_CH3_UB                   0xFF
#define KEYPAD_CH3_LB                   0xA0
#define KEYPAD_CH4_UB                   0xFF
#define KEYPAD_CH4_LB                   0xA0
...
#define ADC_KEY_1_L1                    0x40
#define ADC_KEY_1_L2                    0x70
#define ADC_KEY_1_L3                    0x90
...
#define ADC_KEY_2_L1                    0x40
#define ADC_KEY_2_L2                    0x70
#define ADC_KEY_2_L3                    0x90
...
#define ADC_KEY_2_L1_FLAG               IRKEY_INPUT_SOURCE
#define ADC_KEY_2_L2_FLAG               IRKEY_SELECT
