...
#define BOARD_NAME                  "BD_MST136A_D01A_S"

#define PIN_SPI_CZ1                 BALL_B15
#define PIN_SPI_CZ2                 0
#define PIN_SPI_CZ3                 0
#define PIN_FLASH_WP0               BALL_C12
...
#define BALL_R8_IS_GPIO             GPIO_OUT_HIGH   // PreAMP_EN
#define BALL_N8_IS_GPIO             GPIO_OUT_HIGH   // AUDIO_EN
#define BALL_B14_IS_GPIO            GPIO_IN         // TUNER_SCL
#define BALL_C14_IS_GPIO            GPIO_IN         // TUNER_SDA
#define BALL_G14_IS_GPIO            GPIO_OUT_HIGH   // POWER_DDR
#define BALL_A11_IS_GPIO            GPIO_OUT_LOW    // PANEL_ON/OFF
#define BALL_A10_IS_GPIO            GPIO_OUT_HIGH   // PWR_ON/OFF
#define BALL_B10_IS_GPIO            GPIO_OUT_LOW    // VBL_CTRL
#define BALL_C9_IS_GPIO             GPIO_OUT_HIGH   // MUTE_AMP

//------Chip Type---------------------------------------------------------------
#include "chip/MST6M182VG.h"
...
//#else
#define SECAM_L_PRIME_ON()              mdrv_gpio_set_high(BALL_T4) //GPIO60_SET(1)//_FUNC_NOT_USED()
#define SECAM_L_PRIME_OFF()             mdrv_gpio_set_low(BALL_T4) //GPIO60_SET(0)//_FUNC_NOT_USED()
#define EXT_RF_AGC_ON()                 mdrv_gpio_set_high( BALL_T4 ) // ATV mode: external RF AGC
#define EXT_RF_AGC_OFF()                mdrv_gpio_set_low( BALL_T4 )  // DTV mode: internal RF AGC
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_low( BALL_N8 )
#define Audio_Amplifier_OFF()           mdrv_gpio_set_high( BALL_N8 )

#define Adj_Volume_Off()                mdrv_gpio_set_high( BALL_C9 )
#define Adj_Volume_On()                 mdrv_gpio_set_low( BALL_C9 )

#define Panel_VCC_ON()                  mdrv_gpio_set_low( BALL_A11 )
#define Panel_VCC_OFF()                 mdrv_gpio_set_high( BALL_A11 )
#define Panel_Backlight_VCC_ON()       mdrv_gpio_set_low( BALL_B10 )
#define Panel_Backlight_VCC_OFF()      mdrv_gpio_set_high( BALL_B10 )
...
#define EEPROM_WP_On()                  _FUNC_NOT_USED()//mdrv_gpio_set_high(PIN_225)
#define EEPROM_WP_Off()                 _FUNC_NOT_USED()//mdrv_gpio_set_low(PIN_225)
