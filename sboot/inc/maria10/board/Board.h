...
#define BD_MST004B_20AVS_10306      0x07C5
#define BD_MST006B_10AVS_10315      0x07C6
#define BD_MST006B_20AVS_10313      0x07C7
#define BD_MST6M181_TCL             0x07C8
#define BD_MST136A_D01A_S           0x07C9
...
#if defined (CONFIG_MSTAR_MARIA10_BD_MST109A_D01A_S)
    #define MS_BOARD_TYPE_SEL       BD_MST109A_D01A_S
#elif defined (CONFIG_MSTAR_MARIA10_BD_MST109C_D01A_S)
    #define MS_BOARD_TYPE_SEL       BD_MST109C_D01A_S
#elif defined (CONFIG_MSTAR_MARIA10_BD_MST109D_D01A_S)
    #define MS_BOARD_TYPE_SEL       BD_MST109D_D01A_S
#elif defined (CONFIG_MSTAR_MARIA10_BD_MST109E_D01A_S)
    #define MS_BOARD_TYPE_SEL       BD_MST109E_D01A_S
#elif defined (CONFIG_MSTAR_MARIA10_BD_MST109F_D01A_S)
    #define MS_BOARD_TYPE_SEL       BD_MST109F_D01A_S
#elif defined (CONFIG_MSTAR_MARIA10_BD_MST004B_20AVS_10306)
    #define MS_BOARD_TYPE_SEL       BD_MST004B_20AVS_10306
#elif defined (CONFIG_MSTAR_MARIA10_BD_MST006B_10AVS_10315)
    #define MS_BOARD_TYPE_SEL       BD_MST006B_10AVS_10315
#elif defined (CONFIG_MSTAR_MARIA10_BD_MST006B_20AVS_10313)
    #define MS_BOARD_TYPE_SEL       BD_MST006B_20AVS_10313
#elif defined (CONFIG_MSTAR_MARIA10_BD_MST6M181_TCL)
    #define MS_BOARD_TYPE_SEL       BD_MST6M181_TCL
#elif defined (CONFIG_MSTAR_MARIA10_BD_MST136A_D01A_S)
    #define MS_BOARD_TYPE_SEL       BD_MST136A_D01A_S
#else
...
#elif (MS_BOARD_TYPE_SEL == BD_MST091A_D01A_S)
    #include "BD_MST091A_D01A_S.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST091B_D01A_S)
    #include "BD_MST091B_D01A_S.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST092A_D01A_S)
    #include "BD_MST092A_D01A_S.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST092B_D01A_S)
    #include "BD_MST092B_D01A_S.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST092A_D01A)
    #include "BD_MST092A_D01A.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST092B_D01A)
    #include "BD_MST092B_D01A.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST092C_D01A_S)
    #include "BD_MST092C_D01A_S.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST216A_JNS_10A_9463)
    #include "BD_MST216A_JNS_10A_9463.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST092B_D02A)
    #include "BD_MST092B_D02A.h"

#elif (MS_BOARD_TYPE_SEL == BD_MST109A_D01A_S)
    #include "BD_MST109A_D01A_S.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST109C_D01A_S)
    #include "BD_MST109C_D01A_S.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST109D_D01A_S)
    #include "BD_MST109D_D01A_S.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST109E_D01A_S)
    #include "BD_MST109E_D01A_S.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST109F_D01A_S)
    #include "BD_MST109F_D01A_S.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST004B_20AVS_10306)
    #include "BD_MST004B_20AVS_10306.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST006B_10AVS_10315)
    #include "BD_MST006B_10AVS_10315.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST006B_20AVS_10313)
    #include "BD_MST006B_20AVS_10313.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST6M181_TCL)
    #include "BD_MST6M181_TCL.h"
#elif (MS_BOARD_TYPE_SEL == BD_MST136A_D01A_S)
    #include "BD_MST136A_D01A_S.h"
#else
