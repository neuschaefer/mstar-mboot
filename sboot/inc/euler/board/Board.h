...
// EULER
#define BD_MST165A_D01B_S       0x0890
#define BD_MST165B_D01B_S       0x0891
#define BD_MST165C_D01B_S       0x0892
#define BD_MST042B_EULER       	0x0893
#define BD_MST047B_EULER       	0x0894
...
#if defined (CONFIG_MSTAR_EULER_BD_MST165A_D01B_S)
    #define MS_BOARD_TYPE_SEL       BD_MST165A_D01B_S
#elif defined (CONFIG_MSTAR_EULER_BD_MST165B_D01B_S)
    #define MS_BOARD_TYPE_SEL       BD_MST165B_D01B_S
#elif defined (CONFIG_MSTAR_EULER_BD_MST042B_EULER)
    #define MS_BOARD_TYPE_SEL       BD_MST042B_EULER
#elif defined (CONFIG_MSTAR_EULER_BD_MST047B_EULER)
    #define MS_BOARD_TYPE_SEL       BD_MST047B_EULER
#elif defined (CONFIG_MSTAR_EULER_BD_MST165C_D01B_S)
...
#elif (MS_BOARD_TYPE_SEL == BD_MST047B_EULER)
    #include "BD_MST047B_EULER.h"
