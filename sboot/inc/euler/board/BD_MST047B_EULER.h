...
#define BOARD_NAME                  "BD_MST047B_EULER"
...
#define PIN_58_IS_GPIO              GPIO_OUT_HIGH //GPIO47, AUDIO-EN/AMP_MUTE/[SPI_WP0N] ###==> default : (Mute)
...
#define PIN_94_IS_GPIO              GPIO_OUT_HIGH //GPIO64, PANEL BL(PWR) ON/OFF ###==> default : (Off)

//------Chip Type---------------------------------------------------------------
#include "chip/MSD8120PU.h"
...
#define ADC_KEY_1_L2_FLAG               IRKEY_CHANNEL_PLUS//IRKEY_DOWN
#define ADC_KEY_1_L3_FLAG               IRKEY_VOLUME_MINUS//IRKEY_RIGHT
#define ADC_KEY_1_L4_FLAG               IRKEY_VOLUME_PLUS//IRKEY_LEFT
