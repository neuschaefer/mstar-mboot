...
#define BOARD_NAME                  "BD_MST165C_D01B_S"
...
#define PIN_61_IS_GPIO              GPIO_OUT_HIGH //GPIO47, MUTE_AMP(I2S) ###==> default : (Mute)
#define PIN_63_IS_GPIO              GPIO_OUT_LOW  //GPIO50, AUDIO-EN/WS_OUT ###==> default : (Mute)
#define PIN_65_IS_GPIO              GPIO_IN       //GPIO52, USB OCD/BCK OUT
#define PIN_66_IS_GPIO              GPIO_OUT_LOW  //GPIO53, PreAMP EN/SD OUT ###==> default : (Active)
#define PIN_133_IS_GPIO             GPIO_OUT_HIGH //GPIO54, PWR_ON/OFF
#define PIN_121_IS_GPIO             GPIO_OUT_LOW  //GPIO64, PANEL/BL PWR ON/OFF
#define PIN_130_IS_GPIO             GPIO_IN       //GPIO73, MHL_OCD

//------Chip Type---------------------------------------------------------------
#include "chip/MSD8120PB.h"
