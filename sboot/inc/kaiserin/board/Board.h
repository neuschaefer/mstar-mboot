...
#if defined (CONFIG_KAISERIN_AEON_51_MAU_128MB)
...
#elif defined (CONFIG_MSTAR_KAISERIN_BD_MST138A_D01A_S)
...
#elif defined (CONFIG_MSTAR_KAISERIN_BD_MST178A_D02A)
    #define MS_BOARD_TYPE_SEL       BD_MST178A_D02A
#else
...
#elif (MS_BOARD_TYPE_SEL == BD_MST178A_D02A)
    #include "BD_MST178A_D02A.h"
#else
