...
#define BOARD_NAME                  "BD_MST129B_D01A_S"

//------Function to PIN mapping (PAD_MUX) --------------------------------------
#define PIN_SPI_CZ1                 BALL_K5
#define PIN_SPI_CZ2                 BALL_J6
#define PIN_SPI_CZ3                 BALL_K4
#define PIN_FLASH_WP0               BALL_R7
#define PIN_FLASH_WP1               BALL_T7
...
#define PADS_PWM3_MODE              PAD_PWM3        // ready
#define PADS_PWM4_MODE              PAD_PWM4        // ready
#define PADS_NAND_CS1_EN            Unknown_pad_mux // ready
#define PADS_DDCR_MODE              IIC_PADs        // ready
#define PADS_MIIC_MODE              PAD_GPIO18      // ready
#define PADS_TS_OUT                 Unknown_pad_mux // ready

//------GPIO setting(default GPIO pin level) ------------------------------------
#define BALL_K6_IS_GPIO     GPIO_OUT_LOW                // ETH_RST ready
#define BALL_H6_IS_GPIO     GPIO_OUT_LOW                // Panel_ON ready
#define BALL_H4_IS_GPIO     GPIO_OUT_LOW                // Pre-AMP_SD-C ready
#define BALL_H5_IS_GPIO     GPIO_IN                     // USB_OCD  ready
#define BALL_AC11_IS_GPIO   GPIO_OUT_HIGH               // TUNER_RST ready
#define BALL_AB11_IS_GPIO   GPIO_IN                     // POWER_DET ready
#define BALL_T7_IS_GPIO     GPIO_OUT_HIGH               // FLASH-WPN1 ready
#define BALL_R7_IS_GPIO     GPIO_OUT_HIGH               // FLASH-WPN2 ready
#define BALL_AA11_IS_GPIO   GPIO_OUT_LOW                // PRE_AMP_MUTE ready
#define BALL_AC10_IS_GPIO   GPIO_OUT_LOW                // MUTE_POP ready
#define BALL_AF10_IS_GPIO   GPIO_OUT_HIGH               // SIF_CTL ready
#define BALL_AE10_IS_GPIO   GPIO_OUT_HIGH               // RFAGC_CTL ready
#define BALL_R22_IS_GPIO    GPIO_OUT_LOW                // SPK_AMP_EN ready
#define BALL_R23_IS_GPIO    GPIO_OUT_LOW                // SPK_AMP_MUTE ready
#define BALL_V25_IS_GPIO    GPIO_OUT_HIGH               // PCM_PWR_EN ready
#define BALL_AC14_IS_GPIO   GPIO_IN                     // I2C
#define BALL_AB14_IS_GPIO   GPIO_IN                     // I2C
#define BALL_AD15_IS_GPIO   GPIO_IN                     // I2C
#define BALL_AD16_IS_GPIO   GPIO_IN                     // I2C
#define BALL_V26_IS_GPIO    GPIO_IN
#define BALL_V24_IS_GPIO    GPIO_IN
#define BALL_N23_IS_GPIO    GPIO_OUT_LOW                // I2S_OUT_MUTE

//------Chip Type---------------------------------------------------------------
#include "chip/MSD808KCVF.h"
...
#define INPUT_SV_YMUX               INPUT_PORT_YMUX_CVBS3
#define INPUT_SV_CMUX               INPUT_PORT_CMUX_CVBS4
...
#define AUDIO_SOURCE_DVI            AUDIO_AUIN2_INPUT
...
//#else
#define SECAM_L_PRIME_ON()              mdrv_gpio_set_high( BALL_AF10 ) //GPIO60_SET(1)//_FUNC_NOT_USED()
#define SECAM_L_PRIME_OFF()             mdrv_gpio_set_low( BALL_AF10 ) //GPIO60_SET(0)//_FUNC_NOT_USED()
#define EXT_RF_AGC_ON()                 mdrv_gpio_set_high( BALL_AE10 ) // ATV mode: external RF AGC
#define EXT_RF_AGC_OFF()                mdrv_gpio_set_low( BALL_AE10 )  // DTV mode: internal RF AGC
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_low( BALL_R22 )
#define Audio_Amplifier_OFF()           mdrv_gpio_set_high( BALL_R22  )

#define Adj_Volume_Off()                mdrv_gpio_set_high( BALL_R23 )
#define Adj_Volume_On()                 mdrv_gpio_set_low( BALL_R23 )

#define Panel_VCC_ON()                  mdrv_gpio_set_low( BALL_H6 )
#define Panel_VCC_OFF()                 mdrv_gpio_set_high( BALL_H6 )
#define Panel_Backlight_VCC_ON()        mdrv_gpio_set_low( BALL_H4 )
#define Panel_Backlight_VCC_OFF()       mdrv_gpio_set_high( BALL_H4 )
...
#define PCMCIA_VCC_ON()                 mdrv_gpio_set_high( BALL_V25 )
#define PCMCIA_VCC_OFF()                mdrv_gpio_set_low( BALL_V25 )
