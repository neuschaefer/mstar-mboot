...
#define BOARD_NAME                  "BD_MST129C_D01A_S"
...
#define BALL_B3_IS_GPIO     GPIO_OUT_HIGH           // PRE-AMP_SD
#define BALL_D2_IS_GPIO     GPIO_OUT_LOW            // AMP_EN
#define BALL_D1_IS_GPIO     GPIO_OUT_HIGH           // FLASH-WPN2
#define BALL_AC19_IS_GPIO   GPIO_OUT_LOW            // Panel_ON-P1
#define BALL_AA18_IS_GPIO   GPIO_OUT_LOW            // VBLCTRL-P2
#define BALL_AC18_IS_GPIO   GPIO_OUT_LOW            // PCM_PWR_CTL
#define BALL_AA19_IS_GPIO   GPIO_IN                 // I2C_SDA
#define BALL_AB19_IS_GPIO   GPIO_IN                 // I2C_SCL
#define BALL_AB2_IS_GPIO    GPIO_OUT_HIGH           // SIF_CTRL
#define BALL_AB3_IS_GPIO    GPIO_OUT_HIGH           // RF_AGC_CTRL
#define BALL_AB1_IS_GPIO    GPIO_IN                 // I2CM_SCL
#define BALL_AA3_IS_GPIO    GPIO_IN                 // I2CM_SDA
#define BALL_D3_IS_GPIO     GPIO_OUT_HIGH           // MUTE_POP
...
#define Adj_Volume_Off()                mdrv_gpio_set_high( BALL_B3 )
#define Adj_Volume_On()                 mdrv_gpio_set_low( BALL_B3 )
