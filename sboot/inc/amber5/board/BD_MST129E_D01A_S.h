...
#define BOARD_NAME                  "BD_MST129E_D01A_S"

//------Function to PIN mapping (PAD_MUX) --------------------------------------
#define PIN_SPI_CZ1                 BALL_B1
#define PIN_SPI_CZ2                 BALL_C3
#define PIN_SPI_CZ3                 BALL_B2
#define PIN_FLASH_WP0               BALL_J5
...
#define PADS_SM_MODE                Unknown_pad_mux // ready
...
#define PADS_TS2_CONFIG             PAD_TS2_D0      // ready
#define PADS_NAND_MODE              PCM_D           // ready
...
#define PADS_MPIF_MODE              Unknown_pad_mux // ready
#define PADS_ET_MODE                PAD_GPIO25      // ready
...
#define BALL_D5_IS_GPIO     GPIO_OUT_LOW                // AUMUTE_OUT    ready
#define BALL_B9_IS_GPIO     GPIO_OUT_LOW                // AMP_STB-C     ready
#define BALL_C7_IS_GPIO     GPIO_OUT_HIGH               // PCM_PWR_CTRL  ready
#define BALL_J5_IS_GPIO     GPIO_OUT_HIGH               // FLASH-WPN1   ready
#define BALL_J6_IS_GPIO     GPIO_OUT_HIGH               // FLASH-WPN2   ready
#define BALL_B8_IS_GPIO     GPIO_IN                     // USB_OCD1     ready
#define BALL_F5_IS_GPIO     GPIO_IN                     // USB_OCD      ready
#define BALL_F6_IS_GPIO     GPIO_OUT_LOW                // MUTE_POP     ready
#define BALL_D8_IS_GPIO     GPIO_OUT_LOW                // ETH_RST      ready
#define BALL_AF9_IS_GPIO   GPIO_OUT_HIGH               // SIF_CTL      ready
#define BALL_AF8_IS_GPIO   GPIO_OUT_HIGH               // RF_AGC_CTL   ready
#define BALL_AH5_IS_GPIO    GPIO_IN                     // I2CM_SCL     ready
#define BALL_AF6_IS_GPIO    GPIO_IN                     // I2CM_SDA     ready
#define BALL_R28_IS_GPIO    GPIO_OUT_LOW                // Panel_ON     ready
#define BALL_T26_IS_GPIO    GPIO_OUT_LOW                // Pre-AMP_SD-C ready
#define BALL_R26_IS_GPIO    GPIO_OUT_LOW                // VBLCTRL      ready
#define BALL_T28_IS_GPIO    GPIO_OUT_LOW                // MUTE_S-C     ready
#define BALL_E5_IS_GPIO     GPIO_IN                     // EEPROM I2C   ready
#define BALL_E4_IS_GPIO     GPIO_IN                     // EEPROM I2C   ready
#define BALL_T27_IS_GPIO    GPIO_OUT_HIGH               // TUNER_RST    ready

//------Chip Type---------------------------------------------------------------
#include "chip/MSD898SCV.h"
...
#define INPUT_TV_YMUX               INPUT_PORT_YMUX_CVBS3
...
#define SCART_ID_SEL                0x01   // HSYNC1
#define SCART2_ID_SEL               0x00   // HSYNC2
//============================================
...
#define AUDIO_SOURCE_AV             AUDIO_AUIN3_INPUT    //RCA, AUIN3 or AUIN4, depends on real circuit.
...
#define AUDIO_SOURCE_SCART          AUDIO_AUIN5_INPUT
...
#define AUDIO_SOURCE_DVI2           AUDIO_NULL_INPUT
...
#define AUDIO_PATH_LINEOUT          AUDIO_T3_PATH_AUOUT2    //AUOUT2 or AUOUT3, depends on J23/J24 on real circuit.
#define AUDIO_PATH_SIFOUT           AUDIO_T3_PATH_AUOUT0
...
#define AUDIO_OUTPUT_LINEOUT       AUDIO_AUOUT2_OUTPUT    //AUOUT2 or AUOUT3, depends on J23/J24 on real circuit.
#define AUDIO_OUTPUT_SIFOUT        AUDIO_AUOUT0_OUTPUT
...
//#else
#define SECAM_L_PRIME_ON()              mdrv_gpio_set_high( BALL_AF9 ) //GPIO60_SET(1)//_FUNC_NOT_USED()
#define SECAM_L_PRIME_OFF()             mdrv_gpio_set_low( BALL_AF9 ) //GPIO60_SET(0)//_FUNC_NOT_USED()
#define EXT_RF_AGC_ON()                 mdrv_gpio_set_high( BALL_AF8 ) // ATV mode: external RF AGC
#define EXT_RF_AGC_OFF()                mdrv_gpio_set_low( BALL_AF8 )  // DTV mode: internal RF AGC
...
#define MIU_CONFIG                      DDR3_MIU0_32_MIU1_16_By_8BIT
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_low( BALL_B9 )
#define Audio_Amplifier_OFF()           mdrv_gpio_set_high( BALL_B9  )

#define Adj_Volume_Off()                mdrv_gpio_set_high( BALL_T28 )
#define Adj_Volume_On()                 mdrv_gpio_set_low( BALL_T28 )

#define Panel_VCC_ON()                  mdrv_gpio_set_low( BALL_R28 )
#define Panel_VCC_OFF()                 mdrv_gpio_set_high( BALL_R28 )
#define Panel_Backlight_VCC_ON()        mdrv_gpio_set_low( BALL_R26 )
#define Panel_Backlight_VCC_OFF()       mdrv_gpio_set_high( BALL_R26 )
...
#define PCMCIA_VCC_ON()                 mdrv_gpio_set_high( BALL_C7 )
#define PCMCIA_VCC_OFF()                mdrv_gpio_set_low( BALL_C7 )
...
#define KEYPAD_CH1_LB                   0x70
#define KEYPAD_CH2_UB                   0xFF
#define KEYPAD_CH2_LB                   0x70
#define KEYPAD_CH3_UB                   0xFF
#define KEYPAD_CH3_LB                   0x70
#define KEYPAD_CH4_UB                   0xFF
#define KEYPAD_CH4_LB                   0x70
...
#define ADC_KEY_1_L1                    0x31//0x47
#define ADC_KEY_1_L2                    0x4F//0x63
#define ADC_KEY_1_L3                    0x69//0x7B
...
#define ADC_KEY_2_L1                    0x31//0x47
#define ADC_KEY_2_L2                    0x4F//0x63
#define ADC_KEY_2_L3                    0x69//0x7B
