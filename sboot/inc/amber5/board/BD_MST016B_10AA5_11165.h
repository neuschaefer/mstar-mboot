...
#define BOARD_NAME                  "BD_MST016B_10AA5_11165"
...
#define BALL_A3_IS_GPIO     GPIO_OUT_HIGH           // FLASH_WPN1
#define BALL_B3_IS_GPIO     GPIO_OUT_HIGH           // PCM_PWR_CTL
#define BALL_D2_IS_GPIO     GPIO_OUT_HIGH           // AMP mute
#define BALL_D1_IS_GPIO       GPIO_OUT_HIGH           // eeprom-WP
#define BALL_J7_IS_GPIO       GPIO_OUT_LOW            // Panel_ON-P1
#define BALL_K7_IS_GPIO      GPIO_OUT_LOW            // VBLCTRL-P2
#define BALL_AA19_IS_GPIO   GPIO_IN                 // I2C_SDA
#define BALL_AB19_IS_GPIO   GPIO_IN                 // I2C_SCL
#define BALL_AB2_IS_GPIO    GPIO_OUT_LOW           // IF-AGC-SEL:H->external demo,L->internal demo
#define BALL_AB3_IS_GPIO    GPIO_OUT_LOW           // RF_AGC_CTRL
#define BALL_E3_IS_GPIO      GPIO_OUT_HIGH           // demo reset
#define BALL_AB1_IS_GPIO    GPIO_IN                 // I2CM_SCL
#define BALL_AA3_IS_GPIO    GPIO_IN                 // I2CM_SDA
#define BALL_J4_IS_GPIO       GPIO_OUT_LOW            // Led-red
#define BALL_L7_IS_GPIO       GPIO_OUT_HIGH            // Led-green

//------Chip Type---------------------------------------------------------------
#include "chip/MSD8880CVF.h"
...
//#else
#define SECAM_L_PRIME_ON()              mdrv_gpio_set_high( BALL_AB2 ) //GPIO60_SET(1)//_FUNC_NOT_USED()
#define SECAM_L_PRIME_OFF()             mdrv_gpio_set_low( BALL_AB2 ) //GPIO60_SET(0)//_FUNC_NOT_USED()
#define EXT_RF_AGC_ON()                 mdrv_gpio_set_high( BALL_AB3 ) // ATV mode: external RF AGC
#define EXT_RF_AGC_OFF()                mdrv_gpio_set_low( BALL_AB3 )  // DTV mode: internal RF AGC
...
#define Adj_Volume_Off()                mdrv_gpio_set_high( BALL_D2)
#define Adj_Volume_On()                 mdrv_gpio_set_low( BALL_D2)

#define Panel_VCC_ON()                  mdrv_gpio_set_low( BALL_AC19 )   // Y9->Y10
#define Panel_VCC_OFF()                 mdrv_gpio_set_high( BALL_AC19 )  // Y9->Y10
#define Panel_Backlight_VCC_ON()        mdrv_gpio_set_low( BALL_AA18 )
#define Panel_Backlight_VCC_OFF()       mdrv_gpio_set_high( BALL_AA18 )
...
#define PCMCIA_VCC_ON()                 mdrv_gpio_set_high( BALL_AC18 )
#define PCMCIA_VCC_OFF()                mdrv_gpio_set_low( BALL_AC18 )
