...
#define BOARD_NAME                  "BD_MST105C_D01A_S"

//------Function to PIN mapping (PAD_MUX) --------------------------------------
#define PIN_SPI_CZ1                 BALL_A6
#define PIN_SPI_CZ2                 BALL_C6
#define PIN_SPI_CZ3                 0
#define PIN_FLASH_WP0               BALL_F8
#define PIN_FLASH_WP1               BALL_G9
...
#define PADS_AGC_CTRL               PAD_RF_AGC
...
#define PADS_TS2_CONFIG             PAD_TS2_D0
#define PADS_NAND_MODE              PCM_D
#define PADS_PCM1_CTRL              PAD_PCM_CE_N
#define PADS_PCM1_AD                PAD_PCM_D3
...
#define PADS_I2S_IN                 PAD_I2S_IN_WS
#define PADS_I2S_MUTE               Unknown_pad_mux
#define PADS_I2S_OUT                MULTI_CH_I2S_OUT
#define PADS_MPIF_MODE              Unknown_pad_mux
#define PADS_ET_MODE                PAD_ET_COL
#define PADS_UART2_MODE             PAD_GPIO3
#define PADS_UART3_MODE             PAD_GPIO5
#define PADS_UART4_MODE             PAD_GPIO10
...
#ifdef  BOARD_MOUNT_T12
#define PADS_MIIC_MODE              Unknown_pad_mux
#define PADS_TS_OUT                 Unknown_pad_mux
#endif
#define PADS_P1_ENABLE              Unknown_pad_mux
#define PADS_TTL_CONFIG             Unknown_pad_mux

//------GPIO setting(default GPIO pin level) ------------------------------------
#define BALL_J7_IS_GPIO             GPIO_IN             // TUNER_RST
#define BALL_H4_IS_GPIO             GPIO_IN             // POWER-DET
#define BALL_J5_IS_GPIO             GPIO_OUT_HIGH       // Pre-AMP_SD_C
#define BALL_J6_IS_GPIO             GPIO_IN             // PM_I2C_DA
#define BALL_G4_IS_GPIO             GPIO_IN             // PM_I2C_CK
#define BALL_E6_IS_GPIO             GPIO_OUT_HIGH       // MUTE-POP-C
#define BALL_D2_IS_GPIO             GPIO_IN             // GPIO_PM14
#define BALL_F8_IS_GPIO             GPIO_OUT_HIGH       // FLASH_WPN1
#define BALL_G9_IS_GPIO             GPIO_OUT_HIGH       // FLASH_WPN2
#define BALL_AB10_IS_GPIO           GPIO_OUT_LOW        // Panel_ON
#define BALL_AC10_IS_GPIO           GPIO_OUT_LOW        // VBLCTRL
#define BALL_AC17_IS_GPIO           GPIO_IN             // AUMUTE-OUT
#define BALL_AB17_IS_GPIO           GPIO_OUT_LOW        // PCM_PWR_CTL-C
#define BALL_AB18_IS_GPIO           GPIO_IN             // USB_OCD-C
#define BALL_AF23_IS_GPIO           GPIO_OUT_HIGH       // AMP_STB-C
#define BALL_AD23_IS_GPIO           GPIO_OUT_HIGH       // MUTE_S-C
#define BALL_L7_IS_GPIO             GPIO_OUT_LOW        // ETH_RST

#define BALL_AF9_IS_GPIO            GPIO_OUT_LOW        // SIF_CTL
#define BALL_AD10_IS_GPIO           GPIO_OUT_HIGH       // RF_AGC_CTL
#define BALL_AD9_IS_GPIO            GPIO_IN             // I2CM_SCL
#define BALL_AE9_IS_GPIO            GPIO_IN             // I2CM_SDA
//------Chip Type---------------------------------------------------------------
#include "chip/MSD393SSV.h"
...
#define INPUT_SV_YMUX               INPUT_PORT_YMUX_CVBS3   //INPUT_PORT_NONE_PORT
#define INPUT_SV_CMUX               INPUT_PORT_CMUX_CVBS4   //INPUT_PORT_NONE_PORT
...
#define EXT_RF_AGC_ON()                 mdrv_gpio_set_high( BALL_AD10 ) // ATV mode: external RF AGC
#define EXT_RF_AGC_OFF()                mdrv_gpio_set_low( BALL_AD10 )  // DTV mode: internal RF AGC
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_low( BALL_AD23 )
#define Audio_Amplifier_OFF()           mdrv_gpio_set_high( BALL_AD23  )

#define Adj_Volume_Off()                mdrv_gpio_set_high( BALL_AF23 )
#define Adj_Volume_On()                 mdrv_gpio_set_low( BALL_AF23 )

#define Panel_VCC_ON()                  mdrv_gpio_set_low( BALL_AB10 )   // Y9->Y10
#define Panel_VCC_OFF()                 mdrv_gpio_set_high( BALL_AB10 )  // Y9->Y10
#define Panel_Backlight_VCC_ON()        mdrv_gpio_set_low( BALL_AC10 )
#define Panel_Backlight_VCC_OFF()       mdrv_gpio_set_high( BALL_AC10 )
...
#define PCMCIA_VCC_ON()                 mdrv_gpio_set_high( BALL_AB17 )
#define PCMCIA_VCC_OFF()                mdrv_gpio_set_low( BALL_AB17 )
