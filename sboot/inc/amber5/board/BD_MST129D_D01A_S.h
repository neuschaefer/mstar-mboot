...
#define BOARD_NAME                  "BD_MST129D_D01A_S"

//------Function to PIN mapping (PAD_MUX) --------------------------------------
#define PIN_SPI_CZ1                 BALL_A5
#define PIN_SPI_CZ2                 BALL_C5
...
#define PADS_VSYNC_VIF_OUT_EN       ENABLE           // ready
...
#define BALL_D2_IS_GPIO             GPIO_OUT_LOW	//Backlight On: Low / Off: High
...
#define BALL_V24_IS_GPIO            GPIO_OUT_LOW    //Mute On: Low / Off: High
...
#define AUDIO_SOURCE_SCART2         AUDIO_AUIN3_INPUT
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_high( BALL_Y22 )
#define Audio_Amplifier_OFF()           mdrv_gpio_set_low( BALL_Y22 )
