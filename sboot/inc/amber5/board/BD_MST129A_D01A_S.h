...
#define BOARD_NAME                  "BD_MST129A_D01A_S"

//------Function to PIN mapping (PAD_MUX) --------------------------------------
#define PIN_SPI_CZ1                 BALL_B1
#define PIN_SPI_CZ2                 BALL_C1
#define PIN_SPI_CZ3                 BALL_C2
#define PIN_FLASH_WP0               BALL_E1
...
#define BALL_D4_IS_GPIO     GPIO_OUT_LOW                // AUMUTE_OUT    ready
#define BALL_D7_IS_GPIO     GPIO_OUT_LOW                // AMP_STB-C     ready
#define BALL_C7_IS_GPIO     GPIO_OUT_HIGH               // PCM_PWR_CTRL  ready
#define BALL_E1_IS_GPIO     GPIO_OUT_HIGH               // FLASH-WPN1   ready
#define BALL_L5_IS_GPIO     GPIO_OUT_HIGH               // FLASH-WPN2   ready
#define BALL_B7_IS_GPIO     GPIO_IN                     // USB_OCD1     ready
#define BALL_D8_IS_GPIO     GPIO_IN                     // USB_OCD      ready
#define BALL_D5_IS_GPIO     GPIO_OUT_LOW                // MUTE_POP     ready
#define BALL_E4_IS_GPIO     GPIO_OUT_LOW                // ETH_RST      ready
#define BALL_AE12_IS_GPIO   GPIO_OUT_HIGH               // SIF_CTL      ready
#define BALL_AE11_IS_GPIO   GPIO_OUT_HIGH               // RF_AGC_CTL   ready
#define BALL_AG8_IS_GPIO    GPIO_IN                     // I2CM_SCL     ready
#define BALL_AE9_IS_GPIO    GPIO_IN                     // I2CM_SDA     ready
#define BALL_R26_IS_GPIO    GPIO_OUT_LOW                // Panel_ON     ready
#define BALL_T26_IS_GPIO    GPIO_OUT_LOW                // Pre-AMP_SD-C ready
#define BALL_R27_IS_GPIO    GPIO_OUT_LOW                // VBLCTRL      ready
#define BALL_T25_IS_GPIO    GPIO_OUT_LOW                // MUTE_S-C     ready
#define BALL_K4_IS_GPIO     GPIO_IN                     // EEPROM I2C   ready
#define BALL_K5_IS_GPIO     GPIO_IN                     // EEPROM I2C   ready
#define BALL_T27_IS_GPIO    GPIO_OUT_HIGH               // TUNER_RST    ready

//------Chip Type---------------------------------------------------------------
#include "chip/MSD896SCXF.h"
...
#define INPUT_HDMI1_MUX             INPUT_PORT_DVI2
...
//#else
#define SECAM_L_PRIME_ON()              mdrv_gpio_set_high( BALL_AE12 ) //GPIO60_SET(1)//_FUNC_NOT_USED()
#define SECAM_L_PRIME_OFF()             mdrv_gpio_set_low( BALL_AE12 ) //GPIO60_SET(0)//_FUNC_NOT_USED()
#define EXT_RF_AGC_ON()                 mdrv_gpio_set_high( BALL_AE11 ) // ATV mode: external RF AGC
#define EXT_RF_AGC_OFF()                mdrv_gpio_set_low( BALL_AE11 )  // DTV mode: internal RF AGC
...
// Audio Amplifier
#define Audio_Amplifier_ON()            mdrv_gpio_set_low( BALL_D7 )
#define Audio_Amplifier_OFF()           mdrv_gpio_set_high( BALL_D7  )

#define Adj_Volume_Off()                mdrv_gpio_set_high( BALL_T25 )
#define Adj_Volume_On()                 mdrv_gpio_set_low( BALL_T25 )

#define Panel_VCC_ON()                  mdrv_gpio_set_low( BALL_R26 )
#define Panel_VCC_OFF()                 mdrv_gpio_set_high( BALL_R26 )
#define Panel_Backlight_VCC_ON()        mdrv_gpio_set_low( BALL_R27 )
#define Panel_Backlight_VCC_OFF()       mdrv_gpio_set_high( BALL_R27 )
