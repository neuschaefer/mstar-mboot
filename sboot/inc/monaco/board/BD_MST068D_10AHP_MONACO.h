...
#define BOARD_NAME                              "BD_MST068D_10AHP_14222"
...
//=============I2C
#define BALL_K6_IS_GPIO                         GPIO_OUT_HIGH   //VB1 I2C_SCL (Software control)
#define BALL_L7_IS_GPIO                         GPIO_IN         //VB1 I2C_SDA (Software control)
#define BALL_C16_IS_GPIO                        GPIO_OUT_HIGH   //DDCR_CK: EEPROM I2C_SCL (Software control)
#define BALL_B16_IS_GPIO                        GPIO_IN         //DDCR_DA: EEPROM I2C_SDA (Software control)
#define BALL_AK5_IS_GPIO                        GPIO_OUT_HIGH   //TGPIO2: Tuner I2C_SCL (Software control)
#define BALL_AK6_IS_GPIO                        GPIO_IN         //TGPIO3: Tuner I2C_SDA (Software control)

#define BALL_AE2_IS_GPIO                        GPIO_OUT_LOW	 //FLASH-WPN1 (SPI_FLASH1 Write Protect)
//#define BALL_AH6_IS_GPIO                       GPIO_OUT_HIGH   //FLASH-WPN2 (SPI_FLASH2 Write Protect)

#define BALL_AJ6_IS_GPIO                        GPIO_IN         //MHL-CB-DET
#define BALL_AH5_IS_GPIO                        GPIO_OUT_LOW    //MHL-VBUS-EN (Low: Off / High: On)
...
#define BALL_AM2_IS_GPIO						GPIO_OUT_HIGH	//TGPIO1: Demod reset (Software control)
#define BALL_A15_IS_GPIO						GPIO_OUT_HIGH	//PWM2: Bright adjusts within panel (Software control)

//=============SAR
//#define BALL_J5_IS_GPIO							GPIO_IN			//SAR3: For core power control (Key0)
#define BALL_D1_IS_GPIO							GPIO_IN			//SAR5: Normally SAR5 need be 1V (Power_detect)
#define BALL_AJ4_IS_GPIO						GPIO_OUT_HIGH	//LED

//=============UART
//#define BALL_P5_IS_GPIO							GPIO_OUT_HIGH	//DDDCA_DA: UART for debug port (Software control)
//#define BALL_N5_IS_GPIO							GPIO_IN			//DDDCA_CK: UART for debug port (Software control)
#define BALL_A10_IS_GPIO						GPIO_OUT_HIGH	//UART1 for debug port (Software control)
#define BALL_C9_IS_GPIO							GPIO_IN			//UART1 for debug port (Software control)
#define BALL_M5_IS_GPIO							GPIO_IN			//UART for standby (Software control)
#define BALL_M6_IS_GPIO							GPIO_OUT_HIGH	//UART for standby (Software control)

//=============HDMI IO control
#define BALL_Y6_IS_GPIO							GPIO_OUT_HIGH	//ARC0: HDMI ARC (Software control)
#define BALL_T6_IS_GPIO							GPIO_IN			//CEC_2: HDMI CEC (Software control)
#define BALL_U5_IS_GPIO							GPIO_IN			//CEC_3: HDMI CEC (Software control)
//#define BALL_W6_IS_GPIO							GPIO_IN			//CEC_1: HDMI CEC (Software control)
//#define BALL_W3_IS_GPIO							GPIO_IN			//CEC: HDMI CEC (Software control)
#define BALL_F2_IS_GPIO							GPIO_IN			//SPI_CZ2: HDMI1_DEC (Software control)
#define BALL_H6_IS_GPIO							GPIO_IN			//SAR0: HDMI2_DEC (Software control)
#define BALL_F1_IS_GPIO							GPIO_IN			//SPI_CZ0: HDMI3_DEC (Software control)
#define BALL_AH4_IS_GPIO						GPIO_IN			//HDMI4_DEC (Software control)
//#define BALL_P4_IS_GPIO							GPIO_OUT_HIGH	//HOTPLUGC: HDMI Hot plug 1 (Software control)
//#define BALL_U6_IS_GPIO							GPIO_OUT_HIGH	//HOTPLUGD: HDMI Hot plug 2 (Software control)
//#define BALL_U4_IS_GPIO							GPIO_OUT_HIGH	//HOTPLUGB: HDMI Hot plug 3 (Software control)
#define BALL_V3_IS_GPIO							GPIO_OUT_LOW	//HOTPLUGA: HDMI Hot plug 4 (Software control)

//=============Other
#define BALL_G14_IS_GPIO						GPIO_OUT_HIGH	//SPDIF_OUT: Audio SPDIF output (Software control)
#define BALL_K4_IS_GPIO							GPIO_IN     	//IRIN: Remote control (Software control)
#define BALL_F14_IS_GPIO						GPIO_IN			//SPDIF_IN: 3D flag (Software control)
#define BALL_AD6_IS_GPIO						GPIO_IN			// 3D_LR IN From Panel (Software control)
#define BALL_E4_IS_GPIO							GPIO_OUT_HIGH	//PWM_PM: PWM control 3D Glasses (Software control)
#define BALL_A13_IS_GPIO						GPIO_OUT_LOW	// 3D EN (Software control)
#define BALL_D5_IS_GPIO							GPIO_OUT_HIGH	//VID0: VDDC Adjust (Software control)
#define BALL_C12_IS_GPIO						GPIO_OUT_HIGH	//EEPROM write protect (Low: Normal / High: Protected)
#define BALL_K5_IS_GPIO							GPIO_IN			//Scard_CDZ (Software control)
#define BALL_L6_IS_GPIO							GPIO_IN			//Scard_WP (Software control)
...
#define BALL_AH6_IS_GPIO						GPIO_OUT_LOW	//USB 3.0 Port0 Power Control (Low: Off / High: On)
#define BALL_AJ5_IS_GPIO						GPIO_OUT_LOW	//USB 3.0 Port1 Power Control (Low: Off / High: On)
//#define BALL_C18_IS_GPIO                        GPIO_OUT_LOW
...
//#define BALL_B17_IS_GPIO                        GPIO_OUT_LOW
...
#define REG_USB30_GPIO_BANK                     0xF
#define REG_USB30_GPIO_OFFSET                   0x1A //bit0~bit7 offset addr
#define REG_USB30_GPIO_BIT                      0x1  //bit8~bit10 bit count
...
#define REG_USB30_PORT2_GPIO_BANK               0xF
#define REG_USB30_PORT2_GPIO_OFFSET             0x22 //bit0~bit7 offset addr
#define REG_USB30_PORT2_GPIO_BIT                0x1  //bit8~bit10 bit count
...
// Audio Amplifier
#define Audio_Amplifier_ON()                    mdrv_gpio_set_low(BALL_AF4)
#define Audio_Amplifier_OFF()                   mdrv_gpio_set_high(BALL_AF4)
...
// Power Saving
#define Power_On()                              mdrv_gpio_set_high(BALL_AE3)
#define Power_Off()                             mdrv_gpio_set_low(BALL_AE3)
...
#define ADC_KEY_4_L0                            0x10    //0x27
#define ADC_KEY_4_L1                            0x2F    //0x47
#define ADC_KEY_4_L2                            0x4D    //0x63
#define ADC_KEY_4_L3                            0x71    //0x7B
#define ADC_KEY_4_L4                            0x92    //RFU
#define ADC_KEY_4_L5                            0xAB    //RFU
#define ADC_KEY_4_L6                            0xC3    //RFU
#define ADC_KEY_4_L7                            0xE7    //RFU
...
#define ADC_KEY_4_L0_FLAG                      IRKEY_POWER  //IRKEY_UP
#define ADC_KEY_4_L1_FLAG                      IRKEY_CHANNEL_PLUS
#define ADC_KEY_4_L2_FLAG                      IRKEY_CHANNEL_MINUS
#define ADC_KEY_4_L3_FLAG                      IRKEY_VOLUME_PLUS
#define ADC_KEY_4_L4_FLAG                      IRKEY_VOLUME_MINUS  //RFU
#define ADC_KEY_4_L5_FLAG                      IRKEY_SELECT  //RFU
#define ADC_KEY_4_L6_FLAG                      IRKEY_INPUT_SOURCE  //RFU
#define ADC_KEY_4_L7_FLAG                      IRKEY_MENU  //RFU
