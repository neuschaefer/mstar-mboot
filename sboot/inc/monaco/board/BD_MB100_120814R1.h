...
#define BOARD_NAME                              "BD_MB100_120814R1"
#define ENABLE_ILLUMINATED_LOGO
...
#define BALL_AH5_IS_GPIO                        GPIO_OUT_LOW   //MHL-VBUS-EN
...
#define BALL_A10_IS_GPIO                        GPIO_OUT_HIGH   //USB Port0 Power Control (Low: Enable / High: Disable)
#define BALL_M7_IS_GPIO                         GPIO_OUT_HIGH   //USB Port1 Power Control (Low: Enable / High: Disable)
#define BALL_A12_IS_GPIO                        GPIO_OUT_LOW    //USB Port2 Power Control (Low: Enable / High: Disable)

#define BALL_C11_IS_GPIO                        GPIO_OUT_HIGH    //PANEL_VCC_ON/OFF  Panel On: Low / Off: High
#define BALL_B10_IS_GPIO                        GPIO_OUT_HIGH    //BACKLIGHT_ON/OFF  Backlight On: Low / Off: High
#define BALL_B12_IS_GPIO                         GPIO_OUT_LOW    //MFC_RES //LOW:NORMAL HIGH:RESET
//=============================================================================
...
#define REG_USB30_GPIO_OFFSET                   0x11 //bit0~bit7 offset addr
...
#define REG_USB30_PORT2_GPIO_OFFSET             0x08 //bit0~bit7 offset addr
#define REG_USB30_PORT2_GPIO_BIT                0x0  //bit8~bit10 bit count
#define REG_USB30_PORT2_GPIO_LOW_ACTIVE         0x1  //Turn on 5V  ( 0:  GPIO High   1: GPIO Low) active
//=============================================================================
...
//=============================================================================
//MB100_BRINGUP
#define IR_TYPE_SEL                                     IR_TYPE_CUS08_VL   // IR_TYPE_MSTAR_DTV // IR_TYPE_CUS03_DTV // IR_TYPE_NEW
...
//------ PANEL RELATED ---------------------------------------------------------
#define GPIO_MFC_RESET_NORMAL()                 mdrv_gpio_set_low(BALL_B12);
#define GPIO_MFC_RESET_RESET()                  mdrv_gpio_set_high(BALL_B12);
#define Panel_VCC_ON()                          mdrv_gpio_set_low(BALL_C11)
#define Panel_VCC_OFF()                         mdrv_gpio_set_high(BALL_C11)
