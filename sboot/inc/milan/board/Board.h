...
//Milan
#define BD_MST999A_D01A_S               0x0999
#define BD_MILAN_FPGA          		      0x099F
...
#if defined(CONFIG_MSTAR_BD_MST999A_D01A_S)
    #define MS_BOARD_TYPE_SEL           BD_MST999A_D01A_S
#elif defined(CONFIG_MSTAR_TITANIA_BD_FPGA)
    #define MS_BOARD_TYPE_SEL           BD_MILAN_FPGA
#else
...
#if (MS_BOARD_TYPE_SEL == BD_MST999A_D01A_S)
    #include "BD_MST999A_D01A_S.h"
#elif (MS_BOARD_TYPE_SEL == BD_MILAN_FPGA)
    #include "BD_MILAN_FPGA.h"
#else
