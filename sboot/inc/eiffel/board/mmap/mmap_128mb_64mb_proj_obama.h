...
///////////////////////////////////////////////////////////////////////////////////////////////////
///
/// file    mmap_128mb_64mb_proj_obama.h
/// @brief  Memory mapping for 128MB+64MB RAM with project Obama
/// @author MStar Semiconductor Inc.
///////////////////////////////////////////////////////////////////////////////////////////////////
//#include <linux/undefconf.h>
//#include "../../../../../include/linux/undefconf.h"
#ifndef _MS_MMAP_128MB_64MB_PROJ_OBAMA_H_
#define _MS_MMAP_128MB_64MB_PROJ_OBAMA_H_
...
//tmperarily defined
#define CHAKRA_SUBSYSTEM_LEN        (0x4000000UL)

#ifndef CHAKRA_SUBSYSTEM_LEN
#define CHAKRA_SUBSYSTEM_LEN        0
#endif
...
#define LINUX_MEM_LEN				(0x600000) //6MB
...
#define VD_3DCOMB_LEN      			0x1000//4K //Temporary Setting Due to GOP1 conflict	(0x400000)//4MB
...
#define VE_FRAMEBUFFER_LEN			0x1000//4K //Temporary Setting Due to GOP1 conflict 0x195000UL	// 720*576*2*2
...
#define TTX_BUF_LEN					0x1000//4K //0x100000  //Temporary Setting Due to GOP1 conflict
...
#else
#define MPOOL_LEN					(0x400000UL)//(0x8000000 - MPOOL_ADR - 0x3A00000-0x400000 /*released from POSD0*/)
#endif
...
#define LINUX_MEM2_LEN			    ((MIU0_LEN-CHAKRA_SUBSYSTEM_LEN-64)-LINUX_MEM2_BASE_ADR) // reserve extra 64 byte for guarding

#define CHAKRA_SUBSYSTEM_ADR		(MIU0_LEN-CHAKRA_SUBSYSTEM_LEN)

#define MIU0_END_ADR                (CHAKRA_SUBSYSTEM_ADR+CHAKRA_SUBSYSTEM_LEN)//(LINUX_MEM2_BASE_ADR+LINUX_MEM2_BASE_LEN)//(MPOOL_ADR+MPOOL_LEN)
...
#define POSD0_LEN           	    0x1000000 //16MB
#else
#define POSD0_LEN           	    0x410000
#endif

#define POSD1_AVAILABLE             (POSD0_ADR + POSD0_LEN)
#define POSD1_ADR           	    MemAlign(POSD1_AVAILABLE, 0x1000) //4K aligned
#define POSD1_ADR_GAP_CHK   	    (POSD1_ADR-POSD1_AVAILABLE)
#define POSD1_LEN           	    0 // not used

#define CHAKRA_FW_AVAILABLE			(POSD1_ADR + POSD1_LEN)
#define CHAKRA_FW_ADR				MemAlign(CHAKRA_FW_AVAILABLE, 0x1000)
#define CHAKRA_FW_ADR_GAP_CHK		(CHAKRA_FW_ADR-CHAKRA_FW_AVAILABLE)
#define CHAKRA_FW_LEN				(0x800000UL)


#define MBOX_SHM_AVAILABLE			(CHAKRA_FW_ADR + CHAKRA_FW_LEN)
#define MBOX_SHM_ADR				MemAlign(MBOX_SHM_AVAILABLE, 0x1000)
#define MBOX_SHM_ADR_GAP_CHK		(MBOX_SHM_ADR-MBOX_SHM_AVAILABLE)
#define MBOX_SHM_LEN				(0x100000UL)

#define AUDIO_BIN_AVAILABLE  (MBOX_SHM_ADR+MBOX_SHM_LEN)
#define AUDIO_BIN_ADR MemAlign(AUDIO_BIN_AVAILABLE, 2*1024)
#define AUDIO_BIN_ADR_GAP_CHK   	    (AUDIO_BIN_ADR-AUDIO_BIN_AVAILABLE)
#define AUDIO_BIN_LENGTH 0x100000

#define GE_VQ_AVAILABLE                   (AUDIO_BIN_ADR+AUDIO_BIN_LENGTH)
#define GE_VQ_ADR                             MemAlign(GE_VQ_AVAILABLE, 0x1000)
#define GE_VQ_ADR_GAP_CHK		      (GE_VQ_ADR-GE_VQ_AVAILABLE)
#define GE_VQ_LEN				      (0x00080000)  //512k


#if ((GE_VQ_ADR+GE_VQ_LEN)>MIU_DRAM_LEN)
