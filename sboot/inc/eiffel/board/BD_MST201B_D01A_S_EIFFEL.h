...
#define BOARD_NAME                              "BD_MST201B_D01A_S_EIFFEL"

//=============================================================================
#define PIN_SPI_CZ1                             BALL_B7
#define PIN_SPI_CZ2                             BALL_D8
#define PIN_SPI_CZ3                             0
#define PIN_FLASH_WP0                           BALL_E8
#define PIN_FLASH_WP1                           BALL_A9
...
#define PADS_PCM1_CTRL                          UNKNOWN_PAD_MUX //Option: PAD_PCM_CE_N
#define PADS_PCM1_AD                            UNKNOWN_PAD_MUX //Option: PAD_PCM_D7
...
//=============================================================================
#define BALL_C18_IS_GPIO                        GPIO_OUT_LOW    //Panel
#define BALL_B11_IS_GPIO                        GPIO_OUT_LOW    //Backlight

#define BALL_F12_IS_GPIO                        GPIO_OUT_HIGH   //Audio
#define BALL_G9_IS_GPIO                         GPIO_OUT_LOW    //Mute
#define BALL_A4_IS_GPIO                         GPIO_OUT_HIGH   //MUTE-POP

#define BALL_A18_IS_GPIO                        GPIO_IN         //DDCR_CK: EEPROM I2C_SCL
#define BALL_B18_IS_GPIO                        GPIO_IN         //DDCR_DA: EEPROM I2C_SDA
#define BALL_U2_IS_GPIO                         GPIO_IN         //TGPIO2: Tuner I2C_SCL
#define BALL_U3_IS_GPIO                         GPIO_IN         //TGPIO3: Tuner I2C_SDA

#define BALL_E8_IS_GPIO                         GPIO_OUT_HIGH   //FLASH-WPN1 (SPI_FLASH1 Write Protect)
#define BALL_A9_IS_GPIO                         GPIO_OUT_HIGH   //FLASH-WPN2 (SPI_FLASH2 Write Protect)

#define BALL_A2_IS_GPIO                         GPIO_IN         //MHL-CB-DET
#define BALL_B1_IS_GPIO                         GPIO_OUT_HIGH   //MHL-VBUS-EN

//#define BALL_E14_IS_GPIO                      GPIO_OUT_LOW    //PCM_PWR_CTL (PCM power control)
#define BALL_F8_IS_GPIO                         GPIO_OUT_HIGH   //POWER_SW

#define BALL_B12_IS_GPIO                        GPIO_OUT_HIGH   //USB_CTL1
#define BALL_Y1_IS_GPIO                         GPIO_OUT_HIGH   //USB_CTL2
...
#define AUDIO_SOURCE_PC                         AUDIO_NULL_INPUT
...
// Audio Amplifier
#define Audio_Amplifier_ON()                    mdrv_gpio_set_high(BALL_F12)
#define Audio_Amplifier_OFF()                   mdrv_gpio_set_low(BALL_F12)

#define Adj_Volume_Off()                        mdrv_gpio_set_high(BALL_G9)
#define Adj_Volume_On()                         mdrv_gpio_set_low(BALL_G9)

//------ PANEL RELATED ---------------------------------------------------------
#define Panel_VCC_ON()                          mdrv_gpio_set_low(BALL_C18)
#define Panel_VCC_OFF()                         mdrv_gpio_set_high(BALL_C18)
#define Panel_Backlight_VCC_ON()                mdrv_gpio_set_low(BALL_B11)
#define Panel_Backlight_VCC_OFF()               mdrv_gpio_set_high(BALL_B11)
