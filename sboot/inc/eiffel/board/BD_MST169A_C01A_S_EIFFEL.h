...
#define BOARD_NAME                              "BD_MST169A_C01A_S_EIFFEL"

//=============================================================================
#define PIN_SPI_CZ1                             BALL_F15
#define PIN_SPI_CZ2                             BALL_E15
#define PIN_SPI_CZ3                             0
#define PIN_FLASH_WP0                           BALL_B12
#define PIN_FLASH_WP1                           BALL_C13
...
#define PAD_PCM                                 0x08
#define PAD_PCM2                                0x09
#define PAD_DDCR                                0x0A
#define PAD_IIC                                 0x0B
#define PAD_I2S                                 0x0C
#define PAD_TCON                                0x0D
#define PADS_GPIO                               0x0E
#define PAD_PCM_A_DQS                           0x0F
...
#define PADS_TSERR_OUT                          UNKNOWN_PAD_MUX //Option: ENABLE / DISABLE

#if defined(CONFIG_NAND_FLASH)
#define PADS_NAND_MODE                          PAD_PCM_A       //Option: PAD_PCM_A / PAD_PCM_D / PAD_TS2 / PAD_PCM_A_DQS
...
#define PADS_SD0_MODE                           UNKNOWN_PAD_MUX //Option: PAD_PCM_D / PAD_TS2 / PAD_SPI1
#define PADS_SD1_MODE                           UNKNOWN_PAD_MUX //Option: PAD_PCM_D / PAD_TS2
...
#define PADS_PCM2_CTRL                          PAD_PCM2_CD_N   //Option: PAD_PCM2_CD_N
...
#define PADS_I2S_OUT                            ENABLE          //Option: ENABLE / DISABLE
...
#define PADS_I2S_MUTE                           UNKNOWN_PAD_MUX //Option: ENABLE / DISABLE
...
#define PADS_3D_FLAG_CONFIG                     UNKNOWN_PAD_MUX //Option: PAD_SPDIF_IN / PAD_GPIO2 / PAD_I2S_IN_SD
#define PADS_LED_MODE                           ENABLE          //Option: ENABLE / DISABLE

#define PADS_UART2_MODE                         UNKNOWN_PAD_MUX //Option: PAD_TS0 / PAD_PCM2 / PAD_GPIO
#define PADS_UART3_MODE                         UNKNOWN_PAD_MUX //Option: PAD_GPIO / PAD_I2S / PAD_PCM2
#define PADS_UART4_MODE                         UNKNOWN_PAD_MUX //Option: PAD_TS2 / PAD_GPIO / PAD_I2S
#define PADS_FAST_UART_MODE                     UNKNOWN_PAD_MUX //Option: PAD_GPIO1 / PAD_GPIO2 / PAD_TCON / PAD_GPIO13 / PAD_GPIO14
...
#define PADS_MIIC_MODE0                         UNKNOWN_PAD_MUX //Option: PAD_GPIO19 / PAD_GPIO20
#define PADS_MIIC_MODE1                         UNKNOWN_PAD_MUX //Option: PAD_TGPIO2 / PAD_TGPIO3
#define PADS_MIIC_MODE2                         UNKNOWN_PAD_MUX //Option: PAD_I2S_IN_BCK / PAD_I2S_IN_SD

#define PADS_SM_MODE                            UNKNOWN_PAD_MUX //Option: SMART_CARD_PCM / SMART_CARD_TS1
#define PADS_SMART_CARD_VCC                     UNKNOWN_PAD_MUX //Option: SMART_CARD_VCC_3P3V / SMART_CARD_VCC_5V
#define PADS_PDTRACE_MODE                       UNKNOWN_PAD_MUX //Option: PADS_TS1 / PADS_GPIO
...
//=============================================================================
#define BALL_D14_IS_GPIO                        GPIO_OUT_LOW    //Panel
#define BALL_F18_IS_GPIO                        GPIO_OUT_HIGH    //Backlight high off/low on

#define BALL_B21_IS_GPIO                        GPIO_OUT_HIGH   //Audio
#define BALL_F8_IS_GPIO                         GPIO_OUT_LOW    //Mute
#define BALL_B10_IS_GPIO                        GPIO_OUT_HIGH   //MUTE-POP

#define BALL_E13_IS_GPIO                        GPIO_IN         //DDCR_CK: EEPROM I2C_SCL
#define BALL_F13_IS_GPIO                        GPIO_IN         //DDCR_DA: EEPROM I2C_SDA
#define BALL_U2_IS_GPIO                         GPIO_IN         //TGPIO2: Tuner I2C_SCL
#define BALL_U3_IS_GPIO                         GPIO_IN         //TGPIO3: Tuner I2C_SDA

#define BALL_B12_IS_GPIO                        GPIO_OUT_HIGH   //FLASH-WPN1 (SPI_FLASH1 Write Protect)
#define BALL_C13_IS_GPIO                        GPIO_OUT_HIGH   //FLASH-WPN2 (SPI_FLASH2 Write Protect)

#define BALL_E8_IS_GPIO                         GPIO_IN         //MHL-CB-DET
#define BALL_F9_IS_GPIO                         GPIO_OUT_HIGH   //MHL-VBUS-EN

#define BALL_E14_IS_GPIO                        GPIO_OUT_LOW    //PCM_PWR_CTL (PCM power control)
#define BALL_B11_IS_GPIO                        GPIO_OUT_HIGH   //POWER_SW

#define BALL_G22_IS_GPIO                        GPIO_OUT_HIGH   //USB_CTL
#define BALL_F14_IS_GPIO                        GPIO_OUT_HIGH   //USB_CTL1
#define BALL_B18_IS_GPIO                        GPIO_OUT_HIGH   //USB_CTL2
#define BALL_A18_IS_GPIO                        GPIO_OUT_LOW   //USB_CTL3
...
#define CONFIG_SIDD_THRESHOLD_0                 327     //0x0000FFFF: Unused
...
#define CONFIG_OSC_THRESHOLD_0                  116     //0x0000FFFF: Unused
...
#define INPUT_TV_YMUX                           INPUT_PORT_NONE_PORT
...
// Audio Amplifier
#define Audio_Amplifier_ON()                    mdrv_gpio_set_high(BALL_B21)
#define Audio_Amplifier_OFF()                   mdrv_gpio_set_low(BALL_B21)

#define Adj_Volume_Off()                        mdrv_gpio_set_low(BALL_F8)
#define Adj_Volume_On()                         mdrv_gpio_set_high(BALL_F8)

//------ PANEL RELATED ---------------------------------------------------------
#define Panel_VCC_ON()                          mdrv_gpio_set_low(BALL_D14)
#define Panel_VCC_OFF()                         mdrv_gpio_set_high(BALL_D14)
#define Panel_Backlight_VCC_ON()                mdrv_gpio_set_low(BALL_F18)
#define Panel_Backlight_VCC_OFF()               mdrv_gpio_set_high(BALL_F18)
...
#define PCMCIA_VCC_ON()                         mdrv_gpio_set_high(BALL_E14)
#define PCMCIA_VCC_OFF()                        mdrv_gpio_set_low(BALL_E14)
