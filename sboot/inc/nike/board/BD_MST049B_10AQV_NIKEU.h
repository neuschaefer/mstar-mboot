...
#define BOARD_NAME                              "BD_MST049B_10AQV_NIKEU"
...
//=============================================================================
#define BALL_F3_IS_GPIO                         GPIO_OUT_HIGH   //SDIO_WF_C
//#define BALL_H6_IS_GPIO                       GPIO_OUT_LOW   

#define BALL_F2_IS_GPIO                         GPIO_IN         //Glass_Sync
#define BALL_M6_IS_GPIO                         GPIO_OUT_HIGH   //Backlight (Low: Off / High: On)
#define BALL_N6_IS_GPIO                         GPIO_OUT_HIGH   //GPIO_OUT_LOW    //panel on/off (Low: Off / High: On)
...
#define BALL_L6_IS_GPIO                         GPIO_OUT_HIGH   //AMP-MUTE(H : ON(Mute) , L :Off)
...
#define BALL_AF21_IS_GPIO                       GPIO_OUT_LOW    //3D glasses launch

#define BALL_H5_IS_GPIO                         GPIO_OUT_HIGH   //POWER_SW (Low: Off / High: On)

#define BALL_M24_IS_GPIO                        GPIO_OUT_HIGH   //USB3_EN (Low: Disable / High: Enable)

#define BALL_AG21_IS_GPIO                       GPIO_OUT_HIGH   //EEPROM WP (Low: On / High: Off)
#define BALL_AG2_IS_GPIO                        GPIO_OUT_HIGH   //SD_WP  
#define BALL_AG6_IS_GPIO                        GPIO_OUT_HIGH   //SDIO_WP  
#define BALL_J6_IS_GPIO                         GPIO_OUT_HIGH   //SDIO_WF_D  

#define BALL_M23_IS_GPIO                        GPIO_OUT_LOW    //3D_EN_CTL
#define BALL_J5_IS_GPIO                         GPIO_OUT_LOW    //PM_LED (H : ON,  L : OFF)
#define BALL_J4_IS_GPIO                         GPIO_IN         //Configuration PIN

#define BALL_AC24_IS_GPIO                       GPIO_OUT_HIGH   //GPIO3/EJTAG RESET
#define BALL_AD24_IS_GPIO                       GPIO_OUT_HIGH   //Demod_RST  

#define PAD_GPIO23_IS_GPIO                      GPIO_OUT_HIGH   //Ukulele Chip Config
#define PAD_GPIO10_IS_GPIO                      GPIO_OUT_LOW    //Ukulele Chip Config
#define PAD_GPIO9_IS_GPIO                       GPIO_OUT_LOW    //Ukulele Chip Config
#define PAD_GPIO22_IS_GPIO                      GPIO_OUT_HIGH   //Ukulele Reset
...
#define CONFIG_VID_POWER_LEVEL_0                0xFFFF  //Lower Power for DVFS
#define CONFIG_VID_POWER_LEVEL_1                0x0001  //Higher Power for DVFS
#define CONFIG_VID_POWER_LEVEL_2                0x0002  //Higher Power for DVFS
#define CONFIG_VID_POWER_LEVEL_3                0x0003  //Higher Power for DVFS

#if ((CONFIG_VID_USE_SIDD == 1) || (CONFIG_VID_USE_SIDD == 2))
#define CONFIG_SIDD_THRESHOLD_0                 275     //0x0000FFFF: Unused
#define CONFIG_SIDD_THRESHOLD_0_1               310     //0x0000FFFF: Unused
...
#define CONFIG_OSC_THRESHOLD_0                  126     //0x0000FFFF: Unused
...
#define INPUT_YPBPR2_MUX                        INPUT_PORT_ANALOG2
...
#define AUDIO_SOURCE_YPBPR2                     AUDIO_AUIN0_INPUT
...
// Audio Amplifier
#define Audio_Amplifier_ON()                    mdrv_gpio_set_low(BALL_L6)
#define Audio_Amplifier_OFF()                   mdrv_gpio_set_high(BALL_L6)

#define Adj_Volume_Off()                        _FUNC_NOT_USED()//mdrv_gpio_set_high(BALL_M6)
#define Adj_Volume_On()                         _FUNC_NOT_USED()//mdrv_gpio_set_low(BALL_M6)
...
#define PCMCIA_VCC_ON()                         _FUNC_NOT_USED()//mdrv_gpio_set_high(BALL_AF21)
#define PCMCIA_VCC_OFF()                        _FUNC_NOT_USED()//mdrv_gpio_set_low(BALL_AF21)
...
#define ADC_KEY_L0                              0xF//0x12
#define ADC_KEY_L1                              0x2E//0x36
#define ADC_KEY_L2                              0x4C//0x56
#define ADC_KEY_L3                              0x70//0x7B
#define ADC_KEY_L4                              0x91//0x92
#define ADC_KEY_L5                              0xAA//0xAB
#define ADC_KEY_L6                              0xC1//0xC3
#define ADC_KEY_L7                              0xE5//0xE7
...
#define USB_MBOOT_VERSION                 "MBOT-02.05_U"
