...
#define MMC_DEFAULT_PARTITION UNNECESSARY_PARTITION
#define MMC_DEFAULT_VOLUME "MPOOL"
...
#define FLASH_MBOOT_PARTITION MMC_DEFAULT_PARTITION
#define FLASH_MBOOT_VOLUME "MBOOT"
#else
