...
#define MSIF_TSP_BUILDNUM           {'4','5'}                                                       // Build Number
#define MSIF_TSP_CHANGELIST         {'0','0','6','0','4','0','7','9'}                               // P4 ChangeList Number
...
typedef enum
{
    ...
    E_DRVTSP_CAP_MMFI_AUDIO_FILTER_NUM, // Get MM file in audio path filter number
    E_DRVTSP_CAP_MMFI_V3D_FILTER_NUM,   // Get MM file in video 3D path filter number
...
// DRV_CMD_PVR_TIMESTAMP_27M: Enable PVR timestamp clock 27M
TSP_Result MDrv_TSP_CMD_Run(MS_U32 u32Cmd, MS_U32 u32Config0, MS_U32 u32Config1 ,void *pData);
#define DRV_CMD_PVR_TIMESTAMP_27M        0x00000001 //u32Config0: 0-> Disable, 1-> Enable; u32Config1,pData: Don't care
