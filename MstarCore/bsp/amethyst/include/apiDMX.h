...
#define MSIF_DMX_CHANGELIST                   {'0','0','6','0','4','0','7','9'} //P4 ChangeList Number
...
#define DMX_FILTER_FLT_MASK                     0xF0E00000
#define DMX_FILTER_SOURCE_TYPE_MASK             0xF0E00000                   ///< DMX filter source mask
...
// DMX_CMD_PVR_TIMESTAMP_27M: Enable PVR timestamp clock 27M
DMX_FILTER_STATUS MApi_DMX_CMD_Run(MS_U32 u32Cmd, MS_U32 u32Config, MS_U32 u32DataNum, void *pData);
#define DMX_CMD_PVR_TIMESTAMP_27M        0x00000001 //u32Config0: 0-> Disable, 1-> Enable; u32Config1,pData: Don't care
