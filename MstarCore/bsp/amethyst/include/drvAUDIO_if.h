...
typedef enum
{
    ...
    E_CAPTURE_ADC,                  ///< Data from ADC input port
...
typedef enum
{
    ...
    MSAPI_AUD_ATV_PAL_42M,              ///< 0xB4: System=PALSUM_42M
    MSAPI_AUD_ATV_PAL_44M,              ///< 0xB5: System=PALSUM_44M
    MSAPI_AUD_ATV_FM_RADIO,             ///< 0xB6: System=FM_RADIO
    MSAPI_AUD_ATV_MAX
...
typedef enum
{
  /*********  New Interface ********/
    ...
    /*  請在上面加 ADEC 1 的cmd，且確認ADEC 1/2/3                      */
    /*  都有一樣的cmd 且順序一樣                                       */
    /*******************************************************************/
    ...
    /*  請在上面加 ADEC 2 的cmd，且確認ADEC 1/2/3          */
    /*  都有一樣的cmd 且順序一樣                           */
    /*******************************************************/
    ...
    /*******************************************************/
    /* If you want add new cmd below,                      */
    /* Please make sure ADEC 1 / 2/ 3 have "same" cmd in   */
    /* "same" order"                                       */
    /*******************************************************/
    ...
    /*  請在上面加 ADEC 3 的cmd，且確認ADEC 1/2/3          */
    /*  都有一樣的cmd 且順序一樣                           */
    /*******************************************************/
    ...
    /*  General audio cmd  */
    /****************************************************/
    Audio_Comm_infoType_DecStatus = 0,
    ...
    Audio_Comm_infoType_DEC2_BufferAddr,
    ...
    Audio_Comm_infoType_setNR_Threshold,
    ...
    Audio_Comm_infoType_Set_UNI_NEED_DECODE_FRMCNT,
...
{
    E_TOTSON_STANDARD_TABLE        = 0,
    E_TOTSON_STANDARD_WALL,
    E_TOTSON_NEWS_TABLE,
    E_TOTSON_NEWS_WALL,
    E_TOTSON_MOVIE_TABLE,
    E_TOTSON_MOVIE_WALL,
    E_TOTSON_MUSIC_TABLE,
    E_TOTSON_MUSIC_WALL,
} EN_DBXTV_TotSonMode;
