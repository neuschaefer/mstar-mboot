...
typedef enum
{
    ...
    E_DSCMB_KL_SRC_PRIVATE_0        =   6,
    /// Key ladder source from Private_1
    E_DSCMB_KL_SRC_PRIVATE_1        =   8,
    /// Key ladder source from Private_2
    E_DSCMB_KL_SRC_PRIVATE_2        =   9,
...
typedef enum
{
    ...
    /// Key ladder destination to private 0 
    E_DSCMB_KL_DST_PRIVATE0         =   0x20,
    /// Key ladder destination to private 1 
    E_DSCMB_KL_DST_PRIVATE1         =   0x40,
    /// Key ladder destination to private 2 
    E_DSCMB_KL_DST_PRIVATE2         =   0x80,        
