...
#define MSIF_DMX_CHANGELIST                   {'0','0','5','5','9','0','7','6'} //P4 ChangeList Number
...
#define DMX_FILTER_FLT_MASK                     0xF0FF0000
...
#define DMX_FILTER_SOURCE_TYPE_TSIF0            DMX_FILTER_SOURCE_TYPE_LIVE
#define DMX_FILTER_SOURCE_TYPE_TSIF1            DMX_FILTER_SOURCE_TYPE_TS1
#define DMX_FILTER_SOURCE_TYPE_TSIF2            DMX_FILTER_SOURCE_TYPE_TS2
#define DMX_FILTER_SOURCE_TYPE_TSIF3            DMX_FILTER_SOURCE_TYPE_TS3
...
typedef enum
{
    DMX_DEBUG_MODE_DIS_CONT,
    DMX_DEBUG_MODE_DROP_CONT,
} DMX_DEBUG_MODE;
...
typedef enum
{
    ...
    DMX_FLOW_INPUT_TSIF0,               ///< Kaiser Path TSIF 0
    DMX_FLOW_INPUT_TSIF1,               ///< Kaiser Path TSIF 1
    DMX_FLOW_INPUT_TSIF2,               ///< Kaiser Path TSIF 2
    DMX_FLOW_INPUT_TSIF3,               ///< Kaiser Path TSIF 3
    DMX_FLOW_INPUT_TSIF01_FILE,         ///< Kaiser Path for tsif0,1 filein
    DMX_FLOW_INPUT_TSIF23_FILE,         ///< Kaiser Path for tsif2,3 filein
    DMX_FLOW_INPUT_MMFI0,               ///< Kaiser Path for MMFI0
    DMX_FLOW_INPUT_MMFI1,               ///< Kaiser Path for MMFI0
} DMX_FLOW_INPUT;
...
// General API
DMX_FILTER_STATUS MApi_DMX_InitLibResource(void *pu32ResMemAddr);
...
DMX_FILTER_STATUS MApi_DMX_STC_UpdateCtrl(MS_U8 u8Eng, MS_BOOL bEnable);
...
DMX_FILTER_STATUS MApi_DMX_Get_DisContiCnt(DMX_DEBUG_CMD TspCmd, DMX_DEBUG_SRC TspSrc, DMX_DEBUG_FIFO TspFifo, MS_U32 *pu32Cnt);
DMX_FILTER_STATUS MApi_DMX_Get_DropPktCnt(DMX_DEBUG_CMD TspCmd, DMX_DEBUG_SRC TspSrc, DMX_DEBUG_FIFO TspFifo, MS_U32 *pu32Cnt);
DMX_FILTER_STATUS MApi_DMX_Get_LockPktCnt(DMX_DEBUG_CMD TspCmd, DMX_DEBUG_TSIF TspTsif, MS_U32 *pu32Cnt);
DMX_FILTER_STATUS MApi_DMX_Get_AVPktCnt(DMX_DEBUG_CMD TspCmd, DMX_DEBUG_FIFO TspFifo, MS_U32 *pu32Cnt);
//-----------------------------------------------------
