...
typedef enum{
    ...
    E_XC_OP1_PURE_GREY_PATTERN,                 // 6: gray
    E_XC_OP1_PURE_COLOR_V_BAR_PATTERN,          // 7: vertical color-bar 
    E_XC_OP1_PURE_COLOR_H_BAR_PATTERN,          // 8: horizontal color-bar
    E_XC_OP1_PURE_GREY_BAR_16_PATTERN,          // 9: 16 vertical gray-bar 
    E_XC_OP1_PURE_GREY_BAR_32_PATTERN,          // 10: 32 vertical gray-bar 
    E_XC_OP1_PURE_GREY_BAR_64_PATTERN,          // 11: 64 vertical gray-bar 
    E_XC_OP1_PURE_GREY_RGB_32_PATTERN,          // 12: 32 vertical 4 color bar 
    E_XC_OP1_PURE_RGB_CHECKERBOARD_PATTERN,     // 13: 3x3 checkerboard R/B/G
    E_XC_OP1_DOAFADE_GRAY_PATTERN,              // 14: dotfade gary 
    E_XC_OP1_CALIBRATION_COLOR_DOTFADE_PATTERN, // 15: checkerboard + dotfade gary
    E_XC_OP1_CALIBRATION_PATTERN,               // 16: checkerboard 
    E_XC_OP1_PATTERN_1,                         // 17 
    E_XC_OP1_PATTERN_2,                         // 18: 
    E_XC_OP1_PATTERN_3,                         // 19: same as pattern2, but not full screen 
    E_XC_OP1_3D_PATTERN,                        // 20: side-by-side, if enable 3D effect, can see the word "3D" 
    E_XC_OP1_PURE_RED_100IRE_PATTERN,           // 21: red 
    E_XC_OP1_PURE_GREEN_100IRE_PATTERN,         // 22: green
    E_XC_OP1_PURE_BLUE_100IRE_PATTERN,          // 23: blue
    E_XC_OP1_PURE_RED_70IRE_PATTERN,            // 24 
    E_XC_OP1_PURE_GREEN_70IRE_PATTERN,          // 25  
    E_XC_OP1_PURE_BLUE_70IRE_PATTERN,           // 26
    E_XC_OP1_PURE_RED_40IRE_PATTERN,            // 27
    E_XC_OP1_PURE_GREEN_40IRE_PATTERN,          // 28
    E_XC_OP1_PURE_BLUE_40IRE_PATTERN,           // 29
    E_XC_OP1_PURE_RED_20IRE_PATTERN,            // 30
    E_XC_OP1_PURE_GREEN_20IRE_PATTERN,          // 31
    E_XC_OP1_PURE_BLUE_20IRE_PATTERN,           // 32
    E_XC_OP1_PURE_RED_10IRE_PATTERN,            // 33
    E_XC_OP1_PURE_GREEN_10IRE_PATTERN,          // 34
    E_XC_OP1_PURE_BLUE_10IRE_PATTERN,           // 35
    E_XC_OP1_PURE_WHITE_100IRE_PATTERN,         // 36
    E_XC_OP1_PURE_WHITE_90IRE_PATTERN,          // 37
    E_XC_OP1_PURE_WHITE_80IRE_PATTERN,          // 38
    E_XC_OP1_PURE_WHITE_70IRE_PATTERN,          // 39
    E_XC_OP1_PURE_WHITE_60IRE_PATTERN,          // 40
    E_XC_OP1_PURE_WHITE_50IRE_PATTERN,          // 41
    E_XC_OP1_PURE_WHITE_40IRE_PATTERN,          // 42
    E_XC_OP1_PURE_WHITE_30IRE_PATTERN,          // 43
    E_XC_OP1_PURE_WHITE_20IRE_PATTERN,          // 44
    E_XC_OP1_PURE_WHITE_10IRE_PATTERN,          // 45
    E_XC_OP1_PURE_GAMMA_GREY1_PATTERN,          // 46: gray 
    E_XC_OP1_PURE_GAMMA_GREY2_PATTERN,          // 47: gray 
    E_XC_OP1_PURE_RGB_CHECKERBOARD_PATTERN_2,   // 48: 3x3 checkerboard R/G/B
}E_XC_OP1_PATTERN;
...
//-------------------------------------------------------------------------------------------------
E_APIXC_ReturnValue MApi_XC_Set_OP1_TestPattern(E_XC_OP1_PATTERN ePattern, E_XC_OP1_PATGEN_MODE eMode);
