...
#define MSIF_GOP_LIBVER                     {'8','6'}            //LIB version
#define MSIF_GOP_BUILDNUM                   {'0','7'}            //Build Number
#define MSIF_GOP_CHANGELIST                 {'0','0','5','6','7','0','2','4'} //P4 ChangeList Number
...
E_GOP_API_Result MApi_GOP_Set3DOSDMode(MS_U8 u8Gwin, MS_U16 u16MainFBId, MS_U16 u16SubFBId,EN_GOP_3D_MODETYPE EN_3DOSD_Mode);
