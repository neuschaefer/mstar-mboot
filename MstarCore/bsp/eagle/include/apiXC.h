...
#define MSIF_XC_LIBVER                 {'0','8'}
#define MSIF_XC_BUILDNUM               {'7','1'}
#define MSIF_XC_CHANGELIST             {'0','0','5','6','9','5','9','3'}
...
typedef enum
{
    ...
    INPUT_SOURCE_NUM,           ///<39 number of the source
...
typedef enum
{
    ...
    E_LD_PANEL_TOSHIBA_LR16 = 0x5,
    E_LD_PANEL_TOSHIBA_TB16 = 0x6,
    E_LD_PANEL_LG50inchCinema_TB32 = 0x8,
    E_LD_PANEL_LG60inchCinema_TB32 = 0x9,
    E_LD_PANEL_LG47inch_Direct72 = 0xA,
    E_LD_PANEL_LG55inch_Direct96 = 0xB,
    E_LD_PANEL_LG72inch_Direct480 = 0xC,
    E_LD_PANEL_LG55inch_LR12 = 0xD,
...
/// @return E_APIXC_RET_OK or E_APIXC_RET_FAIL
//-------------------------------------------------------------------------------------------------
MS_BOOL MApi_XC_LD_SetPanelType(Eun_LD_PANEL_TYPE eLdPanelType );
//-------------------------------------------------------------------------------------------------
/// set LD Level
