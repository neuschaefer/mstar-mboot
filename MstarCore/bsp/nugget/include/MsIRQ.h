...
typedef enum
{
    ...
    E_INT_IRQ_UART3                     = E_INT_IRQ_0x100_START+3,  //Nugget
    E_INT_IRQ_TIMER2                    = E_INT_IRQ_0x100_START+4,  //Nugget
    E_INT_FIQ_8051_TO_SECURER2          = E_INT_IRQ_0x100_START+5,  //Nugget
    E_INT_FIQ_AEON_TO_SECURER2          = E_INT_IRQ_0x100_START+6,  //Nugget
    E_INT_FIQ_BEON_TO_SECURER2          = E_INT_IRQ_0x100_START+7,  //Nugget
    E_INT_FIQ_SECURER2_TO_BEON          = E_INT_IRQ_0x100_START+8,  //Nugget
    E_INT_FIQ_SECURER2_TO_AEON          = E_INT_IRQ_0x100_START+9,  //Nugget
    E_INT_FIQ_SECURER2_TO_8051          = E_INT_IRQ_0x100_START+10, //Nugget
