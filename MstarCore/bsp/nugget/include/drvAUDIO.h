...
//================================================================
DLL_PUBLIC void   MDrv_AUDIO_WriteDecMailBox(MS_U8 paramNum, MS_U16 data1);
...
//================================================================
DLL_PUBLIC MS_BOOL MDrv_AUDIO_Close(void);
DLL_PUBLIC MS_BOOL MDrv_AUDIO_Open(void);
DLL_PUBLIC void    MDrv_AUDIO_SetDspBaseAddr(MS_U8 u8Index, MS_U32 u32Bin_Base_Address, MS_U32 u32Mad_Base_Buffer_Adr);
DLL_PUBLIC void    MDrv_AUDIO_TriggerSifPLL(void);
DLL_PUBLIC MS_U32  MDrv_AUDIO_GetDspMadBaseAddr(MS_U8 u8Index) ;
...
//================================================================
DLL_PUBLIC AUDIO_PATH_GROUP_TYPE  MDrv_AUDIO_GetPathGroup(void);
DLL_PUBLIC void    MDrv_AUDIO_SetNormalPath(AUDIO_PATH_TYPE u8Path, AUDIO_INPUT_TYPE u8Input, AUDIO_OUTPUT_TYPE output);
DLL_PUBLIC void    MDrv_AUDIO_SetPowerDownWait(MS_BOOL bEnable);
...
//=====================================================
DLL_PUBLIC void    MDrv_AUDIO_HDMI_AC3_PathCFG(MS_U8 u8Ctrl);
