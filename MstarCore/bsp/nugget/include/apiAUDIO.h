...
//============================================================
DLL_PUBLIC void    MApi_AUDIO_SetPowerOn(MS_BOOL bFlag);
DLL_PUBLIC void    MApi_AUDIO_Initialize(void);
DLL_PUBLIC void    MApi_AUDIO_SetSystemInfo(AUDIO_INIT_INFO *pau_info);
DLL_PUBLIC void    MApi_Audio_Monitor(void);
DLL_PUBLIC void    MApi_AUDIO_SetOutConnectivity(void);
DLL_PUBLIC void    MApi_AUDIO_SetPathInfo(AUDIO_PATH_INFO *path_info);
DLL_PUBLIC void    MApi_AUDIO_SetOutputInfo(AUDIO_OUT_INFO *pout_info);
DLL_PUBLIC void    MApi_AUDIO_SetSourceInfo(AUDIO_SOURCE_INFO_TYPE eSourceType);
DLL_PUBLIC void    MApi_AUDIO_InputSwitch(AUDIO_INPUT_TYPE enSource, AUDIO_SWITCH_GROUP enGroup);
DLL_PUBLIC void   MApi_AUDIO_SetOutputSourceInfo(OUTPUT_SOURCE_INFO *pSourceInfo);
DLL_PUBLIC void   MApi_AUDIO_GetOutputSourceInfo(OUTPUT_SOURCE_INFO *pSourceInfo);
DLL_PUBLIC void    MApi_AUDIO_ExitAudioSystem(void);
DLL_PUBLIC void    MApi_AUDIO_SendIntrupt(MS_BOOL bDspType,MS_U8 u8Cmd);
DLL_PUBLIC void    MApi_AUDIO_WritePreInitTable(void);            //Refine power on sequence for earphone & DAC pop noise issue
DLL_PUBLIC MS_BOOL MApi_AUDIO_SetDataCaptureSource(AUDIO_DEVICE_TYPE eID, AUDIO_CAPTURE_SOURCE_TYPE eSource);
DLL_PUBLIC void    MApi_AUDIO_I2S_SetMode(AUDIO_I2S_MODE_TYPE u8Mode, AUDIO_I2S_MODE_VALUE  u8Val);
...
//=============================================================
DLL_PUBLIC MS_BOOL MApi_SND_ProcessEnable(Sound_ENABLE_Type Type, MS_BOOL enable);
DLL_PUBLIC MS_BOOL MApi_SND_SetParam1( Sound_SET_PARAM_Type Type, MS_U16 param1, MS_U16 param2);
DLL_PUBLIC MS_U16  MApi_SND_GetParam1( Sound_GET_PARAM_Type Type, MS_U16 param1);
DLL_PUBLIC MS_BOOL MApi_AUDIO_SOUND_SetParam( Sound_SET_Type Type, MS_U32 *p_param );
DLL_PUBLIC void    MApi_AUDIO_SetAbsoluteVolume( MS_U8 u8Path, MS_U8 u8Vol1, MS_U8 u8Vol2 );
DLL_PUBLIC void    MApi_AUDIO_SetPreScale ( MS_U8 u8Path, MS_U8 u8PreScale );
DLL_PUBLIC void    MApi_AUDIO_SetMute( MS_U8 u8Path, MS_BOOL EnMute);
DLL_PUBLIC void    MApi_AUDIO_SetBalance ( MS_U8 u8Balance );
DLL_PUBLIC void    MApi_AUDIO_EnableEQ ( MS_BOOL EnEQ );
DLL_PUBLIC void    MApi_AUDIO_EnableTone ( MS_BOOL EnTone );
DLL_PUBLIC void    MApi_AUDIO_EnableAutoVolume ( MS_BOOL EnAVL );
DLL_PUBLIC void    MApi_AUDIO_EnableSurround ( MS_BOOL EnSurround );
DLL_PUBLIC void    MApi_AUDIO_EnableBalance( MS_U8 EnBalance );
DLL_PUBLIC void    MApi_AUDIO_SetBass( MS_U8 u8Bass );
DLL_PUBLIC void    MApi_AUDIO_AbsoluteBass( MS_U8 u8Bass );
DLL_PUBLIC void    MApi_AUDIO_SetTreble( MS_U8 u8Treble );
DLL_PUBLIC void    MApi_AUDIO_AbsoluteTreble( MS_U8 u8Treble );
DLL_PUBLIC void    MApi_AUDIO_SetEq(MS_U8 u8band, MS_U8 u8level);
DLL_PUBLIC void    MApi_AUDIO_SetEq_7band(MS_U8 u8band, MS_U8 u8level);
DLL_PUBLIC void    MApi_AUDIO_SetAvcThreshold(MS_U8 Level);
DLL_PUBLIC void    MApi_AUDIO_SetAvcMode( MS_U8 AvcMode );
DLL_PUBLIC void    MApi_AUDIO_SetAvcAT( MS_U8 AvcAT );
DLL_PUBLIC void    MApi_AUDIO_SetAvcRT( MS_U8 AvcRT );
DLL_PUBLIC void    MApi_AUDIO_SetBufferProcess(MS_U8 DelayTime);
DLL_PUBLIC void    MApi_AUDIO_SetSurroundXA( MS_U8 mode );
DLL_PUBLIC void    MApi_AUDIO_SetSurroundXB( MS_U8 mode );
DLL_PUBLIC void    MApi_AUDIO_SetSurroundXK( MS_U8 mode );
DLL_PUBLIC void    MApi_AUDIO_SetSurroundLPFGain( MS_U8 mode );
DLL_PUBLIC MS_U8   MApi_AUDIO_ConvertVolumeUnit(MS_U8 UiVolume);
DLL_PUBLIC void    MApi_AUDIO_SetPEQCoef(AUDIO_PEQ_COEF *peq_coef);
DLL_PUBLIC void    MApi_AUDIO_EnablePEQ(MS_BOOL Enpeq);
DLL_PUBLIC MS_BOOL MApi_AUDIO_EnableDcRemove(MS_BOOL EnDcRemove);

DLL_PUBLIC void MApi_AUDIO_SourceConnect(AUDIO_OUTPORT_SOURCE_TYPE eConnectSourceType, MS_BOOL bIsConnect );
...
//============================================================
 ...
 // PIP Multiplayer
DLL_PUBLIC MS_BOOL MApi_AUDIO_ReleaseDecodeSystem(AUDIO_DEC_ID DecId);
DLL_PUBLIC MS_BOOL MApi_AUDIO_SetDecodeSystem(AUDIO_DEC_ID DecId, AudioDecStatus_t * p_AudioDecStatus);
DLL_PUBLIC MS_BOOL MApi_AUDIO_GetDecodeSystem(AUDIO_DEC_ID DecId, AudioDecStatus_t * p_AudioDecStatus);
DLL_PUBLIC MS_BOOL MApi_AUDIO_SetDecodeCmd(AUDIO_DEC_ID DecId, En_DVB_decCmdType enDecComamnd);
DLL_PUBLIC AUDIO_DEC_ID MApi_AUDIO_OpenDecodeSystem(AudioDecStatus_t * p_AudioDecStatus);
DLL_PUBLIC MS_BOOL MApi_AUDIO_SetSystem(En_DVB_decSystemType enDecSystem);
DLL_PUBLIC MS_BOOL MApi_AUDIO_IsMadLock(void);
DLL_PUBLIC En_DVB_decCmdType MApi_AUDIO_GetDecStatus ( void );
...
//Play command
DLL_PUBLIC AU_DVB_DECCMD MApi_AUDIO_GetCommand(En_DVB_AudioDecoder AdoDecoderNo);
DLL_PUBLIC void    MApi_AUDIO_SetCommand(En_DVB_decCmdType enDecComamnd);

//Decoder Lock information
DLL_PUBLIC MS_BOOL MApi_AUDIO_GetMAD_LOCK(void);

// Audio Description
DLL_PUBLIC void    MApi_AUDIO_SetADOutputMode (MS_U8 out_mode);
DLL_PUBLIC void    MApi_AUDIO_SetADAbsoluteVolume (MS_U8 AbsVolume);
DLL_PUBLIC void    MApi_AUDIO_ADSetMute(MS_BOOL EnMute);

//============================================================
// AUDIO_PVR RELATED FUNCTIONS
//============================================================
DLL_PUBLIC void    MApi_AUDIO_SetEncCommand(AU_DVB_ENCCMD enEncComamnd);
DLL_PUBLIC void    MApi_AUDIO_GetEncodeFrameInfo(AU_DVB_ENC_FRAME_INFO *EncFrameInfo);
DLL_PUBLIC MS_BOOL MApi_AUDIO_GetEncodeDoneFlag(void);
void    MApi_AUDIO_SetEncInit(AU_DVB_ENCBR BitRate, MS_U8 u8EncFrameNum);

//============================================================
// AUDIO_ATV RELATIONAL API FUNCTION
//============================================================
DLL_PUBLIC void    MApi_AUDIO_SIF_SetStandard(AUDIOSTANDARD_TYPE standard_type);
DLL_PUBLIC MS_U8   MApi_AUDIO_SIF_GetSoundMode(void);
DLL_PUBLIC MS_BOOL MApi_AUDIO_SIF_SetSoundMode(MS_U8 u8SifSoundMode);
DLL_PUBLIC MS_BOOL MApi_AUDIO_SIF_GetAudioStatus(AUDIOSTATUS * eAudioStatus);
DLL_PUBLIC void    MApi_AUDIO_SIF_StartAutoStandardDetection(void);
DLL_PUBLIC AUDIOSTANDARD_TYPE MApi_AUDIO_SIF_GetResultOfAutoStandardDetection(void);
DLL_PUBLIC AUDIOSTANDARD_TYPE MApi_AUDIO_SIF_ConvertToBasicAudioStandard(AUDIOSTANDARD_TYPE eStandard);
DLL_PUBLIC void    MApi_AUDIO_SIF_SetThreshold(THR_TBL_TYPE code *ThrTbl);
DLL_PUBLIC void    MApi_AUDIO_SIF_SetPrescale(MS_U8, int);
DLL_PUBLIC MS_BOOL MApi_AUDIO_SIF_IsPALType(AUDIO_SIF_PAL_TYPE pal_type);
DLL_PUBLIC void    MApi_AUDIO_SIF_SetPALType(AUDIO_SIF_PAL_TYPE pal_type);
DLL_PUBLIC void    MApi_AUDIO_SIF_SendCmd(En_AUD_SIF_CmdType enAudSifCommand, MS_U8 comm_arg1, MS_U8 comm_arg2);
DLL_PUBLIC void    MApi_AUDIO_SIF_Shift(En_AUD_VIF_Type type);
...
//=============================================================
DLL_PUBLIC void    MApi_AUDIO_SPDIF_HWEN(MS_BOOL spdif_hwen);
DLL_PUBLIC void    MApi_AUDIO_SPDIF_SetMute(MS_BOOL mute_en);
DLL_PUBLIC void    MApi_AUDIO_SPDIF_SetMode(MS_U8 spdif_mode);
DLL_PUBLIC MS_U8   MApi_AUDIO_SPDIF_GetMode(void);
DLL_PUBLIC void    MApi_AUDIO_SPDIF_SetSCMS(MS_U8 C_bit_en, MS_U8 L_bit_en);
DLL_PUBLIC MS_U8   MApi_AUDIO_SPDIF_GetSCMS(void);
DLL_PUBLIC void    MApi_AUDIO_SPDIF_SetOutputType(AUDIO_SPDIF_OUTPUT_TYPE eType); // New API for S/PDIF output auto/PCM mode switching
DLL_PUBLIC void    MApi_Audio_SPDIF_Monitor(void);
DLL_PUBLIC void    MApi_Audio_Monitor_SPDIF_NONPCM_SmpRate(void);
DLL_PUBLIC MS_BOOL MApi_AUDIO_SPDIF_ChannelStatus_CTRL(AUDIO_SPDIF_CS_TYPE cs_mode, AUDIO_SPDIF_CS_TYPE_STATUS status);
DLL_PUBLIC MS_BOOL MApi_AUDIO_DigitalOut_SetChannelStatus(DIGITAL_OUTPUT_TYPE ePath, Digital_Out_Channel_Status_t *stChannelStatus);

//=============================================================
// AUDIO_HDMI RELATIONAL API FUNCTION
//=============================================================
DLL_PUBLIC void    MApi_AUDIO_HDMI_Tx_SetMute(MS_BOOL mute_en);
DLL_PUBLIC void    MApi_AUDIO_HDMI_Tx_GetStatus(MS_BOOL *onOff, AUDIO_FS_TYPE *hdmi_SmpFreq, HDMI_TX_OUTPUT_TYPE *outType );
DLL_PUBLIC MS_U8   MApi_AUDIO_HDMI_Monitor(void);
DLL_PUBLIC MS_BOOL MApi_AUDIO_HDMI_GetNonpcmFlag(void);
DLL_PUBLIC void    MApi_AUDIO_HDMI_SetNonpcm(MS_U8 nonPCM_en);
DLL_PUBLIC AUDIO_HDMI_RX_TYPE MApi_AUDIO_HDMI_RX_SetNonpcm(MS_U8 nonPCM_en);
DLL_PUBLIC AUDIO_HDMI_RX_TYPE MApi_AUDIO_HDMI_RX_GetNonPCM(void);
DLL_PUBLIC void    MApi_AUDIO_DTV_HDMI_CFG(MS_U8 ctrl);
DLL_PUBLIC MS_U16  MApi_AUDIO_HDMI_GetSynthFreq(void);
DLL_PUBLIC void    MApi_AUDIO_HDMI_SetDownSample(MS_U8 ratio);
DLL_PUBLIC void    MApi_AUDIO_HDMI_TX_SetMode(HDMI_TX_OUTPUT_TYPE outType);
...
//=============================================================
DLL_PUBLIC MS_BOOL MApi_AUDIO_ADVSOUND_ProcessEnable(ADVSND_TYPE type);
DLL_PUBLIC MS_BOOL MApi_AUDIO_ADVSOUND_SubProcessEnable(ADVFUNC proc, MS_BOOL enable);
DLL_PUBLIC MS_BOOL MApi_AUDIO_ADVSOUND_SetParam(ADVSND_PARAM param, MS_U16 u16value1, MS_U16 u16value2);
DLL_PUBLIC MS_BOOL MApi_AUDIO_ADVSND_SetParam(ADVSND_PARAM param, MS_U32 u32value1, MS_U16 u16value2);
DLL_PUBLIC void    MApi_AUDIO_SetAdvSndSys(MS_U8 u8AdvSurrMod);
DLL_PUBLIC void    MApi_AUDIO_COPY_Parameter(ADVSND_PARAM type, MS_U32 *Parameter_ptr,MS_U32 size);
...
//=============================================================
DLL_PUBLIC MS_BOOL MApi_AUDIO_SetKTVInfo (AUDIO_KTV_MODEL modelType, AUDIO_KTV_PARAMTYPE paramType, MS_U32 param1, MS_U32 param2);
DLL_PUBLIC MS_U32  MApi_AUDIO_GetKTVInfo (AUDIO_KTV_MODEL modelType, AUDIO_KTV_INFOTYPE infoType);
DLL_PUBLIC void    MApi_AUDIO_SetMixModeVolume(AUDIO_SOURCE_INFO_TYPE eSourceType, AUDIO_MIX_VOL_TYPE VolType, MS_U8 u8Vol1, MS_U8 u8Vol2);
DLL_PUBLIC void    MApi_AUDIO_SetMixModeMute(AUDIO_SOURCE_INFO_TYPE eSourceType, AUDIO_MIX_VOL_TYPE VolType, MS_BOOL EnMute);
...
// Set Info
DLL_PUBLIC MS_BOOL MApi_AUDIO_SetCommAudioInfo( Audio_COMM_infoType infoType, MS_U32 param1, MS_U32 param2 );
DLL_PUBLIC MS_BOOL MApi_AUDIO_SetMpegInfo( Audio_MPEG_infoType infoType, MS_U32 param1, MS_U32 param2 );
DLL_PUBLIC MS_BOOL MApi_AUDIO_SetAC3Info( Audio_AC3_infoType infoType, MS_U32 param1, MS_U32 param2 );
DLL_PUBLIC MS_BOOL MApi_AUDIO_SetAC3PInfo( Audio_AC3P_infoType infoType, MS_U32 param1, MS_U32 param2 );
DLL_PUBLIC MS_BOOL MApi_AUDIO_SetAACInfo( Audio_AAC_infoType infoType, MS_U32 param1, MS_U32 param2 );
DLL_PUBLIC MS_BOOL MApi_AUDIO_SetWmaInfo( Audio_WMA_infoType infoType, MS_U32 param1, MS_U32 param2 );
DLL_PUBLIC MS_BOOL MApi_AUDIO_SetDTSCommonCtrl( Audio_DTS_infoType infoType, Audio_DTS_CtrlType ctrl_type );

// Get Info
DLL_PUBLIC long long MApi_AUDIO_GetCommAudioInfo( Audio_COMM_infoType infoType );
DLL_PUBLIC MS_U32  MApi_AUDIO_GetMpegInfo( Audio_MPEG_infoType infoType );
DLL_PUBLIC MS_U32  MApi_AUDIO_GetAC3Info( Audio_AC3_infoType infoType );
DLL_PUBLIC MS_U32  MApi_AUDIO_GetAC3PInfo( Audio_AC3P_infoType infoType );
DLL_PUBLIC MS_U32  MApi_AUDIO_GetAACInfo( Audio_AAC_infoType infoType );
DLL_PUBLIC MS_U32  MApi_AUDIO_GetWmaInfo( Audio_WMA_infoType infoType );
DLL_PUBLIC MS_U8   MApi_AUDIO_XPCM_Param(XPCM_TYPE audioType, MS_U8  channels, MS_U16 sampleRate,
                                MS_U8  bitsPerSample, MS_U16 blockSize, MS_U16 samplePerBlock);
DLL_PUBLIC void    MApi_AUDIO_XPCM2_Param(XPCM_TYPE audioType, MS_U8  channels, MS_U16 sampleRate,
                                MS_U8  bitsPerSample, MS_U16 blockSize, MS_U16 samplePerBlock);
MS_U16  MApi_AUDIO_XPCM2_CheckIntStatus(void);
MS_U32  MApi_AUDIO_GetDTSInfo( Audio_DTS_infoType infoType );
// RM
DLL_PUBLIC MS_U8   MApi_AUDIO_RA8_Param(MS_U16 mNumCodecs, MS_U16 mSamples, MS_U16 mSampleRate,
                                MS_U16* Channels, MS_U16* Regions, MS_U16* cplStart, MS_U16* cplQbits,
                                MS_U16* FrameSize);
DLL_PUBLIC void    MApi_AUDIO_Init(En_DVB_decSystemType enDecSystem);
DLL_PUBLIC void    MApi_AUDIO_StartDecode(void);
DLL_PUBLIC void    MApi_AUDIO_StartBrowse(void);
DLL_PUBLIC void    MApi_AUDIO_StopDecode(void);
DLL_PUBLIC void    MApi_AUDIO_PauseDecode(void);
DLL_PUBLIC MS_U8   MApi_AUDIO_CheckPlayDone(void);
DLL_PUBLIC MS_U16  MApi_AUDIO_GetResidualBufferSize(void);
DLL_PUBLIC MS_U16  MApi_AUDIO_GetPCMBufferSize(MS_U16 u16BitRate);
DLL_PUBLIC MS_U16  MApi_AUDIO_GetPCMBufferSize2(MS_U16 u16BitRate,MS_U16 u16SampleRate);
DLL_PUBLIC MS_U32  MApi_AUDIO_GetCurrentFrameNumber(void);
DLL_PUBLIC MS_U16  MApi_AUDIO_GetSampleRate(void);
DLL_PUBLIC MS_U32  MApi_AUDIO_GetBitRate(void);
DLL_PUBLIC Audio_MP3_LAYER MApi_AUDIO_GetLayer(void);
DLL_PUBLIC MS_U8   MApi_AUDIO_CheckInputRequest(MS_U32 *pU32WrtAddr, MS_U32 *pU32WrtBytes);
DLL_PUBLIC void    MApi_AUDIO_SetInput(void);
DLL_PUBLIC void    MApi_AUDIO_SetSampleRateIndex(MS_U16 u16Index);
DLL_PUBLIC void    MApi_AUDIO_SetXPCMParam(XPCM_TYPE audioType, MS_U8 channels, MS_U16 sampleRate, MS_U8 bitsPerSample, MS_U16 blockSize, MS_U16 samplePerBlock);
DLL_PUBLIC void    MApi_AUDIO_FileEndNotification(void);
DLL_PUBLIC void    MApi_AUDIO_FileEndDataHandle(MS_U32 u32DataLeft);
DLL_PUBLIC MS_U32  MApi_AUDIO_GetPlayTick(void);
DLL_PUBLIC MS_U16  MApi_AUDIO_GetEsMEMCnt(void);
DLL_PUBLIC void    MApi_AUDIO_SetASFParm(WMA_ASF_PARMTYPE parm_type, MS_U32 value);
DLL_PUBLIC void    MApi_AUDIO_MM_SetInput (En_DVB_AudioDecoder AUDDecoderNo, MS_U8 u8IntTag);
DLL_PUBLIC MS_U32  MApi_AUDIO_MM_CheckPlayDone (En_DVB_AudioDecoder AUDDecoderNo);
DLL_PUBLIC MS_U8   MApi_AUDIO_MM_CheckInputRequest(En_DVB_AudioDecoder AUDDecoderNo, MS_U32 *pU32WrtAddr, MS_U32 *pU32WrtBytes);
DLL_PUBLIC void    MApi_AUDIO_DmaReader_Init(SAMPLE_RATE sampleRate);
DLL_PUBLIC void    MApi_AUDIO_DmaReader_AllInput_Init(void);
DLL_PUBLIC MS_BOOL MApi_AUDIO_DmaReader_WritePCM(void* buffer, MS_U32 bytes);
DLL_PUBLIC void    MApi_AUDIO_USBPCM_Enable(MS_BOOL bEnable);
DLL_PUBLIC void    MApi_AUDIO_USBPCM_SetFlag(MS_BOOL bEnable);
DLL_PUBLIC MS_BOOL MApi_AUDIO_USBPCM_GetFlag(void);
DLL_PUBLIC void    MApi_AUDIO_USBPCM_GetMemInfo(AUDIO_UPLOAD_INFO *uploadInfo);
DLL_PUBLIC MS_BOOL MApi_AUDIO_PCMCapture_Init(const AUDIO_DEVICE_TYPE eID, const AUDIO_CAPTURE_SOURCE_TYPE eSource);
DLL_PUBLIC MS_BOOL MApi_AUDIO_PCMCapture_Start(const AUDIO_DEVICE_TYPE eID);
DLL_PUBLIC MS_BOOL MApi_AUDIO_PCMCapture_Stop(const AUDIO_DEVICE_TYPE eID);
DLL_PUBLIC MS_BOOL MApi_AUDIO_PCMCapture_Read(const AUDIO_DEVICE_TYPE eID, void *buffer, const MS_U32 bytes);
DLL_PUBLIC MS_BOOL MApi_AUDIO_VoIP_Config(AUDIO_VoIP_CONFIG_TYPE configType, MS_U32 param1, MS_U32 param2);
DLL_PUBLIC MS_BOOL MApi_AUDIO_ALSA_Check(void);
DLL_PUBLIC MS_BOOL MApi_AUDIO_ALSA_Enable(MS_BOOL bEnable);
DLL_PUBLIC MS_BOOL MApi_AUDIO_MM2_initAesInfo( AUDIO_DEC_ID dec_id );
DLL_PUBLIC MS_BOOL MApi_AUDIO_MM2_checkAesInfo( AUDIO_DEC_ID  dec_id, AES_INFO *aes_info );
DLL_PUBLIC MS_BOOL MApi_AUDIO_MM2_inputAesFinished( AUDIO_DEC_ID dec_id, MS_U32 es_size, MS_BOOL ptsExist, MS_U64 pts );
...
DLL_PUBLIC MS_BOOL MApi_AUDIO_SetAudioParam2( AUDIO_DEC_ID DecId, Audio_ParamType paramType, MS_U32 Param );
DLL_PUBLIC MS_BOOL MApi_AUDIO_GetAudioInfo2( AUDIO_DEC_ID DecId, Audio_InfoType infoType, void * pInfo );
