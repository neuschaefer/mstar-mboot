...
enum {
    ...
    MApi_CMD_DMX_Init,                              // (DMX_TSPParam*)                                                              #0
    MApi_CMD_DMX_Exit,
    ...
    MApi_CMD_DMX_ReadDropCount,                     // pointer to (DMX_POWSTATE_PARAM)
    MApi_CMD_DMX_SetPowerState,

    MApi_CMD_DMX_SetOwner,                          // pointer to (U32_Start_Flt_Id, U32_End_Flt_Id, U32_IsOwner)       #10
    ...
    MApi_CMD_DMX_Stc_Set,                           // pointer to (U32_Eng_Id, U32_STC_H, U32_STC_L)
    MApi_CMD_DMX_Stc_UpdateCtrl,                    // pointer to (U32_Eng_Id, U32_bEnable)
    MApi_CMD_DMX_Stc_ClkAdjust,                     // pointer to (U32_Eng_Id, U32_Mutipletor64)                              #20
    ...
    MApi_CMD_DMX_IsStart,                           // pointer to (U32_DmxId, U32_bEnable)
    MApi_CMD_DMX_CopyData,                          // pointer to (DMX_FLT_COPY_PARAM)
    MApi_CMD_DMX_Proc,                              // pointer to (DMX_FLT_EVENT_PARAM)
    MApi_CMD_DMX_ChangeFltSrc,                      // pointer to (DMX_FLT_TYPE_PARAM)                                       #30
    ...
    MApi_CMD_DMX_Sec_GetStartAddr,                  // pointer to (U32_DmxId, U32_PhyWriteAddr)
    ...
    //TTX API
    MApi_CMD_DMX_GetTTXWrite,                       // pointer to (U32_DmxId, U32_PhyWriteAddr)                             #40
    ...
    //PVR Playback API
    MApi_CMD_DMX_FI_PlayStamp,                      // pointer to (U32_EngId, U32_Stamp, U32_bSet)
    ...
    // PVR Engine API
    MApi_CMD_DMX_Pvr_Open,                          // pointer to (DMX_PVR_INFO_PARAM)                                      #50
    ...
    MApi_CMD_DMX_Pvr_SetPktMode,                    // pointer to (U32_EngId, U32_bSet)
    ...
    MApi_CMD_DMX_Pvr_SetMobfKey,                    // pointer to (U32_EngId, U32_Key0, U32_Key1, U32_bEnable)      #60
    ...
    //MMFI  API
    MApi_CMD_DMX_MMFI_IsIdle,                       // pointer to (U32_MMFIPath, U32_bIdle)
    MApi_CMD_DMX_MMFI_IsBusy,                       // pointer to (U32_MMFIPath, U32_bBusy)
    MApi_CMD_DMX_MMFI_CmdQReset,                    // pointer to (DMX_MMFI_PATH)
    MApi_CMD_DMX_MMFI_GetEmptyNum,                  // pointer to (U32_MMFIPath, U32_EmptyNum)                              #80
    ...
    MApi_CMD_DMX_MMFI_PlayStamp_Get,                // pointer to (U32_EngId, U32_Stamp)
    ...
    MApi_CMD_DMX_MMFI_SetMOBFKey,                   // pointer to (U32_EngId, U32_Key, U32_bEnable)                        #90
    ...
    MApi_CMD_DMX_TSPInit_1_0,                       // (DMX_TSPParam*)
    MApi_CMD_DMX_ReleseHWSemp,                      // None
    MApi_CMD_DMX_GetLibVer,                         // const MSIF_Version **
    MApi_CMD_DMX_STC64ModeEnable,                   // pointer to (BOOL_bEnable)                                                  #100
