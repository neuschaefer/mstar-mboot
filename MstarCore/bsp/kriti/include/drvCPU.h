...
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC void MDrv_COPRO_Disable(void);
DLL_PUBLIC void MDrv_COPRO_Enable(MS_U32 u32_ADR);
...
DLL_PUBLIC void MDrv_SetBEON_Host(MS_BOOL bHost);
DLL_PUBLIC void MDrv_COPRO_Init_Front(void);
DLL_PUBLIC void MDrv_COPRO_Init_End(MS_U32 u32_ADR);

DLL_PUBLIC const COPRO_DrvInfo* MDrv_COPRO_GetInfo(void);
DLL_PUBLIC COPRO_Result MDrv_COPRO_GetLibVer(const MSIF_Version **ppVersion);
DLL_PUBLIC COPRO_Result MDrv_COPRO_GetStatus(COPRO_DrvStatus *pStatus);
DLL_PUBLIC void MDrv_COPRO_SetDbgLevel(MS_U8 level);
DLL_PUBLIC MS_U32 MDrv_COPRO_GetBase(void);
DLL_PUBLIC MS_U32 MDrv_CPU_QueryClock(void);
DLL_PUBLIC MS_U32 MDrv_CPU_SetPowerState(EN_POWER_MODE u16PowerState);
DLL_PUBLIC MS_U32 MDrv_CPU_GetDqmemInfo(MS_U32 *pu32_DqmemAddr, MS_U32 *pu32_DqmemSize);
