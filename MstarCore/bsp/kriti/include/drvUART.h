...
///////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC MS_U32 mdrv_uart_open(UART_DEVICE_TYPE uart_dev);
...
///////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC MS_U16 mdrv_uart_close(MS_U32 uart);
...
///////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC MS_U16 mdrv_uart_connect(UART_PORT_TYPE uart_port, UART_DEVICE_TYPE uart_dev);
...
///////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC UART_DEVICE_TYPE mdrv_uart_get_connection(UART_PORT_TYPE uart_port);
...
/// @return 0: sucess, -1: failed
///////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC MS_U16 mdrv_uart_connect_mux(UART_DEVICE_TYPE uart_dev, UART_PORT_TYPE uart_port, UART_PAD_TYPE uart_pad);
...
///////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC MS_U16 mdrv_uart_invert(UART_PORT_TYPE uart_port, MS_BOOL bInv);
...
///////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC MS_U16 mdrv_uart_set_baudrate(MS_U32 uart, MS_U32 baudrate);
...
/// @return 0: success, -1: failed
///////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC MS_U16 mdrv_uart_set_rx_callback(MS_U32 uart, ms_uart_rx_callback rx_cb);
...
/// @return 0: success, -1: failed
///////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC MS_U16 mdrv_uart_set_tx_buffer(MS_U32 uart, void *tx_buffer, MS_U16 len);
...
/// @return 0: success, -1: failed
///////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC MS_U16 mdrv_uart_set_rx_buffer(MS_U32 uart, void *rx_buffer, MS_U16 len);
...
/// @return 0: success, -1: failed
///////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC MS_U16 mdrv_uart_rx_enable(MS_U32 uart);
...
/// @return 0: success, -1: failed
///////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC MS_U16 mdrv_uart_tx_enable(MS_U32 uart);
...
/// @return 0: success, -1: failed
///////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC MS_U16 mdrv_uart_rx_disable(MS_U32 uart);
...
/// @return 0: success, -1: failed
///////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC MS_U16 mdrv_uart_tx_disable(MS_U32 uart);
...
///////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC MS_U16 mdrv_uart_read(MS_U32 uart, MS_U8 *buf, MS_U32 len);
...
///////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC MS_U16 mdrv_uart_write(MS_U32 uart, const MS_U8 *buf, MS_U16 len);

DLL_PUBLIC MS_U16 mdrv_uart_poll(MS_U32 hUart, int types);
DLL_PUBLIC MS_U16 mdrv_uart_set_rx_callback_halreg(MS_U32 uart, ms_uart_rx_callback_halreg rx_cb);

/// UART callback function used in interrupt context
typedef void(*P_UART_ISR_Proc)(MS_U8 u8UARTID);

DLL_PUBLIC UART_Result MDrv_UART_SetIOMapBase(void);
DLL_PUBLIC void MDrv_UART_Init(UART_DEVICE_TYPE uart_dev, MS_U32 baudrate);
DLL_PUBLIC void MDrv_UART_Standby_Init (void);
DLL_PUBLIC void MDrv_UART_PutChar(MS_U8 u8Ch);
DLL_PUBLIC void MDrv_UART_PutString(char *u8str);
DLL_PUBLIC MS_U8 MDrv_UART_GetChar(void);
DLL_PUBLIC void MDrv_UART_GetFile(MS_U8 *pu8Buf, MS_U32 u32Len);
DLL_PUBLIC const UART_DrvInfo* MDrv_UART_GetInfo(void);
DLL_PUBLIC struct device* MDrv_UART_GetDev(UART_DEVICE_TYPE uart_dev);
DLL_PUBLIC UART_Result MDrv_UART_GetLibVer(const MSIF_Version **ppVersion);
DLL_PUBLIC UART_Result MDrv_UART_GetStatus(UART_DrvStatus *pStatus);
DLL_PUBLIC void MDrv_UART_SetDbgLevel(MS_U8 level);
DLL_PUBLIC UART_Result MDrv_UART_SetPMRxEnable(MS_BOOL bEnable);
