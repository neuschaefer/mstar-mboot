...
typedef struct _s_DTMB_modul_inform
{
    DMD_DTMB_DEMOD_TYPE eType; //0: DTMB, 1:DVBC
    MS_U8  CM;   //0: multiple carrier, 1:single carrier
    MS_U8  QAM;  //4QAM, 16QAM, 32QAM, 64QAM
    MS_U16 IL;   //240, 720
    MS_U16 PNM;  //420, 595, 945
    MS_U8  PNC;  //0: variable, 1: constant
    float  CR;   //0.4, 0.6, 0.8
}s_DTMB_modul_inform;
...
/// MDrv_DMD_DVBT_Init
////////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC extern MS_BOOL MDrv_DMD_DTMB_Init(DMD_DTMB_InitData *pDMD_DVBT_InitData, MS_U32 u32InitDataLen);
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
///DLL_PUBLIC extern MS_BOOL MDrv_DMD_DTMB_SetSerialControl(MS_BOOL bEnable);
...
////////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC extern MS_BOOL MDrv_DMD_DTMB_GetModulationMode(s_DTMB_modul_inform *pModule_Inform);
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC extern MS_BOOL MDrv_DMD_DTMB_GetCellID(MS_U16 *u16CellID);
////////////////////////////////////////////////////////////////////////////////
/// MDrv_DMD_DTMB_Read_PKT_ERR
////////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC extern MS_BOOL MDrv_DMD_DTMB_Read_uCPKT_ERR(MS_U16 *u16PacketErr);
////////////////////////////////////////////////////////////////////////////////
////////////////////////////////////////////////////////////////////////////////
...
DLL_PUBLIC extern MS_BOOL MDrv_DMD_DTMB_Initial_Hal_Interface(void);    //this function will be implemented in DTMB Hal layer

DLL_PUBLIC extern MS_BOOL MDrv_INTERNAL_DMD_DTMB_Link_Func(void);    //this function will be implemented in ISDBT Hal layer
DLL_PUBLIC extern MS_BOOL MDrv_EXTERNAL_DMD_DTMB_Link_Func(void);    //this function will be implemented in ISDBT Hal layer


//DLL_PUBLIC extern MS_U8 MDrv_DMD_DTMB_GetSNRPercentage(void);

DLL_PUBLIC extern MS_BOOL MDrv_DMD_DTMB_SetDtmbMode(void);

DLL_PUBLIC extern MS_BOOL MDrv_DMD_DTMB_Set256QamMode(void);

DLL_PUBLIC extern MS_BOOL MDrv_DMD_DTMB_SetDvbcMode(void);
////////////////////////////////////////////////////////////////////////////////
/// MDrv_DMD_DTMB_SEL_DMD
////////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC extern MS_BOOL MDrv_DMD_DTMB_SEL_DMD(MS_U8 eDMD_NUM);
////////////////////////////////////////////////////////////////////////////////
/// MDrv_DMD_DTMB_GET_DMD_NUM
////////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC extern MS_U8 MDrv_DMD_DTMB_GET_DMD_NUM(void);
////////////////////////////////////////////////////////////////////////////////
/// MDrv_DMD_DTMB_LoadFW
////////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC extern MS_BOOL MDrv_DMD_DTMB_LoadFW(MS_U8 DMD_NUM);
////////////////////////////////////////////////////////////////////////////////
/// MDrv_DMD_DTMB_ADCOut_CTL
////////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC extern MS_BOOL MDrv_DMD_DTMB_ADCOut_CTL(MS_U8 DMD_NUM);
////////////////////////////////////////////////////////////////////////////////
/// MDrv_DMD_DTMB_GetSNRPercentage
////////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC extern MS_U8 MDrv_DMD_DTMB_GetSNRPercentage(void);
////////////////////////////////////////////////////////////////////////////////
/// MDrv_DMD_DTMB_SetPowerState
////////////////////////////////////////////////////////////////////////////////
...
////////////////////////////////////////////////////////////////////////////////
/// MDrv_DMD_DTMB_SetSRType
////////////////////////////////////////////////////////////////////////////////
MS_BOOL MDrv_DMD_DTMB_SetSRType(DMD_DTMB_SR_TYPE  eSR_type);
#ifdef __cplusplus
}
#endif
