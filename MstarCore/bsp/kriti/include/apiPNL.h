...
#define MSIF_PNL_BUILDNUM               {'5','3'}
#define MSIF_PNL_CHANGELIST             {'0','0','6','6','7','4','7','1'}
...
*/
extern DLL_PUBLIC XC_PNL_OBJ g_IPanel;
...
DLL_PUBLIC APIPNL_Result MApi_PNL_GetLibVer(const MSIF_Version **ppVersion);
DLL_PUBLIC const PNL_ApiInfo * MApi_PNL_GetInfo(void);
DLL_PUBLIC MS_BOOL MApi_PNL_GetStatus(PNL_ApiStatus *pPnlStatus);
DLL_PUBLIC MS_BOOL MApi_PNL_GetStatusEx(PNL_ApiExtStatus *pPnlExtStatus);

DLL_PUBLIC MS_BOOL MApi_PNL_SetDbgLevel(MS_U16 u16DbgSwitch);

DLL_PUBLIC MS_BOOL MApi_PNL_IOMapBaseInit(void);

DLL_PUBLIC MS_BOOL MApi_PNL_PreInit(E_PNL_PREINIT_OPTIONS eInitParam);

#ifndef _API_XC_PANEL_C_
#define             MApi_PNL_Init(x) MApi_PNL_Init_Ex(x, (MSIF_Version){{ PNL_API_VERSION },});
#endif

DLL_PUBLIC MS_BOOL MApi_PNL_Init_Ex(PanelType *pSelPanelType/* <in > */, MSIF_Version LIBVER);
DLL_PUBLIC void MApi_PNL_SetOutput(APIPNL_OUTPUT_MODE eOutputMode);
DLL_PUBLIC MS_BOOL MApi_PNL_ChangePanelType(PanelType *pSelPanelType);
//------------------------------------------------------------------------------
/// Dump TCON Table
...
//------------------------------------------------------------------------------
DLL_PUBLIC MS_BOOL MApi_PNL_TCONMAP_DumpTable(MS_U8 *pTCONTable, MS_U8 u8Tcontype);
DLL_PUBLIC MS_BOOL MApi_PNL_TCONMAP_Power_Sequence(MS_U8 *pTCONTable, MS_BOOL bEnable);
DLL_PUBLIC void MApi_PNL_TCON_Count_Reset ( MS_BOOL bEnable );
DLL_PUBLIC void MApi_PNL_TCON_Init( void );
DLL_PUBLIC MS_BOOL MApi_PNL_GetDstInfo(MS_PNL_DST_DispInfo *pDstInfo, MS_U32 u32SizeofDstInfo);
// MOD Output swing should between 40~600
DLL_PUBLIC MS_BOOL MApi_PNL_Control_Out_Swing(MS_U16 u16Swing_Level);
DLL_PUBLIC MS_BOOL MApi_PNL_ForceSetPanelDCLK(MS_U16 u16PanelDCLK ,MS_BOOL bSetDCLKEnable );

DLL_PUBLIC void MApi_PNL_SetOutputPattern(MS_BOOL bEnable, MS_U16 u16Red , MS_U16 u16Green, MS_U16 u16Blue);
DLL_PUBLIC void MApi_Mod_Calibration_Setting(MS_PNL_ModCaliInfo *pstModCaliInfo);
DLL_PUBLIC MS_BOOL MApi_Mod_Do_Calibration(void);
...
*/
DLL_PUBLIC void MApi_BD_LVDS_Output_Type(MS_U16 Type);
DLL_PUBLIC void MApi_PNL_SetLPLLTypeExt(APIPNL_LINK_EXT_TYPE eLPLL_TypeExt);
DLL_PUBLIC void MApi_PNL_Init_MISC(APIPNL_MISC ePNL_MISC);
DLL_PUBLIC void MApi_PNL_MOD_OutputConfig_User(MS_U32 u32OutputCFG0_7, MS_U32 u32OutputCFG8_15, MS_U32 u32OutputCFG16_21);
DLL_PUBLIC void MApi_PNL_HWLVDSReservedtoLRFlag(MS_PNL_HW_LVDSResInfo lvdsresinfo);

DLL_PUBLIC void MApi_MOD_PVDD_Power_Setting(MS_BOOL bIs2p5);

// more SSC function, shall be added into XC_PNL_OBJ
DLL_PUBLIC int MApi_PNL_SetSSC_En(MS_BOOL bEnable);
//------------------------------------------------------------------------------
/// Set panel SSC Fmodulation
/// @param u16Fmodulation              \b IN:Fmodulation, Unit:0.1Khz
/// @return TRUE --OK   FALSE
//------------------------------------------------------------------------------
DLL_PUBLIC int MApi_PNL_SetSSC_Fmodulation(MS_U16 u16Fmodulation);
//------------------------------------------------------------------------------
/// Set panel SSC Rdeviation
/// @param u16Rdeviation              \b IN: u16Rdeviation, Unit:1%%(1/10000)
/// @return TRUE --OK   FALSE
//------------------------------------------------------------------------------
DLL_PUBLIC int MApi_PNL_SetSSC_Rdeviation(MS_U16 u16Rdeviation);

// more SSC OSD function, shall be added into XC_PNL_OBJ
DLL_PUBLIC int MApi_PNL_SetOSDSSC_En(MS_BOOL bEnable);
...
/// @return TRUE --OK   FALSE
//------------------------------------------------------------------------------
DLL_PUBLIC int MApi_PNL_SetOSDSSC_Fmodulation(MS_U16 u16Fmodulation);
...
/// @return TRUE --OK   FALSE
//------------------------------------------------------------------------------
DLL_PUBLIC int MApi_PNL_SetOSDSSC_Rdeviation(MS_U16 u16Rdeviation);

DLL_PUBLIC APIPNL_Result MApi_PNL_SkipTimingChange(MS_BOOL bFlag);
...
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC APIPNL_Result MApi_PNL_OverDriver_Init(MS_PNL_OD_INITDATA *pPNL_ODInitData, MS_U32 u32ODInitDataLen);
...
/// @return E_APIPNL_OK or E_APIPNL_FAIL
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC APIPNL_Result MApi_PNL_OverDriver_Enable(MS_BOOL bEnable);
...
/// @return MS_BOOL
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC MS_BOOL MApi_PNL_Get_TCON_Capability(void);
...
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC void MApi_PNL_SetPairSwap(MS_U32 u32Polarity);
...
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC void MApi_PNL_CalExtLPLLSETbyDClk(MS_U32 ldHz);
...
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC MS_BOOL MApi_PNL_EnableInternalTermination(MS_BOOL bEnable);
...
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC MS_BOOL MApi_PNL_SetDiffSwingLevel(MS_U8 u8Swing_Level);

//-------------------------------------------------------------------------------------------------
/// Do handshake for special output device, ex. VB1
/// @return TRUE or FALSE
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC MS_BOOL MApi_PNL_OutputDeviceHandshake(void);

//-------------------------------------------------------------------------------------------------
/// set necessary setting for outputing interlace timing to rear
/// @return APIPNL_Result
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC APIPNL_Result MApi_PNL_SetOutputInterlaceTiming(MS_BOOL bEnable);
