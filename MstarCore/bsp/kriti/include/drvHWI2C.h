...
// Extern Function
////////////////////////////////////////////////////////////////////////////////
DLL_PUBLIC MS_BOOL MDrv_HWI2C_Init(HWI2C_UnitCfg *psCfg);
DLL_PUBLIC MS_BOOL MDrv_HWI2C_Start(void);
DLL_PUBLIC MS_BOOL MDrv_HWI2C_Stop(void);
DLL_PUBLIC MS_BOOL MDrv_HWI2C_GetPortIndex(HWI2C_PORT ePort, MS_U8* pu8Port);

DLL_PUBLIC MS_BOOL MDrv_HWI2C_SelectPort(HWI2C_PORT ePort);
DLL_PUBLIC MS_BOOL MDrv_HWI2C_SetClk(HWI2C_CLKSEL eClk);
DLL_PUBLIC MS_BOOL MDrv_HWI2C_SetReadMode(HWI2C_ReadMode eReadMode);
DLL_PUBLIC MS_BOOL MDrv_HWI2C_WriteByte(MS_U16 u16SlaveCfg, MS_U8 u8RegAddr, MS_U8 u8Data);
DLL_PUBLIC MS_BOOL MDrv_HWI2C_WriteBytes(MS_U16 u16SlaveCfg, MS_U32 uAddrCnt, MS_U8 *pRegAddr, MS_U32 uSize, MS_U8 *pData);
DLL_PUBLIC MS_BOOL MDrv_HWI2C_ReadByte(MS_U16 u16SlaveCfg, MS_U8 u8RegAddr, MS_U8 *pData);
DLL_PUBLIC MS_BOOL MDrv_HWI2C_ReadBytes(MS_U16 u16SlaveCfg, MS_U32 uAddrCnt, MS_U8 *pRegAddr, MS_U32 uSize, MS_U8 *pData);

DLL_PUBLIC MS_BOOL MDrv_HWI2C_SelectPort1(HWI2C_PORT ePort);
DLL_PUBLIC MS_BOOL MDrv_HWI2C_SetClkP1(HWI2C_CLKSEL eClk);
DLL_PUBLIC MS_BOOL MDrv_HWI2C_SetReadModeP1(HWI2C_ReadMode eReadMode);
DLL_PUBLIC MS_BOOL MDrv_HWI2C_WriteByteP1(MS_U16 u16SlaveCfg, MS_U8 u8RegAddr, MS_U8 u8Data);
DLL_PUBLIC MS_BOOL MDrv_HWI2C_WriteBytesP1(MS_U16 u16SlaveCfg, MS_U32 uAddrCnt, MS_U8 *pRegAddr, MS_U32 uSize, MS_U8 *pData);
DLL_PUBLIC MS_BOOL MDrv_HWI2C_ReadByteP1(MS_U16 u16SlaveCfg, MS_U8 u8RegAddr, MS_U8 *pData);
DLL_PUBLIC MS_BOOL MDrv_HWI2C_ReadBytesP1(MS_U16 u16SlaveCfg, MS_U32 uAddrCnt, MS_U8 *pRegAddr, MS_U32 uSize, MS_U8 *pData);

DLL_PUBLIC MS_BOOL MDrv_HWI2C_SetDbgLevel(HWI2C_DbgLv eLevel);
DLL_PUBLIC MS_BOOL MDrv_HWI2C_GetLibVer(const MSIF_Version **ppVersion);
DLL_PUBLIC void MDrv_HWI2C_GetStatus(HWI2C_Status *pStatus);
DLL_PUBLIC const HWI2C_Info* MDrv_HWI2C_GetInfo(void);
DLL_PUBLIC MS_BOOL  MDrv_HWI2C_ConfigDelay(MS_U32 u32StartDelay, MS_U32 u32StopDelay);
DLL_PUBLIC void  MDrv_HWI2C_EnableRetry(MS_BOOL bEnable);
