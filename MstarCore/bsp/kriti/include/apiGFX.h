...
DLL_LOCAL extern GFX_Result MApi_GFX_SetPatchMode(MS_BOOL enable);
DLL_PUBLIC extern GFX_Result MApi_GFX_SetNearestMode(MS_BOOL enable);
...
DLL_LOCAL extern GFX_Result MApi_GFX_PowerOn(void);
DLL_LOCAL extern GFX_Result MApi_GFX_PowerOff(void);
...
DLL_PUBLIC void MApi_GE_Exit(void);
