...
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC SAR_Result MDrv_SAR_Init(void);
...
/// @return E_SAR_FAIL or other values: Failure
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC SAR_Result MDrv_SAR_Config(SAR_RegCfg *pSARRegCfg);
...
/// @return E_SAR_FAIL or other values: Failure
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC SAR_Result MDrv_SAR_GetKeyCode(MS_U8 *pu8Key, MS_U8 *pu8Repeat);
...
/// @return E_SAR_FAIL or other values: Failure
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC SAR_Result MDrv_SAR_SetCallback(SAR_Callback pCallback);
...
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC SAR_Callback MDrv_SAR_GetCallback(void);
...
/// @return E_SAR_FAIL or other values: Failure
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC SAR_Result MDrv_SAR_GetLibVer(const MSIF_Version **ppVersion);
...
/// @return E_SAR_FAIL or other values: Failure
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC SAR_Result MDrv_SAR_GetStatus(MS_U8 *pu8SARStatus);
...
/// @return E_SAR_FAIL or other values: Failure
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC SAR_Result MDrv_SAR_Enable(MS_BOOL bEnable);
...
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC const SAR_DrvInfo* MDrv_SAR_GetInfo(void);
...
/// @return E_SAR_FAIL or other values: Failure
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC SAR_Result MDrv_SAR_SetDbgLevel(SAR_DbgLvl eLevel);
...
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC SAR_KpdResult MDrv_SAR_Kpd_Init(void);
...
/// @return E_SAR_KPD_FAIL or other values: Failure
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC SAR_KpdResult MDrv_SAR_Kpd_SetChInfo(SAR_KpdRegCfg *sarChInfo);
...
/// @return E_SAR_KPD_FAIL or other values: Failure
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC SAR_KpdResult MDrv_SAR_Kpd_GetKeyCode(MS_U8 *pu8Key, MS_U8 *pu8Repeat);
...
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC SAR_KpdStatus MDrv_SAR_Kpd_GetStatus(void);

//-------------------------------------------------------------------------------------------------
/// Get SAR Keypad driver information function.
/// @return @ref SAR_KpdDrvInfo structure
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC const SAR_KpdDrvInfo* MDrv_SAR_Kpd_GetInfo(void);
...
/// @return E_SAR_KPD_FAIL or other values: Failure
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC SAR_KpdResult MDrv_SAR_Kpd_SetDbgLevel(SAR_KpdDbgLvl eLevel);
...
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC SAR_AdcResult MDrv_SAR_Adc_Config(MS_U8 u8Channel,MS_BOOL bEnable);
...
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC MS_U8 MDrv_SAR_Adc_GetValue(MS_U8 u8Channel);
...
/// @return E_SAR_ADC_FAIL or other values: Failure
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC SAR_AdcResult MDrv_SAR_Adc_SetHSyncChEn(MS_BOOL bEnable);
...
/// @return E_SAR_ADC_FAIL or other values: Failure
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC SAR_AdcResult MDrv_SAR_Adc_SetHSyncCh(SAR_AdcHSyncCh eHSyncCh);
...
/// @return E_SAR_ADC_FAIL or other values: Failure
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC SAR_AdcResult MDrv_SAR_Adc_SetDbgLevel(SAR_AdcDbgLvl eLevel);
...
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC SAR_GpioResult MDrv_SAR_Gpio_CfgDir(MS_U8 u8Channel,MS_BOOL u8InOut);
...
/// @return E_SAR_GPIO_FAIL or other values: Failure
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC SAR_GpioResult MDrv_SAR_Gpio_SetOutput(MS_U8 u8Channel,MS_BOOL bHighLow);
...
/// @return E_SAR_GPIO_FAIL or other values: Failure
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC SAR_GpioResult MDrv_SAR_Gpio_GetInput(MS_U8 u8Channel, MS_BOOL* pbResult);
...
/// @return E_SAR_GPIO_FAIL or other values: Failure
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC SAR_GpioResult MDrv_SAR_Gpio_SetDbgLevel(SAR_GpioDbgLvl eLevel);
...
/// @return E_SAR_GPIO_FAIL or other values: Failure
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC SAR_GpioResult MDrv_SAR_CfgInterrupt(MS_U8 u8Channel, MS_BOOL bEnable);
...
/// @return E_SAR_GPIO_FAIL or other values: Failure
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC SAR_GpioResult MDrv_SAR_CfgPMWakeup(MS_BOOL bEnable);
...
/// @return E_SAR_GPIO_FAIL or other values: Failure
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC void MDrv_SAR_ClearInterrupt(MS_U8 u8Channel);
...
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC SAR_GpioResult MDrv_SAR_GetInterruptStatus(MS_U8 u8Channel);
...
/// @return Void
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC void MDrv_SAR_SetLevel(SAR_LEVEL eSarLevel);

//-------------------------------------------------------------------------------------------------
/// Set SAR Adc TimeDalay ,unit: ms
/// @param eSarLevel: u32AdcTimeDelay
/// @return Void
/// @return Void
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC void MDrv_SAR_Kpd_SetAdcTimeDelay_Ms(MS_U32 u32AdcTimeDelay);

DLL_PUBLIC SAR_KpdResult MDrv_SAR_Kpd_MMIO_Init(void);

DLL_PUBLIC SAR_KpdResult MDrv_SAR_Kpd_CfgChannelBound(MS_U8 u8Channel, MS_U16 u16Upper, MS_U16 u16Lower);
