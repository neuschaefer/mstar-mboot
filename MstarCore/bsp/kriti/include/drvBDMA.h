...
DLL_PUBLIC BDMA_Result MDrv_BDMA_GetLibVer(const MSIF_Version **ppVersion);
DLL_PUBLIC void MDrv_BDMA_GetStatus(BDMA_Status *pStatus);
DLL_PUBLIC const BDMA_Info* MDrv_BDMA_GetInfo(void);
DLL_PUBLIC MS_U32 MDrv_BDMA_GetMinSize(void);
DLL_PUBLIC BDMA_Result MDrv_BDMA_SetDbgLevel(BDMA_DbgLv eLevel);

DLL_PUBLIC BDMA_Result MDrv_BDMA_Init(MS_U32 u32Miu1Base);

DLL_PUBLIC MS_U32 MDrv_BDMA_Search(MS_PHYADDR u32Addr, MS_U32 u32Len, MS_U32 u32Pattern, MS_U32 u32ExcluBit, BDMA_SrcDev eDev);
#ifdef MOBF_ENABLE
DLL_PUBLIC MS_U32 MDrv_BDMA_MOBFSearch(MS_PHYADDR u32Addr, MS_U32 u32Len, BDMA_MOBF_PS *pMobfPsCfg, BDMA_SrcDev eDev);
#endif
DLL_PUBLIC MS_U32 MDrv_BDMA_CRC32(MS_PHYADDR u32Addr, MS_U32 u32Len, MS_U32 u32Poly, MS_U32 u32Seed, BDMA_SrcDev eDev, MS_BOOL bReflect);
DLL_PUBLIC BDMA_Result MDrv_BDMA_PatternFill(MS_PHYADDR u32Addr, MS_U32 u32Len, MS_U32 u32Pattern, BDMA_DstDev eDev);

DLL_PUBLIC BDMA_Result MDrv_BDMA_MemCopy(MS_PHYADDR u32SrcAddr, MS_PHYADDR u32DstAddr, MS_U32 u32Len);
DLL_PUBLIC BDMA_Result MDrv_BDMA_FlashCopy2Dram(MS_PHYADDR u32FlashAddr, MS_PHYADDR u32DramAddr, MS_U32 u32Len);
DLL_PUBLIC BDMA_Result MDrv_BDMA_CopyHnd(MS_PHYADDR u32SrcAddr, MS_PHYADDR u32DstAddr, MS_U32 u32Len, BDMA_CpyType eCpyType, MS_U8 u8OpCfg);
DLL_PUBLIC MS_U32 MDrv_BDMA_SetPowerState(EN_POWER_MODE u16PowerState);

DLL_PUBLIC BDMA_Result MDrv_BDMA_WaitFlashDone(void);

DLL_PUBLIC void MDrv_BDMA_SetSPIOffsetForMCU(void);

// status
DLL_PUBLIC void MDrv_BDMA_DumpCB(void *pvOpCB);

DLL_PUBLIC BDMA_Result MDrv_BDMA_Stop_All(void);
DLL_PUBLIC BDMA_Result MDrv_BDMA_Stop(MS_U8 u8Ch);

DLL_PUBLIC BDMA_Result MDrv_BDMA_Exit(void);
