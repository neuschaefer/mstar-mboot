...
// Extern Function
//------------------------------------------------------------------------------
DLL_PUBLIC E_PWS_Result MDrv_PWS_GetLibVer(const MSIF_Version **ppVersion);
DLL_PUBLIC E_PWS_Result MDrv_PWS_SetDbgLevel(E_PWS_DBG_LEVEL eLEVEL);
DLL_PUBLIC void         MDrv_PWS_GetInfo(PWS_Info *pInfo);
DLL_PUBLIC void         MDrv_PWS_GetStatus(PWS_Status *pStatus);
DLL_PUBLIC E_PWS_SouceInfo MDrv_PWS_GetSourceInfo(void);
DLL_PUBLIC MS_U16       MDrv_PWS_Read2Byte(MS_U32 u32RegAddr );

DLL_PUBLIC E_PWS_Result MDrv_PWS_Init(E_PWS_VIF_type eVifType);
DLL_PUBLIC E_PWS_Result MDrv_PWS_HandleSource(E_PWS_Operation operation,E_PWS_SouceInfo source,E_PWS_Sync sync_type);
DLL_PUBLIC E_PWS_Result MDrv_PWS_HandleIP(E_PWS_IpPowerCtrl IpPowerCtrl,const unsigned char *RegName);
DLL_PUBLIC E_PWS_Result MDrv_PWS_RegisterCallback(MS_U8 index,E_PWS_CallbackCtrl cb_ctrl,unsigned char *RegName,P_PWS_Callback pfCallback);
DLL_PUBLIC E_PWS_Result MDrv_PWS_CancelCallback(MS_U8 index);
DLL_PUBLIC MS_U32 MDrv_PWS_SetPowerState(EN_POWER_MODE u16PowerState);
#if defined (MSOS_TYPE_LINUX)
DLL_PUBLIC E_PWS_Result MDrv_PWS_PHYPower(E_PWS_PHY bSetFlag);
#endif
