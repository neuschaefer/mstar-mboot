...
DLL_PUBLIC MS_BOOL MDrv_RTC_Init(E_MS_DRV_RTC eRtc, MS_U32 u32Freq, MS_U32 u32Xtal, MS_U32 u32Sec,InterruptCb pIntCb);
DLL_PUBLIC MS_U32 MDrv_RTC_GetCount(E_MS_DRV_RTC eRtc);
DLL_PUBLIC void MDrv_RTC_DeInit(E_MS_DRV_RTC eRtc);
