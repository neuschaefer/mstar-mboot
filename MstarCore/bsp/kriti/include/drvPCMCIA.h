...
DLL_PUBLIC void MDrv_PCMCIA_Init( MS_BOOL bCD_Reverse );
DLL_PUBLIC void MDrv_PCMCIA_Exit( void );

DLL_PUBLIC MS_U32 MDrv_PCMCIA_SetPowerState(EN_POWER_MODE u16PowerState);

DLL_PUBLIC MS_BOOL MDrv_PCMCIA_PollingV2( PCMCIA_MODULE eModule );

DLL_PUBLIC void MDrv_PCMCIA_Set_HW_ResetDuration( MS_U8 u8HW_ResetDuration );

DLL_PUBLIC void MDrv_PCMCIA_ResetHW_V2( PCMCIA_MODULE eModule );
...
DLL_PUBLIC void MDrv_PCMCIA_ReadAttribMemV2( PCMCIA_MODULE eModule, MS_U16 u16Addr, MS_U8 *pDest );
...
DLL_PUBLIC void MDrv_PCMCIA_ParseAttribMem( MS_U8 *pAttribMem, MS_U16 dwLen, PCMCIA_INFO *pInfo );
//! Initialization function. During system initialization, this function
//! is called once to initialize the driver.

DLL_PUBLIC void MDrv_PCMCIA_WriteAttribMemV2( PCMCIA_MODULE eModule, MS_U16 wAddr, MS_U8 bData );
//! This function is called to write the byte bData into the card IO memory at address
//! wAddr.

DLL_PUBLIC void MDrv_PCMCIA_WriteIOMemV2( PCMCIA_MODULE eModule, MS_U16 wAddr, MS_U8 bData );
//! This function is read one byte of from the card IO memory at address wAddr.

DLL_PUBLIC void MDrv_PCMCIA_WriteIOMemLongV2( PCMCIA_MODULE eModule, MS_U16 u16Addr, MS_U8 u8Value, MS_U16 u16DataLen, MS_U8* u8pWriteBuffer);

DLL_PUBLIC MS_U8 MDrv_PCMCIA_ReadIOMemV2( PCMCIA_MODULE eModule, MS_U16 wAddr );

DLL_PUBLIC MS_BOOL MDrv_PCMCIA_IsModuleStillPluggedV2( PCMCIA_MODULE eModule );
//! This function is called to enable or disable the TS stream for PCMCIA common interface slots.

DLL_PUBLIC void MDrv_PCMCIA_Set_Detect_Trigger( MS_BOOL bActiveHigh );
DLL_PUBLIC void MDrv_PCMCIA_Set_Detect_Enable( MS_BOOL bEnable );
DLL_PUBLIC MS_U32 MDrv_PCMCIA_Get_CD_IntervalV2( PCMCIA_MODULE eModule );
DLL_PUBLIC MS_BOOL MDrv_PCMCIA_GetLibVer( const MSIF_Version **ppVersion );
DLL_PUBLIC void MDrv_PCMCIA_SetCommandBitV2( PCMCIA_MODULE eModule, MS_U8 u8CommandBit, MS_BOOL bValue );
DLL_PUBLIC MS_BOOL MDrv_PCMCIA_ResetInterfaceV2( PCMCIA_MODULE eModule );
DLL_PUBLIC MS_BOOL MDrv_PCMCIA_IsDataAvailableV2( PCMCIA_MODULE eModule );
DLL_PUBLIC MS_U16 MDrv_PCMCIA_ReadDataV2( PCMCIA_MODULE eModule, MS_U8* u8pReadBuffer, MS_U16 u16ReadBufferSize );
DLL_PUBLIC MS_BOOL MDrv_PCMCIA_WriteDataV2( PCMCIA_MODULE eModule, MS_U8* u8pWriteBuffer, MS_U16 u16DataLen );
DLL_PUBLIC MS_BOOL MDrv_PCMCIA_SwitchToIOmodeV2( PCMCIA_MODULE eModule, PCMCIA_INFO *pInfo );
DLL_PUBLIC MS_U16 MDrv_PCMCIA_NegotiateBufferSizeV2( PCMCIA_MODULE eModule, PCMCIA_INFO *pInfo );
DLL_PUBLIC void MDrv_PCMCIA_WriteBufferSizeV2( PCMCIA_MODULE eModule, MS_U16 u16BufferSize );
DLL_PUBLIC MS_BOOL MDrv_PCMCIA_WaitForStatusBitV2( PCMCIA_MODULE eModule, MS_U8 u8StatusBit );
DLL_PUBLIC MS_U8 MDrv_PCMCIA_ReadyStatus( void );

#if PCMCIA_IRQ_ENABLE
DLL_PUBLIC void MDrv_PCMCIA_Enable_InterruptV2( PCMCIA_MODULE eModule, MS_BOOL bEnable );
DLL_PUBLIC void MDrv_PCMCIA_Set_InterruptStatusV2( PCMCIA_MODULE eModule, MS_BOOL Status );
DLL_PUBLIC MS_BOOL MDrv_PCMCIA_Get_InterruptStatusV2( PCMCIA_MODULE eModule );
DLL_PUBLIC void MDrv_PCMCIA_InstarllIsrCallbackV2( PCMCIA_MODULE eModule, IsrCallback fnIsrCallback );
#endif
...
#define PCMCIA_DEFAULT_MODULE                   E_PCMCIA_MODULE_A
    ...
    #endif
#else
    DLL_PUBLIC MS_BOOL MDrv_PCMCIA_Polling( void );
    DLL_PUBLIC MS_BOOL MDrv_PCMCIA_IsModuleStillPlugged( void );
    DLL_PUBLIC void MDrv_PCMCIA_SetCommandBit( MS_U8 u8CommandBit, MS_BOOL bValue );
    DLL_PUBLIC MS_BOOL MDrv_PCMCIA_ResetInterface( void );
    DLL_PUBLIC MS_BOOL MDrv_PCMCIA_IsDataAvailable( void );
    DLL_PUBLIC MS_U16 MDrv_PCMCIA_ReadData( MS_U8* u8pReadBuffer, MS_U16 u16ReadBufferSize );
    DLL_PUBLIC MS_BOOL MDrv_PCMCIA_WriteData( MS_U8* u8pWriteBuffer, MS_U16 u16DataLen );
    DLL_PUBLIC MS_BOOL MDrv_PCMCIA_SwitchToIOmode( PCMCIA_INFO *pInfo );
    DLL_PUBLIC MS_U16 MDrv_PCMCIA_NegotiateBufferSize( PCMCIA_INFO *pInfo );
    DLL_PUBLIC void MDrv_PCMCIA_WriteBufferSize( MS_U16 u16BufferSize );
    DLL_PUBLIC MS_BOOL MDrv_PCMCIA_WaitForStatusBit( MS_U8 u8StatusBit );
    DLL_PUBLIC void MDrv_PCMCIA_ResetHW( void );
    DLL_PUBLIC void MDrv_PCMCIA_WriteAttribMem( MS_U16 wAddr, MS_U8 bData );
    DLL_PUBLIC void MDrv_PCMCIA_ReadAttribMem( MS_U16 u16Addr, MS_U8 *pDest );
    DLL_PUBLIC void MDrv_PCMCIA_WriteIOMem( MS_U16 wAddr, MS_U8 bData );
    DLL_PUBLIC void MDrv_PCMCIA_WriteIOMemLong( MS_U16 u16Addr, MS_U8 u8Value, MS_U16 u16DataLen, MS_U8* u8pWriteBuffer);
    DLL_PUBLIC MS_U8 MDrv_PCMCIA_ReadIOMem( MS_U16 wAddr );
    DLL_PUBLIC MS_U32 MDrv_PCMCIA_Get_CD_Interval( void );

    #if PCMCIA_IRQ_ENABLE
        DLL_PUBLIC void MDrv_PCMCIA_Enable_Interrupt( MS_BOOL bEnable );
        DLL_PUBLIC void MDrv_PCMCIA_Set_InterruptStatus( MS_BOOL Status );
        DLL_PUBLIC MS_BOOL MDrv_PCMCIA_Get_InterruptStatus( void );
        DLL_PUBLIC void MDrv_PCMCIA_InstarllIsrCallback( IsrCallback fnIsrCallback );
    #endif
#endif
