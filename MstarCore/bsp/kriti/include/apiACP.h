...
// @return ACP_Result
//----------------------------------------------------------------
DLL_PUBLIC ACP_Result MApi_ACP_SetProtection(MS_BOOL bEnable, MS_BOOL bIsYPbPr, MS_U8 u8Type);
...
// @return ACP_Result
//----------------------------------------------------------------
DLL_PUBLIC ACP_Result MApi_DCS_SetProtection(MS_BOOL bEnable, MS_U8 u8Type);
...
// where
//     DCS ACTIVATION KEY
//     Key TBL pu8ActivationKeyTbl is 4*8 array
//     The first element (4) is order by below
//          DCS STATE OFF_TO_TRANSITIONON
//          DCS STATE TRANSITIONON_TO_ON
//          DCS STATE ON_TO_TRANSITIONOFF
//          DCS STATE TRANSITIONOFF_TO_OFF
//     And the second element (8) is order by
//          [7:0], [15:8], [23:16], [31:24], [39:32], [47:40], [55:48], [63:56] (bit)
//
//     ex TRANSITIONON_TO_ON Key = 0xFEDCBA9876543210
//        pu8ActivationKeyTbl[4][8] =
//        {
//         {...},                                             (OFF_TO_TRANSITIONON row)
//         { 0x10, 0x32, 0x54, 0x76, 0x98, 0xBA, 0xDC, 0xFE}, (TRANSITIONON_TO_ON row)
//         {...},                                             (ON_TO_TRANSITIONOFF row)
//         {...}                                              (TRANSITIONOFF_TO_OFF row)
//        };
//----------------------------------------------------------------
DLL_PUBLIC ACP_Result MApi_DCS_SetActivationKey(MS_U8 *pu8ActivationKeyTbl, MS_U8 u8ActivationKeyTblSize);
