...
DLL_PUBLIC MS_BOOL MDrv_MMIO_Init(void);
DLL_PUBLIC MS_BOOL MDrv_MMIO_GetBASE(MS_U32 *u32Baseaddr, MS_U32 *u32Basesize, MS_U32 u32Module);
DLL_PUBLIC MS_BOOL MDrv_MMIO_Close(void);
