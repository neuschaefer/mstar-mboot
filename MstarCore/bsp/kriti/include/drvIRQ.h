...
//-------------------------------------------------------------------------------------------------
DLL_PUBLIC void MDrv_IRQ_Detech(MS_U32 u32Vector);
DLL_PUBLIC void MDrv_IRQ_Attach(MS_U32 u32Vector, void *pIntCb);
DLL_PUBLIC void MDrv_IRQ_Restore(void);
DLL_PUBLIC void MDrv_IRQ_MaskAll(void);
DLL_PUBLIC void MDrv_IRQ_UnMaskAll(void);
DLL_PUBLIC void MDrv_IRQ_Mask(MS_U32 u32Vector);
DLL_PUBLIC void MDrv_IRQ_UnMask(MS_U32 u32Vector);
DLL_PUBLIC void MDrv_IRQ_NotifyCpu(IRQ_CPU_TYPE eType);
DLL_PUBLIC MS_BOOL MDrv_IRQ_Init(void);
DLL_PUBLIC MS_BOOL MDrv_IRQ_InISR(void);
