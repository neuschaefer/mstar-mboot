...
// must have functions
DLL_PUBLIC MS_BOOL MDrv_VBI_GetLibVer(const MSIF_Version **ppVersion);                  ///< Get version (without Mutex protect)
DLL_PUBLIC const VBI_DrvInfo * MDrv_VBI_GetInfo(void);              ///< Get info from driver (without Mutex protect)
DLL_PUBLIC MS_BOOL MDrv_VBI_GetStatus(VBI_DrvStatus *pDrvStatus);   ///< Get VBI current status
DLL_PUBLIC MS_BOOL MDrv_VBI_SetDbgLevel(MS_U16 u16DbgSwitch);       ///< Set debug level (without Mutex protect)
 ...
 ****************************************************************************/
DLL_PUBLIC MS_BOOL MDrv_VBI_Init(VBI_INIT_TYPE type);
DLL_PUBLIC MS_BOOL MDrv_VBI_Exit(void);
/****************************************************************************
 ...
 *@return
 ****************************************************************************/
DLL_PUBLIC void MDrv_VBI_RegisterCB(VBI_CB_FN pFN, MS_PHYADDR bufferAddr, MS_U32 length);
 ...
 *@return
 ****************************************************************************/
DLL_PUBLIC void MDrv_VBI_RingBuffer_Reset(void);
 ...
 *@return
 ****************************************************************************/
DLL_PUBLIC void MDrv_VBI_InitializeTTXSlicer(MS_PHYADDR bufferAddr, MS_U16 packetCount);
 ...
 *@return
 ****************************************************************************/
DLL_PUBLIC void MDrv_VBI_EnableTTXSlicer(MS_BOOL bEnable);
 ...
 ****************************************************************************/
DLL_PUBLIC MS_BOOL MDrv_VBI_IsVPS_Ready(void);
 ...
 ****************************************************************************/
DLL_PUBLIC MS_BOOL MDrv_VBI_IsTTX_Ready(void);
 ...
 ****************************************************************************/
DLL_PUBLIC MS_BOOL MDrv_VBI_IsWSS_Ready(void);
 ...
 ****************************************************************************/
DLL_PUBLIC MS_U16 MDrv_VBI_GetWSS_Data(void);
 ...
 *@return
 ****************************************************************************/
DLL_PUBLIC void MDrv_VBI_GetVPS_Data(MS_U8 *lowerWord, MS_U8 *higherWord);
 ...
 *@return
 ****************************************************************************/
DLL_PUBLIC void MDrv_VBI_SetVideoStandard(VBI_VIDEO_STANDARD eStandard);
 ...
 ****************************************************************************/
DLL_PUBLIC MS_BOOL MDrv_VBI_TTX_CheckCircuitReady(void);
 ...
 ****************************************************************************/
DLL_PUBLIC MS_U16 MDrv_VBI_TTX_GetPacketCount(void);
 ...
 *  - FALSE: not empty
 ****************************************************************************/
DLL_PUBLIC MS_BOOL MDrv_VBI_TTX_PacketBufferIsEmpty(void);
 ...
 ****************************************************************************/
DLL_PUBLIC MS_BOOL MDrv_VBI_TTX_GetPackets(MS_PHYADDR dataAddr, MS_U32 *length);
 ...
 ****************************************************************************/
DLL_PUBLIC MS_BOOL MDrv_VBI_TTX_GetPacket(MS_PHYADDR *packetAddress);
 ...
 *   NULL otherwise.
 ***********************************************************************/
DLL_PUBLIC MS_BOOL MDrv_VBI_TTX_PacketBufferIsOverflow( void );
 ...
 ***********************************************************************/
DLL_PUBLIC MS_U16 MDrv_VBI_TTX_PacketBufferGetNoOfOverflows( void );
 ...
 *@return
 ****************************************************************************/
DLL_PUBLIC void MDrv_VBI_TTX_EnableLine(MS_U16 StartLine, MS_U16 EndLine);
...
****************************************************************************/
DLL_PUBLIC MS_BOOL MDrv_VBI_ProtectMemory(MS_BOOL bEnable, MS_PHYADDR phyAddr, MS_U32 u32Size);
/*
 *  ClosedCaption
 */
DLL_PUBLIC void MDrv_VBI_CC_InitSlicer(MS_U32 u32RiuAddr, MS_PHYADDR bufferAddr, MS_U16 packetCount);
DLL_PUBLIC void MDrv_VBI_CC_InitYPbYr(MS_U8 cvbs_no);
DLL_PUBLIC void MDrv_VBI_CC_EnableSlicer(MS_BOOL bEnable);
DLL_PUBLIC MS_U8 MDrv_VBI_CC_SetDataRate(MS_U8 *ptable);
DLL_PUBLIC void MDrv_VBI_CC_SetFrameCnt(MS_U8 cnt);
DLL_PUBLIC MS_U32 MDrv_VBI_CC_GetInfo(MS_U32 selector);
DLL_PUBLIC void MDrv_VBI_CC_EnableLine(MS_U16 StartLine, MS_U16 EndLine, MS_U8 mode);
DLL_PUBLIC MS_BOOL MDrv_VBI_SyncMemory( MS_U32 u32Start, MS_U32 u32Size );

/*
 *  Others
 */
DLL_PUBLIC void MDrv_VBI_WSS_SetVpsByteNum(MS_U8 cnt);

DLL_PUBLIC MS_BOOL MDrv_VBI_Suspend(void);
DLL_PUBLIC MS_BOOL MDrv_VBI_Resume(void);
DLL_PUBLIC MS_U32  MDrv_VBI_SetPowerState(EN_POWER_MODE u16PowerState);
