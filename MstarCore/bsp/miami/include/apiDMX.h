...
typedef enum
{
    E_DMX_TSO_IN_IF0                    = 0x0,
    E_DMX_TSO_IN_IF1                    = 0x1,
    E_DMX_TSO_IN_IF2                    = 0x2,

    E_DMX_TSO_IN_IF_NUM                 = 0x3,
}DMX_TSO_InputIf;
...
DMX_FILTER_STATUS MApi_DMX_TSO_LocalStreamId(MS_U8 u8Eng, DMX_TSO_InputIf eIf, MS_U8* pu8StrId, MS_BOOL bSet);
