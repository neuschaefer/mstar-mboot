...
typedef enum
{
    ...
    MAPI_CMD_GOP_DWIN_GET_RINGBUFFERINFO,
...
//  GOP FB management
//======================================================================================
int Ioctl_GOP_FB_SEL(MS_U8 u8FB);
int Ioctl_GOP_FB_Get(void);

//======================================================================================
//  GOP Palette setting
//======================================================================================
int Ioctl_GOP_GWIN_2GReadPalette(MS_U8 idx, MS_U32* clr);
int Ioctl_GOP_GWIN_2GSetPaletteRead(EN_GOP_PALETTE_READTYPE type);
int Ioctl_GOP_GWIN_2GSetPaletteOpt(GOP_PaletteEntry *pPalArray, MS_U16 u32PalStart, MS_U16 u32PalEnd);
int Ioctl_GOP_GWIN_SetPalette(void);
int Ioctl_GOP_GWIN_ReadPalette(MS_U8 idx, MS_U32* clr);

//======================================================================================
//  GOP DWIN APIs
//======================================================================================
int Ioctl_GOP_DWIN_Init(void);
int Ioctl_GOP_DWIN_EnableR2YCSC(MS_BOOL bEnable);
int Ioctl_GOP_DWIN_SelectSourceScanType(EN_GOP_DWIN_SCAN_MODE enScanMode);
int Ioctl_GOP_DWIN_SetAlphaValue(MS_U8 u8AlphaVal);
int Ioctl_GOP_DWIN_SetAlphaSrc(EN_GOP_DWIN_ALPHA_SRC source);
int Ioctl_GOP_DWIN_SetAlphaInverse(MS_BOOL bEnable);
int Ioctl_GOP_DWIN_SetUVSample(EN_GOP_DWIN_UVSAMPLE_Mode mode);
int Ioctl_GOP_DWIN_SetUVSwap(MS_BOOL bEnable);
int Ioctl_GOP_DWIN_GetWinProperty(GOP_DwinProperty *pproperty);
int Ioctl_GOP_DWIN_GetDWinIntInfoTimeout(GOP_DWinIntInfo *pDWinIntInfo,MS_U32 u32Timeout);
int Ioctl_GOP_DWIN_SetSkipFrame(MS_U32 framecount);
int Ioctl_GOP_DWIN_SetBufferPINPON(MS_U32 u32fbaddr0,MS_U32 u32fbaddr1);
...
//  OC
//======================================================================================
int Ioctl_GOP_OC_SetOCFBinfo(MS_PHYADDR u32Addr, EN_GOP_OC_SEL_TYPE BankMode, MS_U32 enBufSize);

//======================================================================================
//  MISC
//======================================================================================
void Ioctl_GOP_AtExit(void);
int Ioctl_GOP_Get_GOP(MS_U8 *pGOP);
int Ioctl_GOP_Get_ScaleDst(MS_U8 u8GOPNum,MS_U16 *pHScaleDst,MS_U16 *pVScaleDst);
int Ioctl_GOP_Get_PnlSize(MS_U8 u8GOPNum,MS_U16 *pPnlWidth,MS_U16 *pPnlHeight);
int Ioctl_GOP_GWIN_Set_HStretchMode(EN_GOP_STRETCH_HMODE HStrchMode);
int Ioctl_GOP_GWIN_Set_VStretchMode(EN_GOP_STRETCH_VMODE VStrchMode);
int Ioctl_GOP_GWIN_Set_TranspColorStretchMode(EN_GOP_STRCH_TRANSPCOLORMODE  TColorStrchMode);
int Ioctl_GOP_GWIN_SetBnkForceWrite(MS_U8 u8GOP, MS_BOOL bEnable);
int Ioctl_GOP_GWIN_SetForceWrite(MS_BOOL bEnable);
int Ioctl_GOP_SetClkForCapture(void);
int Ioctl_GOP_PowerOn(void);
int Ioctl_GOP_PowerOff(void);
int Ioctl_GOP_SetGOPBWStrength(EN_GOP_BW_STRENGTH eGOPBWStr, MS_U8 u8GOP);
int Ioctl_GOP_GetGOPBWStrength(MS_U8 u8GOP, EN_GOP_BW_STRENGTH* curBW);
int Ioctl_GOP_SetGOPYUV(MS_U8 u8GOP);
int Ioctl_GOP_MIXER_SetOutputTiming(GOP_MIXER_TIMINGTYPE mode,  GOP_MixerTiming *pMT);
int Ioctl_GOP_MIXER_SetMIXER2OPOutputTiming(GOP_Mixer2OPTiming *pMT);
int Ioctl_GOP_MIXER_EnableVfilter(MS_BOOL bEnable);
int Ioctl_GOP_EnableLBCouple(MS_U8 u8GOP, MS_BOOL bEnable);
int Ioctl_GOP_Enable_VEOSD(MS_U8 u8GOP, MS_BOOL bEn);
int Ioctl_GOP_Set3D_LR_FrameExchange(MS_U8 u8GOP);
int Ioctl_GOP_GWIN_SetScrollRate(MS_U8 u8rate);
int Ioctl_GOP_GWIN_SetScrollType(MS_U8 u8WinId, GOP_SCROLL_TYPE type,  MS_U16 u16Offset, MS_BOOL bEnable );
int Ioctl_GOP_TestPatternAlpha_Enable(MS_BOOL bTSTAlpha);
int Ioctl_GOP_IsRegUpdated(MS_U8 u8GopType);
int Ioctl_GOP_GWIN_IsGwinExist(MS_U8 gId);
int Ioctl_GOP_OutputLayerSwitch(MS_U8 u8GOP);
int Ioctl_GOP_SetGOPClk(MS_U8 gopNum, EN_GOP_DST_TYPE eDstType);
int Ioctl_GOP_GWIN_EnableT3DMode(MS_BOOL bEnable);
int Ioctl_GOP_GWIN_Set_VSCALE(MS_BOOL bEnable, MS_U16 src, MS_U16 dst);
int Ioctl_GOP_GWIN_Set_HSCALE(MS_BOOL bEnable, MS_U16 src, MS_U16 dst);
int Ioctl_GOP_GWIN_SetGWinShared(MS_U8 winId, MS_BOOL bIsShared);
int Ioctl_GOP_GWIN_SetGWinSharedCnt(MS_U8 winId, MS_U16 u16SharedCnt);
int Ioctl_GOP_GWIN_Switch2Gwin(MS_U8 winId);
int Ioctl_GOP_GWIN_GetFreeWinID(void);
int Ioctl_GOP_GWIN_Is32FBExist(MS_U32 u32fbId);
MS_U32 Ioctl_GOP_GWIN_GetFBfromGWIN(MS_U8 gwinId);
int Ioctl_GOP_GWIN_SwapOverlapWin(MS_U8 u8GOP, MS_U8 u8win);
int Ioctl_GOP_GWIN_SetRelativeWinPrio(MS_U8 u8GOP, GOP_GwinPri *pGwinPri);
int Ioctl_GOP_GetInfo(GOP_ApiInfo* pGopApiInfo);
int Ioctl_GOP_GetRTStatus(GOP_ApiStatus *pGopApiSts);
int Ioctl_GOP_Set3DOSDMode(MS_U8 u8Gwin, MS_U16 u16MainFBId, MS_U16 u16SubFBId,EN_GOP_3D_MODETYPE en3DMode);
#ifdef __cplusplus
}
#endif
