...
#define MSIF_PNL_EX_LIBVER                 {'0','3'}
#define MSIF_PNL_EX_BUILDNUM               {'5','2'}
#define MSIF_PNL_EX_CHANGELIST             {'0','0','6','1','4','4','7','7'}
...
const PNL_EX_ApiInfo*   MApi_PNL_EX_GetInfo(const PNL_DeviceId *pPNL_DeviceId);
...
void                    MApi_PNL_EX_Mod_Calibration_Setting(const PNL_DeviceId *pPNL_DeviceId, MS_U8 U8MOD_CALI_TARGET, MS_S8 S8MOD_CALI_OFFSET);
