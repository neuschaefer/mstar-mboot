...
#define MSIF_GOP_BUILDNUM                   {'1','5'}            //Build Number
#define MSIF_GOP_CHANGELIST                 {'0','0','6','0','2','2','3','5'} //P4 ChangeList Number
...
E_GOP_API_Result MApi_GOP_Set3DOSDMode(MS_U8 u8Gwin, MS_U16 u16MainFBId, MS_U16 u16SubFBId,EN_GOP_3D_MODETYPE e3DMode);
