...
#define MSIF_TSP_CHANGELIST         {'0','0','6','1','1','2','5','5'}                               // P4 ChangeList Number
...
// General API
TSP_Result DLL_LOCAL MDrv_TSP_InitLibResource(void *pu32ResMemAddr);
TSP_Result DLL_LOCAL MDrv_TSP_Reinit(MS_BOOL bHK); //for utopia 2.0
...
DLL_PUBLIC TSP_Result MDrv_TSP_PidFlt_GetPid(MS_U32 u32EngId, MS_U32 u32PidFltId, MS_U32* pu32PID);
