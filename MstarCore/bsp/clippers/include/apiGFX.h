...
extern GFX_Result MApi_GFX_SetTLBMode(EN_GFX_TLB_Mode TLBmode);
extern GFX_Result MApi_GFX_SetTLBBaseADDR(MS_PHYADDR u32TLBSrcMiuAddr,MS_PHYADDR u32TLBDstMiuAddr);
extern GFX_Result MApi_GFX_SetTLBFlushTable(MS_BOOL enable);
extern GFX_Result MApi_GFX_SetTLBTag(MS_U16 tag);


//Two source
extern GFX_Result MApi_GFX_BitbltByTwoSourceBuffer(PGFX_BufferInfo dstbufInfo, GFX_DrawTwoSourceRect *pbmpfmt, MS_U32 drawflag);
