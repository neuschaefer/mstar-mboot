...
#define MSIF_XC_BUILDNUM               {'0','7'}
#define MSIF_XC_CHANGELIST             {'0','0','6','2','5','9','8','3'}
...
#define API_XCSTATUS_EX_VERSION                        2
...
//-------------------------------------------------------------------------------------------------
MS_U32 MApi_XC_CalculateHFreqx1K(MS_U16 wHPeriod);
...
//-------------------------------------------------------------------------------------------------
MS_U32 MApi_XC_CalculateVFreqx1K(MS_U32 wHFreq, MS_U16 wVTotal);
...
/// @param  bTrue      \b IN: True: Thresh mode, False: Non-Thresh mode
//-------------------------------------------------------------------------------------------------
void    MApi_XC_Enable_FPLL_Thresh_Mode(MS_BOOL bTrue);
...
//-------------------------------------------------------------------------------------------------
/// Set XC W/R Bank Mapping
/// @param  u8Val                   \b IN: W/R bank mapping value
/// @param  eWindow                 \b IN: which window we are going to set
//-------------------------------------------------------------------------------------------------
void MApi_XC_SetWrBankMapping(MS_U8 u8Val, SCALER_WIN eWindow);
