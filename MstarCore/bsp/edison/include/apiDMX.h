...
#define MSIF_DMX_BUILDNUM                     {'3','2'}            //Build Number
#define MSIF_DMX_CHANGELIST                   {'0','0','6','9','6','7','6','2'} //P4 ChangeList Number
...
#define DMX_FILTER_TYPE_AUDIO4          0x0000000A   ///< DMX audio 3 filter type
