...
//=============================================================
 ...
 void    MApi_AUDIO_PIP_SetMute(AUDIO_OUTPORT_SOURCE_TYPE eProcessor, MS_BOOL EnMute );
...
MS_BOOL MApi_AUDIO_DigitalOut_SetChannelStatus(AUDIO_OUTPUT_TYPE ePath, SPDIF_CS_MODE_TYPE eType, MS_U8 eValue);
//=============================================================
