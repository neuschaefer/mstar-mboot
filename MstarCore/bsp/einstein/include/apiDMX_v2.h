...
enum {
    ...
    MApi_CMD_DMX_Init,                              // (DMX_TSPParam*)
    MApi_CMD_DMX_Exit,
    MApi_CMD_DMX_ForceExit,
    MApi_CMD_DMX_Suspend,
    MApi_CMD_DMX_Resume,                            // (DMX_TSPParam*)
    ...
    //STC API
    MApi_CMD_DMX_GetPcr,                            // pointer to (U32_Eng_Id, U32_PCR_L, U32_PCR_H)
    MApi_CMD_DMX_Stc,                               // pointer to (U32_Eng_Id, U32_STC_L, U32_STC_H, U32_bSet)
    ...
    MApi_CMD_DMX_RemoveDupAVFifoPkt,                // pointer to (DMX_AVFIFO_PARAM), u32Data is for setting bEnable
    ...
    MApi_CMD_DMX_Pvr_PidClose,                      // pointer to (U32_EngId, U32_DmxId, U32_CAEngSel)
    ...
    MApi_CMD_DMX_Pvr_TimeStampMode,                 // pointer to (U32_EngId, U32_bEnable)
    MApi_CMD_DMX_Pvr_RecordStamp,                   // pointer to (U32_EngId, U32_Stamp, U32_bSet)
    MApi_CMD_DMX_Pvr_SetMobfKey,                    // pointer to (U32_EngId, U32_Key0, U32_Key1)
    ...
    MApi_CMD_DMX_FI_SetMobfKey,                     // pointer to (U32_EngId, U32_Key)
    ...
    MApi_CMD_DMX_MMFI_PlayStamp,                    // pointer to (U32_EngId, U32_Stamp, U32_bSet)
    MApi_CMD_DMX_MMFI_RemoveDupAVPkt,               // pointer to (DMX_AVFIFO_PARAM), u32Data is for setting bEnable
    MApi_CMD_DMX_MMFI_SetMOBFKey,                   // pointer to (U32_EngId, U32_Key)
