...
#define MMFI_VER_1_0                     0x0100
#define MMFI_VER_2_0                     0x0200
...
#define MSIF_MMFI_LIBVER             {'0','1'}                                                       // LIB version
#define MSIF_MMFI_BUILDNUM           {'0','1'}                                                       // Build Number
#define MSIF_MMFI_CHANGELIST         {'0','0','5','8','1','2','6','4'}                               // P4 ChangeList Number
...
typedef enum
{    
    E_DRVMMFI_MODE_NO_BYPASS    	= 0x0000,   
        
	E_DRVMMFI_MODE_PS_AU          	= 0x0001,    
	E_DRVMMFI_MODE_PS_AUB          	= 0x0002,     
	E_DRVMMFI_MODE_PS_VD          	= 0x0004,
    E_DRVMMFI_MODE_PS_V3D          	= 0x0008,
	
    E_DRVMMFI_MODE_APID_BYPASS    	= 0x0010,   
	E_DRVMMFI_MODE_APIDB_BYPASS    	= 0x0020,   	
	E_DRVMMFI_MODE_VDPID_BYPASS  	= 0x0040,     
    E_DRVMMFI_MODE_V3DPID_BYPASS  	= 0x0080,     
} DrvMMFI_FileinMode;
