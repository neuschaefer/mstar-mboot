...
typedef enum {
    ...
    MApi_CMD_DMX_WProtectEnable,                    // pointer to (PDMX_WP_PARAM)
    MApi_CMD_DMX_OrzWProtectEnable,                 // pointer to (U32_bEnable, U32_StartAddr, U32_EndAddr)
    ...
    MApi_CMD_DMX_STCEng_Sel,                       /// pointer to (U32_eFltSrc, U32_u32StcEng)
    MApi_CMD_DMX_TSO_LocStrId,                     /// pointer to (DMX_TSO_LOCSTRID_PARAM)
    MApi_CMD_DMX_TSO_CmdQReset,                    /// pointer to (U32_Eng)
    MApi_CMD_DMX_GetFltScmbSts,                    /// pointer to (U32_FltSrc, U32_FltGroupId, U32_PidFltId, U32_ScmbSts)

    //FQ
    MApi_CMD_DMX_FQ_SetFltRushPass,
    MApi_CMD_DMX_FQ_Init,
    MApi_CMD_DMX_FQ_Exit,
    MApi_CMD_DMX_FQ_RushEnable,
    MApi_CMD_DMX_FQ_SkipRushData,
