...
void MHal_EMAC_ClkGen(void)
{
    ...
    MHal_EMAC_WritReg8(0x1012, 0x2E, 0x09);      // set gmac as client id 0
    MHal_EMAC_WritReg8(0x1012, 0x2F, 0x03);      // set cpu as client id 0
    MHal_EMAC_WritReg8(0x1012, 0x22, 0x03);      // enable client id 0 in block1
    MHal_EMAC_WritReg8(0x1012, 0xC4, 0x00);      // set start addr of block1, 0x2400000>>13, 0x1200
    MHal_EMAC_WritReg8(0x1012, 0xC5, 0x12);      // set start addr of block1
    MHal_EMAC_WritReg8(0x1012, 0xC6, 0x7F);      // set end addr of block1, ((0x2400000+0x100000)>>13) - 1, 0x127F
    MHal_EMAC_WritReg8(0x1012, 0xC7, 0x12);      // set end addr of block1
//  MHal_EMAC_WritReg8(0x1012, 0xC4, 0x80);      // set start addr of block1, 0x4100000>>13, 0x2080
//  MHal_EMAC_WritReg8(0x1012, 0xC5, 0x20);      // set start addr of block1
//  MHal_EMAC_WritReg8(0x1012, 0xC6, 0xFF);      // set end addr of block1, ((0x4100000+0x100000)>>13) - 1, 0x20FF
//  MHal_EMAC_WritReg8(0x1012, 0xC7, 0x20);      // set end addr of block1
    MHal_EMAC_WritReg8(0x1012, 0xD2, MHal_EMAC_ReadReg8(0x1012,0xD2)|0x02);      // w_en block1
