...
INTERFACE U16 volatile  g_u16IrRc5Data;          // for store shift ir data    
INTERFACE U8 volatile  g_u8IrRc5Bits;                // for store bit count
INTERFACE U16 volatile  g_u16IrRc5Counter;         // for read counter from register
INTERFACE U8 volatile  g_u8IrRc5Flag;            // for store bit var
INTERFACE U8 volatile  g_u8IrRc5RepeatCount;
