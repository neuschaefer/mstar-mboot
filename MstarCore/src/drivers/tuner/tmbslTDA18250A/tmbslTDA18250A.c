...
static tmErrorCode_t
iTDA18250A_GetPowerLevel(UInt8 u8TunerIndex,pTDA18250AObject_t pObj, UInt8 uRSSIValue, Int32* pPowerLevel);
...
{
    {
        ...
        TDA18250A_Scanning_Mode_Disabled,
...
tmbslTDA18250B_ResetConfig(UInt8 u8TunerIndex)
{
    ...
    gTDA18250AInstance[u8TunerIndex].eXtalFreq = TDA18250A_XtalFreq_16000000;
    ...
    if(err == TM_OK || err == TDA18250A_ERR_ERR_NO_INSTANCES)
    {
        ...
        else
        {
            if(P_OBJ_VALID == False)
            {
                ...
                err = iTDA18250A_AllocInstance(u8TunerIndex, tUnit, &pObj);
                         ...
                         )
{
    ...
    //{
        ...
        pObj = &gTDA18250AInstance[u8TunerIndex];
        if (pObj->init == False)
        {
            err = TM_OK;
