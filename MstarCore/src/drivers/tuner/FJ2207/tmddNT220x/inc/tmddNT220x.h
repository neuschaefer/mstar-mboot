...
#define ddNT220x_ERR_BAD_VERSION        (ddNT220x_ERR_COMP + 0x0003)
    ...
    typedef enum _tmddNT220x_VersionForced_t {
        tmddNT220x_Version_Not_Forced = 0,                                        /* Version Not Forced */
        tmddNT220x_Version_Forced_ES2,                                            /* Version Forced to ES2 */
        tmddNT220x_Version_Forced_ES3                                             /* Version Forced to ES3 */
    } tmddNT220x_VersionForced_t, *ptmddNT220x_VersionForced_t;
