...
#define RIU_BASE_TIMER0  		GET_REG_ADDR(RIU_PM_BASE, REG_BANK_TIMER0)
#define TIMER0_ENABLE			GET_REG_ADDR(TIMER0_BASE, 0x10)
#define TIMER0_HIT				GET_REG_ADDR(TIMER0_BASE, 0x11)
#define TIMER0_MAX_LOW			GET_REG_ADDR(TIMER0_BASE, 0x12)
#define TIMER0_MAX_HIGH			GET_REG_ADDR(TIMER0_BASE, 0x13)
#define TIMER0_CAP_LOW			GET_REG_ADDR(TIMER0_BASE, 0x14)
#define TIMER0_CAP_HIGH			GET_REG_ADDR(TIMER0_BASE, 0x15)
...
#define eMMC_HW_TIMER_HZ    12000000 // [FIXME]
