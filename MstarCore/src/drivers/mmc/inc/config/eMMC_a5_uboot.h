...
#define RIU_BASE                0xBF200000U	//0x1F200000
...
#define REG_TEST_MODE_MASK      (BIT0|BIT1|BIT2|BIT4|BIT5|BIT6) 
...
#define CFG_NAND_PAD_MASK		(BIT2|BIT3|BIT6|BIT7)
#define reg_pcmcia_pad			GET_REG_ADDR(PAD_CHIPTOP_BASE, 0x64)
#define REG_PCMCIA_PAD_MASK     (BIT0|BIT4)
...
#define eMMC_HW_TIMER_HZ   (32*1024)//(384*100*1000)  // [FIXME]
