...
void MHal_EMAC_ClkGen(void)
{
    ...
    *(volatile unsigned int *)(0x1F2453BC) = ((*(volatile unsigned int *)(0x1F2453BC) & 0xFF00) | 0x0059);
    *(volatile unsigned int *)(0x1F2453E8) = ((*(volatile unsigned int *)(0x1F2453E8) & 0xFF00) | 0x0021);
    *(volatile unsigned int *)(0x1F2450E4) = ((*(volatile unsigned int *)(0x1F2450E4) & 0xFF00) | 0x0080);
    *(volatile unsigned int *)(0x1F24536C) = ((*(volatile unsigned int *)(0x1F24536C) & 0x00FF) | 0x0700);
    *(volatile unsigned int *)(0x1F245394) = ((*(volatile unsigned int *)(0x1F245394) & 0x00FF) | 0x1100);
    *(volatile unsigned int *)(0x1F245398) = 0xD180;
    *(volatile unsigned int *)(0x1F2453A8) = (*(volatile unsigned int *)(0x1F2453A8) & 0xFF00);
    *(volatile unsigned int *)(0x1F245370) = ((*(volatile unsigned int *)(0x1F245370) & 0x00FF) | 0x4000);
    *(volatile unsigned int *)(0x1F245374) = ((*(volatile unsigned int *)(0x1F245374) & 0x00FF) | 0x0500); //Power on Tx
    *(volatile unsigned int *)(0x1F245360) = 0x6002;
    *(volatile unsigned int *)(0x1F2450E4) = (*(volatile unsigned int *)(0x1F2450E4) & 0xFFF7); //unset loop_back_enable
    *(volatile unsigned int *)(0x1F245368) = ((*(volatile unsigned int *)(0x1F245368) & 0xFF00) | 0x0056); //gain shift
    *(volatile unsigned int *)(0x1F24529C) = ((*(volatile unsigned int *)(0x1F24529C) & 0x00FF) | 0x0200); //det max
    *(volatile unsigned int *)(0x1F2452A0) = ((*(volatile unsigned int *)(0x1F2452A0) & 0x00FF) | 0x0100); //det min
    *(volatile unsigned int *)(0x1F2452EC) = ((*(volatile unsigned int *)(0x1F2452EC) & 0x00FF) | 0x1800); //snr len (emc noise)
    *(volatile unsigned int *)(0x1F245284) = ((*(volatile unsigned int *)(0x1F245284) & 0x00FF) | 0x1500); //snr k value
