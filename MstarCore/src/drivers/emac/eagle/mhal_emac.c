...
void MHal_EMAC_ClkGen(void)
{
    ...
    *(volatile unsigned int *)(0x1F2433BC) = ((*(volatile unsigned int *)(0x1F2433BC) & 0xFF00) | 0x0059);
    *(volatile unsigned int *)(0x1F2433E8) = ((*(volatile unsigned int *)(0x1F2433E8) & 0xFF00) | 0x0021);
    *(volatile unsigned int *)(0x1F2430E4) = ((*(volatile unsigned int *)(0x1F2430E4) & 0xFF00) | 0x0080);
    *(volatile unsigned int *)(0x1F24336C) = ((*(volatile unsigned int *)(0x1F24336C) & 0x00FF) | 0x0700);
    *(volatile unsigned int *)(0x1F243394) = ((*(volatile unsigned int *)(0x1F243394) & 0x00FF) | 0x1100);
    *(volatile unsigned int *)(0x1F243398) = 0xD180;
    *(volatile unsigned int *)(0x1F2433A8) = (*(volatile unsigned int *)(0x1F2433A8) & 0xFF00);
    *(volatile unsigned int *)(0x1F243370) = ((*(volatile unsigned int *)(0x1F243370) & 0x00FF) | 0x4000);
    *(volatile unsigned int *)(0x1F243374) = ((*(volatile unsigned int *)(0x1F243374) & 0x00FF) | 0x0500); //Power on Tx
    *(volatile unsigned int *)(0x1F243360) = 0x6002;
    //*(volatile unsigned int *)(0x1F203D68) = ((*(volatile unsigned int *)(0x1F203D68) & 0xFF00) | 0x0010); //LED
    *(volatile unsigned int *)(0x1F2430E4) = (*(volatile unsigned int *)(0x1F2430E4) & 0xFFF7); //unset loop_back_enable
    *(volatile unsigned int *)(0x1F243368) = ((*(volatile unsigned int *)(0x1F243368) & 0xFF00) | 0x0056); //gain shift
    *(volatile unsigned int *)(0x1F24329C) = ((*(volatile unsigned int *)(0x1F24329C) & 0x00FF) | 0x0200); //det max
    *(volatile unsigned int *)(0x1F2432A0) = ((*(volatile unsigned int *)(0x1F2432A0) & 0x00FF) | 0x0100); //det min
    *(volatile unsigned int *)(0x1F2432EC) = ((*(volatile unsigned int *)(0x1F2432EC) & 0x00FF) | 0x1800); //snr len (emc noise)
    *(volatile unsigned int *)(0x1F243284) = ((*(volatile unsigned int *)(0x1F243284) & 0x00FF) | 0x1500); //snr k value
