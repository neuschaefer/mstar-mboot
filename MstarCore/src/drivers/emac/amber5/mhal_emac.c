...
void MHal_EMAC_ClkGen(void)
{
    ...
    *(volatile unsigned int *)(0xBF2453BC) = ((*(volatile unsigned int *)(0xBF2453BC) & 0xFF00) | 0x0059);
    *(volatile unsigned int *)(0xBF2453E8) = ((*(volatile unsigned int *)(0xBF2453E8) & 0xFF00) | 0x0021);
    *(volatile unsigned int *)(0xBF2450E4) = ((*(volatile unsigned int *)(0xBF2450E4) & 0xFF00) | 0x0080);
    *(volatile unsigned int *)(0xBF24536C) = ((*(volatile unsigned int *)(0xBF24536C) & 0x00FF) | 0x0700);
    *(volatile unsigned int *)(0xBF245394) = ((*(volatile unsigned int *)(0xBF245394) & 0x00FF) | 0x1100);
    *(volatile unsigned int *)(0xBF245398) = 0xD180;
    *(volatile unsigned int *)(0xBF2453A8) = (*(volatile unsigned int *)(0xBF2453A8) & 0xFF00);
    *(volatile unsigned int *)(0xBF245370) = ((*(volatile unsigned int *)(0xBF245370) & 0x00FF) | 0x4000);
    *(volatile unsigned int *)(0xBF245374) = ((*(volatile unsigned int *)(0xBF245374) & 0x00FF) | 0x0500); //Power on Tx
    *(volatile unsigned int *)(0xBF245360) = 0x6002;
    *(volatile unsigned int *)(0xBF203D68) = ((*(volatile unsigned int *)(0xBF203D68) & 0xFF00) | 0x0010); //LED
