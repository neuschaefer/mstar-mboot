...
{
    *(volatile unsigned int *)(0x1F204274) = 0x0100; //swith RX discriptor format to mode 1
#ifdef CONFIG_ETHERNET_ALBANY
    *(volatile unsigned int *)(0x1F001CC0) = ((*(volatile unsigned int *)(0x1F001CC0) & 0xFF00) | 0x0040); // PD_ETH33
    *(volatile unsigned int *)(0x1F00669C) = ((*(volatile unsigned int *)(0x1F00669C) & 0x00FF) | 0x0200); //det max
    *(volatile unsigned int *)(0x1F0066A0) = ((*(volatile unsigned int *)(0x1F0066A0) & 0x00FF) | 0x0100); //det min
    *(volatile unsigned int *)(0x1F0066EC) = ((*(volatile unsigned int *)(0x1F0066EC) & 0x00FF) | 0x1800); //snr len (emc noise)
    *(volatile unsigned int *)(0x1F0064E4) = ((*(volatile unsigned int *)(0x1F0064E4) & 0xFF00) | 0x0080); // Lpbk_enable set to 0
    *(volatile unsigned int *)(0x1F0067F8) = 0x0000; //Power-on LDO25/LDO11
    *(volatile unsigned int *)(0x1F00676C) = ((*(volatile unsigned int *)(0x1F00676C) & 0x00FF) | 0x0700); // Power-on ADC
    *(volatile unsigned int *)(0x1F006794) = ((*(volatile unsigned int *)(0x1F006794) & 0x00FF) | 0x1100); // Power-on BGAP
    *(volatile unsigned int *)(0x1F006798) = 0xd020; // Power-on ADCPL, Power-on ADCPL
    *(volatile unsigned int *)(0x1F0067A8) = (*(volatile unsigned int *)(0x1F0067A8) & 0xFF00); //Power-on LPF_OP
    *(volatile unsigned int *)(0x1F006770) = ((*(volatile unsigned int *)(0x1F006770) & 0x00FF) | 0x4000); // Power-on LP
    *(volatile unsigned int *)(0x1F006774) = ((*(volatile unsigned int *)(0x1F006774) & 0x00FF) | 0x4500); // Power on REF
    *(volatile unsigned int *)(0x1F006874) = 0x0003; // PD_TX_IDAC, PD_TX_LD = 0	
    *(volatile unsigned int *)(0x1F006988) = ((*(volatile unsigned int *)(0x1F006988) & 0x00FF)); // 100gat
    *(volatile unsigned int *)(0x1F006860) = ((*(volatile unsigned int *)(0x1F006860) & 0xFF00) | 0x43); // 200gat
    *(volatile unsigned int *)(0x1F006870) = ((*(volatile unsigned int *)(0x1F006870) & 0x00FF) | 0x4100); // en_100t_phase;  [6] save2x_tx

    *(volatile unsigned int *)(0x1F006458) = (*(volatile unsigned int *)(0x1F006458) | 0x4000); //disable EEE
...
{
    *( ( u32 * ) ( ( char * ) 0x1F006600 +  0x7E*4) ) = 0x0102;
    *( ( u32 * ) ( ( char * ) 0x1F006600 +  0x5B*4) ) = ( (*( ( u32 * ) ( ( char * ) 0x1F006600 +  0x5B*4) ) & 0x00FF) | 0x1700 );
    *( ( u32 * ) ( ( char * ) 0x1F006600 +  0x65*4) ) = ( (*( ( u32 * ) ( ( char * ) 0x1F006600 +  0x65*4) ) & 0x00FF) | 0x1100 );
    *( ( u32 * ) ( ( char * ) 0x1F006600 +  0x66*4) ) = 0xd930;
    *( ( u32 * ) ( ( char * ) 0x1F006600 +  0x6A*4) ) = ( (*( ( u32 * ) ( ( char * ) 0x1F006600 +  0x6A*4) ) & 0xFF00) | 0x0020 );
    *( ( u32 * ) ( ( char * ) 0x1F006600 +  0x5C*4) ) = ( (*( ( u32 * ) ( ( char * ) 0x1F006600 +  0x5C*4) ) & 0x00FF) | 0x4100 );
    *( ( u32 * ) ( ( char * ) 0x1F006600 +  0x5D*4) ) = ( (*( ( u32 * ) ( ( char * ) 0x1F006600 +  0x5D*4) ) & 0x00FF) | 0x0500 );
    *( ( u32 * ) ( ( char * ) 0x1F006800 +  0x1D*4) ) = 0x03f3;
    *( ( u32 * ) ( ( char * ) 0x1F006800 +  0x62*4) ) = ( (*( ( u32 * ) ( ( char * ) 0x1F006800 +  0x62*4) ) & 0x00FF) | 0x4000 );
    *( ( u32 * ) ( ( char * ) 0x1F006800 +  0x18*4) ) = ( (*( ( u32 * ) ( ( char * ) 0x1F006800 +  0x18*4) ) & 0xFF00) | 0x0053 );
    *(volatile unsigned int *)(0x1F201780) = 0x0101; //Set MII Mode
    *(volatile unsigned int *)(0x1F201784) = 0x0001;
}

void MHal_EMAC_Ewavetest_100M(void)
{
    *( ( u32 * ) ( ( char * ) 0x1F006400 +  0x16*4) ) = ( (*( ( u32 * ) ( 0x1F006400 +  0x16*4) ) & 0xC7FF) | 0x0800 );
    *( ( u32 * ) ( ( char * ) 0x1F006400 +  0x00*4) ) = ( (*( ( u32 * ) ( 0x1F006400 +  0x00*4) ) & 0x6FFF) | 0x8000 );
    *( ( u32 * ) ( ( char * ) 0x1F006400 +  0x00*4) ) = ( (*( ( u32 * ) ( 0x1F006400 +  0x00*4) ) & 0x6FFF) | 0x8000 );
    *( ( u32 * ) ( ( char * ) 0x1F006400 +  0x00*4) ) = ( (*( ( u32 * ) ( 0x1F006400 +  0x00*4) ) & 0x6FFF) | 0x8000 );
    *( ( u32 * ) ( ( char * ) 0x1F006400 +  0x00*4) ) = ( (*( ( u32 * ) ( 0x1F006400 +  0x00*4) ) & 0x6FFF) | 0x8000 );
    *( ( u32 * ) ( ( char * ) 0x1F006400 +  0x00*4) ) = ( (*( ( u32 * ) ( 0x1F006400 +  0x00*4) ) & 0x6FFF) | 0x0000 );
}
