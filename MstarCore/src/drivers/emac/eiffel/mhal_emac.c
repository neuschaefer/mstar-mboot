...
void MHal_EMAC_ClkGen(void)
{
    ...
    *(volatile unsigned int *)(0x1F001CC0) = (*(volatile unsigned int *)(0x1F001CC0) & 0xFFFE);
    ...
    *(volatile unsigned int *)(0x1F0067F8) = (*(volatile unsigned int *)(0x1F0067F8) & 0xFF00);
    ...
    *(volatile unsigned int *)(0x1F006760) = 0x6002;
    *(volatile unsigned int *)(0x1F0064E4) = (*(volatile unsigned int *)(0x1F0064E4) & 0xFFF7); //unset loop_back_enable
...
void MHal_EMAC_PadMux(void)
{
    ...
    *( ( u32 * ) ( ( char * ) 0x1F203C00 + 0x50*4 ) ) &= 0x7FFF;
    //chiptop [9:8] et_mode
#ifdef CONFIG_ETHERNET_ALBANY
    *( ( u32 * ) ( ( char * ) 0x1F203C00 + 0x6F*4 ) ) &= (~0x0200); //patch
#else
    *( ( u32 * ) ( ( char * ) 0x1F203C00 + 0x6F*4 ) ) |= 0x0200;    //et_mode = 1
#endif
}
