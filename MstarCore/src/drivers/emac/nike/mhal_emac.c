...
void MHal_EMAC_ClkGen(void)
{
    ...
    *(volatile unsigned int *)(0x1F0067BC) = ((*(volatile unsigned int *)(0x1F0067BC) & 0xFF00) | 0x0059);
    *(volatile unsigned int *)(0x1F0067E8) = ((*(volatile unsigned int *)(0x1F0067E8) & 0xFF00) | 0x0021);
    *(volatile unsigned int *)(0x1F0064E4) = ((*(volatile unsigned int *)(0x1F0064E4) & 0xFF00) | 0x0080);
    *(volatile unsigned int *)(0x1F0067F8) = 0x0000;
    *(volatile unsigned int *)(0x1F00676C) = ((*(volatile unsigned int *)(0x1F00676C) & 0x00FF) | 0x0700);
    *(volatile unsigned int *)(0x1F006794) = ((*(volatile unsigned int *)(0x1F006794) & 0x00FF) | 0x1100);
    *(volatile unsigned int *)(0x1F006798) = 0xD180;
    *(volatile unsigned int *)(0x1F0067A8) = (*(volatile unsigned int *)(0x1F0067A8) & 0xFF00);
    *(volatile unsigned int *)(0x1F006770) = ((*(volatile unsigned int *)(0x1F006770) & 0x00FF) | 0x4000);
    *(volatile unsigned int *)(0x1F006774) = ((*(volatile unsigned int *)(0x1F006774) & 0x00FF) | 0x0500); //Power on Tx
    *(volatile unsigned int *)(0x1F0067D4) = ((*(volatile unsigned int *)(0x1F0067D4) & 0xFF00) | 0x0046);
    *(volatile unsigned int *)(0x1F006940) = ((*(volatile unsigned int *)(0x1F006940) & 0x00FF) | 0x0000); //Power on Tx
    *(volatile unsigned int *)(0x1F006874) = 0x0003;

    *(volatile unsigned int *)(0x1F006768) = ((*(volatile unsigned int *)(0x1F006768) & 0xFF00) | 0x0056); //gain shift
    ...
    *(volatile unsigned int *)(0x1F006684) = ((*(volatile unsigned int *)(0x1F006684) & 0x00FF) | 0x1500); //snr k value

    *(volatile unsigned int *)(0x1F006988) = (*(volatile unsigned int *)(0x1F006988) & 0x00FF); // 100gat
    *(volatile unsigned int *)(0x1F006860) = ((*(volatile unsigned int *)(0x1F006860) & 0xFF00) | 0x0043); //200 gt
    *(volatile unsigned int *)(0x1F006870) = ((*(volatile unsigned int *)(0x1F006870) & 0x00FF) | 0x0100); //200 gt
