...
void MHal_EMAC_ClkGen(void)
{
    ...
    *(volatile unsigned int *)(0xBF24336C) = ((*(volatile unsigned int *)(0xBF24336C) & 0x00FF) | 0x0700);
    *(volatile unsigned int *)(0xbf243394) = ((*(volatile unsigned int *)(0xbf243394) & 0x00FF) | 0x1100);
    *(volatile unsigned int *)(0xbf243398) = ((*(volatile unsigned int *)(0xbf243398) & 0xFF00) | 0x0080);
    *(volatile unsigned int *)(0xbf243398) = ((*(volatile unsigned int *)(0xbf243398) & 0x00FF) | 0xd100);
    *(volatile unsigned int *)(0xBF2433A8) = (*(volatile unsigned int *)(0xBF2433A8) & 0xFF00);
    *(volatile unsigned int *)(0xBF243370) = ((*(volatile unsigned int *)(0xBF243370) & 0x00FF) | 0x4000);
    *(volatile unsigned int *)(0xBF243374) = ((*(volatile unsigned int *)(0xBF243374) & 0x00FF) | 0x0500);
    *(volatile unsigned int *)(0xBF243360) = 0x6002;
    *(volatile unsigned int *)(0xBF243058) = ((*(volatile unsigned int *)(0xBF243058) & 0x00FF) | 0x1C00);
//    *(volatile unsigned int *)(0xBF243058) = ((*(volatile unsigned int *)(0xBF243058) & 0x00FF) | 0x3C00);
//    *(volatile unsigned int *)(0xBF243058) = ((*(volatile unsigned int *)(0xBF243058) & 0x00FF) | 0x1C00);

    *(volatile unsigned int *)(0xBF203D68) = ((*(volatile unsigned int *)(0xBF203D68) & 0xFF00) | 0x0010);
    *(volatile unsigned int *)(0xBF2430E4) = (*(volatile unsigned int *)(0xBF2430E4) & 0xFFF7); //unset loop_back_enable

    *(volatile unsigned int *)(0xBF201780) = 0x0000; //Set MII Mode
    *(volatile unsigned int *)(0xBF201784) = 0x0000;
    *(volatile unsigned int *)(0xBF201788) = 0x0001; //Disable RX clk from exterenel crystal
...
void MHal_EMAC_PadMux(void)
{
    ...
    *( ( u32 * ) ( ( char * ) 0xBF203C00 + 0x50*4 ) ) &= 0x7FFF;
    //chiptop [9:8] et_mode
#ifdef CONFIG_ETHERNET_ALBANY
    *( ( u32 * ) ( ( char * ) 0xBF203C00 + 0x6F*4 ) ) &= (~0x0100); //patch
#else
