...
void MHal_EMAC_ClkGen(void)
{
    ...
    *( ( u32 * ) ( ( char * ) 0xBF203C00 +  0x5A*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xBF203C00 +  0x5A*4) ) | 0x0010)); //LED patch for nugget
    *( ( u32 * ) ( ( char * ) 0xBF243200 +  0x5A*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xBF243200 +  0x5A*4) ) & 0xFF00) | 0x0056 ); //gain shift
    *( ( u32 * ) ( ( char * ) 0xBF243200 +  0x27*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xBF243200 +  0x27*4) ) & 0x00FF) | 0x0200 ); //det max
    *( ( u32 * ) ( ( char * ) 0xBF243200 +  0x28*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xBF243200 +  0x28*4) ) & 0x00FF) | 0x0100 ); //det min
    *( ( u32 * ) ( ( char * ) 0xBF243200 +  0x3B*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xBF243200 +  0x3B*4) ) & 0x00FF) | 0x1800 ); //snr len (emc noise)
    *( ( u32 * ) ( ( char * ) 0xBF243200 +  0x21*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xBF243200 +  0x21*4) ) & 0x00FF) | 0x1500 ); //snr k value
    *( ( u32 * ) ( ( char * ) 0xBF243200 +  0x6F*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xBF243200 +  0x6F*4) ) & 0xFF00) | 0x0059 ); // PLL DIV
    *( ( u32 * ) ( ( char * ) 0xBF243200 +  0x7A*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xBF243200 +  0x7A*4) ) & 0xFF00) | 0x0021 ); // function PLL MOD
    *( ( u32 * ) ( ( char * ) 0xBF243000 +  0x39*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xBF243000 +  0x39*4) ) & 0xFF00) | 0x0080); // lpbk_enable set to 0
    *( ( u32 * ) ( ( char * ) 0xBF243200 +  0x7E*4) ) = 0; // Power-on LDO
    *( ( u32 * ) ( ( char * ) 0xBF243200 +  0x5B*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xBF243200 +  0x5B*4) ) & 0x00FF) | 0x0700 ); // Power-on ADC
    *( ( u32 * ) ( ( char * ) 0xBF243200 +  0x65*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xBF243200 +  0x65*4) ) & 0x00FF) | 0x1100 ); // Power-on BGAP
    *( ( u32 * ) ( ( char * ) 0xBF243200 +  0x66*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xBF243200 +  0x66*4) ) & 0xFF00) | 0x0080 ); // Power-on ADCPL
    *( ( u32 * ) ( ( char * ) 0xBF243200 +  0x66*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xBF243200 +  0x66*4) ) & 0x00FF) | 0xd100 ); // Power-on ADCPL
    *( ( u32 * ) ( ( char * ) 0xBF243200 +  0x6A*4) ) = (*( ( u32 * ) ( ( char * ) 0xBF243200 +  0x6A*4) ) & 0xFF00); // Power-on LPF_OP
    *( ( u32 * ) ( ( char * ) 0xBF243200 +  0x5C*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xBF243200 +  0x5C*4) ) & 0x00FF) | 0x4000 ); // Power-on LP
    *( ( u32 * ) ( ( char * ) 0xBF243200 +  0x5D*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xBF243200 +  0x5D*4) ) & 0x00FF) | 0x0500 ); // Power-on REF
    *( ( u32 * ) ( ( char * ) 0xBF243200 +  0x75*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xBF243200 +  0x75*4) ) & 0xFF00) | 0x0046 ); // PORST
    *( ( u32 * ) ( ( char * ) 0xBF243400 +  0x50*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xBF243400 +  0x50*4) ) & 0x00FF) ); // VBUF
    *( ( u32 * ) ( ( char * ) 0xBF243400 +  0x1D*4) ) = 0x0003; // PD_TX_IDAC, PD_TX_LD = 0
    *( ( u32 * ) ( ( char * ) 0xBF243400 +  0x62*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xBF243400 +  0x62*4) ) & 0x00FF) ); // 100gat
    *( ( u32 * ) ( ( char * ) 0xBF243400 +  0x18*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xBF243400 +  0x18*4) ) & 0xFF00) | 0x0043 ); // 200gat
    *( ( u32 * ) ( ( char * ) 0xBF243400 +  0x1c*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xBF243400 +  0x1c*4) ) & 0x00FF) | 0x4100 ); // en_100t_phase
    // *( ( u32 * ) ( ( char * ) 0xBF243200 +  0x6c*4) ) = 0x30B0; // 100T TX performance (TEST_TX)
    *( ( u32 * ) ( ( char * ) 0xBF243400 +  0x74*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xBF243400 +  0x74*4) ) & 0xFF00) | 0x0006 );
    *( ( u32 * ) ( ( char * ) 0xBF243000 +  0x15*4) ) = ( (*( ( u32 * ) ( ( char * ) 0xBF243000 +  0x15*4) ) & 0x00FF) );

#else
    *(volatile unsigned int *)(0xBF201780) = 0x0400; //Set RMII Mode
    *(volatile unsigned int *)(0xBF201784) = 0x0004;
    *(volatile unsigned int *)(0xBF201788) = 0x0000; //Enable RX clk from exterenel crystal
...
void MHal_EMAC_PadMux(void)
{
    ...
    *( ( u32 * ) ( ( char * ) 0xBF203C00 + 0x50*4 ) ) &= 0x7FFF;
    //chiptop [9:8] et_mode
#ifdef CONFIG_ETHERNET_ALBANY
    *( ( u32 * ) ( ( char * ) 0xBF203C00 +  0x6F*4) ) &= (~0x0100);//LED patch for nugget
