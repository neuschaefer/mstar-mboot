...
void MHal_EMAC_ClkGen(void)
{
    ...
    if (*(volatile unsigned int *)(0x1F203D9C) >= 0x0101) // if chip revision is latter than K3S_U01
    {
        printf("Phy setting for K3S voltage mode,%x\n",*(volatile unsigned int *)(0x1F203D98));
        *(volatile unsigned int *)(0x1F001CC0) = ((*(volatile unsigned int *)(0x1F001CC0) & 0xFF00) | 0x0040); // PD_ETH33
        *(volatile unsigned int *)(0x1F0065E8) = ((*(volatile unsigned int *)(0x1F0065E8) & 0xFF00) | 0x0021); // Function PLL MOD
    ///?    *(volatile unsigned int *)(0x1F006588) = 0x0108;
        //*(volatile unsigned int *)(0x1F0062E4) = ((*(volatile unsigned int *)(0x1F0062E4) & 0xFF00) | 0x0080); // Lpbk_enable set to 0
        *(volatile unsigned int *)(0x1F0062E4) = ((*(volatile unsigned int *)(0x1F0062E4) & 0xFF00) | 0x00A0); // Lpbk_enable set to 0
        //*(volatile unsigned int *)(0x1F0065F8) = 0x0000; //Power-on LDO25/LDO11
        *(volatile unsigned int *)(0x1F0065F8) = 0x0002; //Power-on LDO25/LDO11
        *(volatile unsigned int *)(0x1F00656C) = ((*(volatile unsigned int *)(0x1F00656C) & 0x00FF) | 0x0700); // Power-on ADC
        *(volatile unsigned int *)(0x1F006594) = ((*(volatile unsigned int *)(0x1F006594) & 0x00FF) | 0x1100); // Power-on BGAP
        *(volatile unsigned int *)(0x1F006598) = 0xD180; // Power-on ADCPL, Power-on ADCPL
        *(volatile unsigned int *)(0x1F0065A8) = (*(volatile unsigned int *)(0x1F0065A8) & 0xFF00); //Power-on LPF_OP
        *(volatile unsigned int *)(0x1F006570) = ((*(volatile unsigned int *)(0x1F006570) & 0x00FF) | 0x4000); // Power-on LP
        *(volatile unsigned int *)(0x1F006574) = ((*(volatile unsigned int *)(0x1F006574) & 0x00FF) | 0x0500); // Power on REF
    ///    *(volatile unsigned int *)(0x1F006560) = 0x6002; // Power-on TX
        *(volatile unsigned int *)(0x1F006660) = ((*(volatile unsigned int *)(0x1F006660) & 0xFF00) | 0x0041); //Enable DAC2x clock, reg_lut_new=1
        *(volatile unsigned int *)(0x1F006788) = ((*(volatile unsigned int *)(0x1F006788) & 0x00FF) | 0x0000); // 100gat

        *(volatile unsigned int *)(0x1F006674) = 0x0000; //PD_TX_IDAC, PAD_TX_LD = 0


        *(volatile unsigned int *)(0x1F006568) = ((*(volatile unsigned int *)(0x1F006568) & 0xFF00) | 0x0056); //gain shift
        *(volatile unsigned int *)(0x1F00649C) = ((*(volatile unsigned int *)(0x1F00649C) & 0x00FF) | 0x0200); //det max
        *(volatile unsigned int *)(0x1F0064A0) = ((*(volatile unsigned int *)(0x1F0064A0) & 0x00FF) | 0x0100); //det min
        *(volatile unsigned int *)(0x1F0064EC) = ((*(volatile unsigned int *)(0x1F0064EC) & 0x00FF) | 0x1800); //snr len (emc noise)
    ///    *(volatile unsigned int *)(0x1F006484) = ((*(volatile unsigned int *)(0x1F006484) & 0x00FF) | 0x1500); //snr k value
    ///    *(volatile unsigned int *)(0x1F0062E4) = (*(volatile unsigned int *)(0x1F0062E4) & 0xFFF7); //unset loop_back_enable

        //*(volatile unsigned int *)(0x1F001DA8) = ((*(volatile unsigned int *)(0x1F001DA8) & 0x00FF) | 0x0600); //LED

        *(volatile unsigned int *)(0x1F006318) = ((*(volatile unsigned int *)(0x1F006318) & 0xFF00) | 0x00FC); // REG_WAVESHAPING_TIN_2
        *(volatile unsigned int *)(0x1F006718) = ((*(volatile unsigned int *)(0x1F006718) & 0xFF00) | 0x00E8); // REG_WAVESHAPING_TIN_2
        *(volatile unsigned int *)(0x1F00631C) = 0xDAC4; // REG_WAVESHAPING_TIN_3
        *(volatile unsigned int *)(0x1F00671C) = 0xCEC0; // REG_WAVESHAPING_TIN_3
        *(volatile unsigned int *)(0x1F006320) = 0xC2D8; // REG_WAVESHAPING_TIN_4
        *(volatile unsigned int *)(0x1F006720) = 0xCCE0; // REG_WAVESHAPING_TIN_4
        *(volatile unsigned int *)(0x1F006324) = 0x0428; // REG_WAVESHAPING_TIN_5
        *(volatile unsigned int *)(0x1F006724) = 0x1836; // REG_WAVESHAPING_TIN_5
        *(volatile unsigned int *)(0x1F006328) = 0x3E3C; // REG_WAVESHAPING_TIN_6
        *(volatile unsigned int *)(0x1F006728) = 0x4032; // REG_WAVESHAPING_TIN_6
        *(volatile unsigned int *)(0x1F00632C) = 0x2220; // REG_WAVESHAPING_TIN_7
        *(volatile unsigned int *)(0x1F00672C) = 0x1020; // REG_WAVESHAPING_TIN_7
        *(volatile unsigned int *)(0x1F006330) = 0x2020; // REG_WAVESHAPING_TIN_8
        *(volatile unsigned int *)(0x1F006730) = 0x2020; // REG_WAVESHAPING_TIN_8
        *(volatile unsigned int *)(0x1F006334) = 0x2016; // REG_WAVESHAPING_TIN_9
        *(volatile unsigned int *)(0x1F006734) = 0x200C; // REG_WAVESHAPING_TIN_9
        *(volatile unsigned int *)(0x1F006338) = 0xE0E0; // REG_WAVESHAPING_TIN_10
        *(volatile unsigned int *)(0x1F006738) = 0xE0E0; // REG_WAVESHAPING_TIN_10
        *(volatile unsigned int *)(0x1F00633C) = 0xE0E0; // REG_WAVESHAPING_TIN_11
        *(volatile unsigned int *)(0x1F00673C) = 0xE0E0; // REG_WAVESHAPING_TIN_11
        *(volatile unsigned int *)(0x1F006340) = 0xEAFC; // REG_WAVESHAPING_TIN_12
        *(volatile unsigned int *)(0x1F006740) = 0xF4E8; // REG_WAVESHAPING_TIN_12
        *(volatile unsigned int *)(0x1F006344) = 0xD8C2; // REG_WAVESHAPING_TIN_13
        *(volatile unsigned int *)(0x1F006744) = 0xCAC0; // REG_WAVESHAPING_TIN_13
        *(volatile unsigned int *)(0x1F006348) = 0xC4DE; // REG_WAVESHAPING_TIN_14
        *(volatile unsigned int *)(0x1F006748) = 0xCEF0; // REG_WAVESHAPING_TIN_14
        *(volatile unsigned int *)(0x1F00634C) = 0x0426; // REG_WAVESHAPING_TIN_15
        *(volatile unsigned int *)(0x1F00674C) = 0x1832; // REG_WAVESHAPING_TIN_15
        *(volatile unsigned int *)(0x1F006350) = 0x3C3E; // REG_WAVESHAPING_TIN_16
        *(volatile unsigned int *)(0x1F006750) = 0x4034; // REG_WAVESHAPING_TIN_16
        *(volatile unsigned int *)(0x1F006354) = ((*(volatile unsigned int *)(0x1F006354) & 0x00FF) | 0x2000); // REG_WAVESHAPING_TIN_17
        *(volatile unsigned int *)(0x1F006754) = ((*(volatile unsigned int *)(0x1F006754) & 0x00FF) | 0x2800); // REG_WAVESHAPING_TIN_17
        *(volatile unsigned int *)(0x1F006678) = ((*(volatile unsigned int *)(0x1F006678) & 0xFF00) | 0x0040); // 100T pos 40h = 64
        *(volatile unsigned int *)(0x1F006678) = ((*(volatile unsigned int *)(0x1F006678) & 0x00FF) | 0x2000); // 100T zero 20h = 32 (keep)
        *(volatile unsigned int *)(0x1F00667C) = ((*(volatile unsigned int *)(0x1F00667C) & 0xFF00) | 0x0000); // 100T neg 00h =  0
        *(volatile unsigned int *)(0x1F006670) = ((*(volatile unsigned int *)(0x1F006670) & 0x00FF) | 0x4100); // [0] en_tx_100t_phase [6] save2x_tx
    }
    else
    {
        printf("Phy setting for k3 current mode,%x,%x\n",*(volatile unsigned int *)(0x1F203D9C),*(volatile unsigned int *)(0x1F203D98));
        *(volatile unsigned int *)(0x1F001CC0) = ((*(volatile unsigned int *)(0x1F001CC0) & 0xFF00) | 0x0040); // PD_ETH33
        *(volatile unsigned int *)(0x1F0065E8) = ((*(volatile unsigned int *)(0x1F0065E8) & 0xFF00) | 0x0021); // Function PLL MOD
        *(volatile unsigned int *)(0x1F006588) = 0x0108;
        *(volatile unsigned int *)(0x1F0062E4) = ((*(volatile unsigned int *)(0x1F0062E4) & 0xFF00) | 0x0080); // Lpbk_enable set to 0
        ...
        *(volatile unsigned int *)(0x1F201780) = 0x0000; //Set MII Mode
        *(volatile unsigned int *)(0x1F201784) = 0x0000;
        *(volatile unsigned int *)(0x1F201788) = 0x0001; //Disable RX clk from exterenel crystal
    }
#else
    *(volatile unsigned int *)(0x1F201780) = 0x0400; //Set RMII Mode
    *(volatile unsigned int *)(0x1F201784) = 0x0004;
    *(volatile unsigned int *)(0x1F201788) = 0x0000; //Enable RX clk from exterenel crystal
...
void MHal_EMAC_PadMux(void)
{
    ...
    *( ( u32 * ) ( ( char * ) 0x1F203C00 + 0x50*4 ) ) &= 0x7FFF;
    //chiptop [9:8] et_mode
#ifdef CONFIG_ETHERNET_ALBANY
    *( ( u32 * ) ( ( char * ) 0x1F203C00 + 0x6F*4 ) ) &= (~0x0100); //patch
#else
    *( ( u32 * ) ( ( char * ) 0x1F203C00 + 0x6F*4 ) ) |= 0x0100;    //et_mode = 1
#endif
}
